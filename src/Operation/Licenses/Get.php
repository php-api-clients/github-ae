...
final class Get
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Licenses\CbLicenseRcb $hydrator, string $license)
    {
    ...
    public function createResponse(ResponseInterface $response): Schema\License
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\License::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
