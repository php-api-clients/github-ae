...
final class Issues
{
    ...
    public function list(string $labels, string $since, bool $collab, bool $orgs, bool $owned, bool $pulls, string $filter, string $state, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listForOrg(string $org, string $labels, string $since, string $filter, string $state, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listAssignees(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkUserCanBeAssigned(string $owner, string $repo, string $assignee): PromiseInterface
    {
    ...
    public function listForRepo(string $owner, string $repo, string $milestone, string $assignee, string $creator, string $mentioned, string $labels, string $since, string $state, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listCommentsForRepo(string $owner, string $repo, string $direction, string $since, string $sort, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getComment(string $owner, string $repo, int $commentId): PromiseInterface
    {
    ...
    public function deleteComment(string $owner, string $repo, int $commentId): PromiseInterface
    {
    ...
    public function updateComment(string $owner, string $repo, int $commentId, array $params): PromiseInterface
    {
    ...
    public function listEventsForRepo(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getEvent(string $owner, string $repo, int $eventId): PromiseInterface
    {
    ...
    public function get(string $owner, string $repo, int $issueNumber): PromiseInterface
    {
    ...
    public function update(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function addAssignees(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function removeAssignees(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function checkUserCanBeAssignedToIssue(string $owner, string $repo, int $issueNumber, string $assignee): PromiseInterface
    {
    ...
    public function listComments(string $owner, string $repo, int $issueNumber, string $since, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createComment(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function listEvents(string $owner, string $repo, int $issueNumber, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listLabelsOnIssue(string $owner, string $repo, int $issueNumber, int $perPage, int $page): PromiseInterface
    {
    ...
    public function setLabels(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function addLabels(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function removeAllLabels(string $owner, string $repo, int $issueNumber): PromiseInterface
    {
    ...
    public function removeLabel(string $owner, string $repo, int $issueNumber, string $name): PromiseInterface
    {
    ...
    public function lock(string $owner, string $repo, int $issueNumber, array $params): PromiseInterface
    {
    ...
    public function unlock(string $owner, string $repo, int $issueNumber): PromiseInterface
    {
    ...
    public function listEventsForTimeline(string $owner, string $repo, int $issueNumber, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listLabelsForRepo(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createLabel(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function getLabel(string $owner, string $repo, string $name): PromiseInterface
    {
    ...
    public function deleteLabel(string $owner, string $repo, string $name): PromiseInterface
    {
    ...
    public function updateLabel(string $owner, string $repo, string $name, array $params): PromiseInterface
    {
    ...
    public function listMilestones(string $owner, string $repo, string $state, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createMilestone(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function getMilestone(string $owner, string $repo, int $milestoneNumber): PromiseInterface
    {
    ...
    public function deleteMilestone(string $owner, string $repo, int $milestoneNumber): PromiseInterface
    {
    ...
    public function updateMilestone(string $owner, string $repo, int $milestoneNumber, array $params): PromiseInterface
    {
    ...
    public function listLabelsForMilestone(string $owner, string $repo, int $milestoneNumber, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listForAuthenticatedUser(string $labels, string $since, string $filter, string $state, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
