...
final class ListWebhookDeliveries
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{hook_id}', '{cursor}', '{redelivery}', '{per_page}'), array($this->org, $this->hookId, $this->cursor, $this->redelivery, $this->perPage), self::PATH . '?cursor={cursor}&redelivery={redelivery}&per_page={per_page}'));
    }
    /**
