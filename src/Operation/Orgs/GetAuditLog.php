...
final class GetAuditLog
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{phrase}', '{after}', '{before}', '{order}', '{per_page}', '{page}'), array($this->org, $this->phrase, $this->after, $this->before, $this->order, $this->perPage, $this->page), self::PATH . '?phrase={phrase}&after={after}&before={before}&order={order}&per_page={per_page}&page={page}'));
    }
    /**
