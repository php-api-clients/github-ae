...
final class ListOutsideCollaboratorsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\OutsideCollaborators $hydrator, string $org, string $filter = 'all', int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
        $this->filter  = $filter;
