...
final class ListWebhooksListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Hooks $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\OrgHook {
                            ...
                            try {
                                ...
                                return $this->hydrators->hydrateObject(Schema\OrgHook::class, $body);
