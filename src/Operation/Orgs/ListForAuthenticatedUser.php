...
final class ListForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Orgs $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Orgs $hydrator, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\OrganizationSimple>|Schema\BasicError
     */
