...
final class Update
{
    ...
    /**
     * @return Schema\OrganizationFull|Schema\Operation\Orgs\Update\Response\Applicationjson\H422|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrganizationFull|Schema\Operation\Orgs\Update\Response\Applicationjson\H422|Schema\BasicError
    {
