...
final class ListAppInstallationsListing
{
    public const OPERATION_ID = 'orgs/list-app-installations';
    public const OPERATION_MATCH = 'LIST /orgs/{org}/installations';
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Installations $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
