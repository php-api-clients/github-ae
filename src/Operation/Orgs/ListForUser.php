...
final class ListForUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Orgs $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
