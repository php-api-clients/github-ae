...
final class GetMembershipForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Memberships\CbUsernameRcb $hydrator, string $org, string $username)
    {
        $this->org                     = $org;
