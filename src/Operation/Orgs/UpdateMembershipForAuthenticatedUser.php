...
final class UpdateMembershipForAuthenticatedUser
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Memberships\Orgs\Org $hydrator, string $org)
    {
        $this->org = $org;
    }
