...
final class UpdateMembershipForAuthenticatedUser
{
    ...
    /**
     * @return Schema\OrgMembership|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrgMembership|Schema\BasicError|Schema\ValidationError
    {
