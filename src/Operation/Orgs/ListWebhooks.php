...
final class ListWebhooks
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Hooks $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\OrgHook::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
