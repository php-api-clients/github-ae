...
final class ListOutsideCollaborators
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{filter}', '{per_page}', '{page}'), array($this->org, $this->filter, $this->perPage, $this->page), self::PATH . '?filter={filter}&perPage={per_page}&page={page}'));
    }
    /**
