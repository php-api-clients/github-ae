...
final class ListWatchedReposForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Subscriptions $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Subscriptions $hydrator, int $per_page = 30, int $page = 1)
    {
