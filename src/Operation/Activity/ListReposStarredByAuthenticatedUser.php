...
final class ListReposStarredByAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{sort}', '{direction}', '{per_page}', '{page}'), array($this->sort, $this->direction, $this->perPage, $this->page), self::PATH . '?sort={sort}&direction={direction}&per_page={per_page}&page={page}'));
    }
    /**
