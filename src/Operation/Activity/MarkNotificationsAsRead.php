...
final class MarkNotificationsAsRead
{
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Activity\MarkNotificationsAsRead\Response\Applicationjson\H202
    {
