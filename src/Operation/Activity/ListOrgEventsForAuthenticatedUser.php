...
final class ListOrgEventsForAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{username}', '{org}', '{per_page}', '{page}'), array($this->username, $this->org, $this->perPage, $this->page), self::PATH . '?perPage={per_page}&page={page}'));
    }
    /**
