...
final class ListOrgEventsForAuthenticatedUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Events\Orgs\CbOrgRcb $hydrator, string $username, string $org, int $per_page = 30, int $page = 1)
    {
