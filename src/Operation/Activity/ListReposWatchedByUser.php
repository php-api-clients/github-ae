...
final class ListReposWatchedByUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Subscriptions $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
