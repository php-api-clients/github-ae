...
final class ListEventsForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Events $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
