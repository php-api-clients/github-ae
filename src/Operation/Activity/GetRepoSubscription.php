...
final class GetRepoSubscription
{
    ...
    /**
     * @return Schema\RepositorySubscription|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\RepositorySubscription|Schema\BasicError
    {
