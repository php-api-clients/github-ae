...
final class ListStargazersForRepoListing
{
    public const OPERATION_ID = 'activity/list-stargazers-for-repo';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/stargazers';
     ...
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Activity\ListStargazersForRepo\Response\Applicationjson\H200
    {
