...
final class ListWatchersForRepoListing
{
    public const OPERATION_ID = 'activity/list-watchers-for-repo';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/subscribers';
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Subscribers $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Subscribers $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
