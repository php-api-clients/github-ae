...
final class ListStargazersForRepo
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Stargazers $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return Schema\Operation\Activity\ListStargazersForRepo\Response\Applicationjson\H200|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Activity\ListStargazersForRepo\Response\Applicationjson\H200|Schema\ValidationError
    {
