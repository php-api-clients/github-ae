...
final class SetThreadSubscription
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Notifications\Threads\CbThreadIdRcb\Subscription $hydrator, int $threadId)
    {
    ...
    public function createResponse(ResponseInterface $response): Schema\ThreadSubscription
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\ThreadSubscription::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
