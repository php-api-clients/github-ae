...
final class ListReposWatchedByUserListing
{
    ...
    private readonly Hydrator\Operation\Users\CbUsernameRcb\Subscriptions $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Subscriptions $hydrator, string $username, int $per_page = 30, int $page = 1)
    {
