...
final class CreateReview
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Pulls\CbPullNumberRcb\Reviews $hydrator, string $owner, string $repo, int $pull_number)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Pulls\CreateReview\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return Schema\PullRequestReview|Schema\ValidationErrorSimple|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequestReview|Schema\ValidationErrorSimple|Schema\BasicError
    {
