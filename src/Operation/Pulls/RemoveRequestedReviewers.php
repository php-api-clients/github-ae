...
final class RemoveRequestedReviewers
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Pulls\CbPullNumberRcb\RequestedReviewers $hydrator, string $owner, string $repo, int $pull_number)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Pulls\RemoveRequestedReviewers\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return Schema\PullRequestSimple|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequestSimple|Schema\ValidationError
    {
