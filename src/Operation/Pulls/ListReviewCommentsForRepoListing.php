...
final class ListReviewCommentsForRepoListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Pulls\Comments $hydrator, string $owner, string $repo, private string $sort, string $direction, string $since, int $perPage = 30, int $page = 1)
    {
        $this->owner     = $owner;
        $this->repo      = $repo;
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\PullRequestReviewComment {
                            ...
                            try {
                                ...
                                return $this->hydrators->hydrateObject(Schema\PullRequestReviewComment::class, $body);
