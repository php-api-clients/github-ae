...
final class GetReview
{
    ...
    /**
     * @return Schema\PullRequestReview|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequestReview|Schema\BasicError
    {
