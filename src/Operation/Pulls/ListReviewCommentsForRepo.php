...
final class ListReviewCommentsForRepo
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{sort}', '{direction}', '{since}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->sort, $this->direction, $this->since, $this->perPage, $this->page), self::PATH . '?sort={sort}&direction={direction}&since={since}&perPage={per_page}&page={page}'));
    }
    /**
