...
final class UpdateBranch
{
    ...
    /**
     * @return Schema\Operation\EnterpriseAdmin\UpdateOrgName\Response\Applicationjson\H202|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\EnterpriseAdmin\UpdateOrgName\Response\Applicationjson\H202|Schema\ValidationError|Schema\BasicError
    {
