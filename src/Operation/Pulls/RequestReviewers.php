...
final class RequestReviewers
{
    ...
    /**
     * @return Schema\PullRequestSimple|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequestSimple|Schema\BasicError
    {
