...
final class CreateReplyForReviewComment
{
    ...
    /**
     * @return Schema\PullRequestReviewComment|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequestReviewComment|Schema\BasicError
    {
