...
final class Migrations
{
    ...
    public function listForOrg(string $org, array $exclude, int $perPage, int $page): PromiseInterface
    {
    ...
    public function startForOrg(string $org, array $params): PromiseInterface
    {
    ...
    public function getStatusForOrg(string $org, int $migrationId, array $exclude): PromiseInterface
    {
    ...
    public function downloadArchiveForOrg(string $org, int $migrationId): PromiseInterface
    {
    ...
    public function downloadArchiveForOrgStreaming(string $org, int $migrationId): PromiseInterface
    {
    ...
    public function deleteArchiveForOrg(string $org, int $migrationId): PromiseInterface
    {
    ...
    public function unlockRepoForOrg(string $org, int $migrationId, string $repoName): PromiseInterface
    {
    ...
    public function listReposForOrg(string $org, int $migrationId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function startForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function getArchiveForAuthenticatedUser(int $migrationId): PromiseInterface
    {
    ...
    public function listReposForAuthenticatedUser(int $migrationId, int $perPage, int $page): PromiseInterface
    {
