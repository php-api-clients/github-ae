...
final class Search
{
    ...
    public function commits(string $q, string $sort, string $order, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\Commits\Response\ApplicationJson\Ok|array
    {
    ...
    public function issuesAndPullRequests(string $q, string $sort, string $order, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\IssuesAndPullRequests\Response\ApplicationJson\Ok|array
    {
    ...
    public function labels(int $repositoryId, string $q, string $sort, string $order, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\Labels\Response\ApplicationJson\Ok|array
    {
    ...
    public function repos(string $q, string $sort, string $order, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\Repos\Response\ApplicationJson\Ok|array
    {
    ...
    public function topics(string $q, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\Topics\Response\ApplicationJson\Ok|array
    {
    ...
    public function users(string $q, string $sort, string $order, int $perPage, int $page): \ApiClients\Client\GitHubAE\Schema\Operations\Search\Users\Response\ApplicationJson\Ok|array
    {
