...
final class Reactions
{
    ...
    /** @return Schema\Reaction */
    public function createForRelease(string $owner, string $repo, int $releaseId, array $params): Reaction|array
    {
        return $this->operators->reactions👷CreateForRelease()->call($owner, $repo, $releaseId, $params);
    }

    /** @return array{code:int} */
    public function deleteForRelease(string $owner, string $repo, int $releaseId, int $reactionId): array
    {
