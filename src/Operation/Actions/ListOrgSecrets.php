...
final class ListOrgSecrets
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Actions\Secrets $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
