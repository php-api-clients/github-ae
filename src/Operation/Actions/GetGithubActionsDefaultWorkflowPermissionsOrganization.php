...
final class GetGithubActionsDefaultWorkflowPermissionsOrganization
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\Actions\Permissions\Workflow $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Actions\Permissions\Workflow $hydrator, string $org)
    {
        $this->org                     = $org;
