...
final class ListSelfHostedRunnersForRepo
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Actions\Runners $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Actions\Runners $hydrator, string $owner, string $repo, int $perPage = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
