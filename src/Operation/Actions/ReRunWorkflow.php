...
final class ReRunWorkflow
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Rerun $hydrator, string $owner, string $repo, int $runId)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookCheckSuiteCompleted\ActionsMeta::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
