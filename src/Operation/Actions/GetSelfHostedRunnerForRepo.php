...
final class GetSelfHostedRunnerForRepo
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Runners\CbRunnerIdRcb $hydrator, string $owner, string $repo, int $runner_id)
    {
        $this->owner = $owner;
        $this->repo = $repo;
