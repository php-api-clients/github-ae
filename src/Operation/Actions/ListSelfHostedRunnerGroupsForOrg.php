...
final class ListSelfHostedRunnerGroupsForOrg
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Actions\RunnerGroups $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org = $org;
