...
final class ListRepoWorkflowsListing
{
    public const OPERATION_ID = 'actions/list-repo-workflows';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/actions/workflows';
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Workflows $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Workflows $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return Schema\Operation\Actions\ListRepoWorkflows\Response\Applicationjson\H200
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Actions\ListRepoWorkflows\Response\Applicationjson\H200
    {
