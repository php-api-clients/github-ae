...
final class ListSelfHostedRunnersForOrgListing
{
    public const OPERATION_ID = 'actions/list-self-hosted-runners-for-org';
    public const OPERATION_MATCH = 'LIST /orgs/{org}/actions/runners';
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Actions\Runners $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
