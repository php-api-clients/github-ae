...
final class ListJobsForWorkflowRunAttempt
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{run_id}', '{attempt_number}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->runId, $this->attemptNumber, $this->perPage, $this->page), self::PATH . '?perPage={per_page}&page={page}'));
    }
    /**
