...
final class ListRecentAnalyses
{
    ...
    /**
     * @return \Rx\Observable<Schema\CodeScanningAnalysis>|Schema\BasicError|Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
