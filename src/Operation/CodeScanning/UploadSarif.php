...
final class UploadSarif
{
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CodeScanning\Sarifs $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CodeScanning\Sarifs $hydrator, string $owner, string $repo)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\CodeScanning\UploadSarif\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodeScanningSarifsReceipt
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 202:
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(Schema\CodeScanningSarifsReceipt::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
