...
final class UploadSarif
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CodeScanning\Sarifs $hydrator, string $owner, string $repo)
    {
    ...
    public function createResponse(ResponseInterface $response): Schema\CodeScanningSarifsReceipt
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 202:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\CodeScanningSarifsReceipt::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
