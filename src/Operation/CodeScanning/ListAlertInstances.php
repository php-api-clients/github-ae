...
final class ListAlertInstances
{
    ...
    /**
     * @return \Rx\Observable<Schema\CodeScanningAlertInstance>|Schema\BasicError|Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(Schema\CodeScanningAlertInstance::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
