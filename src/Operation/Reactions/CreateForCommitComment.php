...
final class CreateForCommitComment
{
    ...
    /**
     * @return Schema\Reaction|Schema\ValidationError|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Reaction|Schema\ValidationError|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
    {
