...
final class ListForIssue
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{issue_number}', '{content}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->issueNumber, $this->content, $this->perPage, $this->page), self::PATH . '?content={content}&perPage={per_page}&page={page}'));
    }
    /**
