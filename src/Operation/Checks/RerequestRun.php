...
final class RerequestRun
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CheckDashRuns\CbCheckRunIdRcb\Rerequest $hydrator, string $owner, string $repo, int $check_run_id)
    {
        $this->owner = $owner;
        $this->repo = $repo;
