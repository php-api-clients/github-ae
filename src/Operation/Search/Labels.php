...
final class Labels
{
    ...
    /**
     * @return Schema\Operation\Search\Labels\Response\Applicationjson\H200|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\Labels\Response\Applicationjson\H200|Schema\BasicError|Schema\ValidationError
    {
