...
final class Topics
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{q}', '{per_page}', '{page}'), array($this->q, $this->perPage, $this->page), self::PATH . '?q={q}&perPage={per_page}&page={page}'));
    }
    /**
