...
final class Code
{
    ...
    /**
     * @return Schema\Operation\Search\Code\Response\Applicationjson\H200|Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\Code\Response\Applicationjson\H200|Schema\Operation\SecretScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
    {
