...
final class Repos
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Search\Repositories $hydrator, string $q, string $sort, string $order = 'desc', int $perPage = 30, int $page = 1)
    {
        $this->q                       = $q;
        $this->sort                    = $sort;
        $this->order                   = $order;
    ...
    public function createResponse(ResponseInterface $response): Schema\Operation\Search\Repos\Response\Applicationjson\H200
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\Operation\Search\Repos\Response\Applicationjson\H200::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
