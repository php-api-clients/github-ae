...
final class CreateRef
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Git\Refs $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Git\Refs $hydrator, string $owner, string $repo)
    {
