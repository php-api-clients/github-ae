...
final class CreateCommit
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Git\Commits $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Git\Commits $hydrator, string $owner, string $repo)
    {
