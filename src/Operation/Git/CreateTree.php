...
final class CreateTree
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Git\Trees $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Git\Trees $hydrator, string $owner, string $repo)
    {
