...
final class CreateRemoveTokenForEnterprise
{
    ...
    private readonly Hydrator\Operation\Enterprises\Enterprise\Actions\Runners\RemoveToken $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\Enterprise\Actions\Runners\RemoveToken $hydrator, string $enterprise)
    {
