...
final class ListGlobalWebhooksListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Admin\Hooks $hydrator, int $perPage = 30, int $page = 1)
    {
