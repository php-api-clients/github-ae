...
final class StartPreReceiveEnvironmentDownloadStreaming
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Admin\PreDashReceiveDashEnvironments\CbPreReceiveEnvironmentIdRcb\Downloads $hydrator, Browser $browser, int $preReceiveEnvironmentId)
    {
            ...
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    ...
                    case 422:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\Operation\EnterpriseAdmin\StartPreReceiveEnvironmentDownloadStreaming\Response\Applicationjson\H422::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
