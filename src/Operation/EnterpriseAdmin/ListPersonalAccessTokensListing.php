...
final class ListPersonalAccessTokensListing
{
    public const OPERATION_ID = 'enterprise-admin/list-personal-access-tokens';
    public const OPERATION_MATCH = 'LIST /admin/tokens';
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Admin\Tokens $hydrator, int $per_page = 30, int $page = 1)
    {
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\Authorization::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
