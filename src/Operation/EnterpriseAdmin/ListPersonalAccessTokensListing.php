...
final class ListPersonalAccessTokensListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Admin\Tokens $hydrator, int $perPage = 30, int $page = 1)
    {
