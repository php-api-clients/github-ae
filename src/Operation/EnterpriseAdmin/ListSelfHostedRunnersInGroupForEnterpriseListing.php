...
final class ListSelfHostedRunnersInGroupForEnterpriseListing
{
    public const OPERATION_ID = 'enterprise-admin/list-self-hosted-runners-in-group-for-enterprise';
    public const OPERATION_MATCH = 'LIST /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/runners';
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\RunnerDashGroups\CbRunnerGroupIdRcb\Runners $hydrator, string $enterprise, int $runner_group_id, int $per_page = 30, int $page = 1)
    {
