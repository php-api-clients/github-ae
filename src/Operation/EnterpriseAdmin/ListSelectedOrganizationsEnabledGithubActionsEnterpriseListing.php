...
final class ListSelectedOrganizationsEnabledGithubActionsEnterpriseListing
{
    public const OPERATION_ID = 'enterprise-admin/list-selected-organizations-enabled-github-actions-enterprise';
    public const OPERATION_MATCH = 'LIST /enterprises/{enterprise}/actions/permissions/organizations';
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Permissions\Organizations $hydrator, string $enterprise, int $per_page = 30, int $page = 1)
    {
