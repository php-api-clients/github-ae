...
final class GetAllowedActionsEnterprise
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Permissions\SelectedActions $hydrator, string $enterprise)
    {
