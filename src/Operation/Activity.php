...
final class Activity
{
    ...
    public function getFeeds(): PromiseInterface
    {
    ...
    public function listNotificationsForAuthenticatedUser(string $since, string $before, bool $all, bool $participating, int $page, int $perPage): PromiseInterface
    {
    ...
    public function markNotificationsAsRead(array $params): PromiseInterface
    {
    ...
    public function getThread(int $threadId): PromiseInterface
    {
    ...
    public function markThreadAsRead(int $threadId): PromiseInterface
    {
    ...
    public function getThreadSubscriptionForAuthenticatedUser(int $threadId): PromiseInterface
    {
    ...
    public function setThreadSubscription(int $threadId, array $params): PromiseInterface
    {
    ...
    public function deleteThreadSubscription(int $threadId): PromiseInterface
    {
    ...
    public function listRepoEvents(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listRepoNotificationsForAuthenticatedUser(string $owner, string $repo, string $since, string $before, bool $all, bool $participating, int $perPage, int $page): PromiseInterface
    {
    ...
    public function markRepoNotificationsAsRead(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function listStargazersForRepo(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listWatchersForRepo(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getRepoSubscription(string $owner, string $repo): PromiseInterface
    {
    ...
    public function setRepoSubscription(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function deleteRepoSubscription(string $owner, string $repo): PromiseInterface
    {
    ...
    public function listReposStarredByAuthenticatedUser(string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkRepoIsStarredByAuthenticatedUser(string $owner, string $repo): PromiseInterface
    {
    ...
    public function starRepoForAuthenticatedUser(string $owner, string $repo): PromiseInterface
    {
    ...
    public function unstarRepoForAuthenticatedUser(string $owner, string $repo): PromiseInterface
    {
    ...
    public function listWatchedReposForAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function listEventsForAuthenticatedUser(string $username, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listOrgEventsForAuthenticatedUser(string $username, string $org, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listReposStarredByUser(string $username, string $sort, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listReposWatchedByUser(string $username, int $perPage, int $page): PromiseInterface
    {
