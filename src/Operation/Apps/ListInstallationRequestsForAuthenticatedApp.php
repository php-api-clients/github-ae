...
final class ListInstallationRequestsForAuthenticatedApp
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\App\InstallationRequests $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    /**
     * @return Observable<Schema\IntegrationInstallationRequest>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\IntegrationInstallationRequest::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
