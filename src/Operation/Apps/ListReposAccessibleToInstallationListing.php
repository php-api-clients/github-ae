...
final class ListReposAccessibleToInstallationListing
{
    public const OPERATION_ID = 'apps/list-repos-accessible-to-installation';
    public const OPERATION_MATCH = 'LIST /installation/repositories';
     ...
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Apps\ListReposAccessibleToInstallation\Response\Applicationjson\H200
    {
