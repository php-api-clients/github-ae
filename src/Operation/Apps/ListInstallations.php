...
final class ListInstallations
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\App\Installations $hydrator, string $since, private string $outdated, int $perPage = 30, int $page = 1)
    {
        $this->since   = $since;
