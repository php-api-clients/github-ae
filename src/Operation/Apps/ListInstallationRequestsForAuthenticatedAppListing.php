...
final class ListInstallationRequestsForAuthenticatedAppListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\App\InstallationRequests $hydrator, int $perPage = 30, int $page = 1)
    {
