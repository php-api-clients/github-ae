...
final class ListInstallationRequestsForAuthenticatedAppListing
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\App\InstallationRequests $hydrator, int $per_page = 30, int $page = 1)
    {
