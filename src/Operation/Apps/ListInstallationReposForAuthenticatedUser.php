...
final class ListInstallationReposForAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{installation_id}', '{per_page}', '{page}'), array($this->installationId, $this->perPage, $this->page), self::PATH . '?perPage={per_page}&page={page}'));
    }
    /**
