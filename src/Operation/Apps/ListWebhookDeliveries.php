...
final class ListWebhookDeliveries
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\App\Hook\Deliveries $hydrator, string $cursor, bool $redelivery, int $perPage = 30)
    {
        $this->cursor                  = $cursor;
