...
final class CreateInstallationAccessToken
{
    ...
    /**
     * @return Schema\InstallationToken|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\InstallationToken|Schema\BasicError|Schema\ValidationError
    {
