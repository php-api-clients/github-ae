...
final class ListCommits
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\CbGistIdRcb\Commits $hydrator, string $gistId, int $perPage = 30, int $page = 1)
    {
        $this->gistId                  = $gistId;
    ...
    /**
     * @return Observable<Schema\GistCommit>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\GistCommit::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
