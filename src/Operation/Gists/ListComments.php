...
final class ListComments
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\CbGistIdRcb\Comments $hydrator, string $gist_id, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\GistComment>|Schema\BasicError
     */
