...
final class ListComments
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\GistId\Comments $hydrator, string $gistId, int $perPage = 30, int $page = 1)
    {
        $this->gistId                  = $gistId;
