...
final class ListComments
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\CbGistIdRcb\Comments $hydrator, string $gistId, int $perPage = 30, int $page = 1)
    {
        $this->gistId                  = $gistId;
    ...
    /**
     * @return Observable<Schema\GistComment>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\GistComment::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
