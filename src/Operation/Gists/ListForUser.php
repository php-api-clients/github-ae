...
final class ListForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Gists $hydrator, string $username, string $since, int $perPage = 30, int $page = 1)
    {
