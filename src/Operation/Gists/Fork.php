...
final class Fork
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\CbGistIdRcb\Forks $hydrator, string $gistId)
    {
        $this->gistId                  = $gistId;
    ...
    public function createResponse(ResponseInterface $response): Schema\BaseGist
    {
