...
final class GetRevision
{
    ...
    /**
     * @return Schema\GistSimple|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\GistSimple|Schema\ValidationError|Schema\BasicError
    {
