...
final class ListForks
{
    ...
    private readonly Hydrator\Operation\Gists\GistId\Forks $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\GistId\Forks $hydrator, string $gistId, int $perPage = 30, int $page = 1)
    {
        $this->gistId                  = $gistId;
