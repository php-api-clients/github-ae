...
final class ListForks
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Gists\GistId\Forks $hydrator, string $gistId, int $perPage = 30, int $page = 1)
    {
        $this->gistId  = $gistId;
