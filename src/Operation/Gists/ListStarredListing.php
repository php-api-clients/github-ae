...
final class ListStarredListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Gists\Starred $hydrator, string $since, int $perPage = 30, int $page = 1)
    {
        $this->since   = $since;
