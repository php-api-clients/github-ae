...
final class List_
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists $hydrator, string $since, int $per_page = 30, int $page = 1)
    {
        $this->since = $since;
