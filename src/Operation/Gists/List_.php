...
final class List_
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Gists $hydrator, string $since, int $perPage = 30, int $page = 1)
    {
        $this->since   = $since;
