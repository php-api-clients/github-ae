...
final class ListPublic
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Gists\Public_ $hydrator, string $since, int $per_page = 30, int $page = 1)
    {
        $this->since = $since;
    ...
    /**
     * @return \Rx\Observable<Schema\BaseGist>|Schema\ValidationError|Schema\BasicError
     */
