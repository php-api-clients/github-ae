...
final class Teams
{
    ...
    public function externalIdpGroupInfoForOrg(string $org, int $groupId): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ExternalIdpGroupInfoForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ExternalIdpGroupInfoForOrg::class] = new Operator\Teams\ExternalIdpGroupInfoForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀ExternalGroup🌀GroupId());
        }

        return $this->operator[Operator\Teams\ExternalIdpGroupInfoForOrg::class]->call($org, $groupId);
    }

    public function listExternalIdpGroupsForOrg(string $org, int $page, string $displayName, int $perPage): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ListExternalIdpGroupsForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ListExternalIdpGroupsForOrg::class] = new Operator\Teams\ListExternalIdpGroupsForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀ExternalGroups());
        }

        return $this->operator[Operator\Teams\ListExternalIdpGroupsForOrg::class]->call($org, $page, $displayName, $perPage);
    }

    public function list(string $org, int $perPage, int $page): PromiseInterface
    {
    ...
    public function create(string $org, array $params): PromiseInterface
    {
    ...
    public function getByName(string $org, string $teamSlug): PromiseInterface
    {
    ...
    public function deleteInOrg(string $org, string $teamSlug): PromiseInterface
    {
    ...
    public function updateInOrg(string $org, string $teamSlug, array $params): PromiseInterface
    {
    ...
    public function listDiscussionsInOrg(string $org, string $teamSlug, string $pinned, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createDiscussionInOrg(string $org, string $teamSlug, array $params): PromiseInterface
    {
    ...
    public function getDiscussionInOrg(string $org, string $teamSlug, int $discussionNumber): PromiseInterface
    {
    ...
    public function deleteDiscussionInOrg(string $org, string $teamSlug, int $discussionNumber): PromiseInterface
    {
    ...
    public function updateDiscussionInOrg(string $org, string $teamSlug, int $discussionNumber, array $params): PromiseInterface
    {
    ...
    public function listDiscussionCommentsInOrg(string $org, string $teamSlug, int $discussionNumber, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createDiscussionCommentInOrg(string $org, string $teamSlug, int $discussionNumber, array $params): PromiseInterface
    {
    ...
    public function getDiscussionCommentInOrg(string $org, string $teamSlug, int $discussionNumber, int $commentNumber): PromiseInterface
    {
    ...
    public function deleteDiscussionCommentInOrg(string $org, string $teamSlug, int $discussionNumber, int $commentNumber): PromiseInterface
    {
    ...
    public function updateDiscussionCommentInOrg(string $org, string $teamSlug, int $discussionNumber, int $commentNumber, array $params): PromiseInterface
    {
    ...
    public function unlinkExternalIdpGroupFromTeamForOrg(string $org, string $teamSlug): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\UnlinkExternalIdpGroupFromTeamForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\UnlinkExternalIdpGroupFromTeamForOrg::class] = new Operator\Teams\UnlinkExternalIdpGroupFromTeamForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀ExternalGroups());
        }

        return $this->operator[Operator\Teams\UnlinkExternalIdpGroupFromTeamForOrg::class]->call($org, $teamSlug);
    }

    public function linkExternalIdpGroupToTeamForOrg(string $org, string $teamSlug, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\LinkExternalIdpGroupToTeamForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\LinkExternalIdpGroupToTeamForOrg::class] = new Operator\Teams\LinkExternalIdpGroupToTeamForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀ExternalGroups());
        }

        return $this->operator[Operator\Teams\LinkExternalIdpGroupToTeamForOrg::class]->call($org, $teamSlug, $params);
    }

    public function listMembersInOrg(string $org, string $teamSlug, string $role, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getMembershipForUserInOrg(string $org, string $teamSlug, string $username): PromiseInterface
    {
    ...
    public function addOrUpdateMembershipForUserInOrg(string $org, string $teamSlug, string $username, array $params): PromiseInterface
    {
    ...
    public function removeMembershipForUserInOrg(string $org, string $teamSlug, string $username): PromiseInterface
    {
    ...
    public function listProjectsInOrg(string $org, string $teamSlug, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkPermissionsForProjectInOrg(string $org, string $teamSlug, int $projectId): PromiseInterface
    {
    ...
    public function addOrUpdateProjectPermissionsInOrg(string $org, string $teamSlug, int $projectId, array $params): PromiseInterface
    {
    ...
    public function removeProjectInOrg(string $org, string $teamSlug, int $projectId): PromiseInterface
    {
    ...
    public function listReposInOrg(string $org, string $teamSlug, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkPermissionsForRepoInOrg(string $org, string $teamSlug, string $owner, string $repo): PromiseInterface
    {
    ...
    public function addOrUpdateRepoPermissionsInOrg(string $org, string $teamSlug, string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function removeRepoInOrg(string $org, string $teamSlug, string $owner, string $repo): PromiseInterface
    {
    ...
    public function listChildInOrg(string $org, string $teamSlug, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getLegacy(int $teamId): PromiseInterface
    {
    ...
    public function deleteLegacy(int $teamId): PromiseInterface
    {
    ...
    public function updateLegacy(int $teamId, array $params): PromiseInterface
    {
    ...
    public function listDiscussionsLegacy(int $teamId, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createDiscussionLegacy(int $teamId, array $params): PromiseInterface
    {
    ...
    public function getDiscussionLegacy(int $teamId, int $discussionNumber): PromiseInterface
    {
    ...
    public function deleteDiscussionLegacy(int $teamId, int $discussionNumber): PromiseInterface
    {
    ...
    public function updateDiscussionLegacy(int $teamId, int $discussionNumber, array $params): PromiseInterface
    {
    ...
    public function listDiscussionCommentsLegacy(int $teamId, int $discussionNumber, string $direction, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createDiscussionCommentLegacy(int $teamId, int $discussionNumber, array $params): PromiseInterface
    {
    ...
    public function getDiscussionCommentLegacy(int $teamId, int $discussionNumber, int $commentNumber): PromiseInterface
    {
    ...
    public function deleteDiscussionCommentLegacy(int $teamId, int $discussionNumber, int $commentNumber): PromiseInterface
    {
    ...
    public function updateDiscussionCommentLegacy(int $teamId, int $discussionNumber, int $commentNumber, array $params): PromiseInterface
    {
    ...
    public function listMembersLegacy(int $teamId, string $role, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getMemberLegacy(int $teamId, string $username): PromiseInterface
    {
    ...
    public function addMemberLegacy(int $teamId, string $username): PromiseInterface
    {
    ...
    public function removeMemberLegacy(int $teamId, string $username): PromiseInterface
    {
    ...
    public function getMembershipForUserLegacy(int $teamId, string $username): PromiseInterface
    {
    ...
    public function addOrUpdateMembershipForUserLegacy(int $teamId, string $username, array $params): PromiseInterface
    {
    ...
    public function removeMembershipForUserLegacy(int $teamId, string $username): PromiseInterface
    {
    ...
    public function listProjectsLegacy(int $teamId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkPermissionsForProjectLegacy(int $teamId, int $projectId): PromiseInterface
    {
    ...
    public function addOrUpdateProjectPermissionsLegacy(int $teamId, int $projectId, array $params): PromiseInterface
    {
    ...
    public function removeProjectLegacy(int $teamId, int $projectId): PromiseInterface
    {
    ...
    public function listReposLegacy(int $teamId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkPermissionsForRepoLegacy(int $teamId, string $owner, string $repo): PromiseInterface
    {
    ...
    public function addOrUpdateRepoPermissionsLegacy(int $teamId, string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function removeRepoLegacy(int $teamId, string $owner, string $repo): PromiseInterface
    {
    ...
    public function listChildLegacy(int $teamId, int $perPage, int $page): PromiseInterface
    {
