...
final class Teams
{
    ...
    public function externalIdpGroupInfoForOrg(string $org, int $groupId): Schema\ExternalGroup
    {
    ...
    public function listExternalIdpGroupsForOrg(string $org, int $page, string $displayName, int $perPage): Schema\ExternalGroups
    {
    ...
    public function unlinkExternalIdpGroupFromTeamForOrg(string $org, string $teamSlug): ResponseInterface
    {
    ...
    public function linkExternalIdpGroupToTeamForOrg(string $org, string $teamSlug, array $params): Schema\ExternalGroup
    {
