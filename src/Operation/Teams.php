...
final class Teams
{
    ...
    /** @return */
    public function externalIdpGroupInfoForOrg(string $org, int $groupId): ExternalGroup
    {
    ...
    /** @return */
    public function unlinkExternalIdpGroupFromTeamForOrg(string $org, string $teamSlug): WithoutBody
    {
        return $this->operators->teams👷UnlinkExternalIdpGroupFromTeamForOrg()->call($org, $teamSlug);
    }

    /** @return */
    public function linkExternalIdpGroupToTeamForOrg(string $org, string $teamSlug, array $params): ExternalGroup
    {
