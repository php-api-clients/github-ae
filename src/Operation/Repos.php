...
final class Repos
{
    ...
    public function listForOrg(string $org, string $type, string $direction, string $sort, int $perPage, int $page): Schema\MinimalRepository
    {
    ...
    public function listForOrgListing(string $org, string $type, string $direction, string $sort, int $perPage, int $page): Schema\MinimalRepository
    {
        ...
        return $this->operator[Operator\Repos\ListForOrgListing::class]->call($org, $type, $direction, $sort, $perPage, $page);
    }
    ...
    public function enableLfsForRepo(string $owner, string $repo): Schema\Operations\Repos\EnableLfsForRepo\Response\ApplicationJson\Accepted
    {
    ...
    public function disableLfsForRepo(string $owner, string $repo): ResponseInterface
    {
