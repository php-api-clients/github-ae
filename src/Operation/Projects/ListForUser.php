...
final class ListForUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{username}', '{state}', '{per_page}', '{page}'), array($this->username, $this->state, $this->perPage, $this->page), self::PATH . '?state={state}&perPage={per_page}&page={page}'));
    }
    /**
