...
final class ListCollaborators
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{project_id}', '{affiliation}', '{per_page}', '{page}'), array($this->projectId, $this->affiliation, $this->perPage, $this->page), self::PATH . '?affiliation={affiliation}&per_page={per_page}&page={page}'));
    }
    /**
