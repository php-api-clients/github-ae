...
final class MoveColumn
{
    ...
    /**
     * @return Schema\Operation\Gists\CheckIsStarred\Response\Applicationjson\H404|Schema\BasicError|Schema\ValidationErrorSimple
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Gists\CheckIsStarred\Response\Applicationjson\H404|Schema\BasicError|Schema\ValidationErrorSimple
    {
