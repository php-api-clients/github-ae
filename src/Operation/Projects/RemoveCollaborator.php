...
final class RemoveCollaborator
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators\CbUsernameRcb $hydrator, int $projectId, string $username)
    {
