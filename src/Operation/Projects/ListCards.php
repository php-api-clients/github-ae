...
final class ListCards
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{column_id}', '{archived_state}', '{per_page}', '{page}'), array($this->columnId, $this->archivedState, $this->perPage, $this->page), self::PATH . '?archived_state={archived_state}&per_page={per_page}&page={page}'));
    }
    /**
