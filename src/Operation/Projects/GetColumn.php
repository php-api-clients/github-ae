...
final class GetColumn
{
    ...
    /**
     * @return Schema\ProjectColumn|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ProjectColumn|Schema\BasicError
    {
