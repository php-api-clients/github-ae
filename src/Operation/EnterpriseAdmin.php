...
final class EnterpriseAdmin
{
    ...
    public function listGlobalWebhooks(int $perPage, int $page): PromiseInterface
    {
    ...
    public function createGlobalWebhook(array $params): PromiseInterface
    {
    ...
    public function getGlobalWebhook(int $hookId): PromiseInterface
    {
    ...
    public function deleteGlobalWebhook(int $hookId): PromiseInterface
    {
    ...
    public function updateGlobalWebhook(int $hookId, array $params): PromiseInterface
    {
    ...
    public function pingGlobalWebhook(int $hookId): PromiseInterface
    {
    ...
    public function listPublicKeys(string $since, int $perPage, int $page, string $direction, string $sort): PromiseInterface
    {
    ...
    public function deletePublicKey(string $keyIds): PromiseInterface
    {
    ...
    public function createOrg(array $params): PromiseInterface
    {
    ...
    public function updateOrgName(string $org, array $params): PromiseInterface
    {
    ...
    public function listPreReceiveEnvironments(int $perPage, int $page, string $direction, string $sort): PromiseInterface
    {
    ...
    public function createPreReceiveEnvironment(array $params): PromiseInterface
    {
    ...
    public function getPreReceiveEnvironment(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function deletePreReceiveEnvironment(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function updatePreReceiveEnvironment(int $preReceiveEnvironmentId, array $params): PromiseInterface
    {
    ...
    public function startPreReceiveEnvironmentDownload(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function startPreReceiveEnvironmentDownloadStreaming(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function getDownloadStatusForPreReceiveEnvironment(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function getDownloadStatusForPreReceiveEnvironmentStreaming(int $preReceiveEnvironmentId): PromiseInterface
    {
    ...
    public function listPersonalAccessTokens(int $perPage, int $page): PromiseInterface
    {
    ...
    public function deletePersonalAccessToken(int $tokenId): PromiseInterface
    {
    ...
    public function deleteUser(string $username): PromiseInterface
    {
    ...
    public function createImpersonationOAuthToken(string $username, array $params): PromiseInterface
    {
    ...
    public function deleteImpersonationOAuthToken(string $username): PromiseInterface
    {
    ...
    public function getAnnouncement(): PromiseInterface
    {
    ...
    public function removeAnnouncement(): PromiseInterface
    {
    ...
    public function setAnnouncement(array $params): PromiseInterface
    {
    ...
    public function getLicenseInformation(): PromiseInterface
    {
    ...
    public function getAllStats(): PromiseInterface
    {
    ...
    public function getCommentStats(): PromiseInterface
    {
    ...
    public function getGistStats(): PromiseInterface
    {
    ...
    public function getHooksStats(): PromiseInterface
    {
    ...
    public function getIssueStats(): PromiseInterface
    {
    ...
    public function getMilestoneStats(): PromiseInterface
    {
    ...
    public function getOrgStats(): PromiseInterface
    {
    ...
    public function getPagesStats(): PromiseInterface
    {
    ...
    public function getPullRequestStats(): PromiseInterface
    {
    ...
    public function getRepoStats(): PromiseInterface
    {
    ...
    public function getUserStats(): PromiseInterface
    {
    ...
    public function getGithubActionsPermissionsEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function setGithubActionsPermissionsEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function listSelectedOrganizationsEnabledGithubActionsEnterprise(string $enterprise, int $perPage, int $page): PromiseInterface
    {
    ...
    public function setSelectedOrganizationsEnabledGithubActionsEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function enableSelectedOrganizationGithubActionsEnterprise(string $enterprise, int $orgId): PromiseInterface
    {
    ...
    public function disableSelectedOrganizationGithubActionsEnterprise(string $enterprise, int $orgId): PromiseInterface
    {
    ...
    public function getAllowedActionsEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function setAllowedActionsEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function listSelfHostedRunnerGroupsForEnterprise(string $enterprise, string $visibleToOrganization, int $perPage, int $page): PromiseInterface
    {
    ...
    public function createSelfHostedRunnerGroupForEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function getSelfHostedRunnerGroupForEnterprise(string $enterprise, int $runnerGroupId): PromiseInterface
    {
    ...
    public function deleteSelfHostedRunnerGroupFromEnterprise(string $enterprise, int $runnerGroupId): PromiseInterface
    {
    ...
    public function updateSelfHostedRunnerGroupForEnterprise(string $enterprise, int $runnerGroupId, array $params): PromiseInterface
    {
    ...
    public function listSelfHostedRunnersInGroupForEnterprise(string $enterprise, int $runnerGroupId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function setSelfHostedRunnersInGroupForEnterprise(string $enterprise, int $runnerGroupId, array $params): PromiseInterface
    {
    ...
    public function addSelfHostedRunnerToGroupForEnterprise(string $enterprise, int $runnerGroupId, int $runnerId): PromiseInterface
    {
    ...
    public function removeSelfHostedRunnerFromGroupForEnterprise(string $enterprise, int $runnerGroupId, int $runnerId): PromiseInterface
    {
    ...
    public function listSelfHostedRunnersForEnterprise(string $enterprise, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listRunnerApplicationsForEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function createRegistrationTokenForEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function createRemoveTokenForEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function getSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId): PromiseInterface
    {
    ...
    public function deleteSelfHostedRunnerFromEnterprise(string $enterprise, int $runnerId): PromiseInterface
    {
    ...
    public function getAuditLog(string $enterprise, string $phrase, string $after, string $before, string $order, int $page, int $perPage): PromiseInterface
    {
    ...
    public function suspendUser(string $username, array $params): PromiseInterface
    {
    ...
    public function unsuspendUser(string $username, array $params): PromiseInterface
    {
