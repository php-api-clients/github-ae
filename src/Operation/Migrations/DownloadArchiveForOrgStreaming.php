...
final class DownloadArchiveForOrgStreaming
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Migrations\CbMigrationIdRcb\Archive $hydrator, Browser $browser, string $org, int $migrationId)
    {
        $this->org                     = $org;
