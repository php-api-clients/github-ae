...
final class ListForOrg
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{exclude}', '{per_page}', '{page}'), array($this->org, $this->exclude, $this->perPage, $this->page), self::PATH . '?exclude={exclude}&perPage={per_page}&page={page}'));
    }
    /**
