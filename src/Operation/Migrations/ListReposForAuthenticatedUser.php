...
final class ListReposForAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{migration_id}', '{per_page}', '{page}'), array($this->migrationId, $this->perPage, $this->page), self::PATH . '?per_page={per_page}&page={page}'));
    }
    /**
