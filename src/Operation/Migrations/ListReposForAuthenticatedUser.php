...
final class ListReposForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Migrations\CbMigrationIdRcb\Repositories $hydrator, int $migrationId, int $perPage = 30, int $page = 1)
    {
