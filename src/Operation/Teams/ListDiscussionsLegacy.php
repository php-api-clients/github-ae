...
final class ListDiscussionsLegacy
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{team_id}', '{direction}', '{per_page}', '{page}'), array($this->teamId, $this->direction, $this->perPage, $this->page), self::PATH . '?direction={direction}&perPage={per_page}&page={page}'));
    }
    /**
