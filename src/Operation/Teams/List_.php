...
final class List_
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Teams $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
