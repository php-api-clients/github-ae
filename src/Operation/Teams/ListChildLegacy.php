...
final class ListChildLegacy
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Teams\CbTeamIdRcb\Teams $hydrator, int $teamId, int $perPage = 30, int $page = 1)
    {
        $this->teamId                  = $teamId;
