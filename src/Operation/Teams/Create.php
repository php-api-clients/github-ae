...
final class Create
{
    ...
    /**
     * @return Schema\TeamFull|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\TeamFull|Schema\ValidationError|Schema\BasicError
    {
