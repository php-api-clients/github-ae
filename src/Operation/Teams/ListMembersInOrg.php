...
final class ListMembersInOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Members $hydrator, string $org, string $teamSlug, string $role = 'all', int $perPage = 30, int $page = 1)
    {
        $this->org      = $org;
