...
final class UpdateInOrg
{
    ...
    /**
     * @return Schema\TeamFull|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\TeamFull|Schema\BasicError|Schema\ValidationError
    {
