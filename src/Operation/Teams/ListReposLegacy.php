...
final class ListReposLegacy
{
    ...
    private readonly Hydrator\Operation\Teams\CbTeamIdRcb\Repos $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Teams\CbTeamIdRcb\Repos $hydrator, int $team_id, int $per_page = 30, int $page = 1)
    {
