...
final class ListListing
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Teams $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
