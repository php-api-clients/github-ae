...
final class AddOrUpdateRepoPermissionsLegacy
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Teams\CbTeamIdRcb\Repos\CbOwnerRcb\CbRepoRcb $hydrator, int $teamId, string $owner, string $repo)
    {
    ...
    function createRequest(array $data = array()) : \Psr\Http\Message\RequestInterface
    {
        ...
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{team_id}', '{owner}', '{repo}'), array($this->teamId, $this->owner, $this->repo), self::PATH), array('Content-Type' => 'application/json'), json_encode($data));
    }
