...
final class AddMemberLegacy
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Members\Username $hydrator, int $teamId, string $username)
    {
        $this->teamId   = $teamId;
