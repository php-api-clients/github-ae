...
final class ListProjectsLegacy
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Projects $hydrator, int $teamId, int $perPage = 30, int $page = 1)
    {
        $this->teamId  = $teamId;
