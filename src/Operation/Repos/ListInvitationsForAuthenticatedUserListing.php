...
final class ListInvitationsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\RepositoryInvitations $hydrator, int $perPage = 30, int $page = 1)
    {
