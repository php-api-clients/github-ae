...
final class ListInvitationsForAuthenticatedUserListing
{
    ...
    private readonly Hydrator\Operation\User\RepositoryInvitations $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\RepositoryInvitations $hydrator, int $per_page = 30, int $page = 1)
    {
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\RepositoryInvitation::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
