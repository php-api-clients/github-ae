...
final class CreateDeployKey
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Keys $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Keys $hydrator, string $owner, string $repo)
    {
