...
final class GetCommit
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{ref}', '{page}', '{per_page}'), array($this->owner, $this->repo, $this->ref, $this->page, $this->perPage), self::PATH . '?page={page}&perPage={per_page}'));
    }
    /**
