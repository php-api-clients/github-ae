...
final class GetContributorsStats
{
    ...
    /**
     * @return \Rx\Observable<Schema\ContributorActivity>|Schema\AuditLogEvent\Config
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\AuditLogEvent\Config
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(Schema\ContributorActivity::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
