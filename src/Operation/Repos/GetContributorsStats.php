...
final class GetContributorsStats
{
    ...
    /**
     * @return Observable<Schema\ContributorActivity>|Schema\Operation\Repos\GetContributorsStats\Response\Applicationjson\H202
     */
    public function createResponse(ResponseInterface $response): Observable|Schema\Operation\Repos\GetContributorsStats\Response\Applicationjson\H202
    {
            ...
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    ...
                    case 202:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\Operation\Repos\GetContributorsStats\Response\Applicationjson\H202::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
