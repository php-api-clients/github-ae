...
final class GetLatestRelease
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Releases\Latest $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Releases\Latest $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
