...
final class ListCollaborators
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{permission}', '{affiliation}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->permission, $this->affiliation, $this->perPage, $this->page), self::PATH . '?permission={permission}&affiliation={affiliation}&per_page={per_page}&page={page}'));
    }
    /**
