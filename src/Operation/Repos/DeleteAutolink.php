...
final class DeleteAutolink
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Autolinks\CbAutolinkIdRcb $hydrator, string $owner, string $repo, int $autolinkId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
