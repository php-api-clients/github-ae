...
final class GetDeploymentStatus
{
    ...
    /**
     * @return Schema\DeploymentStatus|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\DeploymentStatus|Schema\BasicError
    {
