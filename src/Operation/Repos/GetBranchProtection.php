...
final class GetBranchProtection
{
    ...
    /**
     * @return Schema\BranchProtection|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\BranchProtection|Schema\BasicError
    {
