...
final class ListAutolinks
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Autolinks $hydrator, string $owner, string $repo, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
        $this->page = $page;
    ...
    /**
     * @return \Rx\Observable<Schema\Autolink>
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\Autolink::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
