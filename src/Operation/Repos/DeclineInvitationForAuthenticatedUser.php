...
final class DeclineInvitationForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\RepositoryInvitations\CbInvitationIdRcb $hydrator, int $invitationId)
    {
