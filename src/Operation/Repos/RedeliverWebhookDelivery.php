...
final class RedeliverWebhookDelivery
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Hooks\CbHookIdRcb\Deliveries\CbDeliveryIdRcb\Attempts $hydrator, string $owner, string $repo, int $hook_id, int $delivery_id)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return Schema\AuditLogEvent\Config|Schema\BasicError|Schema\ScimError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\AuditLogEvent\Config|Schema\BasicError|Schema\ScimError|Schema\ValidationError
    {
