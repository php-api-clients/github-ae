...
final class GetCommitActivityStats
{
     ...
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\Operation\Repos\GetCommitActivityStats\Response\Applicationjson\H202
    {
