...
final class CreateCommitStatus
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Statuses\Sha $hydrator, string $owner, string $repo, private string $sha)
    {
        $this->owner = $owner;
        $this->repo  = $repo;
    }
