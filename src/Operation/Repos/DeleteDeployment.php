...
final class DeleteDeployment
{
    ...
    /**
     * @return Schema\BasicError|Schema\ValidationErrorSimple
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\BasicError|Schema\ValidationErrorSimple
    {
