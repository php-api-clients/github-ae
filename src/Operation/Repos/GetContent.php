...
final class GetContent
{
    ...
    /**
     * @return Schema\ContentTree|Schema\Operation\Repos\GetContent\Response\Applicationjson\H200|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ContentTree|Schema\Operation\Repos\GetContent\Response\Applicationjson\H200|Schema\BasicError
    {
