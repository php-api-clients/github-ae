...
final class AddStatusCheckContexts
{
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\Repos\AddStatusCheckContexts\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return Observable<Schema\Operation\Repos\AddStatusCheckContexts\Response\Applicationjson\H200>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\Operation\Repos\AddStatusCheckContexts\Response\Applicationjson\H200::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }

                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\Operation\Repos\AddStatusCheckContexts\Response\Applicationjson\H200 {
