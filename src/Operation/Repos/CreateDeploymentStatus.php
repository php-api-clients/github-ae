...
final class CreateDeploymentStatus
{
    ...
    /**
     * @return Schema\DeploymentStatus|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\DeploymentStatus|Schema\ValidationError
    {
