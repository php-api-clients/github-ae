...
final class CreateWebhook
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Hooks $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Hooks $hydrator, string $owner, string $repo)
    {
