...
final class RemoveStatusCheckContexts
{
    ...
    /**
     * @return Observable<Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }

                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200 {
