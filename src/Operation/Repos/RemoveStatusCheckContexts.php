...
final class RemoveStatusCheckContexts
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Repos\RemoveStatusCheckContexts\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return \Rx\Observable<Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200>
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200 {
                            return $this->hydrator->hydrateObject(Schema\Operation\Repos\RemoveStatusCheckContexts\Response\Applicationjson\H200::class, $body);
                        });
                }
                break;
            /**Resource not found**/
