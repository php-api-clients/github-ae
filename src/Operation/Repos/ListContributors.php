...
final class ListContributors
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Contributors $hydrator, string $owner, string $repo, string $anon, int $perPage = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->anon                    = $anon;
    ...
    /**
     * @return Observable<Schema\Contributor>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\Contributor::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
