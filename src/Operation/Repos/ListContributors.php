...
final class ListContributors
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{anon}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->anon, $this->perPage, $this->page), self::PATH . '?anon={anon}&perPage={per_page}&page={page}'));
    }
    /**
