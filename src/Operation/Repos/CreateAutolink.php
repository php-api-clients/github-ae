...
final class CreateAutolink
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Autolinks $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Autolinks $hydrator, string $owner, string $repo)
    {
