...
final class CompareCommits
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{basehead}', '{page}', '{per_page}'), array($this->owner, $this->repo, $this->basehead, $this->page, $this->perPage), self::PATH . '?page={page}&per_page={per_page}'));
    }
    /**
     * @return Schema\CommitComparison
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CommitComparison
    {
