...
final class GetCollaboratorPermissionLevel
{
    ...
    /**
     * @return Schema\RepositoryCollaboratorPermission|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\RepositoryCollaboratorPermission|Schema\BasicError
    {
