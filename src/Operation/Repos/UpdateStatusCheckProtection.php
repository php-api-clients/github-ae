...
final class UpdateStatusCheckProtection
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Branches\CbBranchRcb\Protection\RequiredStatusChecks $hydrator, string $owner, string $repo, string $branch)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Repos\UpdateStatusCheckProtection\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return Schema\StatusCheckPolicy|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\StatusCheckPolicy|Schema\BasicError|Schema\ValidationError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(Schema\StatusCheckPolicy::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
