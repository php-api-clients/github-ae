...
final class GetAccessRestrictions
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Branches\Branch\Protection\Restrictions $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Branches\Branch\Protection\Restrictions $hydrator, string $owner, string $repo, string $branch)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->branch                  = $branch;
