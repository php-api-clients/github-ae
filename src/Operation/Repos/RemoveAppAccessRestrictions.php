...
final class RemoveAppAccessRestrictions
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Repos\RemoveAppAccessRestrictions\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
