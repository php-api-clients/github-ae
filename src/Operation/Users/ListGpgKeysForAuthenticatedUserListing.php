...
final class ListGpgKeysForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\GpgKeys $hydrator, int $perPage = 30, int $page = 1)
    {
