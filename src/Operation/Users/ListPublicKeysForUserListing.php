...
final class ListPublicKeysForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users\Username\Keys $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
