...
final class ListPublicKeysForUserListing
{
    ...
    private readonly Hydrator\Operation\Users\CbUsernameRcb\Keys $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Keys $hydrator, string $username, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\KeySimple>
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\KeySimple::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
