...
final class ListFollowedByAuthenticatedUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Following $hydrator, int $perPage = 30, int $page = 1)
    {
