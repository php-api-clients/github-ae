...
final class ListFollowedByAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Following $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Following $hydrator, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\SimpleUser>|Schema\BasicError
     */
