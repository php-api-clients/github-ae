...
final class GetGpgKeyForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\GpgKeys\CbGpgKeyIdRcb $hydrator, int $gpgKeyId)
    {
    ...
    public function createResponse(ResponseInterface $response): Schema\GpgKey
    {
