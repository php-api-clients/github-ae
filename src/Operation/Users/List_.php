...
final class List_
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users $hydrator, int $since, int $perPage = 30)
    {
        $this->since   = $since;
