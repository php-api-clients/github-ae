...
final class ListFollowersForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Followers $hydrator, int $perPage = 30, int $page = 1)
    {
