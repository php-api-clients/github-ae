...
final class ListFollowersForAuthenticatedUserListing
{
    ...
    private readonly Hydrator\Operation\User\Followers $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Followers $hydrator, int $per_page = 30, int $page = 1)
    {
