...
final class ListGpgKeysForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users\Username\GpgKeys $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
