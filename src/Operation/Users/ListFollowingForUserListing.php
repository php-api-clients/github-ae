...
final class ListFollowingForUserListing
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Following $hydrator, string $username, int $per_page = 30, int $page = 1)
    {
