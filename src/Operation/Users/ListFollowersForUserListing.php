...
final class ListFollowersForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users\Username\Followers $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
