...
final class ListFollowedByAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Following $hydrator, int $perPage = 30, int $page = 1)
    {
