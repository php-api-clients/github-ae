...
final class ListPublicSshKeysForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Keys $hydrator, int $perPage = 30, int $page = 1)
    {
