...
final class ListPublicKeysForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Keys $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\KeySimple::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
