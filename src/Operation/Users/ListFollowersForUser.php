...
final class ListFollowersForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Followers $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
