...
final class GetLabel
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Labels\Name $hydrator, string $owner, string $repo, private string $name)
    {
        $this->owner = $owner;
        $this->repo  = $repo;
    }
