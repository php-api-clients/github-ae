...
final class ListEventsForRepo
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Issues\Events $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Issues\Events $hydrator, string $owner, string $repo, int $perPage = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
