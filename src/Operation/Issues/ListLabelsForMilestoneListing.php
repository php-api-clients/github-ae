...
final class ListLabelsForMilestoneListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Milestones\MilestoneNumber\Labels $hydrator, string $owner, string $repo, int $milestoneNumber, int $perPage = 30, int $page = 1)
    {
        $this->owner           = $owner;
        $this->repo            = $repo;
