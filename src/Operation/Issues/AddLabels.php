...
final class AddLabels
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Issues\AddLabels\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
