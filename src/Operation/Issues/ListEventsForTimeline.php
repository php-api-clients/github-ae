...
final class ListEventsForTimeline
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Timeline $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Timeline $hydrator, string $owner, string $repo, int $issueNumber, int $perPage = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
