...
final class Get
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Issues\CbIssueNumberRcb $hydrator, string $owner, string $repo, int $issue_number)
    {
        $this->owner = $owner;
        $this->repo = $repo;
