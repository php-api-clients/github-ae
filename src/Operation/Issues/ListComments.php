...
final class ListComments
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{issue_number}', '{since}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->issueNumber, $this->since, $this->perPage, $this->page), self::PATH . '?since={since}&per_page={per_page}&page={page}'));
    }
    /**
