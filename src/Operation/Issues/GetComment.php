...
final class GetComment
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Issues\Comments\CbCommentIdRcb $hydrator, string $owner, string $repo, int $comment_id)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return Schema\IssueComment|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\IssueComment|Schema\BasicError
    {
