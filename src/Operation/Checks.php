...
final class Checks
{
    ...
    public function get(string $owner, string $repo, int $checkRunId): PromiseInterface
    {
    ...
    public function update(string $owner, string $repo, int $checkRunId, array $params): PromiseInterface
    {
    ...
    public function listAnnotations(string $owner, string $repo, int $checkRunId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function rerequestRun(string $owner, string $repo, int $checkRunId): PromiseInterface
    {
    ...
    public function createSuite(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function setSuitesPreferences(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function getSuite(string $owner, string $repo, int $checkSuiteId): PromiseInterface
    {
    ...
    public function listForSuite(string $owner, string $repo, int $checkSuiteId, string $checkName, string $status, string $filter, int $perPage, int $page): PromiseInterface
    {
    ...
    public function rerequestSuite(string $owner, string $repo, int $checkSuiteId): PromiseInterface
    {
    ...
    public function listForRef(string $owner, string $repo, string $ref, string $checkName, string $status, int $appId, string $filter, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listSuitesForRef(string $owner, string $repo, string $ref, int $appId, string $checkName, int $perPage, int $page): PromiseInterface
    {
