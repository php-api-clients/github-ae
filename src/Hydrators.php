...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertAutoDismissed', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlert', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlert\\Dependency', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertPackage', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityVulnerability', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityVulnerability\\FirstPatchedVersion', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\Cvss', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\Cwes', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\Identifiers', 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\References', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertAutoReopened', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertCreated', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertDismissed', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertFixed', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertReintroduced', 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDependabotAlertReopened' => $this->getObjectMapperWebHook🪝DependabotAlert()->hydrateObject($className, $payload),
