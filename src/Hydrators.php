...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\GlobalHook', 'ApiClients\\Client\\Github\\Schema\\GlobalHook\\Config' => $this->getObjectMapperOperation🌀Admin🌀Hooks()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\GlobalHook2', 'ApiClients\\Client\\Github\\Schema\\GlobalHook2\\Config' => $this->getObjectMapperOperation🌀Admin🌀Hooks🌀CbHookIdRcb()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\PublicKeyFull' => $this->getObjectMapperOperation🌀Admin🌀Keys()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\OrganizationSimple' => $this->getObjectMapperOperation🌀Admin🌀Organizations()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdateOrgName\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Admin🌀Organizations🌀CbOrgRcb()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironment', 'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironment\\Download' => $this->getObjectMapperOperation🌀Admin🌀PreReceiveEnvironments()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\DeletePreReceiveEnvironment\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\DeletePreReceiveEnvironment\\Response\\Applicationjson\\H422\\Errors', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdatePreReceiveEnvironment\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdatePreReceiveEnvironment\\Response\\Applicationjson\\H422\\Errors' => $this->getObjectMapperOperation🌀Admin🌀PreDashReceiveDashEnvironments🌀CbPreReceiveEnvironmentIdRcb()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironmentDownloadStatus', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownload\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownload\\Response\\Applicationjson\\H422\\Errors', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownloadStreaming\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownloadStreaming\\Response\\Applicationjson\\H422\\Errors' => $this->getObjectMapperOperation🌀Admin🌀PreDashReceiveDashEnvironments🌀CbPreReceiveEnvironmentIdRcb🌀Downloads()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Authorization', 'ApiClients\\Client\\Github\\Schema\\Authorization\\App' => $this->getObjectMapperOperation🌀Admin🌀Tokens()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Announcement' => $this->getObjectMapperOperation🌀Enterprise🌀Announcement()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\LicenseInfo' => $this->getObjectMapperOperation🌀Enterprise🌀Settings🌀License()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\EnterpriseOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseRepositoryOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseHookOverview', 'ApiClients\\Client\\Github\\Schema\\EnterprisePageOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseOrganizationOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseUserOverview', 'ApiClients\\Client\\Github\\Schema\\EnterprisePullRequestOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseIssueOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseMilestoneOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseGistOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseCommentOverview' => $this->getObjectMapperOperation🌀Enterprise🌀Stats🌀All()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\ActionsEnterprisePermissions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelectedOrganizationsEnabledGithubActionsEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀Organizations()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\SelectedActions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀SelectedActions()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnerGroupsForEnterprise\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\RunnerGroupsEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerGroups()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnersInGroupForEnterprise\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\Runner', 'ApiClients\\Client\\Github\\Schema\\RunnerLabel' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Runners()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnersForEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\RunnerApplication' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners🌀Downloads()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\AuthenticationToken' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners🌀RegistrationToken()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\AuditLogEvent', 'ApiClients\\Client\\Github\\Schema\\AuditLogEvent\\ActorLocation' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀AuditLog()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\Github\\Schema\\SimpleRepository', 'ApiClients\\Client\\Github\\Schema\\Operation\\SecretScanning\\ListAlertsForEnterprise\\Response\\Applicationjson\\H503' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀SecretScanning🌀Alerts()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Issue', 'ApiClients\\Client\\Github\\Schema\\Issue\\PullRequest', 'ApiClients\\Client\\Github\\Schema\\ReactionRollup' => $this->getObjectMapperOperation🌀Issues()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Thread', 'ApiClients\\Client\\Github\\Schema\\MinimalRepository', 'ApiClients\\Client\\Github\\Schema\\MinimalRepository\\Permissions', 'ApiClients\\Client\\Github\\Schema\\MinimalRepository\\License', 'ApiClients\\Client\\Github\\Schema\\Thread\\Subject', 'ApiClients\\Client\\Github\\Schema\\Operation\\Activity\\MarkNotificationsAsRead\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Notifications()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnerGroupsForOrg\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\RunnerGroupsOrg' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerGroups()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnersForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Runners()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\EmptyObject' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Secrets🌀CbSecretNameRcb()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ExternalGroup', 'ApiClients\\Client\\Github\\Schema\\ExternalGroup\\Teams', 'ApiClients\\Client\\Github\\Schema\\ExternalGroup\\Members' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀ExternalDashGroup🌀CbGroupIdRcb()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\ExternalGroups', 'ApiClients\\Client\\Github\\Schema\\ExternalGroups\\Groups' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀ExternalGroups()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Team', 'ApiClients\\Client\\Github\\Schema\\Team\\Permissions', 'ApiClients\\Client\\Github\\Schema\\TeamFull', 'ApiClients\\Client\\Github\\Schema\\TeamOrganization', 'ApiClients\\Client\\Github\\Schema\\TeamOrganization\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\FullRepository', 'ApiClients\\Client\\Github\\Schema\\FullRepository\\Permissions', 'ApiClients\\Client\\Github\\Schema\\CodeOfConductSimple', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\AdvancedSecurity', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\SecretScanning', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\SecretScanningPushProtection', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\Delete\\Response\\Applicationjson\\H403' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListWorkflowRunsForRepo\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\WorkflowRun', 'ApiClients\\Client\\Github\\Schema\\ReferencedWorkflow', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Head', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Head\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Base', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Base\\Repo' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Runs()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\WorkflowUsage', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Ubuntu', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Macos', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Windows' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Workflows🌀CbWorkflowIdRcb🌀Timing()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\CheckSuite', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit\\Author', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit\\Committer' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀CheckSuites()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Reactions\\CreateForCommitComment\\Response\\Applicationjson\\H415' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Comments🌀CbCommentIdRcb🌀Reactions()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Deployment', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\CreateDeployment\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Deployments()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\PullRequest', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Labels', 'ApiClients\\Client\\Github\\Schema\\TeamSimple', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\Owner', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\Permissions', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\License', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\User', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo\\Owner', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo\\Permissions', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\User', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Links' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Pulls()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookUserCreated', 'ApiClients\\Client\\Github\\Schema\\WebhookUserCreated\\User', 'ApiClients\\Client\\Github\\Schema\\WebhookUserDeleted', 'ApiClients\\Client\\Github\\Schema\\WebhookUserDeleted\\User' => $this->getObjectMapperWebHook🪝User()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob\\Steps', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob\\Steps', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob\\Steps' => $this->getObjectMapperWebHook🪝WorkflowJob()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\GlobalHook', 'ApiClients\\Client\\Github\\Schema\\GlobalHook\\Config' => $this->getObjectMapperOperation🌀Admin🌀Hooks()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\GlobalHook2', 'ApiClients\\Client\\Github\\Schema\\GlobalHook2\\Config' => $this->getObjectMapperOperation🌀Admin🌀Hooks🌀CbHookIdRcb()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\PublicKeyFull' => $this->getObjectMapperOperation🌀Admin🌀Keys()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\OrganizationSimple' => $this->getObjectMapperOperation🌀Admin🌀Organizations()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdateOrgName\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Admin🌀Organizations🌀CbOrgRcb()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironment', 'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironment\\Download' => $this->getObjectMapperOperation🌀Admin🌀PreReceiveEnvironments()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\DeletePreReceiveEnvironment\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\DeletePreReceiveEnvironment\\Response\\Applicationjson\\H422\\Errors', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdatePreReceiveEnvironment\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdatePreReceiveEnvironment\\Response\\Applicationjson\\H422\\Errors' => $this->getObjectMapperOperation🌀Admin🌀PreDashReceiveDashEnvironments🌀CbPreReceiveEnvironmentIdRcb()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\PreReceiveEnvironmentDownloadStatus', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownload\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownload\\Response\\Applicationjson\\H422\\Errors', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownloadStreaming\\Response\\Applicationjson\\H422', 'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\StartPreReceiveEnvironmentDownloadStreaming\\Response\\Applicationjson\\H422\\Errors' => $this->getObjectMapperOperation🌀Admin🌀PreDashReceiveDashEnvironments🌀CbPreReceiveEnvironmentIdRcb🌀Downloads()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Authorization', 'ApiClients\\Client\\Github\\Schema\\Authorization\\App' => $this->getObjectMapperOperation🌀Admin🌀Tokens()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Announcement' => $this->getObjectMapperOperation🌀Enterprise🌀Announcement()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\LicenseInfo' => $this->getObjectMapperOperation🌀Enterprise🌀Settings🌀License()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\EnterpriseOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseRepositoryOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseHookOverview', 'ApiClients\\Client\\Github\\Schema\\EnterprisePageOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseOrganizationOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseUserOverview', 'ApiClients\\Client\\Github\\Schema\\EnterprisePullRequestOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseIssueOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseMilestoneOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseGistOverview', 'ApiClients\\Client\\Github\\Schema\\EnterpriseCommentOverview' => $this->getObjectMapperOperation🌀Enterprise🌀Stats🌀All()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\ActionsEnterprisePermissions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelectedOrganizationsEnabledGithubActionsEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀Organizations()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\SelectedActions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀SelectedActions()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnerGroupsForEnterprise\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\RunnerGroupsEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerGroups()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnersInGroupForEnterprise\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\Runner', 'ApiClients\\Client\\Github\\Schema\\RunnerLabel' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Runners()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListSelfHostedRunnersForEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\RunnerApplication' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners🌀Downloads()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\AuthenticationToken' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Runners🌀RegistrationToken()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\AuditLogEvent', 'ApiClients\\Client\\Github\\Schema\\AuditLogEvent\\ActorLocation' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀AuditLog()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\Github\\Schema\\SimpleRepository', 'ApiClients\\Client\\Github\\Schema\\Operation\\SecretScanning\\ListAlertsForEnterprise\\Response\\Applicationjson\\H503' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀SecretScanning🌀Alerts()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Issue', 'ApiClients\\Client\\Github\\Schema\\Issue\\PullRequest', 'ApiClients\\Client\\Github\\Schema\\ReactionRollup' => $this->getObjectMapperOperation🌀Issues()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnerGroupsForOrg\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\RunnerGroupsOrg' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerGroups()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnersForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Runners()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\EmptyObject' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Secrets🌀CbSecretNameRcb()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ExternalGroup', 'ApiClients\\Client\\Github\\Schema\\ExternalGroup\\Teams', 'ApiClients\\Client\\Github\\Schema\\ExternalGroup\\Members' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀ExternalDashGroup🌀CbGroupIdRcb()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\ExternalGroups', 'ApiClients\\Client\\Github\\Schema\\ExternalGroups\\Groups' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀ExternalGroups()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Team', 'ApiClients\\Client\\Github\\Schema\\Team\\Permissions', 'ApiClients\\Client\\Github\\Schema\\TeamFull', 'ApiClients\\Client\\Github\\Schema\\TeamOrganization', 'ApiClients\\Client\\Github\\Schema\\TeamOrganization\\Plan' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\FullRepository', 'ApiClients\\Client\\Github\\Schema\\FullRepository\\Permissions', 'ApiClients\\Client\\Github\\Schema\\CodeOfConductSimple', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\AdvancedSecurity', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\SecretScanning', 'ApiClients\\Client\\Github\\Schema\\SecurityAndAnalysis\\SecretScanningPushProtection', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\Delete\\Response\\Applicationjson\\H403' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListWorkflowRunsForRepo\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\WorkflowRun', 'ApiClients\\Client\\Github\\Schema\\ReferencedWorkflow', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Head', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Head\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Base', 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal\\Base\\Repo' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Runs()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WorkflowUsage', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Ubuntu', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Macos', 'ApiClients\\Client\\Github\\Schema\\WorkflowUsage\\Billable\\Windows' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Workflows🌀CbWorkflowIdRcb🌀Timing()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ShortBranch', 'ApiClients\\Client\\Github\\Schema\\ShortBranch\\Commit', 'ApiClients\\Client\\Github\\Schema\\BranchProtection', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchRequiredStatusCheck', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchRequiredStatusCheck\\Checks', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchAdminEnforced', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchPullRequestReview', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchPullRequestReview\\DismissalRestrictions', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranchPullRequestReview\\BypassPullRequestAllowances', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy\\Users', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy\\Teams', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy\\Apps', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy\\Apps\\Owner', 'ApiClients\\Client\\Github\\Schema\\BranchRestrictionPolicy\\Apps\\Permissions', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\RequiredLinearHistory', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\AllowForcePushes', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\AllowDeletions', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\BlockCreations', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\RequiredConversationResolution', 'ApiClients\\Client\\Github\\Schema\\BranchProtection\\RequiredSignatures' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Branches()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ProtectedBranch', 'ApiClients\\Client\\Github\\Schema\\StatusCheckPolicy', 'ApiClients\\Client\\Github\\Schema\\StatusCheckPolicy\\Checks', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredPullRequestReviews', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredPullRequestReviews\\DismissalRestrictions', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredPullRequestReviews\\BypassPullRequestAllowances', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredSignatures', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\EnforceAdmins', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredLinearHistory', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\AllowForcePushes', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\AllowDeletions', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\RequiredConversationResolution', 'ApiClients\\Client\\Github\\Schema\\ProtectedBranch\\BlockCreations' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Branches🌀CbBranchRcb🌀Protection()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\CheckSuite', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit\\Author', 'ApiClients\\Client\\Github\\Schema\\SimpleCommit\\Committer' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀CheckSuites()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Reactions\\CreateForCommitComment\\Response\\Applicationjson\\H415' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Comments🌀CbCommentIdRcb🌀Reactions()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Deployment', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\CreateDeployment\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Deployments()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\PullRequest', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Labels', 'ApiClients\\Client\\Github\\Schema\\TeamSimple', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\Owner', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\Permissions', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\Repo\\License', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Head\\User', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo\\Owner', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\Repo\\Permissions', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Base\\User', 'ApiClients\\Client\\Github\\Schema\\PullRequest\\Links' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Pulls()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionAnswered', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionAnswered\\Answer', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionAnswered\\Answer\\Reactions', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionAnswered\\Answer\\User', 'ApiClients\\Client\\Github\\Schema\\Discussion', 'ApiClients\\Client\\Github\\Schema\\Discussion\\AnswerChosenBy', 'ApiClients\\Client\\Github\\Schema\\Discussion\\Category', 'ApiClients\\Client\\Github\\Schema\\Discussion\\Reactions', 'ApiClients\\Client\\Github\\Schema\\Discussion\\User', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCategoryChanged', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCategoryChanged\\Changes', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCategoryChanged\\Changes\\Category', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCategoryChanged\\Changes\\Category\\From', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated\\Discussion', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated\\Discussion\\AnswerChosenBy', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated\\Discussion\\Category', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated\\Discussion\\Reactions', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionCreated\\Discussion\\User', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionDeleted', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionEdited', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionEdited\\Changes', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionEdited\\Changes\\Body', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionEdited\\Changes\\Title', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionLabeled', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionLabeled\\Label', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionLocked', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionPinned', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionTransferred', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionTransferred\\Changes', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnanswered', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnanswered\\OldAnswer', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnanswered\\OldAnswer\\Reactions', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnanswered\\OldAnswer\\User', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnlabeled', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnlabeled\\Label', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnlocked', 'ApiClients\\Client\\Github\\Schema\\WebhookDiscussionUnpinned' => $this->getObjectMapperWebHook🪝Discussion()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookUserCreated', 'ApiClients\\Client\\Github\\Schema\\WebhookUserCreated\\User', 'ApiClients\\Client\\Github\\Schema\\WebhookUserDeleted', 'ApiClients\\Client\\Github\\Schema\\WebhookUserDeleted\\User' => $this->getObjectMapperWebHook🪝User()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob\\Steps', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob\\Steps', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob', 'ApiClients\\Client\\Github\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob\\Steps' => $this->getObjectMapperWebHook🪝WorkflowJob()->serializeObject($object),
