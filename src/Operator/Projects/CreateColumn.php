...
final readonly class CreateColumn
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Projects\CreateColumn($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $projectId);
