...
final readonly class ListForOrg
{
    ...
    public function call(string $org, string $state = 'open', int $perPage = 30, int $page = 1): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Projects\ListForOrg($this->responseSchemaValidator, $this->hydrator, $org, $state, $perPage, $page);
