...
final readonly class ListForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Projects\ListForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $perPage, $page);
