...
final readonly class ListCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Projects\ListCollaborators($this->responseSchemaValidator, $this->hydrator, $projectId, $affiliation, $perPage, $page);
