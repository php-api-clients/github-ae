...
namespace ApiClients\Client\GitHubAE\Operator\Gitignore;
...
final readonly class GetAllTemplates
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Gitignore\GetAllTemplates($this->responseSchemaValidator, $this->hydrator);
