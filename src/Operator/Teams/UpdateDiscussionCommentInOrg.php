...
final readonly class UpdateDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\UpdateDiscussionCommentInOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $commentNumber);
