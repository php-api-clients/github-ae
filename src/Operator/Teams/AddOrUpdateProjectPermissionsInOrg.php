...
final readonly class AddOrUpdateProjectPermissionsInOrg
{
    ...
    public function call(string $org, string $teamSlug, int $projectId, array $params): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\AddOrUpdateProjectPermissionsInOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $projectId);
