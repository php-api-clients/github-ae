...
final readonly class ListProjectsInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\ListProjectsInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
