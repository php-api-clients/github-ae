...
final readonly class GetDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\GetDiscussionCommentInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $commentNumber);
