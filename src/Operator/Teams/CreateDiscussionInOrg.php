...
final readonly class CreateDiscussionInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\CreateDiscussionInOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $teamSlug);
