...
final readonly class ListDiscussionCommentsInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\ListDiscussionCommentsInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $direction, $perPage, $page);
