...
final readonly class CreateDiscussionCommentLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\CreateDiscussionCommentLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber);
