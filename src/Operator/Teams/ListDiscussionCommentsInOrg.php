...
final readonly class ListDiscussionCommentsInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\ListDiscussionCommentsInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $direction, $perPage, $page);
