...
final readonly class CheckPermissionsForProjectInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Teams\CheckPermissionsForProjectInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $projectId);
