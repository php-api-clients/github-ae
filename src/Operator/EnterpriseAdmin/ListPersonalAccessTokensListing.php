...
final readonly class ListPersonalAccessTokensListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\EnterpriseAdmin\ListPersonalAccessTokensListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
