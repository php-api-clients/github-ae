...
final readonly class ListPublicKeysListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\EnterpriseAdmin\ListPublicKeysListing($this->responseSchemaValidator, $this->hydrator, $since, $perPage, $page, $direction, $sort);
