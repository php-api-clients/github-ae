...
final readonly class ListPreReceiveEnvironments
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\EnterpriseAdmin\ListPreReceiveEnvironments($this->responseSchemaValidator, $this->hydrator, $perPage, $page, $direction, $sort);
