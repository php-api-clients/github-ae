...
final readonly class GetDeploymentStatus
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetDeploymentStatus($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $deploymentId, $statusId);
