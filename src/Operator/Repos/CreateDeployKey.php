...
final readonly class CreateDeployKey
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateDeployKey($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
