...
final readonly class CreateOrUpdateFileContents
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateOrUpdateFileContents($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $path);
