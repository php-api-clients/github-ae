...
final readonly class GetDeploymentBranchPolicy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetDeploymentBranchPolicy($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName, $branchPolicyId);
