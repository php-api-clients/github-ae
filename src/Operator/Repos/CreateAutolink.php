...
final readonly class CreateAutolink
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateAutolink($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
