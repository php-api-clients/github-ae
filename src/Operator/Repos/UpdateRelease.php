...
final readonly class UpdateRelease
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\Repos\Owner\Repo\Releases\ReleaseId $hydrator)
    {
    }

    /** @return */
    public function call(string $owner, string $repo, int $releaseId, array $params): Release|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\UpdateRelease($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId);
