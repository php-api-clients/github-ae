...
final readonly class GetUsersWithAccessToProtectedBranch
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetUsersWithAccessToProtectedBranch($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
