...
final readonly class GetCombinedStatusForRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetCombinedStatusForRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
