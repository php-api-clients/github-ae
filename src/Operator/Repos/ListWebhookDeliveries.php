...
final readonly class ListWebhookDeliveries
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListWebhookDeliveries($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId, $cursor, $redelivery, $perPage);
