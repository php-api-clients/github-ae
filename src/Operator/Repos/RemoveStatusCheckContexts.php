...
final readonly class RemoveStatusCheckContexts
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\RemoveStatusCheckContexts($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
