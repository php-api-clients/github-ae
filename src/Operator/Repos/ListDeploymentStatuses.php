...
final readonly class ListDeploymentStatuses
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListDeploymentStatuses($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $deploymentId, $perPage, $page);
