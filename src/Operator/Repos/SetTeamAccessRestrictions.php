...
final readonly class SetTeamAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\SetTeamAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
