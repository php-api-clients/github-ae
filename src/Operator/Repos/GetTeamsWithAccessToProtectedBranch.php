...
final readonly class GetTeamsWithAccessToProtectedBranch
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetTeamsWithAccessToProtectedBranch($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
