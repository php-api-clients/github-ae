...
final readonly class ListForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $direction, $type, $sort, $perPage, $page);
