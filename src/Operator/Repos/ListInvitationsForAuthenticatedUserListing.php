...
final readonly class ListInvitationsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListInvitationsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
