...
final readonly class UpdateInformationAboutPagesSite
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\UpdateInformationAboutPagesSite($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
