...
final readonly class UpdatePullRequestReviewProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\UpdatePullRequestReviewProtection($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
