...
final readonly class DeleteFile
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\DeleteFile($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $path);
