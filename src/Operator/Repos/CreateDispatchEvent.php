...
final readonly class CreateDispatchEvent
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateDispatchEvent($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
