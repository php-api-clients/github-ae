...
final readonly class AddAppAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\AddAppAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
