...
final readonly class GetAppsWithAccessToProtectedBranch
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\GetAppsWithAccessToProtectedBranch($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
