...
final readonly class ListCommentsForCommitListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListCommentsForCommitListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha, $perPage, $page);
