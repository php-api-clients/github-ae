...
final readonly class AddUserAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\AddUserAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
