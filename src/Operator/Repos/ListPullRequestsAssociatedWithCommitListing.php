...
final readonly class ListPullRequestsAssociatedWithCommitListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListPullRequestsAssociatedWithCommitListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha, $perPage, $page);
