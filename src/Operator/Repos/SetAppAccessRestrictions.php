...
final readonly class SetAppAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\SetAppAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
