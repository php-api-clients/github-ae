...
final readonly class CreateDeploymentBranchPolicy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateDeploymentBranchPolicy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName);
