...
final readonly class DeletePullRequestReviewProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\DeletePullRequestReviewProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
