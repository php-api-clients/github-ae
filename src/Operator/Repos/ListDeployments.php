...
final readonly class ListDeployments
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListDeployments($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sha, $ref, $task, $environment, $perPage, $page);
