...
final readonly class ListCommitStatusesForRefListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListCommitStatusesForRefListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
