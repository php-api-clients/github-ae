...
final readonly class ListContributorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListContributorsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $anon, $perPage, $page);
