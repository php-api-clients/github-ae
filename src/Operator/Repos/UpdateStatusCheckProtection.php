...
final readonly class UpdateStatusCheckProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\UpdateStatusCheckProtection($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
