...
final readonly class RedeliverWebhookDelivery
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\RedeliverWebhookDelivery($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId, $deliveryId);
