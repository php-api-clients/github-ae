...
final readonly class CreateWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\CreateWebhook($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
