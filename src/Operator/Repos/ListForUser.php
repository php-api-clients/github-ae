...
final readonly class ListForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListForUser($this->responseSchemaValidator, $this->hydrator, $username, $direction, $type, $sort, $perPage, $page);
