...
final readonly class ListPullRequestsAssociatedWithCommit
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListPullRequestsAssociatedWithCommit($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha, $perPage, $page);
