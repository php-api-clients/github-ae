...
final readonly class ListCommitStatusesForRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListCommitStatusesForRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
