...
final readonly class ListCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListCollaborators($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $permission, $affiliation, $perPage, $page);
