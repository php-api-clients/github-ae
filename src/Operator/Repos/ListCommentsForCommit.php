...
final readonly class ListCommentsForCommit
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Repos\ListCommentsForCommit($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha, $perPage, $page);
