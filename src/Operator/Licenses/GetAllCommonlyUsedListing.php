...
final readonly class GetAllCommonlyUsedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Licenses\GetAllCommonlyUsedListing($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
