...
final readonly class CreateOrUpdateOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\CreateOrUpdateOrgSecret($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $secretName);
