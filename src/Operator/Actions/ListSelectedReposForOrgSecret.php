...
final readonly class ListSelectedReposForOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\ListSelectedReposForOrgSecret($this->responseSchemaValidator, $this->hydrator, $org, $secretName, $page, $perPage);
