...
final readonly class DownloadArtifact
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\DownloadArtifact($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $artifactId, $archiveFormat);
