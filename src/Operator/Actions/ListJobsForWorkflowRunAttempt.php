...
final readonly class ListJobsForWorkflowRunAttempt
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\ListJobsForWorkflowRunAttempt($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId, $attemptNumber, $perPage, $page);
