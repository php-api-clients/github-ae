...
final readonly class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
