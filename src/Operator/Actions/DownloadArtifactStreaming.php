...
final readonly class DownloadArtifactStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\DownloadArtifactStreaming($this->responseSchemaValidator, $this->hydrator, $this->browser, $owner, $repo, $artifactId, $archiveFormat);
