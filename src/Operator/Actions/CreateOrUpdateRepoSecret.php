...
final readonly class CreateOrUpdateRepoSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\CreateOrUpdateRepoSecret($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $secretName);
