...
final readonly class GetGithubActionsDefaultWorkflowPermissionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Actions\GetGithubActionsDefaultWorkflowPermissionsOrganization($this->responseSchemaValidator, $this->hydrator, $org);
