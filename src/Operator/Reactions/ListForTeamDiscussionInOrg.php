...
final readonly class ListForTeamDiscussionInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\ListForTeamDiscussionInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $content, $perPage, $page);
