...
final readonly class CreateForIssueComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\CreateForIssueComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
