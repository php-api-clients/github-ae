...
final readonly class ListForIssue
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\ListForIssue($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $content, $perPage, $page);
