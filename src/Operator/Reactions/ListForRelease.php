...
final readonly class ListForRelease
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\ListForRelease($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId, $content, $perPage, $page);
