...
final readonly class ListForCommitComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\ListForCommitComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId, $content, $perPage, $page);
