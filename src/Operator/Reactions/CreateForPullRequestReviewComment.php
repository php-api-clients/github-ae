...
final readonly class CreateForPullRequestReviewComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\CreateForPullRequestReviewComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
