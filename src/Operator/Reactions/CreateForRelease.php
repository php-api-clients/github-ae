...
final readonly class CreateForRelease
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\CreateForRelease($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId);
