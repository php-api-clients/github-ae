...
final readonly class ListForTeamDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Reactions\ListForTeamDiscussionCommentInOrg($org, $teamSlug, $discussionNumber, $commentNumber, $content, $perPage, $page);
