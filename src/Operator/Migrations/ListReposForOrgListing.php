...
final readonly class ListReposForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Migrations\ListReposForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $migrationId, $perPage, $page);
