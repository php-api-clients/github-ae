...
final readonly class DownloadArchiveForOrgStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Migrations\DownloadArchiveForOrgStreaming($this->responseSchemaValidator, $this->hydrator, $this->browser, $org, $migrationId);
