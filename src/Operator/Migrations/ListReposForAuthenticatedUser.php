...
final readonly class ListReposForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Migrations\ListReposForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $migrationId, $perPage, $page);
