...
final readonly class ListLocationsForAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\SecretScanning\ListLocationsForAlert($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber, $page, $perPage);
