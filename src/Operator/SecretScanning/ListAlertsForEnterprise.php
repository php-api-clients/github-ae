...
final readonly class ListAlertsForEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\SecretScanning\ListAlertsForEnterprise($this->responseSchemaValidator, $this->hydrator, $enterprise, $state, $secretType, $resolution, $before, $after, $sort, $direction, $perPage);
