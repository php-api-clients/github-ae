...
final readonly class ListAlertsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\SecretScanning\ListAlertsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $secretType, $resolution, $page, $perPage);
