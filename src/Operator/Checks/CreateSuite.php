...
final readonly class CreateSuite
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Checks\CreateSuite($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
