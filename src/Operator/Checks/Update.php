...
final readonly class Update
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Checks\Update($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId);
