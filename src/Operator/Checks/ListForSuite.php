...
final readonly class ListForSuite
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Checks\ListForSuite($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkSuiteId, $checkName, $status, $filter, $perPage, $page);
