...
final readonly class MarkNotificationsAsRead
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Activity\MarkNotificationsAsRead($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
