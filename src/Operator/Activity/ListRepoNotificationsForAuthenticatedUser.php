...
final readonly class ListRepoNotificationsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Activity\ListRepoNotificationsForAuthenticatedUser($owner, $repo, $since, $before, $all, $participating, $perPage, $page);
