...
final readonly class ListRepoNotificationsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Activity\ListRepoNotificationsForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $since, $before, $all, $participating, $perPage, $page);
