...
final readonly class ListReposStarredByAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Activity\ListReposStarredByAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $sort, $direction, $perPage, $page);
