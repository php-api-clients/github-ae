...
final readonly class SetRepoSubscription
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Activity\SetRepoSubscription($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
