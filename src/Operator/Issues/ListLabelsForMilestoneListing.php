...
final readonly class ListLabelsForMilestoneListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListLabelsForMilestoneListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $milestoneNumber, $perPage, $page);
