...
final readonly class CheckUserCanBeAssignedToIssue
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\CheckUserCanBeAssignedToIssue($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $assignee);
