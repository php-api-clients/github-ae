...
final readonly class ListCommentsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListCommentsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $direction, $since, $sort, $perPage, $page);
