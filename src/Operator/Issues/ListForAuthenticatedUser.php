...
final readonly class ListForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $labels, $since, $filter, $state, $sort, $direction, $perPage, $page);
