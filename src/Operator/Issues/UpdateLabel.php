...
final readonly class UpdateLabel
{
    ...
    /** @return */
    public function call(string $owner, string $repo, string $name, array $params): Label|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\UpdateLabel($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $name);
