...
final readonly class CreateComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\CreateComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
