...
final readonly class ListMilestonesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListMilestonesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $sort, $direction, $perPage, $page);
