...
final readonly class ListEventsForTimeline
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListEventsForTimeline($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
