...
final readonly class AddLabels
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\AddLabels($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
