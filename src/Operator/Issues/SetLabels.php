...
final readonly class SetLabels
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\SetLabels($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
