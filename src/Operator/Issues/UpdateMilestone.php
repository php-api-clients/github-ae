...
final readonly class UpdateMilestone
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\UpdateMilestone($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $milestoneNumber);
