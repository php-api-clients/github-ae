...
final readonly class AddAssignees
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\AddAssignees($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
