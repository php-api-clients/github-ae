...
final readonly class Lock
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\Lock($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
