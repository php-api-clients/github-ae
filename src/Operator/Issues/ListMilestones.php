...
final readonly class ListMilestones
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListMilestones($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $sort, $direction, $perPage, $page);
