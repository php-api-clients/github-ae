...
final readonly class ListEventsForTimelineListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\ListEventsForTimelineListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
