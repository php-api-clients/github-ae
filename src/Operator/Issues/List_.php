...
final readonly class List_
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Issues\List_($this->responseSchemaValidator, $this->hydrator, $labels, $since, $collab, $orgs, $owned, $pulls, $filter, $state, $sort, $direction, $perPage, $page);
