...
final readonly class ListPublicSshKeysForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Users\ListPublicSshKeysForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
