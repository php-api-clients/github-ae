...
final readonly class ListFollowersForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Users\ListFollowersForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
