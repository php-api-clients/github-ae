...
namespace ApiClients\Client\GitHubAE\Operator\RateLimit;
...
final readonly class Get
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\RateLimit\Get($this->responseSchemaValidator, $this->hydrator);
