...
final readonly class ListInstallationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Apps\ListInstallationsListing($this->responseSchemaValidator, $this->hydrator, $since, $outdated, $perPage, $page);
