...
final readonly class ListInstallationReposForAuthenticatedUser
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\User\Installations\InstallationId\Repositories $hydrator)
    {
    }
     ...
     **/
    public function call(int $installationId, int $perPage = 30, int $page = 1): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Apps\ListInstallationReposForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $installationId, $perPage, $page);
