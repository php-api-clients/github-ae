...
final readonly class ListInstallationRequestsForAuthenticatedAppListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Apps\ListInstallationRequestsForAuthenticatedAppListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
