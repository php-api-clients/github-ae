...
final readonly class ConvertMemberToOutsideCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Orgs\ConvertMemberToOutsideCollaborator($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $username);
