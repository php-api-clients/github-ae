...
final readonly class SetMembershipForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Orgs\SetMembershipForUser($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $username);
