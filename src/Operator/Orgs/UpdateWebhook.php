...
final readonly class UpdateWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Orgs\UpdateWebhook($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $hookId);
