...
final readonly class UpdateRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Git\UpdateRef($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref);
