...
final readonly class RemoveRequestedReviewers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\RemoveRequestedReviewers($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
