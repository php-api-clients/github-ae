...
final readonly class UpdateReview
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\UpdateReview($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $reviewId);
