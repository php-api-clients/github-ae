...
final readonly class CreateReviewComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\CreateReviewComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
