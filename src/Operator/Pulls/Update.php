...
final readonly class Update
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\Update($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
