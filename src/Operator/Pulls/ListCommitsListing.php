...
final readonly class ListCommitsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\ListCommitsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
