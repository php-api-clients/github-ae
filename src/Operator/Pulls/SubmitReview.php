...
final readonly class SubmitReview
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\SubmitReview($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $reviewId);
