...
final readonly class Merge
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\Merge($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
