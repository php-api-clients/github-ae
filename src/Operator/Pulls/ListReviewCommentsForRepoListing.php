...
final readonly class ListReviewCommentsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\ListReviewCommentsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sort, $direction, $since, $perPage, $page);
