...
final readonly class ListReviewsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\Pulls\ListReviewsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
