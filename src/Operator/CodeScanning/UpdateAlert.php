...
final readonly class UpdateAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\CodeScanning\UpdateAlert($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber);
