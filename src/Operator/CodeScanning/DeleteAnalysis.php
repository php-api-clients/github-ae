...
final readonly class DeleteAnalysis
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\CodeScanning\DeleteAnalysis($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $analysisId, $confirmDelete);
