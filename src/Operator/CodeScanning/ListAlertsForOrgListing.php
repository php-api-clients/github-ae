...
final readonly class ListAlertsForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Operation\CodeScanning\ListAlertsForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $toolName, $toolGuid, $before, $after, $state, $severity, $page, $perPage, $direction, $sort);
