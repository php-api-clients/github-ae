...
class Topics implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches\\Matches',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related(mixed $object): mixed
    {
        ...
        $topic_relation = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation($topic_relation);
