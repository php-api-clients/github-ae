...
class Topics implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️Topics⚡️Response⚡️Applicationjson⚡️H200($payload),
                'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related($payload),
                'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation($payload),
                'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases($payload),
                'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️Topics⚡️Response⚡️Applicationjson⚡️H200(array $payload): \ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\TopicSearchResultItem',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem(array $payload): \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\TopicSearchResultItem\\Related',
));
            }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\TopicSearchResultItem\\Aliases',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches\\Matches',
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related(array $payload): \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation(array $payload): \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases(array $payload): \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'topicRelation';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation(array $payload): \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️Topics⚡️Response⚡️Applicationjson⚡️H200($object),
            'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem($object),
            ...
            'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related($object),
            'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation($object),
            'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases($object),
            'ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️Topics⚡️Response⚡️Applicationjson⚡️H200(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Operation\Search\Topics\Response\Applicationjson\H200);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\TopicSearchResultItem',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches\\Matches',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related);
        $result = [];
        ...
        $topicRelation = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation($topicRelation);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Related⚡️TopicRelation(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Related\TopicRelation);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases);
        $result = [];
        ...
        $topicRelation = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation($topicRelation);
        after_topicRelation:        $result['topic_relation'] = $topicRelation;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TopicSearchResultItem⚡️Aliases⚡️TopicRelation(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem\Aliases\TopicRelation);
        $result = [];
