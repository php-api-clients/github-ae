...
class Issues implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️IssuesAndPullRequests⚡️Response⚡️Applicationjson⚡️H200($payload),
                'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem($payload),
                'ApiClients\Client\GitHubAE\Schema\SimpleUser' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($payload),
                'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️Labels($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️IssuesAndPullRequests⚡️Response⚡️Applicationjson⚡️H200(array $payload): \ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\IssueSearchResultItem',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem(array $payload): \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\IssueSearchResultItem\\Labels',
));
            }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches',
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️Labels(array $payload): \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches\\Matches',
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest(array $payload): \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️IssuesAndPullRequests⚡️Response⚡️Applicationjson⚡️H200($object),
            'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem($object),
            'ApiClients\Client\GitHubAE\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($object),
            'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️Labels($object),
            ...
            'ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Search⚡️IssuesAndPullRequests⚡️Response⚡️Applicationjson⚡️H200(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\IssueSearchResultItem',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches',
        ...
        $pullRequest = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest($pullRequest);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️Labels(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\Labels);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SearchResultTextMatches\\Matches',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueSearchResultItem⚡️PullRequest(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\IssueSearchResultItem\PullRequest);
        $result = [];
