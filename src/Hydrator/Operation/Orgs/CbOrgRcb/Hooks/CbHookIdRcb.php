...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Orgs\CbOrgRcb\Hooks;
...
class CbHookIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\OrgHook' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook($payload),
                'ApiClients\Client\GitHubAE\Schema\OrgHook\Config' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook(array $payload): \ApiClients\Client\GitHubAE\Schema\OrgHook
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config($value);
                    } finally {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgHook', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\OrgHook::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\OrgHook(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgHook', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config(array $payload): \ApiClients\Client\GitHubAE\Schema\OrgHook\Config
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgHook\Config', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\OrgHook\Config::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\OrgHook\Config(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgHook\Config', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\OrgHook' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook($object),
                'ApiClients\Client\GitHubAE\Schema\OrgHook\Config' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\OrgHook);
        $result = [];
        ...
        $config = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config($config);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\OrgHook\Config);
        $result = [];
