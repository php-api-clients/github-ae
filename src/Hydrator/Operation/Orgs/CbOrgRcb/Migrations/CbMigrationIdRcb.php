...
namespace ApiClients\Client\Github\Hydrator\Operation\Orgs\CbOrgRcb\Migrations;
...
class CbMigrationIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\Migration' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Migration($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Migration(array $payload): \ApiClients\Client\Github\Schema\Migration
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\Repository',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Migration', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\Migration::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\Migration(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Migration', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\Migration' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Migration($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Migration(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\Migration);
        $result = [];
