...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Orgs\CbOrgRcb\Migrations;
...
class CbMigrationIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Migration' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Migration($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Migration(array $payload): \ApiClients\Client\GitHubAE\Schema\Migration
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                $properties['lock_repositories'] = $value;
    
                after_lock_repositories:
                ...
                $properties['exclude_metadata'] = $value;
    
                after_exclude_metadata:
                ...
                $properties['exclude_git_data'] = $value;
    
                after_exclude_git_data:
                ...
                $properties['exclude_attachments'] = $value;
    
                after_exclude_attachments:
                ...
                $properties['exclude_releases'] = $value;
    
                after_exclude_releases:
                ...
                $properties['exclude_owner_projects'] = $value;
    
                after_exclude_owner_projects:
                ...
                $properties['org_metadata_only'] = $value;
    
                after_org_metadata_only:
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\Repository',
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Migration', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Migration::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Migration(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Migration', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\Migration' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Migration($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Migration(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Migration);
        $result = [];
        ...
        $lock_repositories = $object->lock_repositories;

        if ($lock_repositories === null) {
            goto after_lock_repositories;
        }
        after_lock_repositories:        $result['lock_repositories'] = $lock_repositories;

        
        $exclude_metadata = $object->exclude_metadata;

        if ($exclude_metadata === null) {
            goto after_exclude_metadata;
        }
        after_exclude_metadata:        $result['exclude_metadata'] = $exclude_metadata;

        
        $exclude_git_data = $object->exclude_git_data;

        if ($exclude_git_data === null) {
            goto after_exclude_git_data;
        }
        after_exclude_git_data:        $result['exclude_git_data'] = $exclude_git_data;

        
        $exclude_attachments = $object->exclude_attachments;

        if ($exclude_attachments === null) {
            goto after_exclude_attachments;
        }
        after_exclude_attachments:        $result['exclude_attachments'] = $exclude_attachments;

        
        $exclude_releases = $object->exclude_releases;

        if ($exclude_releases === null) {
            goto after_exclude_releases;
        }
        after_exclude_releases:        $result['exclude_releases'] = $exclude_releases;

        
        $exclude_owner_projects = $object->exclude_owner_projects;

        if ($exclude_owner_projects === null) {
            goto after_exclude_owner_projects;
        }
        after_exclude_owner_projects:        $result['exclude_owner_projects'] = $exclude_owner_projects;

        
        $org_metadata_only = $object->org_metadata_only;

        if ($org_metadata_only === null) {
            goto after_org_metadata_only;
        }
        after_org_metadata_only:        $result['org_metadata_only'] = $org_metadata_only;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\Repository',
        ...
        static $excludeSerializer0;

        if ($excludeSerializer0 === null) {
            $excludeSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $exclude = $excludeSerializer0->serialize($exclude, $this);
        after_exclude:        $result['exclude'] = $exclude;
