...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Orgs\CbOrgRcb\Memberships;
...
class CbUsernameRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\OrgMembership' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership(array $payload): \ApiClients\Client\GitHubAE\Schema\OrgMembership
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgMembership', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\OrgMembership::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\OrgMembership(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgMembership', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions(array $payload): \ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($value === null) {
                    $properties['can_create_repository'] = null;
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\OrgMembership' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\OrgMembership);
        $result = [];
        ...
        $permissions = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions($permissions);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgMembership⚡️Permissions(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\OrgMembership\Permissions);
        $result = [];
        
        $can_create_repository = $object->can_create_repository;

        if ($can_create_repository === null) {
            goto after_can_create_repository;
        }
