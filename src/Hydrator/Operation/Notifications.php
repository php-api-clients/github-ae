...
class Notifications implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread(array $payload): \ApiClients\Client\GitHubAE\Schema\Thread
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['last_read_at'] = null;
                    goto after_last_read_at;
                }

                $properties['last_read_at'] = $value;
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject(array $payload): \ApiClients\Client\GitHubAE\Schema\Thread\Subject
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['latest_comment_url'] = null;
                    goto after_latest_comment_url;
                }

                $properties['latest_comment_url'] = $value;
    
                after_latest_comment_url:
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread(mixed $object): mixed
    {
        ...
        after_last_read_at:        $result['last_read_at'] = $last_read_at;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject(mixed $object): mixed
    {
        ...
        $latest_comment_url = $object->latest_comment_url;

        if ($latest_comment_url === null) {
            goto after_latest_comment_url;
        }
        after_latest_comment_url:        $result['latest_comment_url'] = $latest_comment_url;
