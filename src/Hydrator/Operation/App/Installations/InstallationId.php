...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\App\Installations;
...
class InstallationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Installation(array $payload): \ApiClients\Client\GitHubAE\Schema\Installation
    {
        ...
        try {
            ...
            if ($accountCaster1 === null) {
                $accountCaster1 = new \ApiClients\Client\GitHubAE\Attribute\CastUnionToType\Schema\Installation\Account(...array (
));
            }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Installation(mixed $object): mixed
    {
        ...
        $account = match(get_class($account)) {
