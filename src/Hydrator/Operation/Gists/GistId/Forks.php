...
class Forks implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\BasicError' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BasicError($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\BaseGist\Files' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist⚡️Files($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist⚡️Files($value);
                } finally {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist⚡️Files(array $payload): \ApiClients\Client\GitHubAE\Schema\BaseGist\Files
    {
        $properties = []; 
        $missingFields = [];
        try {
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\BaseGist\Files', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\BaseGist\Files::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\BaseGist\Files(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\BaseGist\Files', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist(mixed $object): mixed
    {
        ...
        $files = $object->files;
        $files = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist⚡️Files($files);
