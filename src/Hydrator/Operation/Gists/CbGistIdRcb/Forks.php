...
class Forks implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\GistHistory',
        ...
        $forkOf = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf($forkOf);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory(mixed $object): mixed
    {
        ...
        $changeStatus = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus($changeStatus);
