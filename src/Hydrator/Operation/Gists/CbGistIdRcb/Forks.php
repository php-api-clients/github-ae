...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Gists\CbGistIdRcb;
...
class Forks implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\GistSimple' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple($payload),
                'ApiClients\Client\GitHubAE\Schema\GistSimple\Forks' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️Forks($payload),
                'ApiClients\Client\GitHubAE\Schema\PublicUser' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\GistHistory' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory($payload),
                'ApiClients\Client\GitHubAE\Schema\SimpleUser' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($payload),
                'ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus($payload),
                'ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf($payload),
                'ApiClients\Client\GitHubAE\Schema\BasicError' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BasicError($payload),
                'ApiClients\Client\GitHubAE\Schema\BaseGist' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple(array $payload): \ApiClients\Client\GitHubAE\Schema\GistSimple
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\GistSimple\\Forks',
));
                }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\GistHistory',
));
                }
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf($value);
                    } finally {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GistSimple::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\GistSimple(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️Forks(array $payload): \ApiClients\Client\GitHubAE\Schema\GistSimple\Forks
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple\Forks', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GistSimple\Forks::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\GistSimple\Forks(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple\Forks', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser(array $payload): \ApiClients\Client\GitHubAE\Schema\PublicUser
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PublicUser', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\PublicUser::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\PublicUser(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PublicUser', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory(array $payload): \ApiClients\Client\GitHubAE\Schema\GistHistory
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistHistory', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GistHistory::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\GistHistory(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistHistory', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus(array $payload): \ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf(array $payload): \ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist(array $payload): \ApiClients\Client\GitHubAE\Schema\BaseGist
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\BaseGist', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\BaseGist::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\BaseGist(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\BaseGist', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\GistSimple' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple($object),
                'ApiClients\Client\GitHubAE\Schema\GistSimple\Forks' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️Forks($object),
                'ApiClients\Client\GitHubAE\Schema\PublicUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\GistHistory' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory($object),
                'ApiClients\Client\GitHubAE\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($object),
                'ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus($object),
                'ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf($object),
                'ApiClients\Client\GitHubAE\Schema\BasicError' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BasicError($object),
                'ApiClients\Client\GitHubAE\Schema\BaseGist' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GistSimple);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\GistHistory',
        ...
        $fork_of = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf($fork_of);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️Forks(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GistSimple\Forks);
        $result = [];
        ...
        $user = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser($user);
        after_user:        $result['user'] = $user;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PublicUser(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\PublicUser);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GistHistory);
        $result = [];
        ...
        $change_status = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus($change_status);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistHistory⚡️ChangeStatus(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GistHistory\ChangeStatus);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BaseGist(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\BaseGist);
        $result = [];
