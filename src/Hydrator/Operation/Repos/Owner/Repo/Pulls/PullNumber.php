...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\Owner\Repo\Pulls;
...
class PullNumber implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest(mixed $object): mixed
    {
        ...
        if ($requestedReviewersSerializer0 === null) {
            $requestedReviewersSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        ...
        if ($requestedTeamsSerializer0 === null) {
            $requestedTeamsSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
