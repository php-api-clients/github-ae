...
class Pages implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Page' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page($payload),
                'ApiClients\Client\GitHubAE\Schema\PagesSourceHash' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash($payload),
                'ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page(array $payload): \ApiClients\Client\GitHubAE\Schema\Page
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Page', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Page::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Page(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Page', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash(array $payload): \ApiClients\Client\GitHubAE\Schema\PagesSourceHash
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PagesSourceHash', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\PagesSourceHash::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\PagesSourceHash(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PagesSourceHash', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate(array $payload): \ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\Page' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page($object),
            'ApiClients\Client\GitHubAE\Schema\PagesSourceHash' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash($object),
            'ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Page);
        $result = [];
        ...
        $source = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash($source);
        ...
        $httpsCertificate = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate($httpsCertificate);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\PagesSourceHash);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate);
        $result = [];
