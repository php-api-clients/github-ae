...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Attempts;
...
class AttemptNumber implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        if ($referencedWorkflowsSerializer0 === null) {
            $referencedWorkflowsSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
