...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\Owner\Repo\Git\Trees;
...
class TreeSha implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTree(mixed $object): mixed
    {
        ...
        if ($treeSerializer0 === null) {
            $treeSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
