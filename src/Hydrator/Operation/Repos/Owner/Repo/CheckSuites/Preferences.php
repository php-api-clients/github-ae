...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\Owner\Repo\CheckSuites;
...
class Preferences implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference($payload),
                'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference(array $payload): \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference
    {
        $properties = []; 
        $missingFields = [];
        try {
            $value = $payload['preferences'] ?? null;

            if ($value === null) {
                $missingFields[] = 'preferences';
                goto after_preferences;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'preferences';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\CheckSuitePreference::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(array $payload): \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences
    {
        $properties = []; 
        $missingFields = [];
        try {
            $value = $payload['auto_trigger_checks'] ?? null;

            if ($value === null) {
                $properties['autoTriggerChecks'] = null;
                goto after_autoTriggerChecks;
            }

            $properties['autoTriggerChecks'] = $value;

            after_autoTriggerChecks:

        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference($object),
            'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference);
        $result = [];

        $preferences = $object->preferences;
        $preferences = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences($preferences);
        after_preferences:        $result['preferences'] = $preferences;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences);
        $result = [];

        $autoTriggerChecks = $object->autoTriggerChecks;

        if ($autoTriggerChecks === null) {
            goto after_autoTriggerChecks;
        }
        static $autoTriggerChecksSerializer0;

        if ($autoTriggerChecksSerializer0 === null) {
            $autoTriggerChecksSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $autoTriggerChecks = $autoTriggerChecksSerializer0->serialize($autoTriggerChecks, $this);
        after_autoTriggerChecks:        $result['auto_trigger_checks'] = $autoTriggerChecks;
