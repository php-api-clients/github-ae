...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Blobs;
...
class CbFileShaRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Blob' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Blob($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Blob(array $payload): \ApiClients\Client\GitHubAE\Schema\Blob
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($value === null) {
                    $missingFields[] = 'highlighted_content';
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Blob', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Blob::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Blob(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Blob', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\Blob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Blob($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Blob(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Blob);
        $result = [];
