...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Git\Tags;
...
class CbTagShaRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\GitTag' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag($payload),
                'ApiClients\Client\GitHubAE\Schema\GitTag\Tagger' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger($payload),
                'ApiClients\Client\GitHubAE\Schema\GitTag\Object_' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Object_($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag(array $payload): \ApiClients\Client\GitHubAE\Schema\GitTag
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Object_($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GitTag::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\GitTag(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger(array $payload): \ApiClients\Client\GitHubAE\Schema\GitTag\Tagger
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag\Tagger', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GitTag\Tagger::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\GitTag\Tagger(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag\Tagger', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Object_(array $payload): \ApiClients\Client\GitHubAE\Schema\GitTag\Object_
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag\Object_', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\GitTag\Object_::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\GitTag\Object_(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GitTag\Object_', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\GitTag' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag($object),
            'ApiClients\Client\GitHubAE\Schema\GitTag\Tagger' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GitTag);
        $result = [];
        ...
        $tagger = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger($tagger);
        after_tagger:        $result['tagger'] = $tagger;

        
        $object = $object->object;
        $object = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Object_($object);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Tagger(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GitTag\Tagger);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTag⚡️Object_(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\GitTag\Object_);
        $result = [];
