...
class Pages implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page(array $payload): \ApiClients\Client\GitHubAE\Schema\Page
        {
            ...
            try {
                ...
                if ($value === null) {
                    $missingFields[] = 'https_certificate';
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page(mixed $object): mixed
    {
        ...
        $https_certificate = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate($https_certificate);
