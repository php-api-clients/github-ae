...
class Protection implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\BranchRestrictionPolicy\\Apps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch(mixed $object): mixed
    {
        ...
        $required_status_checks = $object->required_status_checks;
        $required_status_checks = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️StatusCheckPolicy($required_status_checks);
        after_required_status_checks:        $result['required_status_checks'] = $required_status_checks;

        
        $required_pull_request_reviews = $object->required_pull_request_reviews;
        $required_pull_request_reviews = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews($required_pull_request_reviews);
        after_required_pull_request_reviews:        $result['required_pull_request_reviews'] = $required_pull_request_reviews;
        ...
        $enforce_admins = $object->enforce_admins;
        $enforce_admins = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️EnforceAdmins($enforce_admins);
        after_enforce_admins:        $result['enforce_admins'] = $enforce_admins;

        
        $required_linear_history = $object->required_linear_history;
        $required_linear_history = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredLinearHistory($required_linear_history);
        after_required_linear_history:        $result['required_linear_history'] = $required_linear_history;

        
        $allow_force_pushes = $object->allow_force_pushes;
        $allow_force_pushes = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredLinearHistory($allow_force_pushes);
        after_allow_force_pushes:        $result['allow_force_pushes'] = $allow_force_pushes;

        
        $allow_deletions = $object->allow_deletions;
        $allow_deletions = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredLinearHistory($allow_deletions);
        after_allow_deletions:        $result['allow_deletions'] = $allow_deletions;
        ...
        $required_conversation_resolution = $object->required_conversation_resolution;
        $required_conversation_resolution = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredConversationResolution($required_conversation_resolution);
        after_required_conversation_resolution:        $result['required_conversation_resolution'] = $required_conversation_resolution;

        
        $block_creations = $object->block_creations;
        $block_creations = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredLinearHistory($block_creations);
        after_block_creations:        $result['block_creations'] = $block_creations;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\StatusCheckPolicy\\Checks',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews(mixed $object): mixed
    {
        ...
        $dismissal_restrictions = $object->dismissal_restrictions;
        $dismissal_restrictions = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews⚡️DismissalRestrictions($dismissal_restrictions);
        after_dismissal_restrictions:        $result['dismissal_restrictions'] = $dismissal_restrictions;

        
        $bypass_pull_request_allowances = $object->bypass_pull_request_allowances;
        $bypass_pull_request_allowances = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProtectedBranch⚡️RequiredPullRequestReviews⚡️BypassPullRequestAllowances($bypass_pull_request_allowances);
        after_bypass_pull_request_allowances:        $result['bypass_pull_request_allowances'] = $bypass_pull_request_allowances;
