    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(array $payload): \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['auto_trigger_checks'] = null;
                    goto after_auto_trigger_checks;
                }

                static $auto_trigger_checksCaster1;
    
                if ($auto_trigger_checksCaster1 === null) {
                    $auto_trigger_checksCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
));
                }
    
                $value = $auto_trigger_checksCaster1->cast($value, $this);

                $properties['auto_trigger_checks'] = $value;
    
                after_auto_trigger_checks:
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(mixed $object): mixed
    {
        ...
        $auto_trigger_checks = $object->auto_trigger_checks;

        if ($auto_trigger_checks === null) {
            goto after_auto_trigger_checks;
        }
        static $auto_trigger_checksSerializer0;

        if ($auto_trigger_checksSerializer0 === null) {
            $auto_trigger_checksSerializer0 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
));
        }
        
        $auto_trigger_checks = $auto_trigger_checksSerializer0->serialize($auto_trigger_checks, $this);
        after_auto_trigger_checks:        $result['auto_trigger_checks'] = $auto_trigger_checks;
