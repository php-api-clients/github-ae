...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CheckSuites;
...
class Preferences implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(array $payload): \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences
    {
        ...
        try {
            ...
            static $autoTriggerChecksCaster1;

            if ($autoTriggerChecksCaster1 === null) {
                $autoTriggerChecksCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
));
            }

            $value = $autoTriggerChecksCaster1->cast($value, $this);
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks(array $payload): \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences(mixed $object): mixed
    {
        ...
        if ($autoTriggerChecksSerializer0 === null) {
            $autoTriggerChecksSerializer0 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
));
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks);
        $result = [];
        ...
        after_setting:        $result['setting'] = $setting;
