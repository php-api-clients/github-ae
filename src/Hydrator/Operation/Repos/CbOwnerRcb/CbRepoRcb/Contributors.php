...
class Contributors implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Contributor' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Contributor($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Contributor(array $payload): \ApiClients\Client\GitHubAE\Schema\Contributor
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($value === null) {
                    $properties['contributions'] = null;
                    goto after_contributions;
                }

                $properties['contributions'] = $value;
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Contributor', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Contributor::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Contributor(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Contributor', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\Contributor' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Contributor($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Contributor(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Contributor);
        $result = [];
        ...
        after_contributions:        $result['contributions'] = $contributions;
