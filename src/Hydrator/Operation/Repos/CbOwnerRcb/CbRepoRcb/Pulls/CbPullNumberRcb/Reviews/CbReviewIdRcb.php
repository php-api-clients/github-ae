...
class CbReviewIdRcb implements ObjectMapper
{
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️Html($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️PullRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links(mixed $object): mixed
    {
        ...
        $html = $object->html;
        $html = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️Html($html);
        after_html:        $result['html'] = $html;

        
        $pullRequest = $object->pullRequest;
        $pullRequest = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️PullRequest($pullRequest);
