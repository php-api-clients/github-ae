...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Runs\CbRunIdRcb;
...
class Timing implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Macos⚡️JobRuns($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Windows⚡️JobRuns($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Ubuntu(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Ubuntu
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Ubuntu\\JobRuns',
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Ubuntu::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Ubuntu(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Ubuntu', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Macos(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($jobRunsCaster1 === null) {
                $jobRunsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Macos\\JobRuns',
));
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Macos⚡️JobRuns(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Windows(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($jobRunsCaster1 === null) {
                $jobRunsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Windows\\JobRuns',
));
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Windows⚡️JobRuns(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Macos⚡️JobRuns($object),
            ...
            'ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Windows⚡️JobRuns($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Ubuntu\\JobRuns',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Macos\\JobRuns',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Macos⚡️JobRuns(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Macos\JobRuns);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRunUsage\\Billable\\Windows\\JobRuns',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRunUsage⚡️Billable⚡️Windows⚡️JobRuns(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns);
        $result = [];
