...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Workflows\CbWorkflowIdRcb;
...
class Runs implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRuns⚡️Response⚡️Applicationjson⚡️H200($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRuns⚡️Response⚡️Applicationjson⚡️H200(array $payload): \ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($value === null) {
                ...
                goto after_workflowRuns;
            }

            static $workflowRunsCaster1;

            if ($workflowRunsCaster1 === null) {
                $workflowRunsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRun',
));
            }

            $value = $workflowRunsCaster1->cast($value, $this);

            $properties['workflowRuns'] = $value;

            after_workflowRuns:

        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WorkflowRun(array $payload): \ApiClients\Client\GitHubAE\Schema\WorkflowRun
    {
        ...
        try {
            ...
            if ($value === null) {
                $properties['checkSuiteNodeId'] = null;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\PullRequestMinimal',
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRuns⚡️Response⚡️Applicationjson⚡️H200($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRuns⚡️Response⚡️Applicationjson⚡️H200(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListWorkflowRuns\Response\Applicationjson\H200);
        $result = [];
        ...
        $workflowRuns = $object->workflowRuns;
        static $workflowRunsSerializer0;

        if ($workflowRunsSerializer0 === null) {
            $workflowRunsSerializer0 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WorkflowRun',
));
        }
        
        $workflowRuns = $workflowRunsSerializer0->serialize($workflowRuns, $this);
        after_workflowRuns:        $result['workflow_runs'] = $workflowRuns;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\PullRequestMinimal',
        ...
        $triggeringActor = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($triggeringActor);
        ...
        $headRepository = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️MinimalRepository($headRepository);
