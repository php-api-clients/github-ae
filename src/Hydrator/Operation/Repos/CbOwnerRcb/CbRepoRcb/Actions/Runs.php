...
class Runs implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRunsForRepo⚡️Response⚡️Applicationjson⚡️H200($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRunsForRepo⚡️Response⚡️Applicationjson⚡️H200(array $payload): \ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\WorkflowRun',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal',
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRunsForRepo⚡️Response⚡️Applicationjson⚡️H200($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️Operation⚡️Actions⚡️ListWorkflowRunsForRepo⚡️Response⚡️Applicationjson⚡️H200(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\Operation\Actions\ListWorkflowRunsForRepo\Response\Applicationjson\H200);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\PullRequestMinimal',
        ...
        $triggeringActor = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️SimpleUser($triggeringActor);
        ...
        $headRepository = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️MinimalRepository($headRepository);
