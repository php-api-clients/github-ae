...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Contents;
...
class CbPathRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\ContentTree' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree($payload),
                'ApiClients\Client\GitHubAE\Schema\ContentTree\Entries' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries($payload),
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ContentTree\\Entries',
));
                }
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries⚡️Links($value);
                    } finally {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries(array $payload): \ApiClients\Client\GitHubAE\Schema\ContentTree\Entries
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ContentTree\Entries', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\ContentTree\Entries::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\ContentTree\Entries(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ContentTree\Entries', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\ContentTree\Entries' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries($object),
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ContentTree\\Entries',
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries⚡️Links($_links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Entries(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\ContentTree\Entries);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Content(mixed $object): mixed
    {
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Content⚡️Links($_links);
        after__links:        $result['_links'] = $_links;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit⚡️Author($committer);
