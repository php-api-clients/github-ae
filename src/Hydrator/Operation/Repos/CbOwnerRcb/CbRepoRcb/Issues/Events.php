...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Issues;
...
class Events implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEvent(array $payload): \ApiClients\Client\GitHubAE\Schema\IssueEvent
        {
            ...
            try {
                ...
                if ($value === null) {
                    $missingFields[] = 'review_requester';
                    goto after_review_requester;
                }

                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'review_requester';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                ...
                if ($value === null) {
                    $missingFields[] = 'requested_reviewer';
                    goto after_requested_reviewer;
                }

                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'requested_reviewer';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEvent(mixed $object): mixed
    {
        ...
        $review_requester = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($review_requester);
        after_review_requester:        $result['review_requester'] = $review_requester;

        
        $requested_reviewer = $object->requested_reviewer;
        $requested_reviewer = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($requested_reviewer);
