...
class Pulls implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\Team',
        ...
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Head($base);
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Links($_links);
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️AutoMerge($auto_merge);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Links(mixed $object): mixed
    {
        ...
        $review_comments = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Link($review_comments);
        ...
        $review_comment = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Link($review_comment);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️AutoMerge(mixed $object): mixed
    {
        ...
        $enabled_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($enabled_by);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\TeamSimple',
        ...
        $merged_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($merged_by);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head(mixed $object): mixed
    {
        ...
        $user = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Owner($user);
        after_user:        $result['user'] = $user;
