...
class Status implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\CombinedCommitStatus' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CombinedCommitStatus($payload),
                'ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCommitStatus($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CombinedCommitStatus(array $payload): \ApiClients\Client\GitHubAE\Schema\CombinedCommitStatus
    {
        ...
        try {
            ...
            static $statusesCaster1;

            if ($statusesCaster1 === null) {
                $statusesCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SimpleCommitStatus',
));
            }

            $value = $statusesCaster1->cast($value, $this);
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCommitStatus(array $payload): \ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCommitStatus($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CombinedCommitStatus(mixed $object): mixed
    {
        ...
        if ($statusesSerializer0 === null) {
            $statusesSerializer0 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\SimpleCommitStatus',
));
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCommitStatus(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\SimpleCommitStatus);
        $result = [];
