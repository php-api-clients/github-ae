...
class Status implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\CombinedCommitStatus' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️CombinedCommitStatus($payload),
                'ApiClients\Client\Github\Schema\SimpleCommitStatus' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️SimpleCommitStatus($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️CombinedCommitStatus(array $payload): \ApiClients\Client\Github\Schema\CombinedCommitStatus
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\SimpleCommitStatus',
));
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\CombinedCommitStatus::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\CombinedCommitStatus(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\CombinedCommitStatus', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️SimpleCommitStatus(array $payload): \ApiClients\Client\Github\Schema\SimpleCommitStatus
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\SimpleCommitStatus', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\SimpleCommitStatus::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\SimpleCommitStatus(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\SimpleCommitStatus', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\SimpleCommitStatus' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️SimpleCommitStatus($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\CombinedCommitStatus);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\SimpleCommitStatus',
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️SimpleCommitStatus(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\SimpleCommitStatus);
        $result = [];
