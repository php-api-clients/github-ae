...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Releases\Tags;
...
class CbTagRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Release' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Release($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\ReleaseAsset' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ReleaseAsset($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Release(array $payload): \ApiClients\Client\GitHubAE\Schema\Release
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ReleaseAsset',
));
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Release::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Release(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Release', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ReleaseAsset(array $payload): \ApiClients\Client\GitHubAE\Schema\ReleaseAsset
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ReleaseAsset', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\ReleaseAsset::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\ReleaseAsset(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ReleaseAsset', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\ReleaseAsset' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ReleaseAsset($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Release);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ReleaseAsset',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ReleaseAsset(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\ReleaseAsset);
        $result = [];
        ...
        $uploader = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($uploader);
