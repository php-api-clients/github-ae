...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Notifications\Threads;
...
class ThreadId implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Thread' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread(array $payload): \ApiClients\Client\GitHubAE\Schema\Thread
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            $value = $payload['last_read_at'] ?? null;

            if ($value === null) {
                $properties['lastReadAt'] = null;
                goto after_lastReadAt;
            }

            $properties['lastReadAt'] = $value;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Thread', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Thread::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Thread(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Thread', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject(array $payload): \ApiClients\Client\GitHubAE\Schema\Thread\Subject
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            $value = $payload['latest_comment_url'] ?? null;

            if ($value === null) {
                $missingFields[] = 'latest_comment_url';
                goto after_latestCommentUrl;
            }

            $properties['latestCommentUrl'] = $value;

            after_latestCommentUrl:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Thread\Subject', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Thread\Subject::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\Thread\Subject(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Thread\Subject', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\Thread' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Thread);
        $result = [];
        ...
        $subject = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject($subject);
        ...
        after_unread:        $result['unread'] = $unread;
        ...
        after_lastReadAt:        $result['last_read_at'] = $lastReadAt;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Thread\Subject);
        $result = [];
        ...
        $latestCommentUrl = $object->latestCommentUrl;
        after_latestCommentUrl:        $result['latest_comment_url'] = $latestCommentUrl;
