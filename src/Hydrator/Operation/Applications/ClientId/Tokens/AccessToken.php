...
namespace ApiClients\Client\GitHubAE\Hydrator\Operation\Applications\ClientId\Tokens;
...
class AccessToken implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Authorization' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Authorization($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\ScopedInstallation' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation(array $payload): \ApiClients\Client\GitHubAE\Schema\ScopedInstallation
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ScopedInstallation', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\ScopedInstallation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\ScopedInstallation(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ScopedInstallation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Authorization(mixed $object): mixed
    {
        ...
        $installation = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation($installation);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\ScopedInstallation);
        $result = [];
