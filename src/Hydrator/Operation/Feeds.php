...
class Feeds implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\LinkWithType',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed(mixed $object): mixed
    {
        ...
        $links = $object->links;
        $links = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links($links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links(mixed $object): mixed
    {
        ...
        $securityAdvisories = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($securityAdvisories);
        ...
        $currentUser = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($currentUser);
        ...
        $currentUserPublic = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($currentUserPublic);
        ...
        $currentUserActor = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($currentUserActor);
        ...
        $currentUserOrganization = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($currentUserOrganization);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\LinkWithType',
        ...
        $repositoryDiscussions = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($repositoryDiscussions);
        ...
        $repositoryDiscussionsCategory = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($repositoryDiscussionsCategory);
