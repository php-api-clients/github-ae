...
class Feeds implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Feed' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed($payload),
                'ApiClients\Client\GitHubAE\Schema\Feed\Links' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links($payload),
                'ApiClients\Client\GitHubAE\Schema\LinkWithType' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed(array $payload): \ApiClients\Client\GitHubAE\Schema\Feed
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links($value);
                    } finally {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Feed', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Feed::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Feed(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Feed', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links(array $payload): \ApiClients\Client\GitHubAE\Schema\Feed\Links
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\LinkWithType',
));
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Feed\Links', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Feed\Links::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Feed\Links(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Feed\Links', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType(array $payload): \ApiClients\Client\GitHubAE\Schema\LinkWithType
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\LinkWithType', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\LinkWithType::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\LinkWithType(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\LinkWithType', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Feed);
        $result = [];
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links($_links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Feed\Links);
        $result = [];
        ...
        $timeline = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($timeline);
        ...
        $user = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($user);
        after_user:        $result['user'] = $user;

        
        $security_advisories = $object->security_advisories;
        $security_advisories = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($security_advisories);
        after_security_advisories:        $result['security_advisories'] = $security_advisories;

        
        $current_user = $object->current_user;
        $current_user = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($current_user);
        after_current_user:        $result['current_user'] = $current_user;

        
        $current_user_public = $object->current_user_public;
        $current_user_public = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($current_user_public);
        after_current_user_public:        $result['current_user_public'] = $current_user_public;

        
        $current_user_actor = $object->current_user_actor;
        $current_user_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($current_user_actor);
        ...
        $current_user_organization = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($current_user_organization);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\LinkWithType',
        ...
        $repository_discussions = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($repository_discussions);
        ...
        $repository_discussions_category = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType($repository_discussions_category);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\LinkWithType);
        $result = [];
