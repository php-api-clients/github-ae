...
class Hovercard implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\Hovercard' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard($payload),
                'ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard⚡️Contexts($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard(array $payload): \ApiClients\Client\GitHubAE\Schema\Hovercard
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($contextsCaster1 === null) {
                    $contextsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\Hovercard\\Contexts',
));
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Hovercard', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Hovercard::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Hovercard(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Hovercard', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard⚡️Contexts(array $payload): \ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                $value = $payload['octicon'] ?? null;
    
                if ($value === null) {
                    $properties['octicon'] = null;
                    goto after_octicon;
                }

                $properties['octicon'] = $value;
    
                after_octicon:

            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\ValidationError\\Errors',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\Hovercard' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard($object),
                'ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard⚡️Contexts($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Hovercard);
        $result = [];
        ...
        if ($contextsSerializer0 === null) {
            $contextsSerializer0 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\Hovercard\\Contexts',
));
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Hovercard⚡️Contexts(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\Hovercard\Contexts);
        $result = [];
        ...
        $octicon = $object->octicon;

        if ($octicon === null) {
            goto after_octicon;
        }
        after_octicon:        $result['octicon'] = $octicon;
