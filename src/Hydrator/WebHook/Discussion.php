...
class Discussion implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes(mixed $object): mixed
    {
        ...
        $new_discussion = $object->new_discussion;

        if ($new_discussion === null) {
            goto after_new_discussion;
        }
        $new_discussion = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion($new_discussion);
        ...
        $new_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository($new_repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionUnanswered(mixed $object): mixed
    {
        ...
        $old_answer = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionAnswered⚡️Answer($old_answer);
