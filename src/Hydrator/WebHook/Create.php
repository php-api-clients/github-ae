...
class Create implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCreate(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookCreate
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($value === null) {
                    $properties['pusher_type'] = null;
                    goto after_pusher_type;
                }

                $properties['pusher_type'] = $value;
                ...
                if ($value === null) {
                    $properties['ref_type'] = null;
                    goto after_ref_type;
                }

                $properties['ref_type'] = $value;
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookCreate::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookCreate(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCreate', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookCreate);
        $result = [];
        ...
        $pusher_type = $object->pusher_type;

        if ($pusher_type === null) {
            goto after_pusher_type;
        }
        after_pusher_type:        $result['pusher_type'] = $pusher_type;
        ...
        $ref_type = $object->ref_type;

        if ($ref_type === null) {
            goto after_ref_type;
        }
        after_ref_type:        $result['ref_type'] = $ref_type;
