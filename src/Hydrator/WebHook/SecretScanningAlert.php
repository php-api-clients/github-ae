...
class SecretScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated($payload),
                'ApiClients\Client\GitHubAE\Schema\SecretScanningAlert' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert($value);
                    } finally {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert(array $payload): \ApiClients\Client\GitHubAE\Schema\SecretScanningAlert
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'resolved_by';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\SecretScanningAlert::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\SecretScanningAlert(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecretScanningAlert', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertReopened(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'alert';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'push_protection_bypassed_by';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertRevoked(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\SecretScanningAlert' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated);
        $result = [];
        ...
        $alert = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert($alert);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlert(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\SecretScanningAlert);
        $result = [];
        ...
        $resolved_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($resolved_by);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved);
        $result = [];
        ...
        $alert = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert($alert);
        after_alert:        $result['alert'] = $alert;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved⚡️Alert(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved\Alert);
        $result = [];
        ...
        $push_protection_bypassed_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($push_protection_bypassed_by);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked);
        $result = [];
