...
class Milestone implements ObjectMapper
{
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneClosed⚡️Milestone⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneDeleted⚡️Milestone(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMilestoneDeleted\Milestone
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneDeleted⚡️Milestone⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneEdited⚡️Milestone(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMilestoneEdited\Milestone
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneEdited⚡️Milestone⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneOpened⚡️Milestone(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMilestoneOpened\Milestone
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneOpened⚡️Milestone⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneClosed⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneClosed⚡️Milestone⚡️Creator($creator);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneDeleted⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneDeleted⚡️Milestone⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneEdited⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneEdited⚡️Milestone⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneOpened⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMilestoneOpened⚡️Milestone⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
