...
class IssueComment implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;
