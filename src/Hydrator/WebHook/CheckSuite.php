...
class CheckSuite implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
                ...
                if ($value === null) {
                    $missingFields[] = 'runs_rerequestable';
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteCompleted(mixed $object): mixed
    {
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite($check_suite);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite(mixed $object): mixed
    {
        ...
        if ($latest_check_runs_count === null) {
            goto after_latest_check_runs_count;
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRequested(mixed $object): mixed
    {
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRerequested(mixed $object): mixed
    {
        ...
        $actions_meta = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta($actions_meta);
        after_actions_meta:        $result['actions_meta'] = $actions_meta;
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta(mixed $object): mixed
    {
        ...
        $rerun_info = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta⚡️RerunInfo($rerun_info);
