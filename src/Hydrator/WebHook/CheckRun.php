...
class CheckRun implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\PullRequestMinimal',
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction
    {
        ...
        try {
            ...
            if ($value === null) {
                $properties['requested_action'] = null;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompleted(mixed $object): mixed
    {
        ...
        $check_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite($check_run);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite(mixed $object): mixed
    {
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite($check_suite);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\PullRequestMinimal',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction(mixed $object): mixed
    {
        ...
        $requested_action = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction($requested_action);
