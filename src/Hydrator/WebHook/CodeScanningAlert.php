...
class CodeScanningAlert implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert(mixed $object): mixed
    {
        ...
        $dismissed_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️AnswerChosenBy($dismissed_by);
        ...
        $most_recent_instance = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance($most_recent_instance);
