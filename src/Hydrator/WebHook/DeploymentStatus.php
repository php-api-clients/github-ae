...
class DeploymentStatus implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated(mixed $object): mixed
    {
        ...
        $check_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($check_run);
        ...
        $deployment_status = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($deployment_status);
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($workflow_run);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(mixed $object): mixed
    {
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($performed_via_github_app);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus(mixed $object): mixed
    {
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository($head_repository);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        $repository = $object->repository;
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
