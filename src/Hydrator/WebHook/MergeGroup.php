...
class MergeGroup implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['merge_group'] = null;
                    goto after_merge_group;
                }

                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'merge_group';
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['head_ref'] = null;
                    goto after_head_ref;
                }

                $properties['head_ref'] = $value;
                ...
                if ($value === null) {
                    $properties['base_sha'] = null;
                    goto after_base_sha;
                }

                $properties['base_sha'] = $value;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested(mixed $object): mixed
    {
        ...
        $merge_group = $object->merge_group;

        if ($merge_group === null) {
            goto after_merge_group;
        }
        $merge_group = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup($merge_group);
        after_merge_group:        $result['merge_group'] = $merge_group;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup(mixed $object): mixed
    {
        ...
        $head_ref = $object->head_ref;

        if ($head_ref === null) {
            goto after_head_ref;
        }
        after_head_ref:        $result['head_ref'] = $head_ref;
        ...
        after_base_sha:        $result['base_sha'] = $base_sha;
