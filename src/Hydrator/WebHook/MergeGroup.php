...
class MergeGroup implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Author($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Committer($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            $value = $payload['merge_group'] ?? null;

            if ($value === null) {
                $missingFields[] = 'merge_group';
                goto after_mergeGroup;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'mergeGroup';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }

            $properties['mergeGroup'] = $value;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            $value = $payload['head_ref'] ?? null;

            if ($value === null) {
                $missingFields[] = 'head_ref';
                goto after_headRef;
            }

            $properties['headRef'] = $value;

            after_headRef:

            $value = $payload['base_sha'] ?? null;

            if ($value === null) {
                $missingFields[] = 'base_sha';
                goto after_baseSha;
            }

            $properties['baseSha'] = $value;
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Author(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Committer(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested($object),
            ...
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup($object),
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit($object),
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Author($object),
            'ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Committer($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested);
        $result = [];
        ...
        $mergeGroup = $object->mergeGroup;
        $mergeGroup = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup($mergeGroup);
        after_mergeGroup:        $result['merge_group'] = $mergeGroup;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup);
        $result = [];
        ...
        after_headRef:        $result['head_ref'] = $headRef;

        
        $baseSha = $object->baseSha;
        after_baseSha:        $result['base_sha'] = $baseSha;
        ...
        $headCommit = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit($headCommit);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Author(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMergeGroupChecksRequested⚡️MergeGroup⚡️HeadCommit⚡️Committer(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer);
        $result = [];
