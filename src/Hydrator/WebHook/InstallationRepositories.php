...
class InstallationRepositories implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationRepositoriesAdded(mixed $object): mixed
    {
        ...
        $repositories_added = $object->repositories_added;

        if ($repositories_added === null) {
            goto after_repositories_added;
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
        ...
        $repositories_added = $repositories_addedSerializer0->serialize($repositories_added, $this);
        after_repositories_added:        $result['repositories_added'] = $repositories_added;

        
        $repositories_removed = $object->repositories_removed;

        if ($repositories_removed === null) {
            goto after_repositories_removed;
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationRepositoriesAdded\\RepositoriesRemoved',
        ...
        $repositories_removed = $repositories_removedSerializer0->serialize($repositories_removed, $this);
        after_repositories_removed:        $result['repositories_removed'] = $repositories_removed;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Installation(mixed $object): mixed
    {
        ...
        $suspended_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($suspended_by);
