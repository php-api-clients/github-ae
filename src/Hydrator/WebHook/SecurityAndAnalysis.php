...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(mixed $object): mixed
    {
        ...
        $security_and_analysis = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis($security_and_analysis);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis(mixed $object): mixed
    {
        ...
        $advanced_security = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity($advanced_security);
        ...
        $secret_scanning = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity($secret_scanning);
        ...
        $secret_scanning_push_protection = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity($secret_scanning_push_protection);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository(mixed $object): mixed
    {
        ...
        $code_of_conduct = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConductSimple($code_of_conduct);
