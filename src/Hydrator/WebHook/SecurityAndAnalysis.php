...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis($payload),
                'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($payload),
                'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis(array $payload): \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️FullRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(array $payload): \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(array $payload): \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis($object),
            'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($object),
            'ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis);
        $result = [];

        $changes = $object->changes;
        $changes = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($changes);
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️FullRepository($repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes);
        $result = [];
        ...
        $from = $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($from);
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookSecurityAndAnalysis\Changes\From);
        $result = [];
