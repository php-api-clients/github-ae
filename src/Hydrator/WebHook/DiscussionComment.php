...
class DiscussionComment implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionCommentCreated⚡️Comment(mixed $object): mixed
    {
        ...
        $child_comment_count = $object->child_comment_count;

        if ($child_comment_count === null) {
            goto after_child_comment_count;
        }
        after_child_comment_count:        $result['child_comment_count'] = $child_comment_count;
        ...
        after_discussion_id:        $result['discussion_id'] = $discussion_id;
        ...
        after_parent_id:        $result['parent_id'] = $parent_id;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion(mixed $object): mixed
    {
        ...
        $answer_chosen_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️AnswerChosenBy($answer_chosen_by);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️Category(mixed $object): mixed
    {
        ...
        $is_answerable = $object->is_answerable;

        if ($is_answerable === null) {
            goto after_is_answerable;
        }
        after_is_answerable:        $result['is_answerable'] = $is_answerable;
