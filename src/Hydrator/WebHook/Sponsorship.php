...
class Sponsorship implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship
    {
        ...
        try {
            ...
            if ($value === null) {
                ...
                goto after_privacy_level;
            }

            $properties['privacy_level'] = $value;
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier
    {
        ...
        try {
            ...
            if ($value === null) {
                $properties['is_custom_ammount'] = null;
                goto after_is_custom_ammount;
            }

            $properties['is_custom_ammount'] = $value;

            after_is_custom_ammount:

            $value = $payload['is_custom_amount'] ?? null;

            if ($value === null) {
                $properties['is_custom_amount'] = null;
                goto after_is_custom_amount;
            }

            $properties['is_custom_amount'] = $value;

            after_is_custom_amount:

            $value = $payload['is_one_time'] ?? null;

            if ($value === null) {
                $missingFields[] = 'is_one_time';
                goto after_is_one_time;
            }

            $properties['is_one_time'] = $value;
            ...
            if ($value === null) {
                ...
                goto after_monthly_price_in_dollars;
            }

            $properties['monthly_price_in_dollars'] = $value;

            after_monthly_price_in_dollars:
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited\Changes
    {
        ...
        try {
            ...
            if ($value === null) {
                $properties['privacy_level'] = null;
                goto after_privacy_level;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'privacy_level';
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship(mixed $object): mixed
    {
        ...
        $maintainer = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($maintainer);
        ...
        after_privacy_level:        $result['privacy_level'] = $privacy_level;
        ...
        $sponsor = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️AnswerChosenBy($sponsor);
        ...
        $sponsorable = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️AnswerChosenBy($sponsorable);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier(mixed $object): mixed
    {
        ...
        $is_custom_ammount = $object->is_custom_ammount;

        if ($is_custom_ammount === null) {
            goto after_is_custom_ammount;
        }
        after_is_custom_ammount:        $result['is_custom_ammount'] = $is_custom_ammount;

        
        $is_custom_amount = $object->is_custom_amount;

        if ($is_custom_amount === null) {
            goto after_is_custom_amount;
        }
        after_is_custom_amount:        $result['is_custom_amount'] = $is_custom_amount;

        
        $is_one_time = $object->is_one_time;
        after_is_one_time:        $result['is_one_time'] = $is_one_time;
        ...
        $monthly_price_in_dollars = $object->monthly_price_in_dollars;
        after_monthly_price_in_dollars:        $result['monthly_price_in_dollars'] = $monthly_price_in_dollars;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $privacy_level = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes⚡️PrivacyLevel($privacy_level);
        after_privacy_level:        $result['privacy_level'] = $privacy_level;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipPendingTierChange⚡️Changes⚡️Tier(mixed $object): mixed
    {
        ...
        $from = $object->from;
        $from = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier($from);
        after_from:        $result['from'] = $from;
