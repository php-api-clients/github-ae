...
class DependabotAlert implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\References',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DependabotAlert(mixed $object): mixed
    {
        ...
        $security_advisory = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DependabotAlertSecurityAdvisory($security_advisory);
        ...
        $security_vulnerability = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DependabotAlertSecurityVulnerability($security_vulnerability);
        ...
        $dismissed_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($dismissed_by);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\DependabotAlertSecurityAdvisory\\References',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DependabotAlertSecurityVulnerability(mixed $object): mixed
    {
        ...
        $first_patched_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DependabotAlertSecurityVulnerability⚡️FirstPatchedVersion($first_patched_version);
