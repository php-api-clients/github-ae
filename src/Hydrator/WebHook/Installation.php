...
class Installation implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationDeleted(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookInstallationDeleted
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookInstallationDeleted::class, $missingFields, stack: $this->hydrationStack);
            }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookInstallationNewPermissionsAccepted
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookInstallationNewPermissionsAccepted::class, $missingFields, stack: $this->hydrationStack);
            }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationSuspend(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookInstallationSuspend
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookInstallationSuspend::class, $missingFields, stack: $this->hydrationStack);
            }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationUnsuspend(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookInstallationDeleted);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookInstallationNewPermissionsAccepted);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookInstallationSuspend);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookInstallationCreated\\Repositories',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend);
        $result = [];
