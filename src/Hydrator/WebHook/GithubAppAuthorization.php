...
class GithubAppAuthorization implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(array $payload): \ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookGithubAppAuthorizationRevoked);
        $result = [];
