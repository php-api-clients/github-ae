...
class PageBuild implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookPageBuild::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher);
        $result = [];
