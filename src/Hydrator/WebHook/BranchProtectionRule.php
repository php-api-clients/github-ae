...
class BranchProtectionRule implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $authorizedActorsOnly = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorizedActorsOnly);
        after_authorizedActorsOnly:        $result['authorized_actors_only'] = $authorizedActorsOnly;
        ...
        $authorizedDismissalActorsOnly = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorizedDismissalActorsOnly);
        after_authorizedDismissalActorsOnly:        $result['authorized_dismissal_actors_only'] = $authorizedDismissalActorsOnly;
        ...
        $requiredStatusChecks = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames($requiredStatusChecks);
        after_requiredStatusChecks:        $result['required_status_checks'] = $requiredStatusChecks;
        ...
        $requiredStatusChecksEnforcementLevel = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel($requiredStatusChecksEnforcementLevel);
        after_requiredStatusChecksEnforcementLevel:        $result['required_status_checks_enforcement_level'] = $requiredStatusChecksEnforcementLevel;
