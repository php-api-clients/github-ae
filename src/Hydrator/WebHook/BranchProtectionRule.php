...
class BranchProtectionRule implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleCreated⚡️Rule(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleCreated\Rule
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['admin_enforced'] = null;
                ...
                if ($value === null) {
                    $properties['allow_deletions_enforcement_level'] = null;
                    goto after_allow_deletions_enforcement_level;
                }

                $properties['allow_deletions_enforcement_level'] = $value;
    
                after_allow_deletions_enforcement_level:

                $value = $payload['allow_force_pushes_enforcement_level'] ?? null;
    
                if ($value === null) {
                    $properties['allow_force_pushes_enforcement_level'] = null;
                    goto after_allow_force_pushes_enforcement_level;
                }

                $properties['allow_force_pushes_enforcement_level'] = $value;
    
                after_allow_force_pushes_enforcement_level:

                $value = $payload['authorized_actor_names'] ?? null;
    
                if ($value === null) {
                    $properties['authorized_actor_names'] = null;
                ...
                if ($value === null) {
                    $properties['authorized_actors_only'] = null;
                ...
                if ($value === null) {
                    $properties['authorized_dismissal_actors_only'] = null;
                ...
                if ($value === null) {
                    $missingFields[] = 'create_protected';
                    goto after_create_protected;
                }

                $properties['create_protected'] = $value;
    
                after_create_protected:
                ...
                if ($value === null) {
                    $properties['dismiss_stale_reviews_on_push'] = null;
                    goto after_dismiss_stale_reviews_on_push;
                }

                $properties['dismiss_stale_reviews_on_push'] = $value;
    
                after_dismiss_stale_reviews_on_push:
                ...
                if ($value === null) {
                    $properties['ignore_approvals_from_contributors'] = null;
                    goto after_ignore_approvals_from_contributors;
                }

                $properties['ignore_approvals_from_contributors'] = $value;
    
                after_ignore_approvals_from_contributors:

                $value = $payload['linear_history_requirement_enforcement_level'] ?? null;
    
                if ($value === null) {
                    $properties['linear_history_requirement_enforcement_level'] = null;
                ...
                if ($value === null) {
                    $properties['merge_queue_enforcement_level'] = null;
                    goto after_merge_queue_enforcement_level;
                }

                $properties['merge_queue_enforcement_level'] = $value;
    
                after_merge_queue_enforcement_level:
                ...
                if ($value === null) {
                    $properties['pull_request_reviews_enforcement_level'] = null;
                    goto after_pull_request_reviews_enforcement_level;
                }

                $properties['pull_request_reviews_enforcement_level'] = $value;
    
                after_pull_request_reviews_enforcement_level:
                ...
                if ($value === null) {
                    $properties['require_code_owner_review'] = null;
                    goto after_require_code_owner_review;
                }

                $properties['require_code_owner_review'] = $value;
    
                after_require_code_owner_review:
                ...
                if ($value === null) {
                    $properties['required_conversation_resolution_level'] = null;
                    goto after_required_conversation_resolution_level;
                }

                $properties['required_conversation_resolution_level'] = $value;
    
                after_required_conversation_resolution_level:

                $value = $payload['required_deployments_enforcement_level'] ?? null;
    
                if ($value === null) {
                    $properties['required_deployments_enforcement_level'] = null;
                    goto after_required_deployments_enforcement_level;
                }

                $properties['required_deployments_enforcement_level'] = $value;
    
                after_required_deployments_enforcement_level:
                ...
                if ($value === null) {
                    $properties['required_status_checks_enforcement_level'] = null;
                ...
                if ($value === null) {
                    $properties['signature_requirement_enforcement_level'] = null;
                    goto after_signature_requirement_enforcement_level;
                }

                $properties['signature_requirement_enforcement_level'] = $value;
    
                after_signature_requirement_enforcement_level:

                $value = $payload['strict_required_status_checks_policy'] ?? null;
    
                if ($value === null) {
                    $properties['strict_required_status_checks_policy'] = null;
                    goto after_strict_required_status_checks_policy;
                }

                $properties['strict_required_status_checks_policy'] = $value;
    
                after_strict_required_status_checks_policy:
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleCreated⚡️Rule(mixed $object): mixed
    {
        ...
        $admin_enforced = $object->admin_enforced;

        if ($admin_enforced === null) {
            goto after_admin_enforced;
        }
        after_admin_enforced:        $result['admin_enforced'] = $admin_enforced;

        
        $allow_deletions_enforcement_level = $object->allow_deletions_enforcement_level;

        if ($allow_deletions_enforcement_level === null) {
            goto after_allow_deletions_enforcement_level;
        }
        after_allow_deletions_enforcement_level:        $result['allow_deletions_enforcement_level'] = $allow_deletions_enforcement_level;

        
        $allow_force_pushes_enforcement_level = $object->allow_force_pushes_enforcement_level;

        if ($allow_force_pushes_enforcement_level === null) {
            goto after_allow_force_pushes_enforcement_level;
        }
        after_allow_force_pushes_enforcement_level:        $result['allow_force_pushes_enforcement_level'] = $allow_force_pushes_enforcement_level;

        
        $authorized_actor_names = $object->authorized_actor_names;

        if ($authorized_actor_names === null) {
            goto after_authorized_actor_names;
        }
        static $authorized_actor_namesSerializer0;

        if ($authorized_actor_namesSerializer0 === null) {
            $authorized_actor_namesSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $authorized_actor_names = $authorized_actor_namesSerializer0->serialize($authorized_actor_names, $this);
        after_authorized_actor_names:        $result['authorized_actor_names'] = $authorized_actor_names;

        
        $authorized_actors_only = $object->authorized_actors_only;

        if ($authorized_actors_only === null) {
            goto after_authorized_actors_only;
        }
        after_authorized_actors_only:        $result['authorized_actors_only'] = $authorized_actors_only;

        
        $authorized_dismissal_actors_only = $object->authorized_dismissal_actors_only;

        if ($authorized_dismissal_actors_only === null) {
            goto after_authorized_dismissal_actors_only;
        }
        after_authorized_dismissal_actors_only:        $result['authorized_dismissal_actors_only'] = $authorized_dismissal_actors_only;

        
        $create_protected = $object->create_protected;
        after_create_protected:        $result['create_protected'] = $create_protected;
        ...
        $dismiss_stale_reviews_on_push = $object->dismiss_stale_reviews_on_push;

        if ($dismiss_stale_reviews_on_push === null) {
            goto after_dismiss_stale_reviews_on_push;
        }
        after_dismiss_stale_reviews_on_push:        $result['dismiss_stale_reviews_on_push'] = $dismiss_stale_reviews_on_push;
        ...
        $ignore_approvals_from_contributors = $object->ignore_approvals_from_contributors;

        if ($ignore_approvals_from_contributors === null) {
            goto after_ignore_approvals_from_contributors;
        }
        after_ignore_approvals_from_contributors:        $result['ignore_approvals_from_contributors'] = $ignore_approvals_from_contributors;

        
        $linear_history_requirement_enforcement_level = $object->linear_history_requirement_enforcement_level;

        if ($linear_history_requirement_enforcement_level === null) {
            goto after_linear_history_requirement_enforcement_level;
        }
        after_linear_history_requirement_enforcement_level:        $result['linear_history_requirement_enforcement_level'] = $linear_history_requirement_enforcement_level;

        
        $merge_queue_enforcement_level = $object->merge_queue_enforcement_level;

        if ($merge_queue_enforcement_level === null) {
            goto after_merge_queue_enforcement_level;
        }
        after_merge_queue_enforcement_level:        $result['merge_queue_enforcement_level'] = $merge_queue_enforcement_level;
        ...
        $pull_request_reviews_enforcement_level = $object->pull_request_reviews_enforcement_level;

        if ($pull_request_reviews_enforcement_level === null) {
            goto after_pull_request_reviews_enforcement_level;
        }
        after_pull_request_reviews_enforcement_level:        $result['pull_request_reviews_enforcement_level'] = $pull_request_reviews_enforcement_level;
        ...
        $require_code_owner_review = $object->require_code_owner_review;

        if ($require_code_owner_review === null) {
            goto after_require_code_owner_review;
        }
        after_require_code_owner_review:        $result['require_code_owner_review'] = $require_code_owner_review;
        ...
        $required_conversation_resolution_level = $object->required_conversation_resolution_level;

        if ($required_conversation_resolution_level === null) {
            goto after_required_conversation_resolution_level;
        }
        after_required_conversation_resolution_level:        $result['required_conversation_resolution_level'] = $required_conversation_resolution_level;

        
        $required_deployments_enforcement_level = $object->required_deployments_enforcement_level;

        if ($required_deployments_enforcement_level === null) {
            goto after_required_deployments_enforcement_level;
        }
        after_required_deployments_enforcement_level:        $result['required_deployments_enforcement_level'] = $required_deployments_enforcement_level;
        ...
        static $required_status_checksSerializer0;

        if ($required_status_checksSerializer0 === null) {
            $required_status_checksSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $required_status_checks = $required_status_checksSerializer0->serialize($required_status_checks, $this);
        after_required_status_checks:        $result['required_status_checks'] = $required_status_checks;

        
        $required_status_checks_enforcement_level = $object->required_status_checks_enforcement_level;

        if ($required_status_checks_enforcement_level === null) {
            goto after_required_status_checks_enforcement_level;
        }
        after_required_status_checks_enforcement_level:        $result['required_status_checks_enforcement_level'] = $required_status_checks_enforcement_level;

        
        $signature_requirement_enforcement_level = $object->signature_requirement_enforcement_level;

        if ($signature_requirement_enforcement_level === null) {
            goto after_signature_requirement_enforcement_level;
        }
        after_signature_requirement_enforcement_level:        $result['signature_requirement_enforcement_level'] = $signature_requirement_enforcement_level;

        
        $strict_required_status_checks_policy = $object->strict_required_status_checks_policy;

        if ($strict_required_status_checks_policy === null) {
            goto after_strict_required_status_checks_policy;
        }
        after_strict_required_status_checks_policy:        $result['strict_required_status_checks_policy'] = $strict_required_status_checks_policy;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $admin_enforced = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($admin_enforced);
        after_admin_enforced:        $result['admin_enforced'] = $admin_enforced;
        ...
        $authorized_actor_names = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames($authorized_actor_names);
        after_authorized_actor_names:        $result['authorized_actor_names'] = $authorized_actor_names;
        ...
        $authorized_actors_only = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorized_actors_only);
        after_authorized_actors_only:        $result['authorized_actors_only'] = $authorized_actors_only;
        ...
        $authorized_dismissal_actors_only = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorized_dismissal_actors_only);
        after_authorized_dismissal_actors_only:        $result['authorized_dismissal_actors_only'] = $authorized_dismissal_actors_only;
        ...
        $linear_history_requirement_enforcement_level = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel($linear_history_requirement_enforcement_level);
        after_linear_history_requirement_enforcement_level:        $result['linear_history_requirement_enforcement_level'] = $linear_history_requirement_enforcement_level;
        ...
        $required_status_checks = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames($required_status_checks);
        after_required_status_checks:        $result['required_status_checks'] = $required_status_checks;
        ...
        $required_status_checks_enforcement_level = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel($required_status_checks_enforcement_level);
        after_required_status_checks_enforcement_level:        $result['required_status_checks_enforcement_level'] = $required_status_checks_enforcement_level;
