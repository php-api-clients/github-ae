...
class SecretScanningAlertLocation implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation(array $payload): \ApiClients\Client\GitHubAE\Schema\SecretScanningLocation
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\SecretScanningLocation::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\SecretScanningLocation(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecretScanningLocation', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment(array $payload): \ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\SecretScanningLocation);
        $result = [];
        ...
        $details = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment($details);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationIssueComment(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\SecretScanningLocationIssueComment);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded);
        $result = [];
