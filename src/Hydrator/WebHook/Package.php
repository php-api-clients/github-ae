...
class Package implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['container_metadata'] = null;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\AuditLogEvent\\Data',
));
                }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\AuditLogEvent\\Config',
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookPackageUpdated\\Package\\PackageVersion\\PackageFiles',
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Discussion⚡️AnswerChosenBy($author);
        ...
        $container_metadata = $object->container_metadata;

        if ($container_metadata === null) {
            goto after_container_metadata;
        }
        $container_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata($container_metadata);
        after_container_metadata:        $result['container_metadata'] = $container_metadata;
        ...
        $docker_metadata = $object->docker_metadata;
        static $docker_metadataSerializer0;

        if ($docker_metadataSerializer0 === null) {
            $docker_metadataSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $docker_metadata = $docker_metadataSerializer0->serialize($docker_metadata, $this);
        after_docker_metadata:        $result['docker_metadata'] = $docker_metadata;
        ...
        $installation_command = $object->installation_command;

        if ($installation_command === null) {
            goto after_installation_command;
        }
        after_installation_command:        $result['installation_command'] = $installation_command;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\AuditLogEvent\\Data',
        ...
        $npm_metadata = $object->npm_metadata;

        if ($npm_metadata === null) {
            goto after_npm_metadata;
        }
        $npm_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata($npm_metadata);
        after_npm_metadata:        $result['npm_metadata'] = $npm_metadata;

        
        $nuget_metadata = $object->nuget_metadata;

        if ($nuget_metadata === null) {
            goto after_nuget_metadata;
        }
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookPackagePublished\\Package\\PackageVersion\\NugetMetadata',
        ...
        $nuget_metadata = $nuget_metadataSerializer0->serialize($nuget_metadata, $this);
        after_nuget_metadata:        $result['nuget_metadata'] = $nuget_metadata;

        
        $package_files = $object->package_files;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookPackagePublished\\Package\\PackageVersion\\PackageFiles',
        ...
        $package_files = $package_filesSerializer0->serialize($package_files, $this);
        after_package_files:        $result['package_files'] = $package_files;
        ...
        $rubygems_metadata = $object->rubygems_metadata;
        static $rubygems_metadataSerializer0;

        if ($rubygems_metadataSerializer0 === null) {
            $rubygems_metadataSerializer0 = new \EventSauce\ObjectHydrator\PropertySerializers\SerializeArrayItems(...array (
));
        }
        
        $rubygems_metadata = $rubygems_metadataSerializer0->serialize($rubygems_metadata, $this);
        after_rubygems_metadata:        $result['rubygems_metadata'] = $rubygems_metadata;

        
        $source_url = $object->source_url;
        after_source_url:        $result['source_url'] = $source_url;
        ...
        $target_oid = $object->target_oid;
        after_target_oid:        $result['target_oid'] = $target_oid;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata(mixed $object): mixed
    {
        ...
        $npm_user = $object->npm_user;

        if ($npm_user === null) {
            goto after_npm_user;
        }
        after_npm_user:        $result['npm_user'] = $npm_user;
        ...
        $dev_dependencies = $object->dev_dependencies;
        ...
        $peer_dependencies = $object->peer_dependencies;
        ...
        $optional_dependencies = $object->optional_dependencies;
        ...
        $git_head = $object->git_head;

        if ($git_head === null) {
            goto after_git_head;
        }
        after_git_head:        $result['git_head'] = $git_head;
        ...
        $node_version = $object->node_version;

        if ($node_version === null) {
            goto after_node_version;
        }
        after_node_version:        $result['node_version'] = $node_version;
        ...
        after_npm_version:        $result['npm_version'] = $npm_version;

        
        $has_shrinkwrap = $object->has_shrinkwrap;

        if ($has_shrinkwrap === null) {
            goto after_has_shrinkwrap;
        }
        after_has_shrinkwrap:        $result['has_shrinkwrap'] = $has_shrinkwrap;
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\AuditLogEvent\\Config',
        ...
        after_release_id:        $result['release_id'] = $release_id;
        ...
        $published_via_actions = $object->published_via_actions;

        if ($published_via_actions === null) {
            goto after_published_via_actions;
        }
        after_published_via_actions:        $result['published_via_actions'] = $published_via_actions;

        
        $deleted_by_id = $object->deleted_by_id;

        if ($deleted_by_id === null) {
            goto after_deleted_by_id;
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata(mixed $object): mixed
    {
        ...
        $value = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($value);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️Registry(mixed $object): mixed
    {
        ...
        $about_url = $object->about_url;

        if ($about_url === null) {
            goto after_about_url;
        }
        after_about_url:        $result['about_url'] = $about_url;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackageUpdated⚡️Package(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPackageUpdated⚡️Package⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
