...
class RegistryPackage implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookRegistryPackagePublished
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'registry_package';
                ...
                $properties['registry_package'] = $value;
    
                after_registry_package:
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookRegistryPackageUpdated\\RegistryPackage\\PackageVersion\\PackageFiles',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished(mixed $object): mixed
    {
        ...
        $registry_package = $object->registry_package;

        if ($registry_package === null) {
            goto after_registry_package;
        }
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage($registry_package);
        after_registry_package:        $result['registry_package'] = $registry_package;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion($package_version);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️Owner($author);
        ...
        $container_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata($container_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\AuditLogEvent\\Data',
        ...
        $npm_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata($npm_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubAE\\Schema\\WebhookRegistryPackagePublished\\RegistryPackage\\PackageVersion\\PackageFiles',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackageUpdated(mixed $object): mixed
    {
        ...
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage($registry_package);
        after_registry_package:        $result['registry_package'] = $registry_package;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
