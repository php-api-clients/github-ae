...
class Member implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMemberEdited⚡️Changes(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookMemberEdited\Changes
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'old_permission';
                ...
                $properties['old_permission'] = $value;
    
                after_old_permission:
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMemberEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $old_permission = $object->old_permission;

        if ($old_permission === null) {
            goto after_old_permission;
        }
        $old_permission = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMemberEdited⚡️Changes⚡️OldPermission($old_permission);
        after_old_permission:        $result['old_permission'] = $old_permission;
