...
class ProjectCard implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookProjectCardConverted\ProjectCard
        {
            ...
            try {
                ...
                if ($value === null) {
                    $properties['after_id'] = null;
                    goto after_after_id;
                }

                $properties['after_id'] = $value;
                ...
                if ($value === null) {
                    $properties['column_id'] = null;
                    goto after_column_id;
                }

                $properties['column_id'] = $value;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardConverted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard($project_card);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardConverted⚡️Changes(mixed $object): mixed
    {
        ...
        $note = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($note);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard(mixed $object): mixed
    {
        ...
        $after_id = $object->after_id;

        if ($after_id === null) {
            goto after_after_id;
        }
        after_after_id:        $result['after_id'] = $after_id;
        ...
        after_column_id:        $result['column_id'] = $column_id;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardDeleted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardDeleted⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardMoved(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardMoved⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes(mixed $object): mixed
    {
        ...
        $column_id = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes⚡️ColumnId($column_id);
        after_column_id:        $result['column_id'] = $column_id;
