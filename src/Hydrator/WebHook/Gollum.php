...
class Gollum implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\Github\Schema\WebhookGollum' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum($payload),
                ...
                'ApiClients\Client\Github\Schema\WebhookGollum\Pages' => $this->hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum⚡️Pages($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum(array $payload): \ApiClients\Client\Github\Schema\WebhookGollum
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\WebhookGollum\\Pages',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGollum', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookGollum::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookGollum(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGollum', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum⚡️Pages(array $payload): \ApiClients\Client\Github\Schema\WebhookGollum\Pages
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGollum\Pages', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\Github\Schema\WebhookGollum\Pages::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\Github\Schema\WebhookGollum\Pages(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\Github\Schema\WebhookGollum\Pages', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\Github\Schema\WebhookGollum' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum($object),
            ...
            'ApiClients\Client\Github\Schema\WebhookGollum\Pages' => $this->serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum⚡️Pages($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookGollum);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\Github\\Schema\\WebhookGollum\\Pages',
    ...
    private function serializeObjectApiClients⚡️Client⚡️Github⚡️Schema⚡️WebhookGollum⚡️Pages(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\Github\Schema\WebhookGollum\Pages);
        $result = [];
