...
final readonly class RepositoryWebhooks
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The repository on GitHub where the event occurred. Webhook payloads contain the `repository` property
when the event occurs from activity in a repository.';
    ...
    public string $fullName, public Schema\LicenseSimple|null $license, public Schema\SimpleUser|null $organization, public int $forks, public Schema\RepositoryWebhooks\Permissions|null $permissions, public Schema\SimpleUser $owner, public bool $private, #[MapFrom('html_url')]
    ...
    public Schema\RepositoryWebhooks\TemplateRepository|null $templateRepository, #[MapFrom('temp_clone_token')]
    ...
    public int|null $networkCount, #[MapFrom('open_issues')]
