...
final readonly class LabeledIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Labeled Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Labeled Issue Event';
    ...
    public Schema\Integration|null $performedViaGithubApp, public Schema\LabeledIssueEvent\Label $label,)
    {
    }
}
