...
final readonly class CheckSuite
{
    ...
    "description": "The [check_suite](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/checks\\/suites#get-a-check-suite)."
}';
    public const SCHEMA_TITLE        = '';
    public const SCHEMA_DESCRIPTION  = 'The [check_suite](https://docs.github.com/github-ae@latest/rest/checks/suites#get-a-check-suite).';
     ...
     */
    public function __construct(public string|null $after, public Schema\WebhookCheckSuiteCompleted\CheckSuite\App $app, public string|null $before, #[MapFrom('check_runs_url')]
    ...
    public Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit $headCommit, #[MapFrom('head_sha')]
