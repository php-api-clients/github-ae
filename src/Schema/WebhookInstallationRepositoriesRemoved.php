...
final readonly class WebhookInstallationRepositoriesRemoved
{
    ...
    public string $repositorySelection, public Schema\WebhookInstallationRepositoriesRemoved\Requester|null $requester, public Schema\SimpleUser $sender,)
    {
    }
}
