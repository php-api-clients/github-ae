...
final readonly class RenamedIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Renamed Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Renamed Issue Event';
    ...
    public Schema\Integration|null $performedViaGithubApp, public Schema\RenamedIssueEvent\Rename $rename,)
    {
    }
}
