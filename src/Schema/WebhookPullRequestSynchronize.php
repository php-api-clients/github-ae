...
final readonly class WebhookPullRequestSynchronize
{
     ...
     */
    public function __construct(public string $action, public string $after, public string $before, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestSynchronize\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
