...
final readonly class WebhookCodeScanningAlertAppearedInBranch
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCodeScanningAlertAppearedInBranch\Alert $alert, #[MapFrom('commit_oid')]
