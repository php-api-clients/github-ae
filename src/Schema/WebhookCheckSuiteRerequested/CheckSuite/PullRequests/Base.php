...
namespace ApiClients\Client\GitHubAE\Schema\WebhookCheckSuiteRerequested\CheckSuite\PullRequests;
...
final readonly class Base
{
    ...
    public function __construct(public string $ref, public Schema\WebhookCheckSuiteRerequested\CheckSuite\PullRequests\Base\Repo $repo, public string $sha)
    {
    }
}
