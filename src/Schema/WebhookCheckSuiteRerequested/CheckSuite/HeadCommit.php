...
final readonly class HeadCommit
{
     ...
     */
    public function __construct(public Schema\WebhookCheckSuiteRerequested\CheckSuite\HeadCommit\Author $author, public Schema\WebhookCheckSuiteRerequested\CheckSuite\HeadCommit\Committer $committer, public string $id, public string $message, public string $timestamp, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId)
    {
    }
}
