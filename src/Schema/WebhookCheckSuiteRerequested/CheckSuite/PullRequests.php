...
namespace ApiClients\Client\GitHubAE\Schema\WebhookCheckSuiteRerequested\CheckSuite;
...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookCheckSuiteRerequested\CheckSuite\PullRequests\Base $base, public Schema\WebhookCheckSuiteRerequested\CheckSuite\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
