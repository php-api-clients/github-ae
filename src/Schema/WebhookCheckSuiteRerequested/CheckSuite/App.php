...
final readonly class App
{
    ...
    public string $nodeId, public Schema\WebhookCheckSuiteRerequested\CheckSuite\App\Owner|null $owner, public Schema\WebhookCheckSuiteRerequested\CheckSuite\App\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
