...
final readonly class WebhookProjectCreated
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookProjectCreated\Project $project, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
