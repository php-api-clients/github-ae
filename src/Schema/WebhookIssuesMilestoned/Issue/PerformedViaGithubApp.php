...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesMilestoned\Issue;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssuesMilestoned\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssuesMilestoned\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
