...
final readonly class WebhookSponsorshipEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookSponsorshipEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender, public Schema\WebhookSponsorshipEdited\Sponsorship $sponsorship)
    {
    }
}
