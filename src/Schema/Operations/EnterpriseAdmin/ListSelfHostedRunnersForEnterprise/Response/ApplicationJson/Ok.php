...
namespace ApiClients\Client\GitHubAE\Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson;
...
final readonly class Ok
{
    ...
    public function __construct(#[MapFrom('total_count')] public null|int|float $totalCount, public ?array $runners)
    {
    }
}
