...
namespace ApiClients\Client\GitHubAE\Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson;
...
final readonly class Ok
{
    ...
    "total_count": 11,
    "repository_selection": "generated",
    "repositories": [
        {
            "id": 42,
    ...
    public int $totalCount, #[MapFrom('repository_selection')]
    public string|null $repositorySelection, public array $repositories,)
    {
    }
}
