...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
