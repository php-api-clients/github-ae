...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookDeploymentCreated\WorkflowRun\PullRequests\Base $base, public Schema\WebhookDeploymentCreated\WorkflowRun\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
