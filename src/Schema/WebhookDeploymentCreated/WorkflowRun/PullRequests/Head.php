...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun\PullRequests;
...
final readonly class Head
{
    ...
    public function __construct(public string $ref, public Schema\WebhookDeploymentCreated\WorkflowRun\PullRequests\Head\Repo $repo, public string $sha)
    {
    }
}
