...
final readonly class WebhookProjectColumnEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectColumnEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, #[MapFrom('project_column')]
    public Schema\WebhookProjectColumnEdited\ProjectColumn $projectColumn, public Schema\Repository|null $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
