...
final readonly class GpgKey
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubAE\Schema\GpgKey\Emails> $emails
     * @param array<\ApiClients\Client\GitHubAE\Schema\GpgKey\Subkeys> $subkeys
     */
    public function __construct(public int $id, public ?string $name, #[\EventSauce\ObjectHydrator\MapFrom('primary_key_id')] public ?int $primaryKeyId, #[\EventSauce\ObjectHydrator\MapFrom('key_id')] public string $keyId, #[\EventSauce\ObjectHydrator\MapFrom('public_key')] public string $publicKey, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\GpgKey\Emails::class)] public array $emails, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\GpgKey\Subkeys::class)] public array $subkeys, #[\EventSauce\ObjectHydrator\MapFrom('can_sign')] public bool $canSign, #[\EventSauce\ObjectHydrator\MapFrom('can_encrypt_comms')] public bool $canEncryptComms, #[\EventSauce\ObjectHydrator\MapFrom('can_encrypt_storage')] public bool $canEncryptStorage, #[\EventSauce\ObjectHydrator\MapFrom('can_certify')] public bool $canCertify, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('expires_at')] public ?string $expiresAt, public bool $revoked, #[\EventSauce\ObjectHydrator\MapFrom('raw_key')] public ?string $rawKey)
    {
    }
}
