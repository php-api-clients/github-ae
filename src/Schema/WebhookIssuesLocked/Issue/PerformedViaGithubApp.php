...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesLocked\Issue;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssuesLocked\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssuesLocked\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
