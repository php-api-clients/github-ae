...
final readonly class GitRef
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"ref":"generated_ref_null","node_id":"generated_node_id_null","url":"https:\\/\\/example.com\\/","object":{"type":"generated_type_null","sha":"7638417db6d59f3c431d3e1f261cc637155684cd","url":"https:\\/\\/example.com\\/"}}';
    public function __construct(public string $ref, public string $node_id, public string $url, public Schema\GitRef\Object_ $object)
    {
    }
}
