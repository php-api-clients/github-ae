...
final readonly class SimpleUserWebhooks
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The GitHub user that triggered the event. This property is included in every webhook payload.';
