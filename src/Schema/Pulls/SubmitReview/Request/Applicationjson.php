...
namespace ApiClients\Client\GitHubAE\Schema\Pulls\SubmitReview\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"body":"generated_body_null","event":"generated_event_null"}';
    /**
