...
namespace ApiClients\Client\GitHubAE\Schema\Pulls\CreateReview\Request;
...
final readonly class Applicationjson
{
     ...
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\Pulls\CreateReview\Request\Applicationjson\Comments> $comments
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('commit_id')] public ?string $commitId, public ?string $body, public ?string $event, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Pulls\CreateReview\Request\Applicationjson\Comments::class)] public ?array $comments)
    {
    }
}
