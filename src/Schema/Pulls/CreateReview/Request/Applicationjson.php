...
use ApiClients\Client\GitHubAE\Schema\Pulls\CreateReview\Request\Applicationjson\Comments;
...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(#[MapFrom('commit_id')] public ?string $commitId, public ?string $body, public ?string $event, #[CastListToType(Schema\Pulls\CreateReview\Request\Applicationjson\Comments::class)] public ?array $comments)
    {
    }
}
