...
namespace ApiClients\Client\GitHubAE\Schema\Pulls\Create\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title_null","head":"generated_head_null","base":"generated_base_null","body":"generated_body_null","maintainerCanModify":false,"draft":false,"issue":1}';
    /**
     ...
     * maintainerCanModify: Indicates whether [maintainers can modify](https://docs.github.com/github-ae@latest/articles/allowing-changes-to-a-pull-request-branch-created-from-a-fork/) the pull request.
     * draft: Indicates whether the pull request is a draft. See "[Draft Pull Requests](https://docs.github.com/github-ae@latest/articles/about-pull-requests#draft-pull-requests)" in the GitHub Help documentation to learn more.
     ...
     */
    public function __construct(public ?string $title, public string $head, public string $base, public ?string $body, #[\EventSauce\ObjectHydrator\MapFrom('maintainer_can_modify')] public ?bool $maintainerCanModify, public ?bool $draft, public ?int $issue)
    {
    }
}
