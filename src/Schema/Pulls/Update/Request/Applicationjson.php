...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title_null","body":"generated_body_null","state":"generated_state_null","base":"generated_base_null","maintainer_can_modify":false}';
    /**
