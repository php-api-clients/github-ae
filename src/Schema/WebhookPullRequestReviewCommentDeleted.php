...
final readonly class WebhookPullRequestReviewCommentDeleted
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestReviewCommentDeleted\Comment $comment, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
