...
final readonly class WebhookPullRequestReviewCommentDeleted
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestReviewCommentDeleted\Comment $comment, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
