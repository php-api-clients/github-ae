...
final readonly class WebhookMemberAdded
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookMemberAdded\Changes|null $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookMemberAdded\Member|null $member, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
