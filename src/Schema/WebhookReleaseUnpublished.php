...
final readonly class WebhookReleaseUnpublished
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookReleaseUnpublished\Release $release, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks|null $sender)
    {
    }
}
