...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base;
...
final readonly class Repo
{
    ...
    public bool $hasIssues, #[MapFrom('has_discussions')]
    public bool $hasDiscussions, #[MapFrom('has_pages')]
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\Repo\Owner|null $owner, public Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
