...
namespace ApiClients\Client\GitHubAE\Schema\WebhookProjectClosed;
...
final readonly class Project
{
     ...
     */
    public function __construct(public ?string $body, #[MapFrom('columns_url')] public string $columnsUrl, #[MapFrom('created_at')] public string $createdAt, public ?Schema\Discussion\AnswerChosenBy $creator, #[MapFrom('html_url')] public string $htmlUrl, public int $id, public string $name, #[MapFrom('node_id')] public string $nodeId, public int $number, #[MapFrom('owner_url')] public string $ownerUrl, public string $state, #[MapFrom('updated_at')] public string $updatedAt, public string $url)
    {
    }
}
