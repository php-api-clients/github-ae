...
final readonly class GistCommit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"https:\\/\\/api.github.com\\/gists\\/aa5a315d61ae9438b18d\\/57a7f021a713b1c5a6a199b54cc514735d2d462f","version":"57a7f021a713b1c5a6a199b54cc514735d2d462f","user":null,"changeStatus":{"total":13,"additions":13,"deletions":13},"committedAt":"2010-04-14T02:15:15Z"}';
    public function __construct(public string $url, public string $version, public mixed $user, #[\EventSauce\ObjectHydrator\MapFrom('change_status')] public Schema\GistHistory\ChangeStatus $changeStatus, #[\EventSauce\ObjectHydrator\MapFrom('committed_at')] public string $committedAt)
    {
    }
}
