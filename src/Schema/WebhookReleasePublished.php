...
final readonly class WebhookReleasePublished
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookReleasePublished\Release $release, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks|null $sender)
    {
    }
}
