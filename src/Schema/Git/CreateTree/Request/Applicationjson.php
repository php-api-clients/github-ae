...
final readonly class Applicationjson
{
     ...
     * @param array<\ApiClients\Client\GitHubAE\Schema\Git\CreateTree\Request\Applicationjson\Tree> $tree
    ...
    If not provided, GitHub will create a new Git tree object from only the entries defined in the `tree` parameter. If you create a new commit pointing to such a tree, then all files which were a part of the parent commit's tree and were not defined in the `tree` parameter will be listed as deleted by the new commit.
    */
    public function __construct(#[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Git\CreateTree\Request\Applicationjson\Tree::class)] public array $tree, #[\EventSauce\ObjectHydrator\MapFrom('base_tree')] public ?string $baseTree)
    {
    }
}
