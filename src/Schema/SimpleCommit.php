...
final readonly class SimpleCommit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":"generated_id_null","treeId":"generated_tree_id_null","message":"generated_message_null","timestamp":"1970-01-01T00:00:00+00:00","author":{"name":"generated_name_null","email":"generated_email_null"},"committer":{"name":"generated_name_null","email":"generated_email_null"}}';
    public function __construct(public string $id, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId, public string $message, public string $timestamp, public ?Schema\SimpleCommit\Author $author, public ?Schema\SimpleCommit\Author $committer)
    {
    }
}
