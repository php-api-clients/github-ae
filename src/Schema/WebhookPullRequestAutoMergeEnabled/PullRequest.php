...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestAutoMergeEnabled;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\User|null $user,)
    {
    }
}
