...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Html $html, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links\Statuses $statuses)
    {
    }
}
