...
namespace ApiClients\Client\GitHubAE\Schema\WebhookWorkflowRunInProgress\WorkflowRun;
...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests\Base $base, public Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
