...
namespace ApiClients\Client\GitHubAE\Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests;
...
final readonly class Head
{
    ...
    public function __construct(public string $ref, public Schema\WebhookWorkflowRunInProgress\WorkflowRun\PullRequests\Head\Repo $repo, public string $sha)
    {
    }
}
