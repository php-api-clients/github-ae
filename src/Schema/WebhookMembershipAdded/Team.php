...
namespace ApiClients\Client\GitHubAE\Schema\WebhookMembershipAdded;
...
final readonly class Team
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"deleted":false,"description":"generated_description_null","htmlUrl":"https:\\/\\/example.com\\/","id":13,"membersUrl":"generated_members_url_uri-template","name":"generated_name_null","nodeId":"generated_node_id_null","parent":{"description":"generated_description_null","htmlUrl":"https:\\/\\/example.com\\/","id":13,"membersUrl":"generated_members_url_uri-template","name":"generated_name_null","nodeId":"generated_node_id_null","permission":"generated_permission_null","privacy":"open","repositoriesUrl":"https:\\/\\/example.com\\/","slug":"generated_slug_null","url":"https:\\/\\/example.com\\/"},"permission":"generated_permission_null","privacy":"open","repositoriesUrl":"https:\\/\\/example.com\\/","slug":"generated_slug_null","url":"https:\\/\\/example.com\\/"}';
    /**
     ...
     */
    public function __construct(public ?bool $deleted, public ?string $description, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, public int $id, #[\EventSauce\ObjectHydrator\MapFrom('members_url')] public ?string $membersUrl, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public ?string $nodeId, public ?Schema\WebhookMembershipAdded\Team\Parent_ $parent, public ?string $permission, public ?string $privacy, #[\EventSauce\ObjectHydrator\MapFrom('repositories_url')] public ?string $repositoriesUrl, public ?string $slug, public ?string $url)
    {
    }
}
