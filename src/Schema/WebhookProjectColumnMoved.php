...
final readonly class WebhookProjectColumnMoved
{
    ...
    public Schema\WebhookProjectColumnMoved\ProjectColumn $projectColumn, public Schema\Repository|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
