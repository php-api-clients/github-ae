...
namespace ApiClients\Client\GitHubAE\Schema\WebhookFork;

use ApiClients\Client\GitHubAE\Schema;
use EventSauce\ObjectHydrator\MapFrom;

final readonly class Forkee
{
    ...
    public string $languagesUrl, public Schema\WebhookFork\Forkee\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookFork\Forkee\Owner|null $owner, public Schema\WebhookFork\Forkee\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
