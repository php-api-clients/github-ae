...
final readonly class WebhookDeployKeyCreated
{
    ...
    "properties": {
        ...
        "key": {
            ...
            "description": "The [`deploy key`](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/deploy-keys\\/deploy-keys#get-a-deploy-key) resource."
        },
        "organization": {
    ...
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/github-ae@latest/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
     * key: The [`deploy key`](https://docs.github.com/github-ae@latest/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookDeployKeyCreated\Key $key, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
