...
final readonly class DemilestonedIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Demilestoned Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Demilestoned Issue Event';
    ...
    public Schema\Integration|null $performedViaGithubApp, public Schema\DemilestonedIssueEvent\Milestone $milestone,)
    {
    }
}
