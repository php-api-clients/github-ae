...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnassigned\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Html $html, public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestUnassigned\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestUnassigned\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestUnassigned\PullRequest\Links\Statuses $statuses)
    {
    }
}
