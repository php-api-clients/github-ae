...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnassigned;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestUnassigned\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestUnassigned\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestUnassigned\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestUnassigned\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestUnassigned\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestUnassigned\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestUnassigned\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestUnassigned\PullRequest\User|null $user,)
    {
    }
}
