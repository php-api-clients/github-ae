...
final readonly class WebhookProjectColumnDeleted
{
    ...
    public const SCHEMA_TITLE        = 'project_column deleted event';
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_column')]
    public Schema\WebhookProjectColumnDeleted\ProjectColumn $projectColumn, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
