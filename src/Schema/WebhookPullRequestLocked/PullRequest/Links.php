...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestLocked\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestLocked\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestLocked\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestLocked\PullRequest\Links\Html $html, public Schema\WebhookPullRequestLocked\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestLocked\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestLocked\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestLocked\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestLocked\PullRequest\Links\Statuses $statuses)
    {
    }
}
