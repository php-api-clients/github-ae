...
final readonly class WebhookWorkflowRunCompleted
{
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender, public Schema\WebhookWorkflowRunCompleted\Workflow|null $workflow, #[MapFrom('workflow_run')]
    public Schema\WebhookWorkflowRunCompleted\WorkflowRun $workflowRun,)
    {
    }
}
