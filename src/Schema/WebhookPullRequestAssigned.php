...
final readonly class WebhookPullRequestAssigned
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestAssigned\Assignee|null $assignee, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimple|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestAssigned\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
