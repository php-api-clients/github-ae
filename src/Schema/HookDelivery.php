...
final readonly class HookDelivery
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":42,"guid":"58474f00-b361-11eb-836d-0e4f3503ccbe","delivered_at":"2021-05-12T20:33:44Z","redelivery":false,"duration":0.03,"status":"failed to connect","status_code":502,"event":"issues","action":"opened","installation_id":123,"repository_id":123,"url":"https:\\/\\/www.example.com","request":{"headers":null,"payload":null},"response":{"headers":null,"payload":"generated_payload_null"}}';
    /**
     ...
     */
    public function __construct(public int $id, public string $guid, #[\EventSauce\ObjectHydrator\MapFrom('delivered_at')] public string $deliveredAt, public bool $redelivery, public int|float $duration, public string $status, #[\EventSauce\ObjectHydrator\MapFrom('status_code')] public int $statusCode, public string $event, public ?string $action, #[\EventSauce\ObjectHydrator\MapFrom('installation_id')] public ?int $installationId, #[\EventSauce\ObjectHydrator\MapFrom('repository_id')] public ?int $repositoryId, public ?string $url, public Schema\HookDelivery\Request $request, public Schema\HookDelivery\Response $response)
    {
    }
}
