...
final readonly class Invitation
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"created_at":"1970-01-01T00:00:00+00:00","email":"generated_email_null","failed_at":"1970-01-01T00:00:00+00:00","failed_reason":"generated_failed_reason_null","id":13.13,"invitation_teams_url":"https:\\/\\/example.com\\/","inviter":{"avatar_url":"https:\\/\\/example.com\\/","deleted":false,"email":"generated_email_null","events_url":"generated_events_url_uri-template","followers_url":"https:\\/\\/example.com\\/","following_url":"generated_following_url_uri-template","gists_url":"generated_gists_url_uri-template","gravatar_id":"generated_gravatar_id_null","html_url":"https:\\/\\/example.com\\/","id":13,"login":"generated_login_null","name":"generated_name_null","node_id":"generated_node_id_null","organizations_url":"https:\\/\\/example.com\\/","received_events_url":"https:\\/\\/example.com\\/","repos_url":"https:\\/\\/example.com\\/","site_admin":false,"starred_url":"generated_starred_url_uri-template","subscriptions_url":"https:\\/\\/example.com\\/","type":"Bot","url":"https:\\/\\/example.com\\/"},"login":"generated_login_null","node_id":"generated_node_id_null","role":"generated_role_null","team_count":13.13,"invitation_source":"generated_invitation_source_null"}';
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public ?string $email, #[\EventSauce\ObjectHydrator\MapFrom('failed_at')] public ?string $failedAt, #[\EventSauce\ObjectHydrator\MapFrom('failed_reason')] public ?string $failedReason, public int|float $id, #[\EventSauce\ObjectHydrator\MapFrom('invitation_teams_url')] public string $invitationTeamsUrl, public ?Schema\WebhookOrganizationMemberInvited\Invitation\Inviter $inviter, public ?string $login, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $role, #[\EventSauce\ObjectHydrator\MapFrom('team_count')] public int|float $teamCount, #[\EventSauce\ObjectHydrator\MapFrom('invitation_source')] public ?string $invitationSource)
    {
    }
}
