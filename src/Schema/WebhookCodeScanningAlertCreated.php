...
final readonly class WebhookCodeScanningAlertCreated
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCodeScanningAlertCreated\Alert $alert, #[MapFrom('commit_oid')]
    public string $commitOid, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public string $ref, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
