...
use ApiClients\Client\GitHubAE\Schema\GitTree\Tree;
...
final readonly class GitTree
{
     ...
     */
    public function __construct(public string $sha, public string $url, public bool $truncated, #[CastListToType(Schema\GitTree\Tree::class)] public array $tree)
    {
    }
}
