...
namespace ApiClients\Client\GitHubAE\Schema\ProtectedBranch\RequiredPullRequestReviews;
...
final readonly class DismissalRestrictions
{
    ...
    public string $teamsUrl, public array $users, public array $teams, public array|null $apps,)
    {
    }
}
