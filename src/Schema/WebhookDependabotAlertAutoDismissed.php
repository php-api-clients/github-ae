...
final readonly class WebhookDependabotAlertAutoDismissed
{
     ...
     */
    public function __construct(public string $action, public Schema\DependabotAlert $alert, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, public Schema\Enterprise|null $enterprise, public Schema\Repository $repository, public Schema\SimpleUser $sender)
    {
    }
}
