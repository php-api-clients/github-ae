...
final readonly class WebhookIssueCommentEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssueCommentEdited\Changes $changes, public Schema\WebhookIssueCommentEdited\Comment $comment, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssueCommentEdited\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
