...
final readonly class WebhookIssueCommentEdited
{
    ...
    "properties": {
        ...
        "comment": {
            ...
            "description": "The [comment](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/issues\\/comments#get-an-issue-comment) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
        ...
        "issue": {
            "allOf": [
                {
                    ...
                    "description": "The [issue](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/issues\\/issues#get-an-issue) itself."
                },
                {
                    "required": [
                        "labels",
            ...
            "description": "The [issue](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/issues\\/issues#get-an-issue) the comment belongs to."
        },
        "organization": {
     ...
     * comment: The [comment](https://docs.github.com/github-ae@latest/rest/issues/comments#get-an-issue-comment) itself.
    ...
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/github-ae@latest/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
     * issue: The [issue](https://docs.github.com/github-ae@latest/rest/issues/issues#get-an-issue) the comment belongs to.
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssueCommentEdited\Changes $changes, public Schema\WebhookIssueCommentEdited\Comment $comment, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssueCommentEdited\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
