...
final readonly class WebhookIssuesEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssuesEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssuesEdited\Issue $issue, public Schema\WebhookIssuesEdited\Label|null $label, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
