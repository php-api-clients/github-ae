...
final readonly class WebhookInstallationTargetRenamed
{
     ...
     */
    public function __construct(public Schema\WebhookInstallationTargetRenamed\Account $account, public string $action, public Schema\WebhookInstallationTargetRenamed\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks|null $sender, #[MapFrom('target_type')]
