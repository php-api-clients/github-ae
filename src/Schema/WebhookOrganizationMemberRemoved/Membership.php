...
namespace ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberRemoved;
...
final readonly class Membership
{
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('organization_url')] public string $organizationUrl, public string $role, public string $state, public string $url, public ?Schema\WebhookOrganizationMemberRemoved\Membership\User $user)
    {
    }
}
