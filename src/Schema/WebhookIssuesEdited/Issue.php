...
final readonly class Issue
{
    ...
    public string|null $activeLockReason, public Schema\WebhookIssuesEdited\Issue\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    ...
    public string $labelsUrl, public bool|null $locked, public Schema\WebhookIssuesEdited\Issue\Milestone|null $milestone, #[MapFrom('node_id')]
    public string $nodeId, public int $number, #[MapFrom('performed_via_github_app')]
    public Schema\WebhookIssuesEdited\Issue\PerformedViaGithubApp|null $performedViaGithubApp, #[MapFrom('pull_request')]
    public Schema\WebhookIssuesEdited\Issue\PullRequest|null $pullRequest, public Schema\WebhookIssuesEdited\Issue\Reactions $reactions, #[MapFrom('repository_url')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookIssuesEdited\Issue\User|null $user,)
    {
    }
}
