...
use ApiClients\Client\GitHubAE\Schema\TimelineCommittedEvent\Parents;
...
final readonly class TimelineCommittedEvent
{
     ...
     */
    public function __construct(public ?string $event, public string $sha, #[MapFrom('node_id')] public string $nodeId, public string $url, public Schema\TimelineCommittedEvent\Author $author, public Schema\TimelineCommittedEvent\Committer $committer, public string $message, public Schema\TimelineCommittedEvent\Tree $tree, #[CastListToType(Schema\TimelineCommittedEvent\Parents::class)] public array $parents, public Schema\TimelineCommittedEvent\Verification $verification, #[MapFrom('html_url')] public string $htmlUrl)
    {
    }
}
