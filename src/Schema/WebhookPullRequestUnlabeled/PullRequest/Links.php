...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnlabeled\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Html $html, public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestUnlabeled\PullRequest\Links\Statuses $statuses)
    {
    }
}
