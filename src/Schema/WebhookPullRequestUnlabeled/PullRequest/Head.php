...
final readonly class Head
{
     ...
     */
    public function __construct(public string|null $label, public string $ref, public Schema\WebhookPullRequestUnlabeled\PullRequest\Head\Repo|null $repo, public string $sha, public Schema\WebhookPullRequestUnlabeled\PullRequest\Head\User|null $user)
    {
    }
}
