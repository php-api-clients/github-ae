...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnlabeled;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestUnlabeled\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestUnlabeled\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestUnlabeled\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestUnlabeled\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestUnlabeled\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestUnlabeled\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestUnlabeled\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestUnlabeled\PullRequest\User|null $user,)
    {
    }
}
