...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestMilestoned\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Html $html, public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestMilestoned\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestMilestoned\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestMilestoned\PullRequest\Links\Statuses $statuses)
    {
    }
}
