...
final readonly class Comment
{
     ...
     */
    public function __construct(#[MapFrom('author_association')] public string $authorAssociation, public string $body, #[MapFrom('commit_id')] public string $commitId, #[MapFrom('created_at')] public string $createdAt, #[MapFrom('html_url')] public string $htmlUrl, public int $id, public ?int $line, #[MapFrom('node_id')] public string $nodeId, public ?string $path, public ?int $position, public ?Schema\WebhookCommitCommentCreated\Comment\Reactions $reactions, #[MapFrom('updated_at')] public string $updatedAt, public string $url, public ?Schema\WebhookCommitCommentCreated\Comment\User $user)
    {
    }
}
