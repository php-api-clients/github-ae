...
final readonly class MovedColumnInProjectIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Moved Column in Project Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Moved Column in Project Issue Event';
    ...
    public Schema\MovedColumnInProjectIssueEvent\ProjectCard|null $projectCard,)
    {
    }
}
