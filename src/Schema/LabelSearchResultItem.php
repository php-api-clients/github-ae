...
final readonly class LabelSearchResultItem
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":13,"nodeId":"generated_node_id_null","url":"https:\\/\\/example.com\\/","name":"generated_name_null","color":"generated_color_null","default":false,"description":"generated_description_null","score":13,"textMatches":[{"objectUrl":"generated_object_url_null","objectType":"generated_object_type_null","property":"generated_property_null","fragment":"generated_fragment_null","matches":[{"text":"generated_text_null","indices":[13]}]}]}';
    /**
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\SearchResultTextMatches> $textMatches
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $url, public string $name, public string $color, public bool $default, public ?string $description, public int $score, #[\EventSauce\ObjectHydrator\MapFrom('text_matches')] #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\SearchResultTextMatches::class)] public ?array $textMatches)
    {
    }
}
