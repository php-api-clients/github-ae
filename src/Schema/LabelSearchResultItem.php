...
final readonly class LabelSearchResultItem
{
     ...
     */
    public function __construct(public int $id, #[MapFrom('node_id')] public string $nodeId, public string $url, public string $name, public string $color, public bool $default, public ?string $description, public int|float $score, #[MapFrom('text_matches')] #[CastListToType(Schema\SearchResultTextMatches::class)] public ?array $textMatches)
    {
    }
}
