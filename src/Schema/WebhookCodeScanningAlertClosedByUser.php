...
final readonly class WebhookCodeScanningAlertClosedByUser
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCodeScanningAlertClosedByUser\Alert $alert, #[MapFrom('commit_oid')]
