...
namespace ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes;
...
final readonly class From
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"securityAndAnalysis":{"advancedSecurity":{"status":"enabled"},"secretScanning":{"status":"enabled"},"secretScanningPushProtection":{"status":"enabled"}}}';
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('security_and_analysis')] public ?Schema\SecurityAndAnalysis $securityAndAnalysis)
    {
    }
}
