...
final readonly class From
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"security_and_analysis":{"advanced_security":{"status":"generated_status_null"},"secret_scanning":{"status":"generated_status_null"},"secret_scanning_push_protection":{"status":"generated_status_null"}}}';
