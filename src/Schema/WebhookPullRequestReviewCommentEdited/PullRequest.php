...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentEdited;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Base $base, public string|null $body, #[MapFrom('closed_at')]
    ...
    public string $diffUrl, public bool|null $draft, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public string|null $mergedAt, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\User|null $user,)
    {
    }
}
