...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentEdited\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links\Statuses $statuses)
    {
    }
}
