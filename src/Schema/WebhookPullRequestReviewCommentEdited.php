...
final readonly class WebhookPullRequestReviewCommentEdited
{
    ...
    "properties": {
        ...
        "comment": {
            ...
            "description": "The [comment](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/pulls\\/comments#get-a-review-comment-for-a-pull-request) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
     ...
     * comment: The [comment](https://docs.github.com/github-ae@latest/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestReviewCommentEdited\Changes $changes, public Schema\WebhookPullRequestReviewCommentEdited\Comment $comment, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestReviewCommentEdited\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
