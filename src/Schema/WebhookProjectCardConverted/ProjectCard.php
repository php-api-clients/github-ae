...
final readonly class ProjectCard
{
     ...
     */
    public function __construct(#[MapFrom('after_id')] public ?int $afterId, public bool $archived, #[MapFrom('column_id')] public int $columnId, #[MapFrom('column_url')] public string $columnUrl, #[MapFrom('content_url')] public ?string $contentUrl, #[MapFrom('created_at')] public string $createdAt, public ?Schema\Discussion\AnswerChosenBy $creator, public int $id, #[MapFrom('node_id')] public string $nodeId, public ?string $note, #[MapFrom('project_url')] public string $projectUrl, #[MapFrom('updated_at')] public string $updatedAt, public string $url)
    {
    }
}
