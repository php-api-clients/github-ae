...
final readonly class WebhookRepositoryDispatchSample
{
    ...
    public Schema\WebhookRepositoryDispatchSample\ClientPayload|null $clientPayload, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
