...
final readonly class Comment
{
     ...
     */
    public function __construct(#[MapFrom('author_association')] public string $authorAssociation, public string $body, #[MapFrom('child_comment_count')] public int $childCommentCount, #[MapFrom('created_at')] public string $createdAt, #[MapFrom('discussion_id')] public int $discussionId, #[MapFrom('html_url')] public string $htmlUrl, public int $id, #[MapFrom('node_id')] public string $nodeId, #[MapFrom('parent_id')] public ?int $parentId, public Schema\Discussion\Reactions $reactions, #[MapFrom('repository_url')] public string $repositoryUrl, #[MapFrom('updated_at')] public string $updatedAt, public ?Schema\Discussion\AnswerChosenBy $user)
    {
    }
}
