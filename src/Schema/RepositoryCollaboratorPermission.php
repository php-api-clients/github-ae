...
final readonly class RepositoryCollaboratorPermission
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"permission":"generated_permission_null","role_name":"admin","user":null}';
    public function __construct(public string $permission, #[\EventSauce\ObjectHydrator\MapFrom('role_name')] public string $roleName, public mixed $user)
    {
    }
}
