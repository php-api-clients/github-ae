...
final readonly class WebhookPageBuild
{
    ...
    "properties": {
        "build": {
            ...
            "description": "The [List GitHub Pages builds](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/pages\\/pages#list-github-pages-builds) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
     ...
     */
    public function __construct(public Schema\WebhookPageBuild\Build $build, public Schema\Enterprise|null $enterprise, public int $id, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, public Schema\Repository $repository, public Schema\SimpleUser $sender)
    {
    }
}
