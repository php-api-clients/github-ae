...
use ApiClients\Client\GitHubAE\Schema\StatusCheckPolicy\Checks;
...
final readonly class StatusCheckPolicy
{
     ...
     */
    public function __construct(public string $url, public bool $strict, public array $contexts, #[CastListToType(Schema\StatusCheckPolicy\Checks::class)] public array $checks, #[MapFrom('contexts_url')] public string $contextsUrl)
    {
    }
}
