...
final readonly class WebhookDiscussionCommentEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookDiscussionCommentEdited\Changes $changes, public Schema\WebhookDiscussionCommentEdited\Comment $comment, public Schema\Discussion $discussion, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
