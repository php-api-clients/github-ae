...
final readonly class OrgHook
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":1,"url":"https:\\/\\/api.github.com\\/orgs\\/octocat\\/hooks\\/1","ping_url":"https:\\/\\/api.github.com\\/orgs\\/octocat\\/hooks\\/1\\/pings","deliveries_url":"https:\\/\\/api.github.com\\/orgs\\/octocat\\/hooks\\/1\\/deliveries","name":"web","events":["push"],"active":true,"config":{"url":"\\"http:\\/\\/example.com\\/2\\"","insecure_ssl":"\\"0\\"","content_type":"\\"form\\"","secret":"\\"********\\""},"updated_at":"2011-09-06T20:39:23Z","created_at":"2011-09-06T17:26:27Z","type":"generated_type_null"}';

    /**
     * @param array<string> $events
     */
    public function __construct(public int $id, public string $url, #[MapFrom('ping_url')] public string $pingUrl, #[MapFrom('deliveries_url')] public ?string $deliveriesUrl, public string $name, public array $events, public bool $active, public Schema\OrgHook\Config $config, #[MapFrom('updated_at')] public string $updatedAt, #[MapFrom('created_at')] public string $createdAt, public string $type)
    {
    }
}
