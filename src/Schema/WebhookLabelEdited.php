...
final readonly class WebhookLabelEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookLabelEdited\Changes|null $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookLabelEdited\Label $label, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
