...
final readonly class WebhookIssueCommentDeleted
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssueCommentDeleted\Comment $comment, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssueCommentDeleted\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
