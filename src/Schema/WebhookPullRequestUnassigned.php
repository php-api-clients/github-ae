...
final readonly class WebhookPullRequestUnassigned
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestUnassigned\Assignee|null $assignee, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestUnassigned\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
