...
final readonly class WebhookMembershipRemoved
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookMembershipRemoved\Member|null $member, public Schema\OrganizationSimpleWebhooks $organization, public Schema\RepositoryWebhooks|null $repository, public string $scope, public Schema\WebhookMembershipRemoved\Sender|null $sender, public Schema\WebhookMembershipRemoved\Team $team)
    {
    }
}
