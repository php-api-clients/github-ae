...
final readonly class WorkflowRun
{
    ...
    public function __construct(public Schema\WebhookDeploymentReviewRequested\WorkflowRun\Actor|null $actor, #[MapFrom('artifacts_url')]
    ...
    public Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadCommit|null $headCommit, #[MapFrom('head_repository')]
    public Schema\WebhookDeploymentReviewRequested\WorkflowRun\HeadRepository|null $headRepository, #[MapFrom('head_sha')]
    ...
    public array|null $referencedWorkflows, public Schema\WebhookDeploymentReviewRequested\WorkflowRun\Repository|null $repository, #[MapFrom('rerun_url')]
    ...
    public Schema\WebhookDeploymentReviewRequested\WorkflowRun\TriggeringActor|null $triggeringActor, #[MapFrom('updated_at')]
    public string $updatedAt, public string $url, #[MapFrom('workflow_id')]
    public int $workflowId, #[MapFrom('workflow_url')]
    public string|null $workflowUrl, #[MapFrom('display_title')]
