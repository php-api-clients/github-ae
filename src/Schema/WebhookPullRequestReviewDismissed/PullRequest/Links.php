...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewDismissed\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewDismissed\PullRequest\Links\Statuses $statuses)
    {
    }
}
