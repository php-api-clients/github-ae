...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewDismissed\Review;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestAssigned\PullRequest\Links\Comments $html, #[MapFrom('pull_request')] public Schema\WebhookPullRequestAssigned\PullRequest\Links\Comments $pullRequest)
    {
    }
}
