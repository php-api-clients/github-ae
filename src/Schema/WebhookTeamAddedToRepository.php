...
final readonly class WebhookTeamAddedToRepository
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, public Schema\WebhookTeamAddedToRepository\Repository|null $repository, public Schema\SimpleUserWebhooks|null $sender, public Schema\WebhookTeamAddedToRepository\Team $team)
    {
    }
}
