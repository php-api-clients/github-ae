...
final readonly class RunnerGroupsOrg
{
     ...
     */
    public function __construct(public float $id, public string $name, public string $visibility, public bool $default, #[\EventSauce\ObjectHydrator\MapFrom('selected_repositories_url')] public ?string $selectedRepositoriesUrl, #[\EventSauce\ObjectHydrator\MapFrom('runners_url')] public string $runnersUrl, public bool $inherited, #[\EventSauce\ObjectHydrator\MapFrom('inherited_allows_public_repositories')] public ?bool $inheritedAllowsPublicRepositories, #[\EventSauce\ObjectHydrator\MapFrom('allows_public_repositories')] public bool $allowsPublicRepositories, #[\EventSauce\ObjectHydrator\MapFrom('workflow_restrictions_read_only')] public ?bool $workflowRestrictionsReadOnly, #[\EventSauce\ObjectHydrator\MapFrom('restricted_to_workflows')] public ?bool $restrictedToWorkflows, #[\EventSauce\ObjectHydrator\MapFrom('selected_workflows')] public ?array $selectedWorkflows)
    {
    }
}
