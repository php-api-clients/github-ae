...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewEdited;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestReviewEdited\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public Schema\WebhookPullRequestReviewEdited\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestReviewEdited\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestReviewEdited\PullRequest\Base $base, public string|null $body, #[MapFrom('closed_at')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestReviewEdited\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public string|null $mergedAt, public Schema\WebhookPullRequestReviewEdited\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestReviewEdited\PullRequest\User|null $user,)
    {
    }
}
