...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewEdited\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewEdited\PullRequest\Links\Statuses $statuses)
    {
    }
}
