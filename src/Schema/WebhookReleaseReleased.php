...
final readonly class WebhookReleaseReleased
{
    ...
    "properties": {
        ...
        "release": {
            ...
            "description": "The [release](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/releases\\/releases\\/#get-a-release) object."
        },
        "repository": {
            "title": "Repository",
            "required": [
    ...
    public const SCHEMA_TITLE        = 'release released event';
    ...
    organization, or when the event occurs from activity in a repository owned by an organization.
     * release: The [release](https://docs.github.com/github-ae@latest/rest/releases/releases/#get-a-release) object.
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookReleaseReleased\Release $release, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks|null $sender)
    {
    }
}
