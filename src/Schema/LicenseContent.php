...
final readonly class LicenseContent
{
    ...
    public function __construct(public string $name, public string $path, public string $sha, public int $size, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('git_url')] public ?string $gitUrl, #[\EventSauce\ObjectHydrator\MapFrom('download_url')] public ?string $downloadUrl, public string $type, public string $content, public string $encoding, #[\EventSauce\ObjectHydrator\MapFrom('_links')] public Schema\LicenseContent\Links $links, public mixed $license)
    {
    }
}
