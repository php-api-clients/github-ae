...
final readonly class LicenseContent
{
    ...
    public function __construct(public string $name, public string $path, public string $sha, public int $size, public string $url, public ?string $html_url, public ?string $git_url, public ?string $download_url, public string $type, public string $content, public string $encoding, public Schema\ContentTree\Entries\Links $_links, public mixed $license)
    {
    }
}
