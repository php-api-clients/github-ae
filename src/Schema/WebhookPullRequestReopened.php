...
final readonly class WebhookPullRequestReopened
{
    ...
    public const SCHEMA_TITLE        = 'pull_request reopened event';
    ...
    public Schema\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
