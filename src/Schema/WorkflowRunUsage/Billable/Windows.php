...
final readonly class Windows
{
    ...
    /**
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\WorkflowRunUsage\Billable\Windows\JobRuns> $jobRuns
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_ms')] public int $totalMs, public int $jobs, #[\EventSauce\ObjectHydrator\MapFrom('job_runs')] #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WorkflowRunUsage\Billable\Windows\JobRuns::class)] public ?array $jobRuns)
    {
    }
}
