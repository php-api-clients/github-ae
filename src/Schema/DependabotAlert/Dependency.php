...
final readonly class Dependency
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"package":{"ecosystem":"generated_ecosystem_null","name":"generated_name_null"},"manifestPath":"generated_manifest_path_null","scope":"development"}';
    /**
