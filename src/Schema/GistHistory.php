...
final readonly class GistHistory
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"user":null,"version":"generated_version","committed_at":"generated_committed_at","change_status":{"total":13,"additions":13,"deletions":13},"url":"generated_url"}';
