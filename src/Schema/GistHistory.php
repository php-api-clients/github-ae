...
final readonly class GistHistory
{
    ...
    public function __construct(public mixed $user, public ?string $version, public ?string $committed_at, public ?Schema\GistHistory\ChangeStatus $change_status, public ?string $url)
    {
    }
}
