...
final readonly class GistHistory
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"user":null,"version":"generated_version_null","committed_at":"1970-01-01T00:00:00+00:00","change_status":{"total":13,"additions":13,"deletions":13},"url":"https:\\/\\/example.com\\/"}';
    public function __construct(public mixed $user, public ?string $version, #[\EventSauce\ObjectHydrator\MapFrom('committed_at')] public ?string $committedAt, #[\EventSauce\ObjectHydrator\MapFrom('change_status')] public ?Schema\GistHistory\ChangeStatus $changeStatus, public ?string $url)
    {
    }
}
