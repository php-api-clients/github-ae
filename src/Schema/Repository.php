...
final readonly class Repository
{
    ...
    public string $fullName, public Schema\LicenseSimple|null $license, public Schema\SimpleUser|null $organization, public int $forks, public Schema\Repository\Permissions|null $permissions, public Schema\SimpleUser $owner, public bool $private, #[MapFrom('html_url')]
    ...
    public Schema\Repository\TemplateRepository|null $templateRepository, #[MapFrom('temp_clone_token')]
