...
final readonly class DiffEntry
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"sha":"bbcd538c8e72b8c175046e27cc8f907076331401","filename":"file1.txt","status":"added","additions":103,"deletions":21,"changes":124,"blobUrl":"https:\\/\\/github.com\\/octocat\\/Hello-World\\/blob\\/6dcb09b5b57875f334f61aebed695e2e4193db5e\\/file1.txt","rawUrl":"https:\\/\\/github.com\\/octocat\\/Hello-World\\/raw\\/6dcb09b5b57875f334f61aebed695e2e4193db5e\\/file1.txt","contentsUrl":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/contents\\/file1.txt?ref=6dcb09b5b57875f334f61aebed695e2e4193db5e","patch":"@@ -132,7 +132,7 @@ module Test @@ -1000,7 +1000,7 @@ module Test","previousFilename":"file.txt"}';
    public function __construct(public string $sha, public string $filename, public string $status, public int $additions, public int $deletions, public int $changes, #[\EventSauce\ObjectHydrator\MapFrom('blob_url')] public string $blobUrl, #[\EventSauce\ObjectHydrator\MapFrom('raw_url')] public string $rawUrl, #[\EventSauce\ObjectHydrator\MapFrom('contents_url')] public string $contentsUrl, public ?string $patch, #[\EventSauce\ObjectHydrator\MapFrom('previous_filename')] public ?string $previousFilename)
    {
    }
}
