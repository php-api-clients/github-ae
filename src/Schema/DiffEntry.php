...
final readonly class DiffEntry
{
    ...
    public function __construct(public string $sha, public string $filename, public string $status, public int $additions, public int $deletions, public int $changes, #[MapFrom('blob_url')] public string $blobUrl, #[MapFrom('raw_url')] public string $rawUrl, #[MapFrom('contents_url')] public string $contentsUrl, public ?string $patch, #[MapFrom('previous_filename')] public ?string $previousFilename)
    {
    }
}
