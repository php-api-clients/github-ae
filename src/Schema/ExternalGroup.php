...
use ApiClients\Client\GitHubAE\Schema\ExternalGroup\Members;
use ApiClients\Client\GitHubAE\Schema\ExternalGroup\Teams;
...
final readonly class ExternalGroup
{
     ...
     *
     * @param array<Teams>   $teams   members: An array of external members linked to this group
     * @param array<Members> $members
     */
    public function __construct(#[MapFrom('group_id')] public int $groupId, #[MapFrom('group_name')] public string $groupName, #[MapFrom('updated_at')] public ?string $updatedAt, #[CastListToType(Schema\ExternalGroup\Teams::class)] public array $teams, #[CastListToType(Schema\ExternalGroup\Members::class)] public array $members)
    {
    }
}
