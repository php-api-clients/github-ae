...
final readonly class WebhookPullRequestLocked
{
    ...
    public Schema\WebhookPullRequestLocked\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
