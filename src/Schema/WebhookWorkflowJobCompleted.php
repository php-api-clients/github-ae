...
final readonly class WebhookWorkflowJobCompleted
{
    ...
    public Schema\WebhookWorkflowJobCompleted\WorkflowJob $workflowJob, public Schema\Deployment|null $deployment,)
    {
    }
}
