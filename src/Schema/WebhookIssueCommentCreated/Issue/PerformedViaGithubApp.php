...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssueCommentCreated\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssueCommentCreated\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
