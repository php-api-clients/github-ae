...
namespace ApiClients\Client\GitHubAE\Schema\Issues\CreateMilestone\Request;
...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated","state":"open","description":"generated","due_on":"1970-01-01T00:00:00+00:00"}';
     ...
     */
    public function __construct(public string $title, public ?string $state, public ?string $description, #[MapFrom('due_on')] public ?string $dueOn)
    {
    }
}
