...
namespace ApiClients\Client\GitHubAE\Schema\Issues\Update\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title_null","body":"generated_body_null","assignee":"generated_assignee_null","state":"generated_state_null","state_reason":"not_planned","milestone":"generated_milestone_null","labels":["generated_labels_null"],"assignees":["generated_assignees_null"]}';
    /**
     ...
     */
    public function __construct(public ?string $title, public ?string $body, public ?string $assignee, public ?string $state, public ?string $state_reason, public ?string $milestone, public ?array $labels, public ?array $assignees)
    {
    }
}
