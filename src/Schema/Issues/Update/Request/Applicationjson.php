...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?string $title, public ?string $body, public ?string $assignee, public ?string $state, #[MapFrom('state_reason')] public ?string $stateReason, public ?string $milestone, public ?array $labels, public ?array $assignees)
    {
    }
}
