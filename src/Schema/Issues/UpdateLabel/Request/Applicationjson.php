...
namespace ApiClients\Client\GitHubAE\Schema\Issues\UpdateLabel\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"newName":"generated_new_name_null","color":"generated_color_null","description":"generated_description_null"}';
    /**
