...
final readonly class AutoMerge
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('commit_message')] public ?string $commitMessage, #[\EventSauce\ObjectHydrator\MapFrom('commit_title')] public ?string $commitTitle, #[\EventSauce\ObjectHydrator\MapFrom('enabled_by')] public ?Schema\WebhookPullRequestReviewCommentCreated\PullRequest\AutoMerge\EnabledBy $enabledBy, #[\EventSauce\ObjectHydrator\MapFrom('merge_method')] public string $mergeMethod)
    {
    }
}
