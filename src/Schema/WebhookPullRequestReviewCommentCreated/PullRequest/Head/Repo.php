...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head;
...
final readonly class Repo
{
    ...
    public bool|null $hasDiscussions, public string|null $homepage, #[MapFrom('hooks_url')]
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo\Owner|null $owner, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
