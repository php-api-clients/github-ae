...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentCreated\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links\Statuses $statuses)
    {
    }
}
