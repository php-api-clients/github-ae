...
final readonly class ActionsRepositoryPermissions
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"enabled":false,"allowed_actions":"generated_allowed_actions_null","selected_actions_url":"generated_selected_actions_url_null"}';
    /**
