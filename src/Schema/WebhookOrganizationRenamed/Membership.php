...
namespace ApiClients\Client\GitHubAE\Schema\WebhookOrganizationRenamed;
...
final readonly class Membership
{
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('organization_url')] public string $organizationUrl, public string $role, public string $state, public string $url, public ?Schema\WebhookOrganizationRenamed\Membership\User $user)
    {
    }
}
