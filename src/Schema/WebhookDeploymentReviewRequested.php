...
final readonly class WebhookDeploymentReviewRequested
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public string $environment, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple $organization, public Schema\Repository $repository, public Schema\WebhookDeploymentReviewRequested\Requestor|null $requestor, public array $reviewers, public Schema\SimpleUser $sender, public string $since, #[MapFrom('workflow_job_run')]
