...
final readonly class WebhookDiscussionUnlabeled
{
    ...
    public const SCHEMA_TITLE        = 'discussion unlabeled event';
     ...
     */
    public function __construct(public string $action, public Schema\Discussion $discussion, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookDiscussionUnlabeled\Label $label, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
