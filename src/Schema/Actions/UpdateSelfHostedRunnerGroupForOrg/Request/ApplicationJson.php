...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"generated","visibility":"private","allows_public_repositories":false,"restricted_to_workflows":false,"selected_workflows":["generated","generated"]}';
     ...
     */
    public function __construct(public string $name, public ?string $visibility, #[MapFrom('allows_public_repositories')] public ?bool $allowsPublicRepositories, #[MapFrom('restricted_to_workflows')] public ?bool $restrictedToWorkflows, #[MapFrom('selected_workflows')] public ?array $selectedWorkflows)
    {
    }
}
