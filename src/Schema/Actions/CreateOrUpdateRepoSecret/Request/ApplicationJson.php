...
final readonly class ApplicationJson
{
    ...
    "properties": {
        "encrypted_value": {
            ...
            "type": "string",
            "description": "Value for your secret, encrypted with [LibSodium](https:\\/\\/libsodium.gitbook.io\\/doc\\/bindings_for_other_languages) using the public key retrieved from the [Get a repository public key](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/actions\\/secrets#get-a-repository-public-key) endpoint."
        },
        "key_id": {
            "type": "string",
    ...
    /**
     * encryptedValue: Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get a repository public key](https://docs.github.com/github-ae@latest/rest/actions/secrets#get-a-repository-public-key) endpoint.
