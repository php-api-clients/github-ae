...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('encrypted_value')] public ?string $encryptedValue, #[\EventSauce\ObjectHydrator\MapFrom('key_id')] public ?string $keyId, public string $visibility, #[\EventSauce\ObjectHydrator\MapFrom('selected_repository_ids')] public ?array $selectedRepositoryIds)
    {
    }
}
