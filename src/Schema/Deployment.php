...
final readonly class Deployment
{
    ...
    public string $nodeId, public string $sha, public string $ref, public string $task, #[Payload]
    public Schema\Deployment\Payload\Zero|string $payload, #[MapFrom('original_environment')]
    public string|null $originalEnvironment, public string $environment, public string|null $description, public Schema\SimpleUser|null $creator, #[MapFrom('created_at')]
