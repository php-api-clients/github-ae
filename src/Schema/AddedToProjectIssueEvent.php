...
final readonly class AddedToProjectIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Added to Project Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Added to Project Issue Event';
    ...
    public Schema\AddedToProjectIssueEvent\ProjectCard|null $projectCard,)
    {
    }
}
