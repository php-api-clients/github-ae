...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestLabeled\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestLabeled\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestLabeled\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestLabeled\PullRequest\Links\Html $html, public Schema\WebhookPullRequestLabeled\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestLabeled\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestLabeled\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestLabeled\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestLabeled\PullRequest\Links\Statuses $statuses)
    {
    }
}
