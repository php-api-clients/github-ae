...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestLabeled;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestLabeled\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestLabeled\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestLabeled\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestLabeled\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestLabeled\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestLabeled\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestLabeled\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestLabeled\PullRequest\User|null $user,)
    {
    }
}
