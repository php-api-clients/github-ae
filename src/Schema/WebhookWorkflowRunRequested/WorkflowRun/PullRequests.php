...
namespace ApiClients\Client\GitHubAE\Schema\WebhookWorkflowRunRequested\WorkflowRun;
...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookWorkflowRunRequested\WorkflowRun\PullRequests\Base $base, public Schema\WebhookWorkflowRunRequested\WorkflowRun\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
