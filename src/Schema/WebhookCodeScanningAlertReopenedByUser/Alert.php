...
final readonly class Alert
{
     ...
     */
    public function __construct(#[MapFrom('created_at')] public string $createdAt, #[MapFrom('dismissed_at')] public string $dismissedAt, #[MapFrom('dismissed_by')] public string $dismissedBy, #[MapFrom('dismissed_reason')] public string $dismissedReason, #[MapFrom('html_url')] public string $htmlUrl, #[MapFrom('most_recent_instance')] public ?Schema\WebhookCodeScanningAlertReopenedByUser\Alert\MostRecentInstance $mostRecentInstance, public int $number, public Schema\WebhookCodeScanningAlertReopenedByUser\Alert\Rule $rule, public string $state, public Schema\WebhookCodeScanningAlertReopenedByUser\Alert\Tool $tool, public string $url)
    {
    }
}
