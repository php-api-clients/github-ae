...
namespace ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopenedByUser;
...
final readonly class Alert
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"created_at":"1970-01-01T00:00:00+00:00","dismissed_at":"generated","dismissed_by":"generated","dismissed_reason":"generated","html_url":"https:\\/\\/example.com\\/","most_recent_instance":{"analysis_key":"generated","category":"generated","classifications":["generated","generated"],"commit_sha":"generated","environment":"generated","location":{"end_column":10,"end_line":8,"path":"generated","start_column":12,"start_line":10},"message":{"text":"generated"},"ref":"generated","state":"open"},"number":6,"rule":{"description":"generated","id":"generated","severity":"error"},"state":"open","tool":{"name":"generated","version":"generated"},"url":"https:\\/\\/example.com\\/"}';
     ...
     */
    public function __construct(#[MapFrom('created_at')] public string $createdAt, #[MapFrom('dismissed_at')] public string $dismissedAt, #[MapFrom('dismissed_by')] public string $dismissedBy, #[MapFrom('dismissed_reason')] public string $dismissedReason, #[MapFrom('html_url')] public string $htmlUrl, #[MapFrom('most_recent_instance')] public ?Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $mostRecentInstance, public int $number, public Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule $rule, public string $state, public Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool $tool, public string $url)
    {
    }
}
