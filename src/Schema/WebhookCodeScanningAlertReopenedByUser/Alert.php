...
final readonly class Alert
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('dismissed_at')] public mixed $dismissedAt, #[\EventSauce\ObjectHydrator\MapFrom('dismissed_by')] public mixed $dismissedBy, #[\EventSauce\ObjectHydrator\MapFrom('dismissed_reason')] public mixed $dismissedReason, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('most_recent_instance')] public ?Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $mostRecentInstance, public int $number, public Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule $rule, public string $state, public Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool $tool, public string $url)
    {
    }
}
