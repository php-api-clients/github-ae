...
final readonly class ContainerMetadata
{
    ...
    public function __construct(public ?Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Labels $labels, public ?Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Manifest $manifest, public ?Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag $tag)
    {
    }
}
