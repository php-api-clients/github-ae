...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestDemilestoned\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Html $html, public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestDemilestoned\PullRequest\Links\Statuses $statuses)
    {
    }
}
