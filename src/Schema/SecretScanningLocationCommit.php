...
final readonly class SecretScanningLocationCommit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"path":"\\/example\\/secrets.txt","start_line":13,"end_line":13,"start_column":13,"end_column":13,"blob_sha":"af5626b4a114abcb82d63db7c8082c3c4756e51b","blob_url":"generated_blob_url_null","commit_sha":"af5626b4a114abcb82d63db7c8082c3c4756e51b","commit_url":"generated_commit_url_null"}';
    /**
     ...
     */
    public function __construct(public string $path, #[\EventSauce\ObjectHydrator\MapFrom('start_line')] public int $startLine, #[\EventSauce\ObjectHydrator\MapFrom('end_line')] public int $endLine, #[\EventSauce\ObjectHydrator\MapFrom('start_column')] public int $startColumn, #[\EventSauce\ObjectHydrator\MapFrom('end_column')] public int $endColumn, #[\EventSauce\ObjectHydrator\MapFrom('blob_sha')] public string $blobSha, #[\EventSauce\ObjectHydrator\MapFrom('blob_url')] public string $blobUrl, #[\EventSauce\ObjectHydrator\MapFrom('commit_sha')] public string $commitSha, #[\EventSauce\ObjectHydrator\MapFrom('commit_url')] public string $commitUrl)
    {
    }
}
