...
final readonly class Release
{
    ...
    public function __construct(public ?Schema\WebhookRegistryPackagePublished\RegistryPackage\Owner $author, public ?string $created_at, public ?bool $draft, public ?string $html_url, public ?int $id, public ?string $name, public ?bool $prerelease, public ?string $published_at, public ?string $tag_name, public ?string $target_commitish, public ?string $url)
    {
    }
}
