...
final readonly class Output
{
     ...
     *
     * @param ?array<Annotations> $annotations images: Adds images to the output displayed in the GitHub pull request UI.
     * @param ?array<Images>      $images
     */
    public function __construct(public ?string $title, public string $summary, public ?string $text, #[CastListToType(Schema\Checks\Update\Request\Applicationjson\Output\Annotations::class)] public ?array $annotations, #[CastListToType(Schema\Checks\Update\Request\Applicationjson\Output\Images::class)] public ?array $images)
    {
    }
}
