...
final readonly class Output
{
     ...
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\Checks\Update\Request\Applicationjson\Output\Annotations> $annotations
     * images: Adds images to the output displayed in the GitHub pull request UI.
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\Checks\Update\Request\Applicationjson\Output\Images> $images
     */
    public function __construct(public ?string $title, public string $summary, public ?string $text, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Checks\Update\Request\Applicationjson\Output\Annotations::class)] public ?array $annotations, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Checks\Update\Request\Applicationjson\Output\Images::class)] public ?array $images)
    {
    }
}
