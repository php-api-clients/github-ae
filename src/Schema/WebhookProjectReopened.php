...
final readonly class WebhookProjectReopened
{
    ...
    public const SCHEMA_TITLE        = 'project reopened event';
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookProjectReopened\Project $project, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
