...
final readonly class ContentFile
{
    ...
    public function __construct(public string $type, public string $encoding, public int $size, public string $name, public string $path, public string $content, public string $sha, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('git_url')] public ?string $gitUrl, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('download_url')] public ?string $downloadUrl, #[\EventSauce\ObjectHydrator\MapFrom('_links')] public Schema\ContentFile\Links $links, public ?string $target, #[\EventSauce\ObjectHydrator\MapFrom('submodule_git_url')] public ?string $submoduleGitUrl)
    {
    }
}
