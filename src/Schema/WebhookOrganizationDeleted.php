...
final readonly class WebhookOrganizationDeleted
{
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookOrganizationDeleted\Membership|null $membership, public Schema\OrganizationSimpleWebhooks $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
