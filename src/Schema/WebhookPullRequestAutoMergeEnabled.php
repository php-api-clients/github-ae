...
final readonly class WebhookPullRequestAutoMergeEnabled
{
    ...
    public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest $pullRequest, public string|null $reason, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
