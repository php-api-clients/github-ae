...
final readonly class WebhookPullRequestAutoMergeEnabled
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest $pullRequest, public string|null $reason, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
