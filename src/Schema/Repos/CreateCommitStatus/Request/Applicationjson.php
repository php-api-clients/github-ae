...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"state":"error","targetUrl":"generated_target_url_null","description":"generated_description_null","context":"generated_context_null"}';
    /**
