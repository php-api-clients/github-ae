...
namespace ApiClients\Client\GitHubAE\Schema\Repos\UpdateWebhook\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"config":{"url":"https:\\/\\/example.com\\/webhook","content_type":"\\"json\\"","secret":"\\"********\\"","insecure_ssl":"generated_insecure_ssl_null","address":"\\"bar@example.com\\"","room":"\\"The Serious Room\\""},"events":["generated_events_null"],"add_events":["generated_add_events_null"],"remove_events":["generated_remove_events_null"],"active":false}';
    /**
     ...
     * events: Determines what [events](https://docs.github.com/github-ae@latest/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
