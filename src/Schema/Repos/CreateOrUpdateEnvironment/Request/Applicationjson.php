...
namespace ApiClients\Client\GitHubAE\Schema\Repos\CreateOrUpdateEnvironment\Request;

use ApiClients\Client\GitHubAE\Schema;
use ApiClients\Client\GitHubAE\Schema\Repos\CreateOrUpdateEnvironment\Request\Applicationjson\Reviewers;
...
final readonly class Applicationjson
{
     ...
     *
     * @param ?array<Reviewers> $reviewers deploymentBranchPolicy: The type of deployment branch policy for this environment. To allow all branches to deploy, set to `null`.
     */
    public function __construct(#[MapFrom('wait_timer')] public ?int $waitTimer, #[CastListToType(Schema\Repos\CreateOrUpdateEnvironment\Request\Applicationjson\Reviewers::class)] public ?array $reviewers, #[MapFrom('deployment_branch_policy')] public ?Schema\DeploymentBranchPolicySettings $deploymentBranchPolicy)
    {
    }
}
