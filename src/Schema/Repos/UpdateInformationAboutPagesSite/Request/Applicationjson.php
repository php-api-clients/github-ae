...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?string $cname, #[MapFrom('https_enforced')] public ?bool $httpsEnforced, #[MapFrom('build_type')] public ?string $buildType, public ?string $source)
    {
    }
}
