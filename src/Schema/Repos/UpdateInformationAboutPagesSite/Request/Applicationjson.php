...
namespace ApiClients\Client\GitHubAE\Schema\Repos\UpdateInformationAboutPagesSite\Request;
...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?string $cname, #[\EventSauce\ObjectHydrator\MapFrom('https_enforced')] public ?bool $httpsEnforced, #[\EventSauce\ObjectHydrator\MapFrom('build_type')] public ?string $buildType, public ?string $source)
    {
    }
}
