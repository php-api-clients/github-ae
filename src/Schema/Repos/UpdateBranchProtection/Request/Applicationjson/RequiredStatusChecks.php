...
use ApiClients\Client\GitHubAE\Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredStatusChecks\Checks;
...
final readonly class RequiredStatusChecks
{
     ...
     */
    public function __construct(public bool $strict, public array $contexts, #[CastListToType(Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredStatusChecks\Checks::class)] public ?array $checks)
    {
    }
}
