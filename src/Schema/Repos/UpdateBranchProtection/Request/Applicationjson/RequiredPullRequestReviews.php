...
namespace ApiClients\Client\GitHubAE\Schema\Repos\UpdateBranchProtection\Request\Applicationjson;
...
final readonly class RequiredPullRequestReviews
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismissalRestrictions":{"users":["generated_users_null"],"teams":["generated_teams_null"],"apps":["generated_apps_null"]},"dismissStaleReviews":false,"requireCodeOwnerReviews":false,"requiredApprovingReviewCount":13,"bypassPullRequestAllowances":{"users":["generated_users_null"],"teams":["generated_teams_null"],"apps":["generated_apps_null"]}}';
    /**
     ...
     * requireCodeOwnerReviews: Blocks merging pull requests until [code owners](https://docs.github.com/github-ae@latest/articles/about-code-owners/) review them.
