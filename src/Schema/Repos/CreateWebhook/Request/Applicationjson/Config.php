...
namespace ApiClients\Client\GitHubAE\Schema\Repos\CreateWebhook\Request\Applicationjson;
...
final readonly class Config
{
     ...
     */
    public function __construct(public ?string $url, #[\EventSauce\ObjectHydrator\MapFrom('content_type')] public ?string $contentType, public ?string $secret, #[\EventSauce\ObjectHydrator\MapFrom('insecure_ssl')] public ?string $insecureSsl, public ?string $token, public ?string $digest)
    {
    }
}
