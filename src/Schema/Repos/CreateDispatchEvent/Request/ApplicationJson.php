...
namespace ApiClients\Client\GitHubAE\Schema\Repos\CreateDispatchEvent\Request;
...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"event_type":"generated","client_payload":"generated"}';
     ...
     */
    public function __construct(#[MapFrom('event_type')] public string $eventType, #[MapFrom('client_payload')] public string $clientPayload)
    {
    }
}
