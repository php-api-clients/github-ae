...
namespace ApiClients\Client\GitHubAE\Schema\Repos\CreateDeployment\Request;
...
final readonly class ApplicationJson
{
     ...
     */
    public function __construct(public string $ref, public ?string $task, #[MapFrom('auto_merge')] public ?bool $autoMerge, #[MapFrom('required_contexts')] public ?array $requiredContexts, public null|Schema\AuditLogEvent\Data|string $payload, public ?string $environment, public ?string $description, #[MapFrom('transient_environment')] public ?bool $transientEnvironment, #[MapFrom('production_environment')] public ?bool $productionEnvironment)
    {
    }
}
