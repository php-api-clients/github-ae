...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"keyPrefix":"generated_key_prefix_null","urlTemplate":"generated_url_template_null","isAlphanumeric":false}';
    /**
     * keyPrefix: The prefix appended by a number will generate a link any time it is found in an issue, pull request, or commit.
