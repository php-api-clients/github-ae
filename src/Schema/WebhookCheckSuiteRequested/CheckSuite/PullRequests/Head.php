...
namespace ApiClients\Client\GitHubAE\Schema\WebhookCheckSuiteRequested\CheckSuite\PullRequests;
...
final readonly class Head
{
    ...
    public function __construct(public string $ref, public Schema\WebhookCheckSuiteRequested\CheckSuite\PullRequests\Head\Repo $repo, public string $sha)
    {
    }
}
