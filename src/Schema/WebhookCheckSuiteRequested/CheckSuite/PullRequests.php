...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookCheckSuiteRequested\CheckSuite\PullRequests\Base $base, public Schema\WebhookCheckSuiteRequested\CheckSuite\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
