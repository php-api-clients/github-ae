...
final readonly class HeadCommit
{
     ...
     */
    public function __construct(public Schema\WebhookCheckSuiteRequested\CheckSuite\HeadCommit\Author $author, public Schema\WebhookCheckSuiteRequested\CheckSuite\HeadCommit\Committer $committer, public string $id, public string $message, public string $timestamp, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId)
    {
    }
}
