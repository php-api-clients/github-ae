...
final readonly class MilestonedIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Milestoned Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Milestoned Issue Event';
    ...
    public Schema\Integration|null $performedViaGithubApp, public Schema\MilestonedIssueEvent\Milestone $milestone,)
    {
    }
}
