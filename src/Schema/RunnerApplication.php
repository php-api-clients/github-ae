...
final readonly class RunnerApplication
{
     ...
     */
    public function __construct(public string $os, public string $architecture, #[MapFrom('download_url')] public string $downloadUrl, public string $filename, #[MapFrom('temp_download_token')] public ?string $tempDownloadToken, #[MapFrom('sha256_checksum')] public ?string $sha256Checksum)
    {
    }
}
