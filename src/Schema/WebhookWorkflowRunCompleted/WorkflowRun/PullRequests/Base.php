...
namespace ApiClients\Client\GitHubAE\Schema\WebhookWorkflowRunCompleted\WorkflowRun\PullRequests;
...
final readonly class Base
{
    ...
    public function __construct(public string $ref, public Schema\WebhookWorkflowRunCompleted\WorkflowRun\PullRequests\Base\Repo $repo, public string $sha)
    {
    }
}
