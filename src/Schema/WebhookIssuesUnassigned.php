...
final readonly class WebhookIssuesUnassigned
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssuesUnassigned\Assignee|null $assignee, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssuesUnassigned\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
