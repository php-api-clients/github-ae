...
use ApiClients\Client\GitHubAE\Schema\Job\Steps;
...
final readonly class Job
{
     ...
     *
     * @param ?array<Steps> $steps  labels: Labels for the workflow job. Specified by the "runs_on" attribute in the action's workflow file.
