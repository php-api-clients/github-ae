...
final readonly class Commit
{
    ...
    public function __construct(public Schema\CommitSearchResultItem\Commit\Author $author, public ?Schema\GitUser $committer, #[MapFrom('comment_count')] public int $commentCount, public string $message, public Schema\ShortBranch\Commit $tree, public string $url, public ?Schema\Verification $verification)
    {
    }
}
