...
final readonly class ActionsPublicKey
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"keyId":"1234567","key":"hBT5WZEj8ZoOv6TYJsfWq7MxTEQopZO5\\/IT3ZCVQPzs=","id":2,"url":"https:\\/\\/api.github.com\\/user\\/keys\\/2","title":"ssh-rsa AAAAB3NzaC1yc2EAAA","createdAt":"2011-01-26T19:01:12Z"}';
    /**
     * keyId: The identifier for the key.
     * key: The Base64 encoded public key.
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('key_id')] public string $keyId, public string $key, public ?int $id, public ?string $url, public ?string $title, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt)
    {
    }
}
