...
final readonly class WebhookIssuesAssigned
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssuesAssigned\Assignee|null $assignee, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssuesAssigned\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
