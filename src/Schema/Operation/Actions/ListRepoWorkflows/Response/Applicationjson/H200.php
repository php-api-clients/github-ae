...
namespace ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListRepoWorkflows\Response\Applicationjson;
...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"totalCount":13,"workflows":[{"id":5,"nodeId":"MDg6V29ya2Zsb3cxMg==","name":"CI","path":"ruby.yaml","state":"active","createdAt":"2019-12-06T14:20:20.000Z","updatedAt":"2019-12-06T14:20:20.000Z","url":"https:\\/\\/api.github.com\\/repos\\/actions\\/setup-ruby\\/workflows\\/5","htmlUrl":"https:\\/\\/github.com\\/actions\\/setup-ruby\\/blob\\/master\\/.github\\/workflows\\/ruby.yaml","badgeUrl":"https:\\/\\/github.com\\/actions\\/setup-ruby\\/workflows\\/CI\\/badge.svg","deletedAt":"2019-12-06T14:20:20.000Z"}]}';
    /**
     * @param array<\ApiClients\Client\GitHubAE\Schema\Workflow> $workflows
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Workflow::class)] public array $workflows)
    {
    }
}
