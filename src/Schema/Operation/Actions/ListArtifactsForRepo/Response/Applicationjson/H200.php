...
namespace ApiClients\Client\GitHubAE\Schema\Operation\Actions\ListArtifactsForRepo\Response\Applicationjson;
...
final readonly class H200
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubAE\Schema\Artifact> $artifacts
     */
