...
final readonly class H200
{
    ...
    /**
     * @param array<OrganizationActionsSecret> $secrets
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[CastListToType(Schema\OrganizationActionsSecret::class)] public array $secrets)
    {
    }
}
