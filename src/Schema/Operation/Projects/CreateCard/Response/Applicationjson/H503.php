...
namespace ApiClients\Client\GitHubAE\Schema\Operation\Projects\CreateCard\Response\Applicationjson;
...
final readonly class H503
{
    ...
    /**
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\Operation\Projects\CreateCard\Response\Applicationjson\H503\Errors> $errors
     */
    public function __construct(public ?string $code, public ?string $message, #[\EventSauce\ObjectHydrator\MapFrom('documentation_url')] public ?string $documentationUrl, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Operation\Projects\CreateCard\Response\Applicationjson\H503\Errors::class)] public ?array $errors)
    {
    }
}
