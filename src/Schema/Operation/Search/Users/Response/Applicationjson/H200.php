...
use ApiClients\Client\GitHubAE\Schema\UserSearchResultItem;
...
final readonly class H200
{
    ...
    /**
     * @param array<UserSearchResultItem> $items
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[MapFrom('incomplete_results')] public bool $incompleteResults, #[CastListToType(Schema\UserSearchResultItem::class)] public array $items)
    {
    }
}
