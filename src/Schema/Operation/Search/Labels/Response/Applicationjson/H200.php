...
use ApiClients\Client\GitHubAE\Schema\LabelSearchResultItem;
...
final readonly class H200
{
    ...
    /**
     * @param array<LabelSearchResultItem> $items
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[MapFrom('incomplete_results')] public bool $incompleteResults, #[CastListToType(Schema\LabelSearchResultItem::class)] public array $items)
    {
    }
}
