...
use ApiClients\Client\GitHubAE\Schema\TopicSearchResultItem;
...
final readonly class H200
{
    ...
    /**
     * @param array<TopicSearchResultItem> $items
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[MapFrom('incomplete_results')] public bool $incompleteResults, #[CastListToType(Schema\TopicSearchResultItem::class)] public array $items)
    {
    }
}
