...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"totalCount":13,"runners":[{"id":5,"name":"iMac","os":"macos","status":"online","busy":false,"labels":[{"id":13,"name":"generated_name_null","type":"read-only"}]}]}';
    /**
