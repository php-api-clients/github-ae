...
namespace ApiClients\Client\GitHubAE\Schema\Operation\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\Applicationjson;
...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"total_count":13.13,"runners":[{"id":5,"name":"iMac","os":"macos","status":"online","busy":false,"labels":[{"id":13,"name":"generated_name_null","type":"read-only"}]}]}';
    /**
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\Runner> $runners
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public null|int|float $totalCount, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Runner::class)] public ?array $runners)
    {
    }
}
