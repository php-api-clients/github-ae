...
final readonly class H403
{
    ...
    public function __construct(public ?Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block $block, public ?string $message, #[MapFrom('documentation_url')] public ?string $documentationUrl)
    {
    }
}
