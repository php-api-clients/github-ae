...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesOpened\Changes;

use ApiClients\Client\GitHubAE\Schema;
use EventSauce\ObjectHydrator\MapFrom;

final readonly class OldIssue
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [issue](https://docs.github.com/github-ae@latest/rest/issues/issues#get-an-issue) itself.';
    ...
    public string|null $activeLockReason, public Schema\WebhookIssuesOpened\Changes\OldIssue\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    ...
    public string $labelsUrl, public bool|null $locked, public Schema\WebhookIssuesOpened\Changes\OldIssue\Milestone|null $milestone, #[MapFrom('node_id')]
    public string $nodeId, public int $number, #[MapFrom('performed_via_github_app')]
    public Schema\WebhookIssuesOpened\Changes\OldIssue\PerformedViaGithubApp|null $performedViaGithubApp, #[MapFrom('pull_request')]
    public Schema\WebhookIssuesOpened\Changes\OldIssue\PullRequest|null $pullRequest, public Schema\WebhookIssuesOpened\Changes\OldIssue\Reactions $reactions, #[MapFrom('repository_url')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookIssuesOpened\Changes\OldIssue\User|null $user,)
    {
    }
}
