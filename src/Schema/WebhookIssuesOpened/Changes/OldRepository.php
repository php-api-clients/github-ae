...
final readonly class OldRepository
{
     ...
     * hasDiscussions: Whether the repository has discussions enabled.
     ...
     * webCommitSignoffRequired: Whether to require commit signoff.
     */
    ...
    public string $gitUrl, #[MapFrom('has_discussions')]
    public bool|null $hasDiscussions, #[MapFrom('has_downloads')]
