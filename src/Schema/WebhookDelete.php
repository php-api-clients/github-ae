...
final readonly class WebhookDelete
{
    ...
    "properties": {
        ...
        "ref": {
            "type": "string",
            "description": "The [`git ref`](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/git\\/refs#get-a-reference) resource."
        },
        "ref_type": {
            "enum": [
                "tag",
     ...
     * ref: The [`git ref`](https://docs.github.com/github-ae@latest/rest/git/refs#get-a-reference) resource.
     * refType: The type of Git ref object deleted in the repository.
     ...
     */
    public function __construct(public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pusher_type')]
