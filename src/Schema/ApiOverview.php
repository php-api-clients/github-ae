...
final readonly class ApiOverview
{
    ...
    public Schema\ApiOverview\SshKeyFingerprints|null $sshKeyFingerprints, public array|null $hooks, #[MapFrom('github_enterprise_importer')]
