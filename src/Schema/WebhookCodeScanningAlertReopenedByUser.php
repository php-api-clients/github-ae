...
final readonly class WebhookCodeScanningAlertReopenedByUser
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCodeScanningAlertReopenedByUser\Alert $alert, #[MapFrom('commit_oid')]
