...
namespace ApiClients\Client\GitHubAE\Schema\WebhookReleasePublished\Release;
...
final readonly class Assets
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('browser_download_url')] public string $browserDownloadUrl, #[\EventSauce\ObjectHydrator\MapFrom('content_type')] public string $contentType, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('download_count')] public int $downloadCount, public int $id, public ?string $label, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public int $size, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public ?Schema\WebhookReleasePublished\Release\Assets\Uploader $uploader, public string $url)
    {
    }
}
