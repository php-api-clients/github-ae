...
final readonly class WebhookDiscussionLabeled
{
     ...
     */
    public function __construct(public string $action, public Schema\Discussion $discussion, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookDiscussionLabeled\Label $label, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
