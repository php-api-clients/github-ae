...
use ApiClients\Client\GitHubAE\Schema\ContributorActivity\Weeks;
...
final readonly class ContributorActivity
{
     ...
     */
    public function __construct(public ?Schema\SimpleUser $author, public int $total, #[CastListToType(Schema\ContributorActivity\Weeks::class)] public array $weeks)
    {
    }
}
