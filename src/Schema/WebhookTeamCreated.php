...
final readonly class WebhookTeamCreated
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, public Schema\WebhookTeamCreated\Repository|null $repository, public Schema\SimpleUserWebhooks $sender, public Schema\WebhookTeamCreated\Team $team)
    {
    }
}
