...
final readonly class WebhookRepositoryArchived
{
    ...
    public const SCHEMA_TITLE        = 'repository archived event';
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, public Schema\Repository $repository, public Schema\SimpleUser $sender)
    {
    }
}
