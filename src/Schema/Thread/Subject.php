...
final readonly class Subject
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title_null","url":"generated_url_null","latestCommentUrl":"generated_latest_comment_url_null","type":"generated_type_null"}';
