...
final readonly class WebhookCodeScanningAlertFixed
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCodeScanningAlertFixed\Alert $alert, #[MapFrom('commit_oid')]
