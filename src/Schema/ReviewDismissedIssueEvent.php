...
final readonly class ReviewDismissedIssueEvent
{
    ...
    public Schema\Integration|null $performedViaGithubApp, #[MapFrom('dismissed_review')]
    public Schema\ReviewDismissedIssueEvent\DismissedReview $dismissedReview,)
    {
    }
}
