...
final readonly class WebhookPullRequestDemilestoned
{
    ...
    public const SCHEMA_TITLE        = 'pull_request demilestoned event';
    ...
    public Schema\WebhookPullRequestDemilestoned\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
