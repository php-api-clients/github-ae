...
final readonly class WebhookIssueCommentCreated
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssueCommentCreated\Comment $comment, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssueCommentCreated\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
