...
final readonly class WebhookProjectsV2ProjectEdited
{
    ...
    public const SCHEMA_TITLE        = 'Projects v2 Project Edited Event';
    ...
    organization, or when the event occurs from activity in a repository owned by an organization.
     * projectsVTwo: A projects v2 project
     * sender: The GitHub user that triggered the event. This property is included in every webhook payload.
     */
    public function __construct(public string $action, public Schema\WebhookProjectsV2ProjectEdited\Changes $changes, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, #[MapFrom('projects_v2')]
    public Schema\ProjectsV2 $projectsVTwo, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
