...
final readonly class RemovedFromProjectIssueEvent
{
    ...
    public const SCHEMA_TITLE        = 'Removed from Project Issue Event';
    public const SCHEMA_DESCRIPTION  = 'Removed from Project Issue Event';
    ...
    public Schema\RemovedFromProjectIssueEvent\ProjectCard|null $projectCard,)
    {
    }
}
