...
final readonly class WebhookPullRequestReviewSubmitted
{
    ...
    public Schema\WebhookPullRequestReviewSubmitted\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\WebhookPullRequestReviewSubmitted\Review $review, public Schema\SimpleUser $sender,)
    {
    }
}
