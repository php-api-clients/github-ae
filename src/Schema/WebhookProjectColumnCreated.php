...
final readonly class WebhookProjectColumnCreated
{
    ...
    public Schema\WebhookProjectColumnCreated\ProjectColumn $projectColumn, public Schema\Repository|null $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
