...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesDeleted\Issue;
...
final readonly class Milestone
{
     ...
     */
    public function __construct(#[MapFrom('closed_at')] public ?string $closedAt, #[MapFrom('closed_issues')] public int $closedIssues, #[MapFrom('created_at')] public string $createdAt, public ?Schema\Discussion\AnswerChosenBy $creator, public ?string $description, #[MapFrom('due_on')] public ?string $dueOn, #[MapFrom('html_url')] public string $htmlUrl, public int $id, #[MapFrom('labels_url')] public string $labelsUrl, #[MapFrom('node_id')] public string $nodeId, public int $number, #[MapFrom('open_issues')] public int $openIssues, public string $state, public string $title, #[MapFrom('updated_at')] public string $updatedAt, public string $url)
    {
    }
}
