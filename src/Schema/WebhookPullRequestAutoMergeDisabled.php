...
final readonly class WebhookPullRequestAutoMergeDisabled
{
    ...
    public Schema\WebhookPullRequestAutoMergeDisabled\PullRequest $pullRequest, public string $reason, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
