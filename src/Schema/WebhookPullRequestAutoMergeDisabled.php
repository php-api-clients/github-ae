...
final readonly class WebhookPullRequestAutoMergeDisabled
{
    ...
    public Schema\WebhookPullRequestAutoMergeDisabled\PullRequest $pullRequest, public string $reason, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
