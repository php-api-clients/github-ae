...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers;
...
final readonly class One
{
     ...
     */
    public function __construct(public ?bool $deleted, public ?string $description, #[MapFrom('html_url')] public string $htmlUrl, public int $id, #[MapFrom('members_url')] public string $membersUrl, public string $name, #[MapFrom('node_id')] public string $nodeId, public ?Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers\One\Parent_ $parent, public string $permission, public string $privacy, #[MapFrom('repositories_url')] public string $repositoriesUrl, public string $slug, public string $url)
    {
    }
}
