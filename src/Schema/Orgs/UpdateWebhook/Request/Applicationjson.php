...
namespace ApiClients\Client\GitHubAE\Schema\Orgs\UpdateWebhook\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"config":{"url":"https:\\/\\/example.com\\/webhook","content_type":"\\"json\\"","secret":"\\"********\\"","insecure_ssl":"generated_insecure_ssl_null"},"events":["generated_events_null"],"active":false,"name":"\\"web\\""}';
    /**
     * config: Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/github-ae@latest/rest/reference/orgs#update-hook-config-params).
