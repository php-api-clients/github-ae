...
final readonly class Config
{
     ...
     */
    public function __construct(public string $url, #[MapFrom('content_type')] public ?string $contentType, public ?string $secret, #[MapFrom('insecure_ssl')] public ?string $insecureSsl)
    {
    }
}
