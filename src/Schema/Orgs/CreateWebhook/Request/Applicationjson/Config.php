...
final readonly class Config
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"https:\\/\\/example.com\\/webhook","content_type":"\\"json\\"","secret":"\\"********\\"","insecure_ssl":"generated_insecure_ssl","username":"\\"kdaigle\\"","password":"\\"password\\""}';
    /**
     ...
     */
    public function __construct(public ?string $url, public string $content_type, public string $secret, public string $insecure_ssl, public string $username, public string $password)
    {
    }
}
