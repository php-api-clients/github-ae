...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesReopened\Issue;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssuesReopened\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssuesReopened\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
