...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesReopened;
...
final readonly class Issue
{
    ...
    public string|null $activeLockReason, public Schema\WebhookIssuesReopened\Issue\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    ...
    public string $labelsUrl, public bool|null $locked, public Schema\WebhookIssuesReopened\Issue\Milestone|null $milestone, #[MapFrom('node_id')]
