...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesDemilestoned\Issue;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssuesDemilestoned\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssuesDemilestoned\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
