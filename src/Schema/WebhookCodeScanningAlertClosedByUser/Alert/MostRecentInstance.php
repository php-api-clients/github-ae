...
final readonly class MostRecentInstance
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('analysis_key')] public string $analysisKey, public ?string $category, public ?array $classifications, #[\EventSauce\ObjectHydrator\MapFrom('commit_sha')] public ?string $commitSha, public string $environment, public ?Schema\WebhookCodeScanningAlertClosedByUser\Alert\MostRecentInstance\Location $location, public ?Schema\WebhookCodeScanningAlertClosedByUser\Alert\MostRecentInstance\Message $message, public string $ref, public string $state)
    {
    }
}
