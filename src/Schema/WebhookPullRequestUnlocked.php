...
final readonly class WebhookPullRequestUnlocked
{
    ...
    public const SCHEMA_TITLE        = 'pull_request unlocked event';
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimple|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestUnlocked\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
