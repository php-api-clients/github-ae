...
final readonly class WebhookDiscussionEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookDiscussionEdited\Changes|null $changes, public Schema\Discussion $discussion, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
