...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewSubmitted\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links\Statuses $statuses)
    {
    }
}
