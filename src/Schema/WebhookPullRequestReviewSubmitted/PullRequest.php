...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewSubmitted;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestReviewSubmitted\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Base $base, public string|null $body, #[MapFrom('closed_at')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public string|null $mergedAt, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestReviewSubmitted\PullRequest\User|null $user,)
    {
    }
}
