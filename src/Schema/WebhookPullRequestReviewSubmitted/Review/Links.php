...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewSubmitted\Review;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewSubmitted\Review\Links\Html $html, #[\EventSauce\ObjectHydrator\MapFrom('pull_request')] public Schema\WebhookPullRequestReviewSubmitted\Review\Links\PullRequest $pullRequest)
    {
    }
}
