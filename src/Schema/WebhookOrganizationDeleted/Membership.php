...
final readonly class Membership
{
    ...
    public function __construct(#[MapFrom('organization_url')] public string $organizationUrl, public string $role, public string $state, public string $url, public ?Schema\Discussion\AnswerChosenBy $user)
    {
    }
}
