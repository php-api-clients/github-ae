...
final readonly class Runner
{
     ...
     */
    public function __construct(public int $id, #[MapFrom('runner_group_id')] public ?int $runnerGroupId, public string $name, public string $os, public string $status, public bool $busy, #[CastListToType(Schema\RunnerLabel::class)] public array $labels)
    {
    }
}
