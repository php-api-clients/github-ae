...
final readonly class Runner
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":5,"name":"iMac","os":"macos","status":"online","busy":false,"labels":[{"id":13,"name":"generated_name_null","type":"generated_type_null"}]}';
    /**
     * id: The id of the runner.
     * name: The name of the runner.
     * os: The Operating System of the runner.
     * status: The status of the runner.
     * @param array<\ApiClients\Client\GitHubAE\Schema\RunnerLabel> $labels
     */
