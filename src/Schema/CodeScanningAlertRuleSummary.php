...
final readonly class CodeScanningAlertRuleSummary
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":"generated_id_null","name":"generated_name_null","severity":"generated_severity_null","description":"generated_description_null"}';
    /**
