...
final readonly class Steps
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"completedAt":"generated_completed_at_null","conclusion":"failure","name":"generated_name_null","number":13,"startedAt":"generated_started_at_null","status":"in_progress"}';
