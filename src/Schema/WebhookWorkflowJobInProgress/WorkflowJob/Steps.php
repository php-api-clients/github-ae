...
namespace ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob;
...
final readonly class Steps
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"completed_at":"generated_completed_at_null","conclusion":"generated_conclusion_null","name":"generated_name_null","number":13,"started_at":"generated_started_at_null","status":"generated_status_null"}';
