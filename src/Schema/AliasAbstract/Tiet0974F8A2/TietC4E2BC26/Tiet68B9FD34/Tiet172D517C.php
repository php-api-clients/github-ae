...
abstract readonly class Tiet172D517C
{
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base\Repo\Owner|null $owner, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
