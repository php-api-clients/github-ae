...
abstract readonly class Abstract559ae5a21a07006714156653d2e15261
{
    ...
    public function __construct(#[MapFrom('_PLUSES_1')] public int $pluses1, #[MapFrom('_MINUS_1')] public int $minus1, public int $confused, public int $eyes, public int $heart, public int $hooray, public int $laugh, public int $rocket, #[MapFrom('total_count')] public int $totalCount, public string $url)
    {
    }
}
