...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\TietB93BCA5E\TietE4DA40E4\Tiet6DC94A0B;

use ApiClients\Client\GitHubAE\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet72FA76AA
{
    ...
    public string|null $deploymentsUrl, public string $description, #[MapFrom('downloads_url')]
    ...
    public string|null $notificationsUrl, public Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner|null $owner, public bool|null $private, #[MapFrom('pulls_url')]
