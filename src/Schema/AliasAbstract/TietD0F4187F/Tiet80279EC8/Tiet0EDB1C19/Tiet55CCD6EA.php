...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\TietD0F4187F\Tiet80279EC8\Tiet0EDB1C19;
...
abstract readonly class Tiet55CCD6EA
{
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo\Owner|null $owner, public Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
