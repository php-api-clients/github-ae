...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\TietB05C64DE\Tiet4B78C5E2\TietABFD31AC;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet7CBAECD2
{
    public const SCHEMA_JSON         = '{"required":["id","name","status","conclusion","html_url","created_at","updated_at","environment"],"type":"object","properties":{"conclusion":{"type":["null"]},"created_at":{"type":"string"},"environment":{"type":"string"},"html_url":{"type":"string"},"id":{"type":"integer"},"name":{"type":["null"]},"status":{"type":"string"},"updated_at":{"type":"string"}}}';
