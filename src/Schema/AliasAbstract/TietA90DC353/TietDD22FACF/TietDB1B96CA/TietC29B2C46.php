...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\TietA90DC353\TietDD22FACF\TietDB1B96CA;
...
abstract readonly class TietC29B2C46
{
    ...
    public Schema\WebhookTeamAddedToRepository\Repository\CustomProperties|null $customProperties, #[MapFrom('default_branch')]
    ...
    public string $languagesUrl, public Schema\WebhookTeamAddedToRepository\Repository\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookTeamAddedToRepository\Repository\Owner|null $owner, public Schema\WebhookTeamAddedToRepository\Repository\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
