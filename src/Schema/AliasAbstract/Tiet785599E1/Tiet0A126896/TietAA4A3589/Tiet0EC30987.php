...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\Tiet785599E1\Tiet0A126896\TietAA4A3589;

use ApiClients\Client\GitHubAE\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet0EC30987
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"author_association":"OWNER","body":"generated","child_comment_count":19,"created_at":"generated","discussion_id":13,"html_url":"generated","id":2,"node_id":"generated","parent_id":9,"reactions":{"+1":11,"-1":10,"confused":8,"eyes":4,"heart":5,"hooray":6,"laugh":5,"rocket":6,"total_count":11,"url":"https:\\/\\/example.com\\/"},"repository_url":"generated","updated_at":"generated","user":{"avatar_url":"https:\\/\\/example.com\\/","deleted":false,"email":"generated","events_url":"generated","followers_url":"https:\\/\\/example.com\\/","following_url":"generated","gists_url":"generated","gravatar_id":"generated","html_url":"https:\\/\\/example.com\\/","id":2,"login":"generated","name":"generated","node_id":"generated","organizations_url":"https:\\/\\/example.com\\/","received_events_url":"https:\\/\\/example.com\\/","repos_url":"https:\\/\\/example.com\\/","site_admin":false,"starred_url":"generated","subscriptions_url":"https:\\/\\/example.com\\/","type":"Organization","url":"https:\\/\\/example.com\\/"}}';

    /**
     * authorAssociation: How the author is associated with the repository.
     */
    public function __construct(#[MapFrom('author_association')] public string $authorAssociation, public string $body, #[MapFrom('child_comment_count')] public int $childCommentCount, #[MapFrom('created_at')] public string $createdAt, #[MapFrom('discussion_id')] public int $discussionId, #[MapFrom('html_url')] public string $htmlUrl, public int $id, #[MapFrom('node_id')] public string $nodeId, #[MapFrom('parent_id')] public ?int $parentId, public Schema\WebhookDiscussionCommentCreated\Comment\Reactions $reactions, #[MapFrom('repository_url')] public string $repositoryUrl, #[MapFrom('updated_at')] public string $updatedAt, public ?Schema\WebhookDiscussionCommentCreated\Comment\User $user)
    {
    }
}
