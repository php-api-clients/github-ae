...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\Tiet78A1ED87\Tiet350943AE\TietDA8047D8;
...
abstract readonly class Tiet006E988E
{
     ...
     * useSquashPrTitleAsDefault: Whether a squash merge commit can use the pull request title as default.
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestDemilestoned\PullRequest\Base\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestDemilestoned\PullRequest\Base\Repo\Owner|null $owner, public Schema\WebhookPullRequestDemilestoned\PullRequest\Base\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
