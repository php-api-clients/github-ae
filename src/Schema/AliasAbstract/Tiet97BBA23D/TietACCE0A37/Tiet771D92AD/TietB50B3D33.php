...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\Tiet97BBA23D\TietACCE0A37\Tiet771D92AD;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietB50B3D33
{
    ...
    public string|null $htmlUrl, public int|null $id, public string|null $login, public string|null $name, #[MapFrom('node_id')]
