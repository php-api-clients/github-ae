...
namespace ApiClients\Client\GitHubAE\Schema\AliasAbstract\Tiet067B84F7\TietD0AA2418\Tiet59585D81;
...
abstract readonly class TietA391DB12
{
    ...
    public string $aboutUrl, public string $name, public string $type, public string $url, public string $vendor,)
    {
    }
}
