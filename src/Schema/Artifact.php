...
final readonly class Artifact
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":5,"nodeId":"MDEwOkNoZWNrU3VpdGU1","name":"AdventureWorks.Framework","sizeInBytes":12345,"url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/actions\\/artifacts\\/5","archiveDownloadUrl":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/actions\\/artifacts\\/5\\/zip","expired":false,"createdAt":"1970-01-01T00:00:00+00:00","expiresAt":"1970-01-01T00:00:00+00:00","updatedAt":"1970-01-01T00:00:00+00:00","workflowRun":{"id":10,"repositoryId":42,"headRepositoryId":42,"headBranch":"main","headSha":"009b8a3a9ccbb128af87f9b1c0f4c62e8a304f6d"}}';
    /**
     * name: The name of the artifact.
     * sizeInBytes: The size in bytes of the artifact.
     * expired: Whether or not the artifact has expired.
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('size_in_bytes')] public int $sizeInBytes, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('archive_download_url')] public string $archiveDownloadUrl, public bool $expired, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('expires_at')] public ?string $expiresAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('workflow_run')] public ?Schema\Artifact\WorkflowRun $workflowRun)
    {
    }
}
