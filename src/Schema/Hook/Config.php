...
final readonly class Config
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"email":"\\"foo@bar.com\\"","password":"\\"foo\\"","room":"\\"roomer\\"","subdomain":"\\"foo\\"","url":"https:\\/\\/example.com\\/webhook","insecure_ssl":"generated_insecure_ssl","content_type":"\\"json\\"","digest":"\\"sha256\\"","secret":"\\"********\\"","token":"\\"abc\\""}';
    /**
     ...
     */
    public function __construct(public ?string $email, public ?string $password, public ?string $room, public ?string $subdomain, public ?string $url, public ?string $insecure_ssl, public ?string $content_type, public ?string $digest, public ?string $secret, public ?string $token)
    {
    }
}
