...
final readonly class Config
{
     ...
     */
    public function __construct(public ?string $email, public ?string $password, public ?string $room, public ?string $subdomain, public ?string $url, #[MapFrom('insecure_ssl')] public ?string $insecureSsl, #[MapFrom('content_type')] public ?string $contentType, public ?string $digest, public ?string $secret, public ?string $token)
    {
    }
}
