...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPackageUpdated\Package\PackageVersion;
...
final readonly class Release
{
    ...
    public function __construct(public ?Schema\WebhookPackageUpdated\Package\PackageVersion\Release\Author $author, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public bool $draft, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public int $id, public string $name, public bool $prerelease, #[\EventSauce\ObjectHydrator\MapFrom('published_at')] public string $publishedAt, #[\EventSauce\ObjectHydrator\MapFrom('tag_name')] public string $tagName, #[\EventSauce\ObjectHydrator\MapFrom('target_commitish')] public string $targetCommitish, public string $url)
    {
    }
}
