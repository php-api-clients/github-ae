...
final readonly class WebhookProjectCardMoved
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectCardMoved\Changes|null $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, #[MapFrom('project_card')]
    public Schema\WebhookProjectCardMoved\ProjectCard $projectCard, public Schema\Repository|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
