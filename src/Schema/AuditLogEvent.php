...
final readonly class AuditLogEvent
{
     ...
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\AuditLogEvent\Config> $config
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\AuditLogEvent\Config> $config_was
     ...
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\AuditLogEvent\Config> $events
     * @param ?array<\ApiClients\Client\GitHubAE\Schema\AuditLogEvent\Config> $events_were
     ...
     */
    public function __construct(public ?int $_AT_timestamp, public ?string $action, public ?bool $active, public ?bool $active_was, public ?string $actor, public ?int $actor_id, public ?Schema\AuditLogEvent\ActorLocation $actor_location, public mixed $data, public ?int $org_id, public ?int $user_id, public ?int $business_id, public ?string $blocked_user, public ?string $business, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\AuditLogEvent\Config::class)] public ?array $config, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\AuditLogEvent\Config::class)] public ?array $config_was, public ?string $content_type, public ?string $operation_type, public ?int $created_at, public ?string $deploy_key_fingerprint, public ?string $_document_id, public ?string $emoji, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\AuditLogEvent\Config::class)] public ?array $events, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\AuditLogEvent\Config::class)] public ?array $events_were, public ?string $explanation, public ?string $fingerprint, public ?int $hook_id, public ?bool $limited_availability, public ?string $message, public ?string $name, public ?string $old_user, public ?string $openssh_public_key, public ?string $org, public ?string $previous_visibility, public ?bool $read_only, public ?string $repo, public ?string $repository, public ?bool $repository_public, public ?string $target_login, public ?string $team, public ?int $transport_protocol, public ?string $transport_protocol_name, public ?string $user, public ?string $visibility)
    {
    }
}
