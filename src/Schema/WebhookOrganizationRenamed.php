...
final readonly class WebhookOrganizationRenamed
{
    ...
    public const SCHEMA_TITLE        = 'organization renamed event';
     ...
     */
    public function __construct(public string $action, public Schema\WebhookOrganizationRenamed\Changes|null $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookOrganizationRenamed\Membership|null $membership, public Schema\OrganizationSimpleWebhooks $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
