...
namespace ApiClients\Client\GitHubAE\Schema\PullRequestSimple;
...
final readonly class Links
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"comments":{"href":"generated_href_null"},"commits":{"href":"generated_href_null"},"statuses":{"href":"generated_href_null"},"html":{"href":"generated_href_null"},"issue":{"href":"generated_href_null"},"reviewComments":{"href":"generated_href_null"},"reviewComment":{"href":"generated_href_null"},"self":{"href":"generated_href_null"}}';
    /**
     ...
     */
    public function __construct(public Schema\Link $comments, public Schema\Link $commits, public Schema\Link $statuses, public Schema\Link $html, public Schema\Link $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\Link $reviewComments, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\Link $reviewComment, public Schema\Link $self)
    {
    }
}
