...
final readonly class WebhookProjectCardConverted
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectCardConverted\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_card')]
