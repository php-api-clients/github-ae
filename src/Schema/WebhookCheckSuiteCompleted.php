...
final readonly class WebhookCheckSuiteCompleted
{
    ...
    public const SCHEMA_TITLE        = 'check_suite completed event';
    ...
    public Schema\WebhookCheckSuiteCompleted\CheckSuite $checkSuite, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
