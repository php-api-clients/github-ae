...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\DeploymentStatus;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
