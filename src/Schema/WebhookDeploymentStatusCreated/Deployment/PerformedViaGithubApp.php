...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
