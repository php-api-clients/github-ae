...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests;
...
final readonly class Base
{
    ...
    public function __construct(public string $ref, public Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo $repo, public string $sha)
    {
    }
}
