...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun;
...
final readonly class PullRequests
{
    ...
    public function __construct(public Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base $base, public Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head $head, public int $id, public int $number, public string $url)
    {
    }
}
