...
final readonly class WebhookWorkflowJobQueued
{
    ...
    public const SCHEMA_TITLE        = 'workflow_job queued event';
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender, #[MapFrom('workflow_job')]
    public Schema\WebhookWorkflowJobQueued\WorkflowJob $workflowJob, public Schema\Deployment|null $deployment,)
    {
    }
}
