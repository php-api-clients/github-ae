...
final readonly class WebhookFork
{
     ...
     * forkee: The created [`repository`](https://docs.github.com/github-ae@latest/rest/repos/repos#get-a-repository) resource.
     ...
     */
    public function __construct(public Schema\EnterpriseWebhooks|null $enterprise, public Schema\WebhookFork\Forkee $forkee, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
