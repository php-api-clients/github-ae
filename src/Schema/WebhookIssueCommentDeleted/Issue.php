...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssueCommentDeleted;
...
final readonly class Issue
{
    ...
    public string|null $activeLockReason, public Schema\WebhookIssueCommentDeleted\Issue\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    ...
    public string $labelsUrl, public bool|null $locked, public Schema\WebhookIssueCommentDeleted\Issue\Milestone|null $milestone, #[MapFrom('node_id')]
    public string $nodeId, public int $number, #[MapFrom('performed_via_github_app')]
    public Schema\WebhookIssueCommentDeleted\Issue\PerformedViaGithubApp|null $performedViaGithubApp, #[MapFrom('pull_request')]
    public Schema\WebhookIssueCommentDeleted\Issue\PullRequest|null $pullRequest, public Schema\WebhookIssueCommentDeleted\Issue\Reactions $reactions, #[MapFrom('repository_url')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookIssueCommentDeleted\Issue\User|null $user,)
    {
    }
}
