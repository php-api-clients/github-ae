...
use ApiClients\Client\GitHubAE\Attribute\CastUnionToType\Schema\SecretScanningLocation\Details;
...
final readonly class SecretScanningLocation
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"commit","details":null}';
