...
final readonly class WebhookPullRequestReviewThreadUnresolved
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser|null $sender, public Schema\WebhookPullRequestReviewThreadUnresolved\Thread $thread,)
    {
    }
}
