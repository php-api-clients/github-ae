...
final readonly class WebhookDeploymentStatusCreated
{
    ...
    "properties": {
        ...
        "deployment_status": {
            ...
            "description": "The [deployment status](https:\\/\\/docs.github.com\\/github-ae@latest\\/rest\\/deployments\\/statuses#list-deployment-statuses)."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
     ...
     * deploymentStatus: The [deployment status](https://docs.github.com/github-ae@latest/rest/deployments/statuses#list-deployment-statuses).
