...
final readonly class RepositorySubscription
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"subscribed":true,"ignored":false,"reason":"generated","created_at":"2012-10-06T21:34:12Z","url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/example\\/subscription","repository_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/example"}';
     ...
     */
    public function __construct(public bool $subscribed, public bool $ignored, public ?string $reason, #[MapFrom('created_at')] public string $createdAt, public string $url, #[MapFrom('repository_url')] public string $repositoryUrl)
    {
    }
}
