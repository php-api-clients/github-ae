...
use ApiClients\Client\GitHubAE\Schema\ExternalGroups\Groups;
...
final readonly class ExternalGroups
{
     ...
     */
    public function __construct(#[CastListToType(Schema\ExternalGroups\Groups::class)] public ?array $groups)
    {
    }
}
