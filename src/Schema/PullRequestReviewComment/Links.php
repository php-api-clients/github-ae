...
final readonly class Links
{
    ...
    public function __construct(public Schema\PullRequestReviewComment\Links\Self_ $self, public Schema\PullRequestReviewComment\Links\Html $html, #[MapFrom('pull_request')] public Schema\PullRequestReviewComment\Links\PullRequest $pullRequest)
    {
    }
}
