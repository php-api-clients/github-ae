...
final readonly class Resources
{
    ...
    public function __construct(public Schema\RateLimit $core, public ?Schema\RateLimit $graphql, public Schema\RateLimit $search, #[MapFrom('code_search')] public ?Schema\RateLimit $codeSearch, #[MapFrom('source_import')] public ?Schema\RateLimit $sourceImport, #[MapFrom('integration_manifest')] public ?Schema\RateLimit $integrationManifest, #[MapFrom('code_scanning_upload')] public ?Schema\RateLimit $codeScanningUpload, #[MapFrom('actions_runner_registration')] public ?Schema\RateLimit $actionsRunnerRegistration, public ?Schema\RateLimit $scim)
    {
    }
}
