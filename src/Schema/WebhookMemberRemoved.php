...
final readonly class WebhookMemberRemoved
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookMemberRemoved\Member|null $member, public Schema\OrganizationSimple|null $organization, public Schema\Repository $repository, public Schema\SimpleUser $sender)
    {
    }
}
