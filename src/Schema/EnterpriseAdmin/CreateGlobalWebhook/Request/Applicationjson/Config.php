...
final readonly class Config
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"generated_url_null","contentType":"generated_content_type_null","secret":"generated_secret_null","insecureSsl":"generated_insecure_ssl_null"}';
    /**
