...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"generated_name_null","config":{"url":"generated_url_null","contentType":"generated_content_type_null","secret":"generated_secret_null","insecureSsl":"generated_insecure_ssl_null"},"events":["generated_events_null"],"active":false}';
    /**
