...
final readonly class Changes
{
    ...
    public function __construct(public ?Schema\WebhookLabelEdited\Changes\Description $description, public ?Schema\WebhookLabelEdited\Changes\Name $name, public ?Schema\WebhookTeamEdited\Changes\Privacy $privacy, #[MapFrom('notification_setting')] public ?Schema\WebhookTeamEdited\Changes\NotificationSetting $notificationSetting, public ?Schema\WebhookTeamEdited\Changes\Repository $repository)
    {
    }
}
