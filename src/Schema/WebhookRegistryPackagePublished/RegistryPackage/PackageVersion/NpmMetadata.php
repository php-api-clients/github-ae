...
final readonly class NpmMetadata
{
     ...
     */
    public function __construct(public ?string $name, public ?string $version, #[MapFrom('npm_user')] public ?string $npmUser, public ?string $author, public ?string $bugs, public mixed $dependencies, #[MapFrom('dev_dependencies')] public mixed $devDependencies, #[MapFrom('peer_dependencies')] public mixed $peerDependencies, #[MapFrom('optional_dependencies')] public mixed $optionalDependencies, public ?string $description, public ?string $dist, #[MapFrom('git_head')] public ?string $gitHead, public ?string $homepage, public ?string $license, public ?string $main, public ?string $repository, public mixed $scripts, public ?string $id, #[MapFrom('node_version')] public ?string $nodeVersion, #[MapFrom('npm_version')] public ?string $npmVersion, #[MapFrom('has_shrinkwrap')] public ?bool $hasShrinkwrap, public ?array $maintainers, public ?array $contributors, public mixed $engines, public ?array $keywords, public ?array $files, public mixed $bin, public mixed $man, public ?string $directories, public ?array $os, public ?array $cpu, public ?string $readme, #[MapFrom('installation_command')] public ?string $installationCommand, #[MapFrom('release_id')] public ?int $releaseId, #[MapFrom('commit_oid')] public ?string $commitOid, #[MapFrom('published_via_actions')] public ?bool $publishedViaActions, #[MapFrom('deleted_by_id')] public ?int $deletedById)
    {
    }
}
