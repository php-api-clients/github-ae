...
final readonly class WebhookRegistryPackageUpdated
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('registry_package')]
    public Schema\WebhookRegistryPackageUpdated\RegistryPackage $registryPackage, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
