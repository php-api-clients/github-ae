...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"repositories":["generated_repositories_null"],"lockRepositories":true,"excludeMetadata":false,"excludeGitData":false,"excludeAttachments":true,"excludeReleases":true,"excludeOwnerProjects":true,"orgMetadataOnly":true,"exclude":["generated_exclude_null"]}';
    /**
