...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"lockRepositories":true,"excludeMetadata":true,"excludeGitData":true,"excludeAttachments":true,"excludeReleases":true,"excludeOwnerProjects":true,"orgMetadataOnly":true,"exclude":["repositories"],"repositories":["generated_repositories_null"]}';
    /**
