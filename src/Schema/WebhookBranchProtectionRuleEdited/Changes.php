...
namespace ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited;
...
final readonly class Changes
{
    ...
    public function __construct(#[MapFrom('admin_enforced')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\AdminEnforced $adminEnforced, #[MapFrom('authorized_actor_names')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorNames $authorizedActorNames, #[MapFrom('authorized_actors_only')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\AdminEnforced $authorizedActorsOnly, #[MapFrom('authorized_dismissal_actors_only')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\AdminEnforced $authorizedDismissalActorsOnly, #[MapFrom('linear_history_requirement_enforcement_level')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\LinearHistoryRequirementEnforcementLevel $linearHistoryRequirementEnforcementLevel, #[MapFrom('required_status_checks')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorNames $requiredStatusChecks, #[MapFrom('required_status_checks_enforcement_level')] public ?Schema\WebhookBranchProtectionRuleEdited\Changes\LinearHistoryRequirementEnforcementLevel $requiredStatusChecksEnforcementLevel)
    {
    }
}
