...
final readonly class Changes
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"admin_enforced":{"from":false},"authorized_actor_names":{"from":["generated_from_null"]},"authorized_actors_only":{"from":false},"authorized_dismissal_actors_only":{"from":false},"linear_history_requirement_enforcement_level":{"from":"generated_from_null"},"required_status_checks":{"from":["generated_from_null"]},"required_status_checks_enforcement_level":{"from":"generated_from_null"}}';
