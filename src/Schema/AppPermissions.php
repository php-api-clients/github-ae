...
final readonly class AppPermissions
{
    ...
    public string|null $organizationAdministration, #[MapFrom('organization_copilot_seat_management')]
    public string|null $organizationCopilotSeatManagement, #[MapFrom('organization_events')]
