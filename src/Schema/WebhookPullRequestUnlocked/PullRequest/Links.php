...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnlocked\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Html $html, public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestUnlocked\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestUnlocked\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestUnlocked\PullRequest\Links\Statuses $statuses)
    {
    }
}
