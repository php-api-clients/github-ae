...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestUnlocked;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestUnlocked\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestUnlocked\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestUnlocked\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestUnlocked\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestUnlocked\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestUnlocked\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestUnlocked\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestUnlocked\PullRequest\User|null $user,)
    {
    }
}
