...
namespace ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled;
...
final readonly class Label
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"color":"generated_color_null","default":false,"description":"generated_description_null","id":13,"name":"generated_name_null","nodeId":"generated_node_id_null","url":"https:\\/\\/example.com\\/"}';
    /**
