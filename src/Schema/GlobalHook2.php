...
final readonly class GlobalHook2
{
    ...
    public function __construct(public string|null $type, public int|null $id, public string|null $name, public bool|null $active, public array|null $events, public Schema\GlobalHook2\Config|null $config, #[MapFrom('updated_at')]
