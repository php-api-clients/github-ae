...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPageBuild;
...
final readonly class Build
{
    ...
    public function __construct(public ?string $commit, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public int $duration, public Schema\WebhookPageBuild\Build\Error $error, public ?Schema\WebhookPageBuild\Build\Pusher $pusher, public string $status, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public string $url)
    {
    }
}
