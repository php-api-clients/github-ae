...
final readonly class Page
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/pages","status":"built","cname":"example.com","protectedDomainState":"pending","pendingDomainUnverifiedAt":"1970-01-01T00:00:00+00:00","custom404":false,"htmlUrl":"https:\\/\\/example.com","buildType":"legacy","source":{"branch":"generated_branch_null","path":"generated_path_null"},"public":true,"httpsCertificate":{"state":"approved","description":"Certificate is approved","domains":["example.com"],"expiresAt":"generated_expires_at_date"},"httpsEnforced":true}';
    /**
     ...
     */
    public function __construct(public string $url, public ?string $status, public ?string $cname, #[\EventSauce\ObjectHydrator\MapFrom('protected_domain_state')] public ?string $protectedDomainState, #[\EventSauce\ObjectHydrator\MapFrom('pending_domain_unverified_at')] public ?string $pendingDomainUnverifiedAt, #[\EventSauce\ObjectHydrator\MapFrom('custom_404')] public bool $custom404, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('build_type')] public ?string $buildType, public ?Schema\PagesSourceHash $source, public bool $public, #[\EventSauce\ObjectHydrator\MapFrom('https_certificate')] public ?Schema\PagesHttpsCertificate $httpsCertificate, #[\EventSauce\ObjectHydrator\MapFrom('https_enforced')] public ?bool $httpsEnforced)
    {
    }
}
