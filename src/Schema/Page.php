...
final readonly class Page
{
     ...
     */
    public function __construct(public string $url, public ?string $status, public ?string $cname, #[MapFrom('protected_domain_state')] public ?string $protectedDomainState, #[MapFrom('pending_domain_unverified_at')] public ?string $pendingDomainUnverifiedAt, #[MapFrom('custom_404')] public bool $custom404, #[MapFrom('html_url')] public ?string $htmlUrl, #[MapFrom('build_type')] public ?string $buildType, public ?Schema\PagesSourceHash $source, public bool $public, #[MapFrom('https_certificate')] public ?Schema\PagesHttpsCertificate $httpsCertificate, #[MapFrom('https_enforced')] public ?bool $httpsEnforced)
    {
    }
}
