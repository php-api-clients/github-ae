...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest\Links\Statuses $statuses)
    {
    }
}
