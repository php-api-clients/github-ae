...
final readonly class AutoMerge
{
     ...
     */
    public function __construct(#[MapFrom('commit_message')] public ?string $commitMessage, #[MapFrom('commit_title')] public string $commitTitle, #[MapFrom('enabled_by')] public ?Schema\Discussion\AnswerChosenBy $enabledBy, #[MapFrom('merge_method')] public string $mergeMethod)
    {
    }
}
