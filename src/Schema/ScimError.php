...
final readonly class ScimError
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"message":"generated_message_null","documentationUrl":"generated_documentation_url_null","detail":"generated_detail_null","status":13,"scimType":"generated_scimType_null","schemas":["generated_schemas_null"]}';
    /**
