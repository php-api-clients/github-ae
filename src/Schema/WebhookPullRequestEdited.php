...
final readonly class WebhookPullRequestEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimple|null $organization, #[MapFrom('pull_request')]
    public Schema\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
