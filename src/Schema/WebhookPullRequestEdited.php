...
final readonly class WebhookPullRequestEdited
{
    ...
    public const SCHEMA_TITLE        = 'pull_request edited event';
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestEdited\Changes $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
