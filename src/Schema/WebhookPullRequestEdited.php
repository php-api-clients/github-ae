...
final readonly class WebhookPullRequestEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookPullRequestEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
