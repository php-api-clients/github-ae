...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewThreadResolved\Thread\Comments;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewThreadResolved\Thread\Comments\Links\Html $html, #[\EventSauce\ObjectHydrator\MapFrom('pull_request')] public Schema\WebhookPullRequestReviewThreadResolved\Thread\Comments\Links\PullRequest $pullRequest, public Schema\WebhookPullRequestReviewThreadResolved\Thread\Comments\Links\Self_ $self)
    {
    }
}
