...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewThreadResolved\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links\Statuses $statuses)
    {
    }
}
