...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base $base, public string|null $body, #[MapFrom('closed_at')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public string|null $mergedAt, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestReviewThreadResolved\PullRequest\User|null $user,)
    {
    }
}
