...
final readonly class WebhookRepositoryEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookRepositoryEdited\Changes $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
