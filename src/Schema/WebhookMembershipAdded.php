...
final readonly class WebhookMembershipAdded
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookMembershipAdded\Member|null $member, public Schema\OrganizationSimpleWebhooks $organization, public Schema\RepositoryWebhooks|null $repository, public string $scope, public Schema\WebhookMembershipAdded\Sender|null $sender, public Schema\WebhookMembershipAdded\Team $team)
    {
    }
}
