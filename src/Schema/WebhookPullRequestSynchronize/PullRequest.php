...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestSynchronize;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestSynchronize\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestSynchronize\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestSynchronize\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestSynchronize\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestSynchronize\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestSynchronize\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestSynchronize\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestSynchronize\PullRequest\User|null $user,)
    {
    }
}
