...
final readonly class Repo
{
    ...
    public bool|null $isTemplate, #[MapFrom('node_id')]
    ...
    public string $notificationsUrl, public Schema\PullRequest\Base\Repo\Owner $owner, public bool $private, #[MapFrom('pulls_url')]
    ...
    public bool $hasPages, #[MapFrom('has_discussions')]
    public bool $hasDiscussions, public string|null $homepage, public string|null $language, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public Schema\PullRequest\Base\Repo\Permissions|null $permissions, #[MapFrom('temp_clone_token')]
    ...
    public bool|null $allowRebaseMerge, public Schema\LicenseSimple|null $license, #[MapFrom('pushed_at')]
