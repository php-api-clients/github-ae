...
final readonly class Head
{
    ...
    public function __construct(public string $label, public string $ref, public Schema\PullRequest\Head\Repo|null $repo, public string $sha, public Schema\PullRequest\Head\User $user)
    {
    }
}
