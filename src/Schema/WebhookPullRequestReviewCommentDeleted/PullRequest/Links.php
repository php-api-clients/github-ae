...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest;
...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Html $html, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links\Statuses $statuses)
    {
    }
}
