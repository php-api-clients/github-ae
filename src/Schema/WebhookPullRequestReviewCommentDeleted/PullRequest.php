...
namespace ApiClients\Client\GitHubAE\Schema\WebhookPullRequestReviewCommentDeleted;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Base $base, public string|null $body, #[MapFrom('closed_at')]
    ...
    public string $diffUrl, public bool|null $draft, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public string|null $mergedAt, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\User|null $user,)
    {
    }
}
