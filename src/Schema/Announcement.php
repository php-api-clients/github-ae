...
final readonly class Announcement
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"announcement":"Very **important** announcement about _something_.","expiresAt":"\\"2021-01-01T00:00:00.000-07:00\\""}';
    /**
     ...
     */
    public function __construct(public ?string $announcement, #[\EventSauce\ObjectHydrator\MapFrom('expires_at')] public ?string $expiresAt)
    {
    }
}
