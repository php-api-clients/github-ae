...
final readonly class WebhookTeamEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookTeamEdited\Changes $changes, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, public Schema\WebhookTeamEdited\Repository|null $repository, public Schema\SimpleUserWebhooks $sender, public Schema\WebhookTeamEdited\Team $team)
    {
    }
}
