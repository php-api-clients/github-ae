...
namespace ApiClients\Client\GitHubAE\Schema\WebhookIssuesClosed\Issue;
...
final readonly class PerformedViaGithubApp
{
    ...
    public string $nodeId, public Schema\WebhookIssuesClosed\Issue\PerformedViaGithubApp\Owner|null $owner, public Schema\WebhookIssuesClosed\Issue\PerformedViaGithubApp\Permissions|null $permissions, public string|null $slug, #[MapFrom('updated_at')]
