...
final readonly class WebhookPullRequestReviewThreadResolved
{
    ...
    public Schema\WebhookPullRequestReviewThreadResolved\PullRequest $pullRequest, public Schema\Repository $repository, public Schema\SimpleUser|null $sender, public Schema\WebhookPullRequestReviewThreadResolved\Thread $thread,)
    {
    }
}
