...
namespace ApiClients\Client\GitHubAE\Schema\WebhookMergeGroupChecksRequested\MergeGroup;
...
final readonly class HeadCommit
{
     ...
     */
    public function __construct(public Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Author $author, public Schema\WebhookMergeGroupChecksRequested\MergeGroup\HeadCommit\Committer $committer, public string $id, public string $message, public string $timestamp, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId)
    {
    }
}
