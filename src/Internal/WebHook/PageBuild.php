...
/** @internal */
final class PageBuild implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\PageBuild $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookPageBuild
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookPageBuild::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
