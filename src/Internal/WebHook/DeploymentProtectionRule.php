...
/** @internal */
final class DeploymentProtectionRule implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\DeploymentProtectionRule $hydrator)
    {
    }

    public function resolve(array $headers, array $data): Schema\WebhookDeploymentProtectionRuleRequested
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookDeploymentProtectionRuleRequested::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));

                return $this->hydrator->hydrateObject(Schema\WebhookDeploymentProtectionRuleRequested::class, $data);
            } catch (Throwable) {
                goto actions_aaaaa;
            }
        }
