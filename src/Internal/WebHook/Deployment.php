...
/** @internal */
final class Deployment implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Deployment $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookDeploymentCreated
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookDeploymentCreated::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
