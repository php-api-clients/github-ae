...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\GithubAppAuthorization $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookGithubAppAuthorizationRevoked
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookGithubAppAuthorizationRevoked::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
