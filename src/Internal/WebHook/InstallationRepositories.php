...
/** @internal */
final class InstallationRepositories implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\InstallationRepositories $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookInstallationRepositoriesAdded|Schema\WebhookInstallationRepositoriesRemoved
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookInstallationRepositoriesAdded::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], Reader::readFromJson(Schema\WebHookHeader\XGitHubDelivery::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], Reader::readFromJson(Schema\WebHookHeader\XHubSignature::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookInstallationRepositoriesRemoved::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
