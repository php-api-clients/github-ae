...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Create $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookCreate
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookCreate::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
