...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Delete $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookDelete
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookDelete::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
