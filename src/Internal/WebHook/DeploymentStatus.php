...
/** @internal */
final class DeploymentStatus implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\DeploymentStatus $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookDeploymentStatusCreated
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookDeploymentStatusCreated::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
