...
/** @internal */
final class Public_ implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Public_ $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookPublic
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookPublic::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
