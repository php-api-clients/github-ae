...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Gollum $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookGollum
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookGollum::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
