...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\TeamAdd $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookTeamAdd
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookTeamAdd::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
