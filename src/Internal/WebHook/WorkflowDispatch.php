...
/** @internal */
final class WorkflowDispatch implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\WorkflowDispatch $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookWorkflowDispatch
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookWorkflowDispatch::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
