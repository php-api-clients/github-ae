...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Package $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookPackagePublished|Schema\WebhookPackageUpdated
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookPackagePublished::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], Reader::readFromJson(Schema\WebHookHeader\XGitHubDelivery::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], Reader::readFromJson(Schema\WebHookHeader\XHubSignature::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookPackageUpdated::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
