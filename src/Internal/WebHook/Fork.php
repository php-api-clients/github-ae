...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Fork $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookFork
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookFork::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
