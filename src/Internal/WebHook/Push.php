...
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Push $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookPush
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookPush::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
