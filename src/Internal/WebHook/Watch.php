...
/** @internal */
final class Watch implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Watch $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookWatchStarted
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookWatchStarted::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
