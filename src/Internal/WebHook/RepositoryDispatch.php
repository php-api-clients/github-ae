...
/** @internal */
final class RepositoryDispatch implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\RepositoryDispatch $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookRepositoryDispatchSample
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookRepositoryDispatchSample::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
