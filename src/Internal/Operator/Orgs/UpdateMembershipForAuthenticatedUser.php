...
final readonly class UpdateMembershipForAuthenticatedUser
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\User\Memberships\Orgs\Org $hydrator)
    {
    }

    /** @return */
    public function call(string $org, array $params): OrgMembership
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\UpdateMembershipForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
