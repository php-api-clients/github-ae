...
final readonly class ListMembersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\ListMembersListing($this->responseSchemaValidator, $this->hydrator, $org, $filter, $role, $perPage, $page);
