...
final readonly class ListForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\ListForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
