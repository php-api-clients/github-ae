...
final readonly class ListMembershipsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\ListMembershipsForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $state, $perPage, $page);
