...
final readonly class ListOutsideCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\ListOutsideCollaborators($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
