...
final readonly class MarkNotificationsAsRead
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Activity\MarkNotificationsAsRead($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
