...
final readonly class ListAnnotationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Checks\ListAnnotationsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId, $perPage, $page);
