...
final readonly class RerequestRun
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\CheckRuns\CheckRunId\Rerequest $hydrator)
    {
    }

    /** @return */
    public function call(string $owner, string $repo, int $checkRunId): EmptyObject|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Checks\RerequestRun($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId);
