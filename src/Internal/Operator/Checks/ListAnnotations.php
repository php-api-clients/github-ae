...
final readonly class ListAnnotations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Checks\ListAnnotations($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId, $perPage, $page);
