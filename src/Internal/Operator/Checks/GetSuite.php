...
final readonly class GetSuite
{
    ...
    public function call(string $owner, string $repo, int $checkSuiteId): CheckSuite
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Checks\GetSuite($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkSuiteId);
