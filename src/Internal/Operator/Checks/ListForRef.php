...
final readonly class ListForRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Checks\ListForRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $checkName, $status, $appId, $filter, $perPage, $page);
