...
final readonly class GetRef
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Ref\Ref $hydrator)
    {
    }

    /** @return */
    public function call(string $owner, string $repo, string $ref): GitRef|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Git\GetRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref);
