...
final readonly class CreateBlob
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Git\CreateBlob($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
