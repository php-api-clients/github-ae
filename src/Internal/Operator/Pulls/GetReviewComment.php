...
final readonly class GetReviewComment
{
    ...
    /** @return */
    public function call(string $owner, string $repo, int $commentId): PullRequestReviewComment|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\GetReviewComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
