...
final readonly class ListListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\ListListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $head, $base, $direction, $state, $sort, $perPage, $page);
