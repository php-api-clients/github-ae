...
final readonly class List_
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\List_($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $head, $base, $direction, $state, $sort, $perPage, $page);
