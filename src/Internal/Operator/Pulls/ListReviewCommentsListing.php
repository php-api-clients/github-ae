...
final readonly class ListReviewCommentsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\ListReviewCommentsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $direction, $since, $sort, $perPage, $page);
