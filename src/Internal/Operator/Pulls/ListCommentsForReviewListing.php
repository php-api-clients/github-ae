...
final readonly class ListCommentsForReviewListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\ListCommentsForReviewListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $reviewId, $perPage, $page);
