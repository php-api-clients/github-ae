...
final readonly class ListFilesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\ListFilesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
