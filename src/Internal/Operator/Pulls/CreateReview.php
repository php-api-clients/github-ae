...
final readonly class CreateReview
{
    ...
    public function call(string $owner, string $repo, int $pullNumber, array $params): PullRequestReview
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Pulls\CreateReview($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
