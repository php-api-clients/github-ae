...
final readonly class MoveColumn
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\MoveColumn($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $columnId);
