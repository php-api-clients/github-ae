...
final readonly class AddCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\AddCollaborator($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $projectId, $username);
