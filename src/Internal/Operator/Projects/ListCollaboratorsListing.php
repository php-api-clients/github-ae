...
final readonly class ListCollaboratorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListCollaboratorsListing($this->responseSchemaValidator, $this->hydrator, $projectId, $affiliation, $perPage, $page);
