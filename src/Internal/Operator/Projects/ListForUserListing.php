...
final readonly class ListForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $state, $perPage, $page);
