...
final readonly class GetPermissionForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\GetPermissionForUser($this->responseSchemaValidator, $this->hydrator, $projectId, $username);
