...
final readonly class ListForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListForUser($this->responseSchemaValidator, $this->hydrator, $username, $state, $perPage, $page);
