...
final readonly class ListCards
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListCards($this->responseSchemaValidator, $this->hydrator, $columnId, $archivedState, $perPage, $page);
