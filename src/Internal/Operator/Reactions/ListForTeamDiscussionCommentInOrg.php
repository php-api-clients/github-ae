...
final readonly class ListForTeamDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\ListForTeamDiscussionCommentInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $commentNumber, $content, $perPage, $page);
