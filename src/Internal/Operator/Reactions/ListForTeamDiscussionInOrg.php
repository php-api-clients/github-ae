...
final readonly class ListForTeamDiscussionInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\ListForTeamDiscussionInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $content, $perPage, $page);
