...
final readonly class CreateForRelease
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\ReleaseId\Reactions $hydrator)
    {
    }

    /** @return Schema\Reaction */
    public function call(string $owner, string $repo, int $releaseId, array $params): Reaction|array
    {
