...
final readonly class ListForTeamDiscussionInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\ListForTeamDiscussionInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber, $content, $perPage, $page);
