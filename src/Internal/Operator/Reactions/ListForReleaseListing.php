...
final readonly class ListForReleaseListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\ListForReleaseListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId, $content, $perPage, $page);
