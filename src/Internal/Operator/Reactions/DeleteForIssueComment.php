...
final readonly class DeleteForIssueComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\DeleteForIssueComment($owner, $repo, $commentId, $reactionId);
