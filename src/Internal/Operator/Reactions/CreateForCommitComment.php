...
final readonly class CreateForCommitComment
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Comments\CommentId\Reactions $hydrator)
    {
    }

    public function call(string $owner, string $repo, int $commentId, array $params): Reaction
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\CreateForCommitComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
