...
final readonly class GetAllCommonlyUsedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Licenses\GetAllCommonlyUsedListing($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
