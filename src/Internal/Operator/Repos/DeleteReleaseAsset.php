...
final readonly class DeleteReleaseAsset
{
    ...
    public function call(string $owner, string $repo, int $assetId): array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\DeleteReleaseAsset($owner, $repo, $assetId);
