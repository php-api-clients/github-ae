...
final readonly class GetAdminBranchProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetAdminBranchProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
