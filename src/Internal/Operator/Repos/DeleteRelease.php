...
final readonly class DeleteRelease
{
    ...
    public function call(string $owner, string $repo, int $releaseId): WithoutBody
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\DeleteRelease($owner, $repo, $releaseId);
