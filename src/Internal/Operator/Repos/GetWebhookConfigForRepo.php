...
final readonly class GetWebhookConfigForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetWebhookConfigForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId);
