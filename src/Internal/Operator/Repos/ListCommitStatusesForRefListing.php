...
final readonly class ListCommitStatusesForRefListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListCommitStatusesForRefListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
