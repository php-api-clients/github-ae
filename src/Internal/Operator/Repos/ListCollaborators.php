...
final readonly class ListCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListCollaborators($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $permission, $affiliation, $perPage, $page);
