...
final readonly class DeleteCommitSignatureProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\DeleteCommitSignatureProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
