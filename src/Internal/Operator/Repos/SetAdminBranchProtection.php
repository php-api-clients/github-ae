...
final readonly class SetAdminBranchProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\SetAdminBranchProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
