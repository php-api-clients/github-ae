...
final readonly class ListForksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListForksListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sort, $perPage, $page);
