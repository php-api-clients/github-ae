...
final readonly class Update
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo $hydrator)
    {
    }

    /** @return Schema\FullRepository|Schema\BasicError */
    public function call(string $owner, string $repo, array $params): FullRepository|BasicError|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\Update($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
