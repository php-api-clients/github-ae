...
use ApiClients\Client\GitHubAE\Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json;
...
final readonly class GetContributorsStats
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetContributorsStats($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
