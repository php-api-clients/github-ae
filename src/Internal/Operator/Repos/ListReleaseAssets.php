...
final readonly class ListReleaseAssets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListReleaseAssets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId, $perPage, $page);
