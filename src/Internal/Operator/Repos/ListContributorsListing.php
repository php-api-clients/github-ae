...
final readonly class ListContributorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListContributorsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $anon, $perPage, $page);
