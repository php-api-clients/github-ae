...
final readonly class GetStatusChecksProtection
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Branches\Branch\Protection\RequiredStatusChecks $hydrator)
    {
    }

    public function call(string $owner, string $repo, string $branch): StatusCheckPolicy
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetStatusChecksProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
