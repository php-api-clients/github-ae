...
final readonly class GetAllEnvironments
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Environments $hydrator)
    {
    }

    public function call(string $owner, string $repo, int $perPage = 30, int $page = 1): Ok
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetAllEnvironments($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
