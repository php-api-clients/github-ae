...
final readonly class ListBranchesForHeadCommit
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListBranchesForHeadCommit($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha);
