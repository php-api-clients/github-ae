...
final readonly class CompareCommits
{
    ...
    public function call(string $owner, string $repo, string $basehead, int $page = 1, int $perPage = 30): CommitComparison
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\CompareCommits($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $basehead, $page, $perPage);
