...
final readonly class GetDeploymentStatus
{
    ...
    public function call(string $owner, string $repo, int $deploymentId, int $statusId): DeploymentStatus
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetDeploymentStatus($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $deploymentId, $statusId);
