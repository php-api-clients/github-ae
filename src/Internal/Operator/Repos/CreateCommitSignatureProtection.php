...
final readonly class CreateCommitSignatureProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\CreateCommitSignatureProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
