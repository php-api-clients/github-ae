...
final readonly class ListContributors
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\ListContributors($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $anon, $perPage, $page);
