...
final readonly class GetPagesBuild
{
    ...
    public function call(string $owner, string $repo, int $buildId): PageBuild
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetPagesBuild($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $buildId);
