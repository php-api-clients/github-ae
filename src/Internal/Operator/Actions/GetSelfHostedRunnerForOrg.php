...
final readonly class GetSelfHostedRunnerForOrg
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Orgs\Org\Actions\Runners\RunnerId $hydrator)
    {
    }

    public function call(string $org, int $runnerId): Runner
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\GetSelfHostedRunnerForOrg($this->responseSchemaValidator, $this->hydrator, $org, $runnerId);
