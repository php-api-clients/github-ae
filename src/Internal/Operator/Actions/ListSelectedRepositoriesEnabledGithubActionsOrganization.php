...
final readonly class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Orgs\Org\Actions\Permissions\Repositories $hydrator)
    {
    }
