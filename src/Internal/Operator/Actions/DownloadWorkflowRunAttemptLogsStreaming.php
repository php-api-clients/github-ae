...
final readonly class DownloadWorkflowRunAttemptLogsStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\DownloadWorkflowRunAttemptLogsStreaming($this->browser, $owner, $repo, $runId, $attemptNumber);
