...
final readonly class GetRepoPublicKey
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Secrets\PublicKey $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\GetRepoPublicKey($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
