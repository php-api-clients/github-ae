...
final readonly class ListJobsForWorkflowRunAttempt
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Attempts\AttemptNumber\Jobs $hydrator)
    {
    }

    /** @return Schema\Operations\Actions\ListJobsForWorkflowRunAttempt\Response\ApplicationJson\Ok */
    public function call(string $owner, string $repo, int $runId, int $attemptNumber, int $perPage = 30, int $page = 1): Ok|array
    {
