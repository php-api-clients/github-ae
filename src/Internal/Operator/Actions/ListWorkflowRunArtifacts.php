...
final readonly class ListWorkflowRunArtifacts
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\ListWorkflowRunArtifacts($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId, $perPage, $page);
