...
final readonly class SetGithubActionsDefaultWorkflowPermissionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\SetGithubActionsDefaultWorkflowPermissionsOrganization($this->requestSchemaValidator, $org);
