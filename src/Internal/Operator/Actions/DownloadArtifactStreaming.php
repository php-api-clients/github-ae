...
final readonly class DownloadArtifactStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\DownloadArtifactStreaming($this->responseSchemaValidator, $this->hydrator, $this->browser, $owner, $repo, $artifactId, $archiveFormat);
