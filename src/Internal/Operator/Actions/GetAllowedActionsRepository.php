...
final readonly class GetAllowedActionsRepository
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\SelectedActions $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\GetAllowedActionsRepository($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
