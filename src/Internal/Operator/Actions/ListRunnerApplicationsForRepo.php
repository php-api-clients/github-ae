...
final readonly class ListRunnerApplicationsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Actions\ListRunnerApplicationsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
