...
final readonly class ListFollowersForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\ListFollowersForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
