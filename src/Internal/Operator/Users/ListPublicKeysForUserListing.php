...
final readonly class ListPublicKeysForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\ListPublicKeysForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
