...
final readonly class ListGpgKeysForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\ListGpgKeysForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
