...
final readonly class ListFollowersForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\ListFollowersForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
