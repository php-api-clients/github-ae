...
final readonly class ListPublicKeysForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\ListPublicKeysForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
