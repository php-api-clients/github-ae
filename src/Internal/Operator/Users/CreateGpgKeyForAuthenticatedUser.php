...
final readonly class CreateGpgKeyForAuthenticatedUser
{
    ...
    public function call(array $params): GpgKey|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Users\CreateGpgKeyForAuthenticatedUser($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
