...
final readonly class ListPublicListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Gists\ListPublicListing($this->responseSchemaValidator, $this->hydrator, $since, $perPage, $page);
