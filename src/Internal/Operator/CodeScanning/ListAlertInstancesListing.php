...
final readonly class ListAlertInstancesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\CodeScanning\ListAlertInstancesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber, $ref, $page, $perPage);
