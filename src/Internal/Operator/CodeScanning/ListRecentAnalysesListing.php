...
final readonly class ListRecentAnalysesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\CodeScanning\ListRecentAnalysesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $toolName, $toolGuid, $ref, $sarifId, $page, $perPage, $direction, $sort);
