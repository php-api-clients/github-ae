...
final readonly class ListAlertsForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\CodeScanning\ListAlertsForOrg($this->responseSchemaValidator, $this->hydrator, $org, $toolName, $toolGuid, $before, $after, $state, $severity, $page, $perPage, $direction, $sort);
