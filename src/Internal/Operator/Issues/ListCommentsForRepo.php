...
final readonly class ListCommentsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListCommentsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $direction, $since, $sort, $perPage, $page);
