...
final readonly class ListLabelsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListLabelsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
