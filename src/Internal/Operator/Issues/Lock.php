...
final readonly class Lock
{
    ...
    public function call(string $owner, string $repo, int $issueNumber, array $params): WithoutBody
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\Lock($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
