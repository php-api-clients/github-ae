...
final readonly class ListForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListForOrg($this->responseSchemaValidator, $this->hydrator, $org, $labels, $since, $filter, $state, $sort, $direction, $perPage, $page);
