...
final readonly class ListLabelsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListLabelsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
