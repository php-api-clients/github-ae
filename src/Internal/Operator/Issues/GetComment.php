...
final readonly class GetComment
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Comments\CommentId $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\GetComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
