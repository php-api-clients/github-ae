...
final readonly class ListForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $milestone, $assignee, $creator, $mentioned, $labels, $since, $state, $sort, $direction, $perPage, $page);
