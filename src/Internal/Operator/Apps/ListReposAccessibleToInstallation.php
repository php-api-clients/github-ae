...
final readonly class ListReposAccessibleToInstallation
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Apps\ListReposAccessibleToInstallation($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
