...
final readonly class CreateInstallationAccessToken
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Apps\CreateInstallationAccessToken($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $installationId);
