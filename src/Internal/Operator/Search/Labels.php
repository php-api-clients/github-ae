...
final readonly class Labels
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Search\Labels $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Search\Labels($this->responseSchemaValidator, $this->hydrator, $repositoryId, $q, $sort, $order, $perPage, $page);
