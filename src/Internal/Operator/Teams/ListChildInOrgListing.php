...
final readonly class ListChildInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListChildInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
