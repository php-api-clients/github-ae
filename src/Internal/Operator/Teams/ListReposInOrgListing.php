...
final readonly class ListReposInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListReposInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
