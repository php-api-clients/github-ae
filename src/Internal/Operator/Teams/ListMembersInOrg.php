...
final readonly class ListMembersInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListMembersInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $role, $perPage, $page);
