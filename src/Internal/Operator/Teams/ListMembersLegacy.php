...
final readonly class ListMembersLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListMembersLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $role, $perPage, $page);
