...
final readonly class ListMembersInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListMembersInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $role, $perPage, $page);
