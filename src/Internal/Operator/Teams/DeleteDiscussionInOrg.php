...
final readonly class DeleteDiscussionInOrg
{
    ...
    public function call(string $org, string $teamSlug, int $discussionNumber): array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\DeleteDiscussionInOrg($org, $teamSlug, $discussionNumber);
