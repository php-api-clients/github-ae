...
final readonly class CreateDiscussionLegacy
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Teams\TeamId\Discussions $hydrator)
    {
    }

    public function call(int $teamId, array $params): TeamDiscussion
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\CreateDiscussionLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId);
