...
final readonly class ListDiscussionsLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListDiscussionsLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $direction, $perPage, $page);
