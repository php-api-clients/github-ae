...
final readonly class UpdateLegacy
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Teams\TeamId $hydrator)
    {
    }

    /** @return Schema\TeamFull */
    public function call(int $teamId, array $params): TeamFull|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\UpdateLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId);
