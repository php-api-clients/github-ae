...
final readonly class AddOrUpdateMembershipForUserLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\AddOrUpdateMembershipForUserLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId, $username);
