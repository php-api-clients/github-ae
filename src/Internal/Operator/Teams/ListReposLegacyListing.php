...
final readonly class ListReposLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\ListReposLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $perPage, $page);
