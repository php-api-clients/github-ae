...
final readonly class CreateDiscussionCommentInOrg
{
    ...
    public function call(string $org, string $teamSlug, int $discussionNumber, array $params): TeamDiscussionComment|array
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Teams\CreateDiscussionCommentInOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $discussionNumber);
