...
final readonly class DownloadArchiveForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\DownloadArchiveForOrg($this->responseSchemaValidator, $this->hydrator, $org, $migrationId);
