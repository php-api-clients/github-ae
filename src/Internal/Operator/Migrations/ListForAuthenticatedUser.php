...
final readonly class ListForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\ListForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
