...
final readonly class ListReposForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\ListReposForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $migrationId, $perPage, $page);
