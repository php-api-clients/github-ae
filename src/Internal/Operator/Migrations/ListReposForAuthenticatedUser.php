...
final readonly class ListReposForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\ListReposForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $migrationId, $perPage, $page);
