...
final readonly class ListLocationsForAlertListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\SecretScanning\ListLocationsForAlertListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber, $page, $perPage);
