...
final readonly class ListLocationsForAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\SecretScanning\ListLocationsForAlert($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber, $page, $perPage);
