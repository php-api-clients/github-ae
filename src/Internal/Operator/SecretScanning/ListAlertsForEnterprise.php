...
final readonly class ListAlertsForEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\SecretScanning\ListAlertsForEnterprise($this->responseSchemaValidator, $this->hydrator, $enterprise, $state, $secretType, $resolution, $before, $after, $validity, $sort, $direction, $perPage);
