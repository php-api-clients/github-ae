...
final readonly class GetAuditLog
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\EnterpriseAdmin\GetAuditLog($this->responseSchemaValidator, $this->hydrator, $enterprise, $phrase, $after, $before, $order, $page, $perPage);
