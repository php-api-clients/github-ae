...
final readonly class ListGlobalWebhooksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\EnterpriseAdmin\ListGlobalWebhooksListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
