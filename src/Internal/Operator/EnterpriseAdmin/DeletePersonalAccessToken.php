...
final readonly class DeletePersonalAccessToken
{
    ...
    public function call(int $tokenId): WithoutBody
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\EnterpriseAdmin\DeletePersonalAccessToken($tokenId);
