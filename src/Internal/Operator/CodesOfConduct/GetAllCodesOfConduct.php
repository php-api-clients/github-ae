...
namespace ApiClients\Client\GitHubAE\Internal\Operator\CodesOfConduct;
...
final readonly class GetAllCodesOfConduct
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubAE\Internal\Operation\CodesOfConduct\GetAllCodesOfConduct($this->responseSchemaValidator, $this->hydrator);
