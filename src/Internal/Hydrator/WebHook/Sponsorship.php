...
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Maintainer;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsor;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsorable;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Tier;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited\Changes;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited\Changes\PrivacyLevel;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipPendingCancellation;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipPendingTierChange;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipPendingTierChange\Changes\Tier\From;
use ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipTierChanged;
...
class Sponsorship implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled(array $payload): WebhookSponsorshipCancelled
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['sponsorship'] ?? null;

            if ($value === null) {
                $missingFields[] = 'sponsorship';
                goto after_sponsorship;
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipCancelled::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipCancelled(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship
    {
        ...
        try {
            ...
            $value = $payload['maintainer'] ?? null;

            if ($value === null) {
                $properties['maintainer'] = null;
            ...
            $value = $payload['privacy_level'] ?? null;

            if ($value === null) {
                $missingFields[] = 'privacy_level';
                goto after_privacyLevel;
            }

            $properties['privacyLevel'] = $value;

            after_privacyLevel:

            $value = $payload['sponsor'] ?? null;

            if ($value === null) {
                $properties['sponsor'] = null;
                goto after_sponsor;
            }
            ...
            $properties['sponsor'] = $value;

            after_sponsor:

            $value = $payload['sponsorable'] ?? null;

            if ($value === null) {
                $properties['sponsorable'] = null;
            ...
            $properties['sponsorable'] = $value;

            after_sponsorable:

            $value = $payload['tier'] ?? null;
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Maintainer(array $payload): Maintainer
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Maintainer::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Sponsor(array $payload): Sponsor
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Sponsor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Sponsor(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsor', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Sponsorable(array $payload): Sponsorable
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Sponsorable::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Sponsorable(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCancelled\Sponsorship\Sponsorable', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier(array $payload): Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['is_custom_ammount'] ?? null;

            if ($value === null) {
                $properties['isCustomAmmount'] = null;
                goto after_isCustomAmmount;
            }

            $properties['isCustomAmmount'] = $value;

            after_isCustomAmmount:

            $value = $payload['is_custom_amount'] ?? null;

            if ($value === null) {
                $properties['isCustomAmount'] = null;
                goto after_isCustomAmount;
            }

            $properties['isCustomAmount'] = $value;

            after_isCustomAmount:

            $value = $payload['is_one_time'] ?? null;

            if ($value === null) {
                $missingFields[] = 'is_one_time';
                goto after_isOneTime;
            }

            $properties['isOneTime'] = $value;
            ...
            $value = $payload['monthly_price_in_dollars'] ?? null;

            if ($value === null) {
                $missingFields[] = 'monthly_price_in_dollars';
                goto after_monthlyPriceInDollars;
            }

            $properties['monthlyPriceInDollars'] = $value;

            after_monthlyPriceInDollars:
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Tier::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCreated(array $payload): WebhookSponsorshipCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited(array $payload): WebhookSponsorshipEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipEdited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipEdited(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes⚡️PrivacyLevel(array $payload): PrivacyLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(PrivacyLevel::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new PrivacyLevel(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipEdited\Changes\PrivacyLevel', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipPendingCancellation(array $payload): WebhookSponsorshipPendingCancellation
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipPendingCancellation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipPendingCancellation(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipPendingCancellation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipPendingTierChange(array $payload): WebhookSponsorshipPendingTierChange
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipPendingTierChange::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipPendingTierChange(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipPendingTierChange', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipPendingTierChange⚡️Changes⚡️Tier⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipTierChanged(array $payload): WebhookSponsorshipTierChanged
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSponsorshipTierChanged::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSponsorshipTierChanged(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSponsorshipTierChanged', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof WebhookSponsorshipCancelled);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship(mixed $object): mixed
    {
        ...
        $sponsorable = $object->sponsorable;
    ...
    {
        assert($object instanceof Maintainer);
        $result = [];
    ...
    {
        assert($object instanceof Sponsor);
        $result = [];
    ...
    {
        assert($object instanceof Sponsorable);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier(mixed $object): mixed
    {
        ...
        $isCustomAmmount = $object->isCustomAmmount;

        if ($isCustomAmmount === null) {
            goto after_isCustomAmmount;
        }

        after_isCustomAmmount:        $result['is_custom_ammount'] = $isCustomAmmount;

        $isCustomAmount = $object->isCustomAmount;

        if ($isCustomAmount === null) {
            goto after_isCustomAmount;
        }

        after_isCustomAmount:        $result['is_custom_amount'] = $isCustomAmount;

        $isOneTime                                     = $object->isOneTime;
        after_isOneTime:        $result['is_one_time'] = $isOneTime;
        ...
        $monthlyPriceInDollars                                                  = $object->monthlyPriceInDollars;
        after_monthlyPriceInDollars:        $result['monthly_price_in_dollars'] = $monthlyPriceInDollars;
    ...
    {
        assert($object instanceof WebhookSponsorshipCreated);
        $result = [];
    ...
    {
        assert($object instanceof WebhookSponsorshipEdited);
        $result = [];
    ...
    {
        assert($object instanceof PrivacyLevel);
        $result = [];
    ...
    {
        assert($object instanceof WebhookSponsorshipPendingCancellation);
        $result = [];
    ...
    {
        assert($object instanceof WebhookSponsorshipPendingTierChange);
        $result = [];
    ...
    {
        assert($object instanceof WebhookSponsorshipTierChanged);
        $result = [];
