...
use ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch;
use ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch\Inputs;
...
class WorkflowDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch\Inputs' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch(array $payload): WebhookWorkflowDispatch
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookWorkflowDispatch::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookWorkflowDispatch(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs(array $payload): Inputs
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch\Inputs', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Inputs::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowDispatch' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch(mixed $object): mixed
    {
        assert($object instanceof WebhookWorkflowDispatch);
        $result = [];
        ...
        $inputs                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($inputs);
