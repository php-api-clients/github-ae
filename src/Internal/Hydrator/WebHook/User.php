...
use ApiClients\Client\GitHubAE\Schema\WebhookUserCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted;
...
class User implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookUserCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated(array $payload): WebhookUserCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookUserCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookUserCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted(array $payload): WebhookUserDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'user';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookUserDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookUserDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookUserCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated(mixed $object): mixed
    {
        assert($object instanceof WebhookUserCreated);
        $result = [];
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User($user);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserCreated⚡️User(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookUserCreated\User);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted(mixed $object): mixed
    {
        assert($object instanceof WebhookUserDeleted);
        $result = [];
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User($user);
        after_user:        $result['user'] = $user;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookUserDeleted⚡️User(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookUserDeleted\User);
        $result = [];
