...
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated\Requester;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationDeleted;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationNewPermissionsAccepted;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationSuspend;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend;
...
class Installation implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated(array $payload): WebhookInstallationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationDeleted(array $payload): WebhookInstallationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationDeleted', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(array $payload): WebhookInstallationNewPermissionsAccepted
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationNewPermissionsAccepted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationNewPermissionsAccepted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationNewPermissionsAccepted', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationSuspend(array $payload): WebhookInstallationSuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationSuspend::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationSuspend(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationSuspend', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationUnsuspend(array $payload): WebhookInstallationUnsuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationUnsuspend::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationUnsuspend(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationUnsuspend', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookInstallationCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationCreated(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationCreated);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationDeleted(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationDeleted);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationNewPermissionsAccepted);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationSuspend(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationSuspend);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationUnsuspend(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationUnsuspend);
        $result = [];
