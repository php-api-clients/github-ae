...
use ApiClients\Client\GitHubAE\Schema\WebhookPing;
use ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook;
use ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook\Config;
use ApiClients\Client\GitHubAE\Schema\WebhookPingFormEncoded;
...
class Ping implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookPing' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook\Config' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPingFormEncoded' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPingFormEncoded($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing(array $payload): WebhookPing
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook($value);
                } finally {
            ...
            $properties['zen'] = $value;

            after_zen:
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPing', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookPing::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookPing(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPing', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook\Config', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPingFormEncoded(array $payload): WebhookPingFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPingFormEncoded', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookPingFormEncoded::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookPingFormEncoded(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPingFormEncoded', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPing' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookPing\Hook\Config' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPingFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPingFormEncoded($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing(mixed $object): mixed
    {
        assert($object instanceof WebhookPing);
        $result = [];
        ...
        $hook                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook($hook);
        ...
        after_zen:        $result['zen'] = $zen;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook(mixed $object): mixed
    {
        ...
        $config                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config($config);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPingFormEncoded(mixed $object): mixed
    {
        assert($object instanceof WebhookPingFormEncoded);
        $result = [];
