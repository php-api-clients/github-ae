...
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Account;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Changes;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Changes\Login;
use ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Changes\Slug;
...
class InstallationTarget implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed(array $payload): WebhookInstallationTargetRenamed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Account($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookInstallationTargetRenamed::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookInstallationTargetRenamed(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Account(array $payload): Account
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if ($value === null) {
                $properties['hasOrganizationProjects'] = null;
            ...
            if ($value === null) {
                $properties['hasRepositoryProjects'] = null;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Account', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Account::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes⚡️Login(array $payload): Login
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes⚡️Slug(array $payload): Slug
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Slug::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Slug(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookInstallationTargetRenamed\Changes\Slug', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed(mixed $object): mixed
    {
        assert($object instanceof WebhookInstallationTargetRenamed);
        $result = [];

        $account                                 = $object->account;
        $account                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Account($account);
        ...
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes($changes);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Account(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes(mixed $object): mixed
    {
