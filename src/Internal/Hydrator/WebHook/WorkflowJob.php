...
use ApiClients\Client\GitHubAE\Internal\Attribute\CastUnionToType\Schema\Deployment\Payload;
...
use ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted;
use ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress;
use ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued;
...
class WorkflowJob implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubAE\Schema\Deployment' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted(array $payload): WebhookWorkflowJobCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookWorkflowJobCompleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookWorkflowJobCompleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment(array $payload): Deployment
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Deployment', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress(array $payload): WebhookWorkflowJobInProgress
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJob';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookWorkflowJobInProgress::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookWorkflowJobInProgress(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued(array $payload): WebhookWorkflowJobQueued
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJob';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookWorkflowJobQueued::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookWorkflowJobQueued(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($object),
                'ApiClients\Client\GitHubAE\Schema\Deployment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted(mixed $object): mixed
    {
        assert($object instanceof WebhookWorkflowJobCompleted);
        $result = [];
        ...
        $workflowJob                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($workflowJob);
        ...
        $deployment                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment($deployment);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobCompleted\WorkflowJob);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Deployment(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress(mixed $object): mixed
    {
        assert($object instanceof WebhookWorkflowJobInProgress);
        $result = [];
        ...
        $workflowJob                                      = $object->workflowJob;
        $workflowJob                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($workflowJob);
        after_workflowJob:        $result['workflow_job'] = $workflowJob;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobInProgress\WorkflowJob);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued(mixed $object): mixed
    {
        assert($object instanceof WebhookWorkflowJobQueued);
        $result = [];
        ...
        $workflowJob                                      = $object->workflowJob;
        $workflowJob                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($workflowJob);
        after_workflowJob:        $result['workflow_job'] = $workflowJob;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookWorkflowJobQueued\WorkflowJob);
        $result = [];
