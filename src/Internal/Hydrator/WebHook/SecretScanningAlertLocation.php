...
use ApiClients\Client\GitHubAE\Internal\Attribute\CastUnionToType\Schema\SecretScanningLocation\Details;
...
use ApiClients\Client\GitHubAE\Schema\SecretScanningLocation;
...
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded;
...
class SecretScanningAlertLocation implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\SecretScanningLocation' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated(array $payload): WebhookSecretScanningAlertLocationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation(array $payload): SecretScanningLocation
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecretScanningLocation', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded(array $payload): WebhookSecretScanningAlertLocationCreatedFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\SecretScanningLocation' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertLocationCreatedFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreated(mixed $object): mixed
    {
        ...
        $location                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation($location);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocation(mixed $object): mixed
    {
        ...
        $details = match ($details::class) {
                        'ApiClients\Client\GitHubAE\Schema\SecretScanningLocationCommit' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningLocationCommit($details),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertLocationCreatedFormEncoded(mixed $object): mixed
    {
