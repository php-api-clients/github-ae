...
use ApiClients\Client\GitHubAE\Schema\WebhookPageBuild;
use ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build;
use ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error;
use ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher;
...
class PageBuild implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild(array $payload): WebhookPageBuild
    {
        $properties    = [];
        $missingFields = [];
        try {
            $value = $payload['build'] ?? null;
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'build';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookPageBuild::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookPageBuild(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): Build
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Build::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(array $payload): Error
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Error::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Pusher::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Pusher(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Error' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookPageBuild\Build\Pusher' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild(mixed $object): mixed
    {
        assert($object instanceof WebhookPageBuild);
        $result = [];

        $build                               = $object->build;
        $build                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build($build);
        after_build:        $result['build'] = $build;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build(mixed $object): mixed
    {
        assert($object instanceof Build);
        $result = [];
        ...
        $error                               = $object->error;
        $error                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($error);
        ...
        $pusher                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($pusher);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(mixed $object): mixed
    {
        assert($object instanceof Error);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(mixed $object): mixed
    {
        assert($object instanceof Pusher);
        $result = [];
