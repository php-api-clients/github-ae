...
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationDeleted;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationDeleted\Membership;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationDeleted\Membership\User;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberAdded;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberInvited;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberInvited\Invitation;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberInvited\Invitation\Inviter;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberRemoved;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationRenamed;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationRenamed\Changes;
use ApiClients\Client\GitHubAE\Schema\WebhookOrganizationRenamed\Changes\Login;
...
class Organization implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationDeleted(array $payload): WebhookOrganizationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['membership'] ?? null;

            if ($value === null) {
                $properties['membership'] = null;
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrganizationDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookOrganizationDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookOrganizationDeleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationDeleted⚡️Membership(array $payload): Membership
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationDeleted⚡️Membership⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationMemberAdded(array $payload): WebhookOrganizationMemberAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrganizationMemberAdded::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationMemberInvited(array $payload): WebhookOrganizationMemberInvited
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['invitation'] ?? null;

            if ($value === null) {
                $missingFields[] = 'invitation';
                goto after_invitation;
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrganizationMemberInvited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookOrganizationMemberInvited(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookOrganizationMemberInvited', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationMemberInvited⚡️Invitation(array $payload): Invitation
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if ($value === null) {
                $properties['failedAt'] = null;
                goto after_failedAt;
            }

            $properties['failedAt'] = $value;
            ...
            if ($value === null) {
                $properties['failedReason'] = null;
                goto after_failedReason;
            }

            $properties['failedReason'] = $value;
            ...
            if ($value === null) {
                ...
                goto after_invitationTeamsUrl;
            }

            $properties['invitationTeamsUrl'] = $value;

            after_invitationTeamsUrl:
            ...
            if ($value === null) {
                ...
                goto after_teamCount;
            }

            $properties['teamCount'] = $value;
            ...
            if ($value === null) {
                $properties['invitationSource'] = null;
                goto after_invitationSource;
            }

            $properties['invitationSource'] = $value;
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Invitation::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationMemberInvited⚡️Invitation⚡️Inviter(array $payload): Inviter
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Inviter::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationMemberRemoved(array $payload): WebhookOrganizationMemberRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrganizationMemberRemoved::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationRenamed(array $payload): WebhookOrganizationRenamed
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrganizationRenamed::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookOrganizationRenamed(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookOrganizationRenamed', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationRenamed⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookOrganizationRenamed⚡️Changes⚡️Login(array $payload): Login
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Login::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    {
        assert($object instanceof WebhookOrganizationDeleted);
        $result = [];
    ...
    {
        assert($object instanceof WebhookOrganizationMemberAdded);
        $result = [];
    ...
    {
        assert($object instanceof WebhookOrganizationMemberInvited);
        $result = [];
    ...
    {
        assert($object instanceof Invitation);
        $result = [];
        ...
        $failedAt = $object->failedAt;

        if ($failedAt === null) {
            goto after_failedAt;
        }

        after_failedAt:        $result['failed_at'] = $failedAt;

        $failedReason = $object->failedReason;

        if ($failedReason === null) {
            goto after_failedReason;
        }

        after_failedReason:        $result['failed_reason'] = $failedReason;

        $id                            = $object->id;
        after_id:        $result['id'] = $id;

        $invitationTeamsUrl                                              = $object->invitationTeamsUrl;
        after_invitationTeamsUrl:        $result['invitation_teams_url'] = $invitationTeamsUrl;
        ...
        $teamCount                                    = $object->teamCount;
        after_teamCount:        $result['team_count'] = $teamCount;

        $invitationSource = $object->invitationSource;

        if ($invitationSource === null) {
            goto after_invitationSource;
        }

        after_invitationSource:        $result['invitation_source'] = $invitationSource;
    ...
    {
        assert($object instanceof Inviter);
        $result = [];
    ...
    {
        assert($object instanceof WebhookOrganizationMemberRemoved);
        $result = [];
    ...
    {
        assert($object instanceof WebhookOrganizationRenamed);
        $result = [];
    ...
    {
        assert($object instanceof Login);
        $result = [];
