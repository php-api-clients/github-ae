...
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\DismissedBy;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Location;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Message;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertClosedByUser;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertFixed;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened;
use ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopenedByUser;
...
class CodeScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertAppearedInBranch' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch(array $payload): WebhookCodeScanningAlertAppearedInBranch
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert(array $payload): Alert
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️DismissedBy(array $payload): DismissedBy
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance(array $payload): MostRecentInstance
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance⚡️Location(array $payload): Location
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance⚡️Message(array $payload): Message
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️Rule(array $payload): Rule
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️Tool(array $payload): Tool
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser(array $payload): WebhookCodeScanningAlertClosedByUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertCreated(array $payload): WebhookCodeScanningAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertFixed(array $payload): WebhookCodeScanningAlertFixed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened(array $payload): WebhookCodeScanningAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'dismissedBy';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopenedByUser(array $payload): WebhookCodeScanningAlertReopenedByUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCodeScanningAlertReopened\Alert\DismissedBy', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert(mixed $object): mixed
    {
        ...
        $dismissedBy                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert⚡️DismissedBy($dismissedBy);
        after_dismissedBy:        $result['dismissed_by'] = $dismissedBy;
