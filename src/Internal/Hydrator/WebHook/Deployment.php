...
use ApiClients\Client\GitHubAE\Internal\Attribute\CastUnionToType\Schema\WebhookDeploymentCreated\Deployment\Payload;
...
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\Deployment\Creator;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Owner;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Permissions;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\Workflow;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun\Actor;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun\Repository;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated\WorkflowRun\TriggeringActor;
...
class Deployment implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated(array $payload): WebhookDeploymentCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookDeploymentCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookDeploymentCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDeploymentCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️Creator(array $payload): Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp(array $payload): PerformedViaGithubApp
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️Workflow(array $payload): Workflow
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository(array $payload): HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️TriggeringActor(array $payload): TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof WebhookDeploymentCreated);
        $result = [];
