...
use ApiClients\Client\GitHubAE\Schema\SecretScanningAlertWebhook;
...
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened;
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved;
use ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked;
...
class SecretScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated($payload),
                'ApiClients\Client\GitHubAE\Schema\SecretScanningAlertWebhook' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertReopened($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertRevoked($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated(array $payload): WebhookSecretScanningAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningAlertCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningAlertCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook(array $payload): SecretScanningAlertWebhook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertReopened(array $payload): WebhookSecretScanningAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningAlertReopened::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningAlertReopened(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved(array $payload): WebhookSecretScanningAlertResolved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningAlertResolved::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningAlertResolved(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertRevoked(array $payload): WebhookSecretScanningAlertRevoked
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated($object),
                'ApiClients\Client\GitHubAE\Schema\SecretScanningAlertWebhook' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertReopened' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertReopened($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertResolved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecretScanningAlertRevoked' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertRevoked($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertCreated(mixed $object): mixed
    {
        assert($object instanceof WebhookSecretScanningAlertCreated);
        $result = [];
        ...
        $alert                               = $object->alert;
        $alert                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook($alert);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecretScanningAlertWebhook(mixed $object): mixed
    {
        ...
        $resolvedBy                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($resolvedBy);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertReopened(mixed $object): mixed
    {
        assert($object instanceof WebhookSecretScanningAlertReopened);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertResolved(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecretScanningAlertRevoked(mixed $object): mixed
    {
