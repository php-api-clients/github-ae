...
use ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite;
use ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite\Output;
use ApiClients\Client\GitHubAE\Schema\CodeOfConduct;
use ApiClients\Client\GitHubAE\Schema\DeploymentSimple;
...
use ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis\AdvancedSecurity;
...
use ApiClients\Client\GitHubAE\Schema\SimpleCheckSuite;
...
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompleted;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompletedFormEncoded;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreatedFormEncoded;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction\RequestedAction;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedActionFormEncoded;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequested;
use ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequestedFormEncoded;
...
class CheckRun implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompleted($payload),
                'ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\SimpleCheckSuite' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite\Output' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompletedFormEncoded' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompletedFormEncoded($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreated($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreatedFormEncoded' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreatedFormEncoded($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction\RequestedAction' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompleted(array $payload): WebhookCheckRunCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite(array $payload): CheckRunWithSimpleCheckSuite
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite(array $payload): SimpleCheckSuite
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SimpleCheckSuite', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️MinimalRepository(array $payload): MinimalRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConduct(array $payload): CodeOfConduct
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️MinimalRepository⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis(array $payload): SecurityAndAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanning($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningPushProtection($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity(array $payload): AdvancedSecurity
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis\AdvancedSecurity', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️DependabotSecurityUpdates(array $payload): DependabotSecurityUpdates
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanning(array $payload): SecretScanning
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis\SecretScanning', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanningPushProtection(array $payload): SecretScanningPushProtection
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DeploymentSimple(array $payload): DeploymentSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output(array $payload): Output
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite\Output', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompletedFormEncoded(array $payload): WebhookCheckRunCompletedFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompletedFormEncoded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreated(array $payload): WebhookCheckRunCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreatedFormEncoded(array $payload): WebhookCheckRunCreatedFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreatedFormEncoded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction(array $payload): WebhookCheckRunRequestedAction
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction(array $payload): RequestedAction
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction\RequestedAction', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedActionFormEncoded(array $payload): WebhookCheckRunRequestedActionFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedActionFormEncoded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequested(array $payload): WebhookCheckRunRerequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequested', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequestedFormEncoded(array $payload): WebhookCheckRunRerequestedFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequestedFormEncoded', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompleted($object),
                'ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\SimpleCheckSuite' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\CheckRunWithSimpleCheckSuite\Output' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCompletedFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompletedFormEncoded($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreated($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunCreatedFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreatedFormEncoded($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedAction\RequestedAction' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRequestedActionFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedActionFormEncoded($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequested' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequested($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCheckRunRerequestedFormEncoded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequestedFormEncoded($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompleted(mixed $object): mixed
    {
        ...
        $checkRun                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite($checkRun);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite(mixed $object): mixed
    {
        ...
        $checkSuite                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite($checkSuite);
        ...
        $output                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output($output);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleCheckSuite(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️MinimalRepository(mixed $object): mixed
    {
        ...
        $codeOfConduct                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConduct($codeOfConduct);
        ...
        $securityAndAnalysis                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis($securityAndAnalysis);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis(mixed $object): mixed
    {
        ...
        $advancedSecurity                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity($advancedSecurity);
        ...
        $secretScanning                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️SecretScanning($secretScanning);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis⚡️AdvancedSecurity(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CheckRunWithSimpleCheckSuite⚡️Output(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCompletedFormEncoded(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreated(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunCreatedFormEncoded(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction(mixed $object): mixed
    {
        ...
        $requestedAction                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction($requestedAction);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedAction⚡️RequestedAction(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRequestedActionFormEncoded(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequested(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCheckRunRerequestedFormEncoded(mixed $object): mixed
    {
