...
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleCreated\Rule;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleDeleted;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AdminEnforced;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorNames;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorsOnly;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedDismissalActorsOnly;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\LinearHistoryRequirementEnforcementLevel;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\RequiredStatusChecks;
use ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\RequiredStatusChecksEnforcementLevel;
...
class BranchProtectionRule implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleCreated(array $payload): WebhookBranchProtectionRuleCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookBranchProtectionRuleCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookBranchProtectionRuleCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleCreated⚡️Rule(array $payload): Rule
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleDeleted(array $payload): WebhookBranchProtectionRuleDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookBranchProtectionRuleDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookBranchProtectionRuleDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleDeleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited(array $payload): WebhookBranchProtectionRuleEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookBranchProtectionRuleEdited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookBranchProtectionRuleEdited(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if ($value === null) {
                $properties['authorizedActorNames'] = null;
                goto after_authorizedActorNames;
            }
            ...
            if ($value === null) {
                $properties['authorizedActorsOnly'] = null;
                goto after_authorizedActorsOnly;
            }
            ...
            if ($value === null) {
                $properties['authorizedDismissalActorsOnly'] = null;
                goto after_authorizedDismissalActorsOnly;
            }
            ...
            if ($value === null) {
                $properties['linearHistoryRequirementEnforcementLevel'] = null;
                goto after_linearHistoryRequirementEnforcementLevel;
            }
            ...
            if ($value === null) {
                $properties['requiredStatusChecksEnforcementLevel'] = null;
                goto after_requiredStatusChecksEnforcementLevel;
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced(array $payload): AdminEnforced
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(AdminEnforced::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new AdminEnforced(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AdminEnforced', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames(array $payload): AuthorizedActorNames
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(AuthorizedActorNames::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new AuthorizedActorNames(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorNames', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorsOnly(array $payload): AuthorizedActorsOnly
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(AuthorizedActorsOnly::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new AuthorizedActorsOnly(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedActorsOnly', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedDismissalActorsOnly(array $payload): AuthorizedDismissalActorsOnly
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(AuthorizedDismissalActorsOnly::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new AuthorizedDismissalActorsOnly(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\AuthorizedDismissalActorsOnly', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel(array $payload): LinearHistoryRequirementEnforcementLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(LinearHistoryRequirementEnforcementLevel::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new LinearHistoryRequirementEnforcementLevel(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\LinearHistoryRequirementEnforcementLevel', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️RequiredStatusChecks(array $payload): RequiredStatusChecks
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(RequiredStatusChecks::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new RequiredStatusChecks(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\RequiredStatusChecks', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️RequiredStatusChecksEnforcementLevel(array $payload): RequiredStatusChecksEnforcementLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(RequiredStatusChecksEnforcementLevel::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new RequiredStatusChecksEnforcementLevel(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookBranchProtectionRuleEdited\Changes\RequiredStatusChecksEnforcementLevel', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof WebhookBranchProtectionRuleCreated);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookBranchProtectionRuleCreated⚡️Rule(mixed $object): mixed
    {
        ...
        if ($authorizedActorNamesSerializer0 === null) {
            $authorizedActorNamesSerializer0 = new SerializeArrayItems(...[]);
        }
        ...
        if ($requiredStatusChecksSerializer0 === null) {
            $requiredStatusChecksSerializer0 = new SerializeArrayItems(...[]);
        }
    ...
    {
        assert($object instanceof WebhookBranchProtectionRuleDeleted);
        $result = [];
    ...
    {
        assert($object instanceof WebhookBranchProtectionRuleEdited);
        $result = [];
    ...
    {
        assert($object instanceof AdminEnforced);
        $result = [];
    ...
    {
        assert($object instanceof AuthorizedActorNames);
        $result = [];
    ...
    {
        assert($object instanceof AuthorizedActorsOnly);
        $result = [];
    ...
    {
        assert($object instanceof AuthorizedDismissalActorsOnly);
        $result = [];
    ...
    {
        assert($object instanceof LinearHistoryRequirementEnforcementLevel);
        $result = [];
    ...
    {
        assert($object instanceof RequiredStatusChecks);
        $result = [];
    ...
    {
        assert($object instanceof RequiredStatusChecksEnforcementLevel);
        $result = [];
