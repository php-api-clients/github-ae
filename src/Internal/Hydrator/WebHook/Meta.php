...
use ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted;
use ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook;
use ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook\Config;
...
class Meta implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook\Config' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted(array $payload): WebhookMetaDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookMetaDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookMetaDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook\Config', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookMetaDeleted\Hook\Config' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted(mixed $object): mixed
    {
        assert($object instanceof WebhookMetaDeleted);
        $result = [];
        ...
        $hook                              = $object->hook;
        $hook                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($hook);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(mixed $object): mixed
    {
        ...
        $config                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($config);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(mixed $object): mixed
    {
