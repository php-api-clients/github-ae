...
use ApiClients\Client\GitHubAE\Schema\WebhookPush\HeadCommit\Committer;
use ApiClients\Client\GitHubAE\Schema\WebhookPush\Pusher;
use ApiClients\Client\GitHubAE\Schema\WebhookPush\Repository;
use ApiClients\Client\GitHubAE\Schema\WebhookPush\Repository\License;
use ApiClients\Client\GitHubAE\Schema\WebhookPush\Repository\Owner;
use ApiClients\Client\GitHubAE\Schema\WebhookPush\Repository\Permissions;
...
class Push implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush(array $payload): WebhookPush
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookPush::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookPush(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookPush', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️HeadCommit(array $payload): HeadCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️HeadCommit⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️HeadCommit⚡️Committer(array $payload): Committer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️Repository⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️Repository⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️Repository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof WebhookPush);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPush⚡️HeadCommit(mixed $object): mixed
    {
        ...
        if ($addedSerializer0 === null) {
            $addedSerializer0 = new SerializeArrayItems(...[]);
        }
        ...
        if ($modifiedSerializer0 === null) {
            $modifiedSerializer0 = new SerializeArrayItems(...[]);
        }
        ...
        if ($removedSerializer0 === null) {
            $removedSerializer0 = new SerializeArrayItems(...[]);
        }
