...
use ApiClients\Client\GitHubAE\Schema\WebhookFork;
use ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee;
use ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\CustomProperties;
use ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\License;
use ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\Owner;
use ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\Permissions;
...
class Fork implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookFork' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\CustomProperties' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️CustomProperties($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork(array $payload): WebhookFork
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['forkee'] ?? null;

            if ($value === null) {
                $missingFields[] = 'forkee';
                goto after_forkee;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'forkee';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }

            $properties['forkee'] = $value;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookFork', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookFork::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookFork(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookFork', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee(array $payload): Forkee
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️CustomProperties($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Forkee::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Forkee(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\Owner', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️CustomProperties(array $payload): CustomProperties
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\CustomProperties', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RepositoryWebhooks⚡️CustomProperties(array $payload): \ApiClients\Client\GitHubAE\Schema\RepositoryWebhooks\CustomProperties
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\RepositoryWebhooks\CustomProperties::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\RepositoryWebhooks\CustomProperties(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\RepositoryWebhooks\CustomProperties', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookFork\Forkee\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork(mixed $object): mixed
    {
        assert($object instanceof WebhookFork);
        $result = [];
        ...
        $forkee                                = $object->forkee;
        $forkee                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee($forkee);
        after_forkee:        $result['forkee'] = $forkee;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee(mixed $object): mixed
    {
        assert($object instanceof Forkee);
        $result = [];
        ...
        $customProperties                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️CustomProperties($customProperties);
        ...
        $owner                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner($owner);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Owner(mixed $object): mixed
    {
