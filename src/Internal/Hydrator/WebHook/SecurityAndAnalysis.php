...
use ApiClients\Client\GitHubAE\Schema\CodeOfConductSimple;
use ApiClients\Client\GitHubAE\Schema\EnterpriseWebhooks;
use ApiClients\Client\GitHubAE\Schema\FullRepository;
use ApiClients\Client\GitHubAE\Schema\FullRepository\Permissions;
...
use ApiClients\Client\GitHubAE\Schema\Repository\TemplateRepository;
use ApiClients\Client\GitHubAE\Schema\Repository\TemplateRepository\Owner;
...
use ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis;
use ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes;
use ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes\From;
...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\FullRepository' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis(array $payload): WebhookSecurityAndAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes\From', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SecurityAndAnalysis(array $payload): \ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository(array $payload): FullRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConductSimple($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\FullRepository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository⚡️TemplateRepository(array $payload): TemplateRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository⚡️TemplateRepository⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConductSimple(array $payload): CodeOfConductSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CodeOfConductSimple', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\FullRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis(mixed $object): mixed
    {
        assert($object instanceof WebhookSecurityAndAnalysis);
        $result = [];

        $changes                                 = $object->changes;
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($changes);
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository($repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(mixed $object): mixed
    {
        ...
        $from                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($from);
        after_from:        $result['from'] = $from;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(mixed $object): mixed
    {
    ...
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\SecurityAndAnalysis);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FullRepository(mixed $object): mixed
    {
        ...
        $templateRepository                                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository($templateRepository);
        ...
        $parent                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository($parent);
        ...
        $source                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository($source);
        ...
        $codeOfConduct                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConductSimple($codeOfConduct);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeOfConductSimple(mixed $object): mixed
    {
