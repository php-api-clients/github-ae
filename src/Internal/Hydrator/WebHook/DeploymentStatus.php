...
use ApiClients\Client\GitHubAE\Internal\Attribute\CastUnionToType\Schema\WebhookDeploymentStatusCreated\Deployment\Payload;
...
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\CheckRun;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment\Creator;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\Workflow;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository;
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor;
...
class DeploymentStatus implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated(array $payload): WebhookDeploymentStatusCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookDeploymentStatusCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookDeploymentStatusCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDeploymentStatusCreated', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun(array $payload): CheckRun
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(array $payload): Deployment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator(array $payload): Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp(array $payload): PerformedViaGithubApp
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow(array $payload): Workflow
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository(array $payload): HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor(array $payload): TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof WebhookDeploymentStatusCreated);
        $result = [];
