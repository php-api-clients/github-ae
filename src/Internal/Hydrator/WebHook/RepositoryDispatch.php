...
use ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample;
use ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample\ClientPayload;
...
class RepositoryDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample(array $payload): WebhookRepositoryDispatchSample
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['client_payload'] ?? null;

            if ($value === null) {
                $properties['clientPayload'] = null;
                goto after_clientPayload;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'clientPayload';
            ...
            $properties['clientPayload'] = $value;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryDispatchSample::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryDispatchSample(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload(array $payload): ClientPayload
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(ClientPayload::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookRepositoryDispatchSample' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryDispatchSample);
        $result = [];
        ...
        $clientPayload                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($clientPayload);
        after_clientPayload:        $result['client_payload'] = $clientPayload;
