...
use ApiClients\Client\GitHubAE\Schema\WebhookGithubAppAuthorizationRevoked;
...
class GithubAppAuthorization implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookGithubAppAuthorizationRevoked' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(array $payload): WebhookGithubAppAuthorizationRevoked
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookGithubAppAuthorizationRevoked', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookGithubAppAuthorizationRevoked::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookGithubAppAuthorizationRevoked(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookGithubAppAuthorizationRevoked', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookGithubAppAuthorizationRevoked' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(mixed $object): mixed
    {
        assert($object instanceof WebhookGithubAppAuthorizationRevoked);
        $result = [];
