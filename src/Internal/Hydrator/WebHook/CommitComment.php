...
use ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated;
use ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment;
use ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\Reactions;
use ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\User;
...
class CommitComment implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\Reactions' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\User' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated(array $payload): WebhookCommitCommentCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookCommitCommentCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookCommitCommentCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment(array $payload): Comment
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\Reactions', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\User', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\Reactions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookCommitCommentCreated\Comment\User' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated(mixed $object): mixed
    {
        assert($object instanceof WebhookCommitCommentCreated);
        $result = [];
        ...
        $comment                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment($comment);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment(mixed $object): mixed
    {
        ...
        $reactions                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions($reactions);
        ...
        $user                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User($user);
        after_user:        $result['user'] = $user;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️Reactions(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookCommitCommentCreated⚡️Comment⚡️User(mixed $object): mixed
    {
