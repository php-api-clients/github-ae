...
use ApiClients\Client\GitHubAE\Schema\WebhookDeploymentProtectionRuleRequested;
...
class DeploymentProtectionRule implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookDeploymentProtectionRuleRequested' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested(array $payload): WebhookDeploymentProtectionRuleRequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['deployment_callback_url'] ?? null;

            if ($value === null) {
                $properties['deploymentCallbackUrl'] = null;
                goto after_deploymentCallbackUrl;
            }

            $properties['deploymentCallbackUrl'] = $value;

            after_deploymentCallbackUrl:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDeploymentProtectionRuleRequested', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookDeploymentProtectionRuleRequested::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookDeploymentProtectionRuleRequested(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDeploymentProtectionRuleRequested', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookDeploymentProtectionRuleRequested' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested(mixed $object): mixed
    {
        assert($object instanceof WebhookDeploymentProtectionRuleRequested);
        $result = [];
        ...
        $deploymentCallbackUrl = $object->deploymentCallbackUrl;

        if ($deploymentCallbackUrl === null) {
            goto after_deploymentCallbackUrl;
        }

        after_deploymentCallbackUrl:        $result['deployment_callback_url'] = $deploymentCallbackUrl;
