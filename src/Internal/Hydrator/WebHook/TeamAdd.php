...
use ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd;
use ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd\Team;
use ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd\Team\Parent_;
...
class TeamAdd implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd(array $payload): WebhookTeamAdd
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team(array $payload): Team
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd\Team', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team⚡️Parent_(array $payload): Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd\Team' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookTeamAdd\Team\Parent_' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team⚡️Parent_($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd(mixed $object): mixed
    {
        ...
        $team                              = $object->team;
        $team                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team($team);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookTeamAdd⚡️Team⚡️Parent_(mixed $object): mixed
    {
