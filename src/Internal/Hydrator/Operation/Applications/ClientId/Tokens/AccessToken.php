...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Applications\ClientId\Tokens;

use ApiClients\Client\GitHubAE\Schema\AppPermissions;
use ApiClients\Client\GitHubAE\Schema\Authorization;
use ApiClients\Client\GitHubAE\Schema\Authorization\App;
use ApiClients\Client\GitHubAE\Schema\ScopedInstallation;
...
class AccessToken implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Authorization(array $payload): Authorization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Authorization⚡️App(array $payload): App
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScopedInstallation(array $payload): ScopedInstallation
    {
        $properties    = [];
        $missingFields = [];
        try {
