...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Admin\Hooks;

use ApiClients\Client\GitHubAE\Schema\GlobalHook;
use ApiClients\Client\GitHubAE\Schema\GlobalHook\Config;
...
class HookId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GlobalHook(array $payload): GlobalHook
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(GlobalHook::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new GlobalHook(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GlobalHook', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GlobalHook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GlobalHook2(array $payload): GlobalHook2
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(GlobalHook2::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new GlobalHook2(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\GlobalHook2', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof GlobalHook);
        $result = [];
    ...
    {
        assert($object instanceof GlobalHook2);
        $result = [];
