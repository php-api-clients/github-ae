...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Enterprises\Enterprise\Actions;
...
class RunnerGroups implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️EnterpriseAdmin⚡️ListSelfHostedRunnerGroupsForEnterprise⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RunnerGroupsEnterprise(array $payload): RunnerGroupsEnterprise
    {
        $properties    = [];
        $missingFields = [];
        try {
