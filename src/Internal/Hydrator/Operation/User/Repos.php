...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\User;
...
use ApiClients\Client\GitHubAE\Schema\ScimError;
...
class Repos implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ScimError(array $payload): ScimError
    {
        $properties    = [];
        $missingFields = [];
        try {
