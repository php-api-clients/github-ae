...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\User\Keys;
...
class KeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Key(array $payload): Key
    {
        $properties    = [];
        $missingFields = [];
        try {
