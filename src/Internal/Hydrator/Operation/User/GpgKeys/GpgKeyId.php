...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\User\GpgKeys;
...
class GpgKeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GpgKey(array $payload): GpgKey
    {
        $properties    = [];
        $missingFields = [];
        try {
