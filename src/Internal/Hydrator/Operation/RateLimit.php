...
use ApiClients\Client\GitHubAE\Schema\RateLimitOverview\Resources;
...
class RateLimit implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RateLimitOverview(array $payload): RateLimitOverview
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RateLimitOverview⚡️Resources(array $payload): Resources
    {
        $properties    = [];
        $missingFields = [];
        try {
