...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Teams\TeamId\Projects;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\Operations\Teams\AddOrUpdateProjectPermissionsLegacy\Response\ApplicationJson\Forbidden\Application\Json;
...
class ProjectId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Teams⚡️AddOrUpdateProjectPermissionsLegacy⚡️Response⚡️ApplicationJson⚡️Forbidden⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
