...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Teams\TeamId;
...
class Discussions implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamDiscussion(array $payload): TeamDiscussion
    {
        $properties    = [];
        $missingFields = [];
        try {
