...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Teams;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\TeamFull;
use ApiClients\Client\GitHubAE\Schema\TeamOrganization;
use ApiClients\Client\GitHubAE\Schema\TeamOrganization\Plan;
...
class TeamId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamFull(array $payload): TeamFull
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(TeamFull::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new TeamFull(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TeamFull', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamOrganization(array $payload): TeamOrganization
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(TeamOrganization::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new TeamOrganization(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TeamOrganization', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamOrganization⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Plan::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    {
        assert($object instanceof TeamFull);
        $result = [];
    ...
    {
        assert($object instanceof TeamOrganization);
        $result = [];
