...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Licenses;
...
class License implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\License' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️License($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️License(array $payload): \ApiClients\Client\GitHubAE\Schema\License
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\License', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\License::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubAE\Schema\License(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\License', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\License' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️License($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️License(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubAE\Schema\License);
        $result = [];
        ...
        if ($conditionsSerializer0 === null) {
            $conditionsSerializer0 = new SerializeArrayItems(...[]);
        }
        ...
        if ($limitationsSerializer0 === null) {
            $limitationsSerializer0 = new SerializeArrayItems(...[]);
        }
