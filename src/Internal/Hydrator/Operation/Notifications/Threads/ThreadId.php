...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Notifications\Threads;
...
use ApiClients\Client\GitHubAE\Schema\Thread\Subject;
...
class ThreadId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread(array $payload): Thread
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Thread⚡️Subject(array $payload): Subject
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Subject::class, $missingFields, stack: $this->hydrationStack);
        }
