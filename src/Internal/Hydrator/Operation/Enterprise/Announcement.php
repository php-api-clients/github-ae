...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Enterprise;
...
class Announcement implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\Announcement' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Announcement($payload),
