...
class RunnerGroups implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Actions⚡️ListSelfHostedRunnerGroupsForOrg⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RunnerGroupsOrg(array $payload): RunnerGroupsOrg
    {
        $properties    = [];
        $missingFields = [];
        try {
