...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Repos\Owner;
...
use ApiClients\Client\GitHubAE\Schema\TeamRepository\Permissions;
...
class Repo implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamRepository(array $payload): TeamRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamRepository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
