...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions\DiscussionNumber\Comments;
...
class CommentNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamDiscussionComment(array $payload): TeamDiscussionComment
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(TeamDiscussionComment::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new TeamDiscussionComment(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\TeamDiscussionComment', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof TeamDiscussionComment);
        $result = [];
