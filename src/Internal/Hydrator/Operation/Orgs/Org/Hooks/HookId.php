...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Orgs\Org\Hooks;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\OrgHook;
use ApiClients\Client\GitHubAE\Schema\OrgHook\Config;
...
class HookId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook(array $payload): OrgHook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️OrgHook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
