...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Orgs\Org\Migrations;
...
class MigrationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Migration(array $payload): Migration
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Migration::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    {
        assert($object instanceof Migration);
        $result = [];
        ...
        if ($excludeSerializer0 === null) {
            $excludeSerializer0 = new SerializeArrayItems(...[]);
        }
