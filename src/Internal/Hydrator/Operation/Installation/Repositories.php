...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Installation;
...
class Repositories implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Apps⚡️ListReposAccessibleToInstallation⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
