...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Gists;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\GistSimple;
use ApiClients\Client\GitHubAE\Schema\GistSimple\Files;
use ApiClients\Client\GitHubAE\Schema\GistSimple\ForkOf;
use ApiClients\Client\GitHubAE\Schema\Operations\Gists\Get\Response\ApplicationJson\Forbidden;
use ApiClients\Client\GitHubAE\Schema\Operations\Gists\Get\Response\ApplicationJson\Forbidden\Block;
...
class GistId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple(array $payload): GistSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️ForkOf(array $payload): ForkOf
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Gists⚡️Get⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): Forbidden
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Forbidden::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Forbidden(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Operations\Gists\Get\Response\ApplicationJson\Forbidden', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Gists⚡️Get⚡️Response⚡️ApplicationJson⚡️Forbidden⚡️Block(array $payload): Block
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Block::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GistSimple⚡️Files(array $payload): Files
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof Forbidden);
        $result = [];
