...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Events;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\Integration;
use ApiClients\Client\GitHubAE\Schema\Issue;
use ApiClients\Client\GitHubAE\Schema\Issue\PullRequest;
use ApiClients\Client\GitHubAE\Schema\IssueEvent;
use ApiClients\Client\GitHubAE\Schema\IssueEventDismissedReview;
use ApiClients\Client\GitHubAE\Schema\IssueEventLabel;
use ApiClients\Client\GitHubAE\Schema\IssueEventMilestone;
use ApiClients\Client\GitHubAE\Schema\IssueEventProjectCard;
use ApiClients\Client\GitHubAE\Schema\IssueEventRename;
...
use ApiClients\Client\GitHubAE\Schema\Team;
use ApiClients\Client\GitHubAE\Schema\TeamSimple;
...
class EventId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEvent(array $payload): IssueEvent
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'reviewRequester';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'requestedReviewer';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEvent::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEvent(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEvent', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Issue(array $payload): Issue
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Issue⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEventLabel(array $payload): IssueEventLabel
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEventLabel::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEventLabel(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEventLabel', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Team(array $payload): Team
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️TeamSimple(array $payload): TeamSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEventDismissedReview(array $payload): IssueEventDismissedReview
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEventDismissedReview::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEventDismissedReview(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEventDismissedReview', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEventMilestone(array $payload): IssueEventMilestone
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEventMilestone::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEventMilestone(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEventMilestone', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEventProjectCard(array $payload): IssueEventProjectCard
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEventProjectCard::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEventProjectCard(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEventProjectCard', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️IssueEventRename(array $payload): IssueEventRename
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(IssueEventRename::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new IssueEventRename(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\IssueEventRename', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof IssueEvent);
        $result = [];
        ...
        $assigner                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($assigner);
        ...
        $reviewRequester                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($reviewRequester);
        ...
        $requestedReviewer                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️SimpleUser($requestedReviewer);
    ...
    {
        assert($object instanceof IssueEventLabel);
        $result = [];
    ...
    {
        assert($object instanceof TeamSimple);
        $result = [];
    ...
    {
        assert($object instanceof IssueEventDismissedReview);
        $result = [];
    ...
    {
        assert($object instanceof IssueEventMilestone);
        $result = [];
    ...
    {
        assert($object instanceof IssueEventProjectCard);
        $result = [];
    ...
    {
        assert($object instanceof IssueEventRename);
        $result = [];
