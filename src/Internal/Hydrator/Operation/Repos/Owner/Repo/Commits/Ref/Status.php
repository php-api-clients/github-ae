...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\Ref;
...
class Status implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CombinedCommitStatus(array $payload): CombinedCommitStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
