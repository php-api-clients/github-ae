...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Jobs;
...
class JobId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Job(array $payload): Job
    {
        $properties    = [];
        $missingFields = [];
        try {
