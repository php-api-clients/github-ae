...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Contents;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\ContentTree;
use ApiClients\Client\GitHubAE\Schema\ContentTree\Links;
use ApiClients\Client\GitHubAE\Schema\FileCommit;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Commit;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Commit\Author;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Commit\Committer;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Commit\Tree;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Commit\Verification;
use ApiClients\Client\GitHubAE\Schema\FileCommit\Content;
...
class Path implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree(array $payload): ContentTree
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ContentTree⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit(array $payload): FileCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Content(array $payload): Content
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit(array $payload): Commit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit⚡️Committer(array $payload): Committer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit⚡️Tree(array $payload): Tree
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️FileCommit⚡️Commit⚡️Verification(array $payload): Verification
    {
        $properties    = [];
        $missingFields = [];
        try {
