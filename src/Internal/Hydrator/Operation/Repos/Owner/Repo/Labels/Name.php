...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Labels;
...
class Name implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Label(array $payload): Label
    {
        $properties    = [];
        $missingFields = [];
        try {
