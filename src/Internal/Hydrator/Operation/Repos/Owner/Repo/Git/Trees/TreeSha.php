...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Trees;
...
class TreeSha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitTree(array $payload): GitTree
    {
        $properties    = [];
        $missingFields = [];
        try {
