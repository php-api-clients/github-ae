...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Branches;
...
use ApiClients\Client\GitHubAE\Schema\BranchWithProtection\Links;
use ApiClients\Client\GitHubAE\Schema\Commit;
use ApiClients\Client\GitHubAE\Schema\Commit\Commit\Tree;
use ApiClients\Client\GitHubAE\Schema\Commit\Stats;
use ApiClients\Client\GitHubAE\Schema\GitUser;
...
use ApiClients\Client\GitHubAE\Schema\Verification;
...
class Branch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BranchWithProtection(array $payload): BranchWithProtection
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Commit(array $payload): Commit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️GitUser(array $payload): GitUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Commit⚡️Commit⚡️Tree(array $payload): Tree
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Verification(array $payload): Verification
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Commit⚡️Stats(array $payload): Stats
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BranchWithProtection⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BranchWithProtection(mixed $object): mixed
    {
        ...
        $links                                = $object->links;
        $links                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️BranchWithProtection⚡️Links($links);
