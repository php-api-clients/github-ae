...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Comments\CommentId;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\Operations\Reactions\CreateForCommitComment\Response\ApplicationJson\UnsupportedMediaType;
...
class Reactions implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Reaction(array $payload): Reaction
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Reaction::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Reactions⚡️CreateForCommitComment⚡️Response⚡️ApplicationJson⚡️UnsupportedMediaType(array $payload): UnsupportedMediaType
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof Reaction);
        $result = [];
