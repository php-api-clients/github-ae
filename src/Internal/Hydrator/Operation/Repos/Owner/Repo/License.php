...
use ApiClients\Client\GitHubAE\Schema\LicenseContent\Links;
...
class License implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LicenseContent(array $payload): LicenseContent
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LicenseContent⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
