...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Hooks\HookId\Deliveries;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\HookDelivery;
use ApiClients\Client\GitHubAE\Schema\HookDelivery\Request;
use ApiClients\Client\GitHubAE\Schema\HookDelivery\Request\Headers;
use ApiClients\Client\GitHubAE\Schema\HookDelivery\Request\Payload;
use ApiClients\Client\GitHubAE\Schema\HookDelivery\Response;
...
class DeliveryId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️HookDelivery(array $payload): HookDelivery
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️HookDelivery⚡️Request(array $payload): Request
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️HookDelivery⚡️Response(array $payload): Response
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️HookDelivery⚡️Request⚡️Headers(array $payload): Headers
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️HookDelivery⚡️Request⚡️Payload(array $payload): Payload
    {
        $properties    = [];
        $missingFields = [];
        try {
