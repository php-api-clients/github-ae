...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Keys;
...
class KeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️DeployKey(array $payload): DeployKey
    {
        $properties    = [];
        $missingFields = [];
        try {
