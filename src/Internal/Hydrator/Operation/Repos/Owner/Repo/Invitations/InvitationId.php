...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Invitations;
...
class InvitationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️RepositoryInvitation(array $payload): RepositoryInvitation
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(RepositoryInvitation::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new RepositoryInvitation(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\RepositoryInvitation', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof RepositoryInvitation);
        $result = [];
