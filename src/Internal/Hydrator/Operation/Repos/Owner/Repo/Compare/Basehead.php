...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Compare;
...
class Basehead implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CommitComparison(array $payload): CommitComparison
    {
        $properties    = [];
        $missingFields = [];
        try {
