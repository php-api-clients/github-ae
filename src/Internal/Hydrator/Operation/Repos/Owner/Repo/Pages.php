...
use ApiClients\Client\GitHubAE\Schema\PagesHttpsCertificate;
use ApiClients\Client\GitHubAE\Schema\PagesSourceHash;
...
class Pages implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Page(array $payload): Page
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesSourceHash(array $payload): PagesSourceHash
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PagesHttpsCertificate(array $payload): PagesHttpsCertificate
    {
        $properties    = [];
        $missingFields = [];
        try {
