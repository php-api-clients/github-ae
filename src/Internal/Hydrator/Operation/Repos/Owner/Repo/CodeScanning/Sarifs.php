...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning;
...
class Sarifs implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeScanningSarifsReceipt(array $payload): CodeScanningSarifsReceipt
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(CodeScanningSarifsReceipt::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new CodeScanningSarifsReceipt(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\CodeScanningSarifsReceipt', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof CodeScanningSarifsReceipt);
        $result = [];
