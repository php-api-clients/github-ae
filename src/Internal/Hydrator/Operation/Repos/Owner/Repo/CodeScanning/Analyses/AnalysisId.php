...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Analyses;
...
class AnalysisId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeScanningAnalysis(array $payload): CodeScanningAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️CodeScanningAnalysisDeletion(array $payload): CodeScanningAnalysisDeletion
    {
        $properties    = [];
        $missingFields = [];
        try {
