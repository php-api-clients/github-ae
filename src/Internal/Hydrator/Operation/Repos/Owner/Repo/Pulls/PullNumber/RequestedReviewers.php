...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber;
...
use ApiClients\Client\GitHubAE\Schema\PullRequestSimple\Base;
use ApiClients\Client\GitHubAE\Schema\PullRequestSimple\Head;
use ApiClients\Client\GitHubAE\Schema\PullRequestSimple\Links;
use ApiClients\Client\GitHubAE\Schema\Repository;
use ApiClients\Client\GitHubAE\Schema\Repository\Permissions;
...
class RequestedReviewers implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReviewRequest(array $payload): PullRequestReviewRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(PullRequestReviewRequest::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new PullRequestReviewRequest(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PullRequestReviewRequest', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple(array $payload): PullRequestSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(PullRequestSimple::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new PullRequestSimple(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\PullRequestSimple', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Repository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestSimple⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof PullRequestReviewRequest);
        $result = [];
    ...
    {
        assert($object instanceof PullRequestSimple);
        $result = [];
