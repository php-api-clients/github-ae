...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Reviews;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\PullRequestReview;
use ApiClients\Client\GitHubAE\Schema\PullRequestReview\Links;
use ApiClients\Client\GitHubAE\Schema\PullRequestReview\Links\Html;
use ApiClients\Client\GitHubAE\Schema\PullRequestReview\Links\PullRequest;
...
class ReviewId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview(array $payload): PullRequestReview
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️Html(array $payload): Html
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequestReview⚡️Links⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
