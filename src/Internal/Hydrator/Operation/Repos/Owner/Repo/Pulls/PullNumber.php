...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls;

use ApiClients\Client\GitHubAE\Schema\AutoMerge;
use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\LicenseSimple;
use ApiClients\Client\GitHubAE\Schema\Link;
...
use ApiClients\Client\GitHubAE\Schema\PullRequest\Base;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head\Repo;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head\Repo\License;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head\Repo\Owner;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head\Repo\Permissions;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Head\User;
use ApiClients\Client\GitHubAE\Schema\PullRequest\Links;
...
class PullNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Milestone(array $payload): Milestone
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️Repo(array $payload): Repo
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Head⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️PullRequest⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Link(array $payload): Link
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️AutoMerge(array $payload): AutoMerge
    {
        $properties    = [];
        $missingFields = [];
        try {
