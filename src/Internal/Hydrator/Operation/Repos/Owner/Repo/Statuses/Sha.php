...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Statuses;
...
class Sha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Status(array $payload): Status
    {
        $properties    = [];
        $missingFields = [];
        try {
