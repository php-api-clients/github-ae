...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner\Repo\Autolinks;
...
class AutolinkId implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubAE\Schema\Autolink' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Autolink($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Autolink(array $payload): Autolink
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Autolink::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Autolink(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\Autolink', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof Autolink);
        $result = [];
