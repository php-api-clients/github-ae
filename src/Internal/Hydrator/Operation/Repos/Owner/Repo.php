...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Repos\Owner;
...
use ApiClients\Client\GitHubAE\Schema\Operations\Repos\Delete\Response\ApplicationJson\Forbidden\Application\Json;
...
class Repo implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Repos⚡️Delete⚡️Response⚡️ApplicationJson⚡️Forbidden⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
