...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\App\Installations\InstallationId;
...
class AccessTokens implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️InstallationToken(array $payload): InstallationToken
    {
        $properties    = [];
        $missingFields = [];
        try {
