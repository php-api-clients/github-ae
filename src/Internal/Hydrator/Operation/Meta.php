...
use ApiClients\Client\GitHubAE\Schema\ApiOverview\Domains;
use ApiClients\Client\GitHubAE\Schema\ApiOverview\SshKeyFingerprints;
...
class Meta implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ApiOverview(array $payload): ApiOverview
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ApiOverview⚡️SshKeyFingerprints(array $payload): SshKeyFingerprints
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ApiOverview⚡️Domains(array $payload): Domains
    {
        $properties    = [];
        $missingFields = [];
        try {
