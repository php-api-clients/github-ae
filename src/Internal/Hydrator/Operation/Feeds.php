...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation;

use ApiClients\Client\GitHubAE\Schema\Feed;
use ApiClients\Client\GitHubAE\Schema\Feed\Links;
use ApiClients\Client\GitHubAE\Schema\LinkWithType;
...
class Feeds implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed(array $payload): Feed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Feed⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️LinkWithType(array $payload): LinkWithType
    {
        $properties    = [];
        $missingFields = [];
        try {
