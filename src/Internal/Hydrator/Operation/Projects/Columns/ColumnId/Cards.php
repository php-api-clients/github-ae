...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Projects\Columns\ColumnId;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\Operations\Projects\CreateCard\Response\ApplicationJson\ServiceUnavailable\Application\Json;
...
class Cards implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️ProjectCard(array $payload): ProjectCard
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(ProjectCard::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new ProjectCard(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\ProjectCard', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Projects⚡️CreateCard⚡️Response⚡️ApplicationJson⚡️ServiceUnavailable⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof ProjectCard);
        $result = [];
