...
namespace ApiClients\Client\GitHubAE\Internal\Hydrator\Operation\Projects\Columns\Cards;

use ApiClients\Client\GitHubAE\Schema\BasicError;
use ApiClients\Client\GitHubAE\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden;
...
class CardId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): Forbidden
    {
        $properties    = [];
        $missingFields = [];
        try {
