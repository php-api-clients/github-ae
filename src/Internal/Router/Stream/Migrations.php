...
final class Migrations
{
    ...
    public function downloadArchiveForOrgStreaming(array $params): iterable
    {
        ...
        $operator = new Internal\Operator\Migrations\DownloadArchiveForOrgStreaming($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Migrations🌀MigrationId🌀Archive());
