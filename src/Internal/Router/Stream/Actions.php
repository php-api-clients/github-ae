...
final class Actions
{
    ...
    public function downloadArtifactStreaming(array $params): iterable
    {
        ...
        $operator = new Internal\Operator\Actions\DownloadArtifactStreaming($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Artifacts🌀ArtifactId🌀ArchiveFormat());
    ...
    public function downloadJobLogsForWorkflowRunStreaming(array $params): iterable
    {
        ...
        unset($params['job_id']);
        $operator = new Internal\Operator\Actions\DownloadJobLogsForWorkflowRunStreaming($this->browser, $this->authentication);
    ...
    public function downloadWorkflowRunLogsStreaming(array $params): iterable
    {
        ...
        unset($params['run_id']);
        $operator = new Internal\Operator\Actions\DownloadWorkflowRunLogsStreaming($this->browser, $this->authentication);
    ...
    public function downloadWorkflowRunAttemptLogsStreaming(array $params): iterable
    {
        ...
        $operator = new Internal\Operator\Actions\DownloadWorkflowRunAttemptLogsStreaming($this->browser, $this->authentication);
