...
final class Teams
{
    ...
    public function linkExternalIdpGroupToTeamForOrg(array $params): ExternalGroup
    {
        ...
        $operator = new Internal\Operator\Teams\LinkExternalIdpGroupToTeamForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀ExternalGroups());
