...
final class EnterpriseAdmin
{
    ...
    public function listGlobalWebhooksListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\EnterpriseAdmin\ListGlobalWebhooksListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Admin🌀Hooks());
    ...
    public function listPublicKeysListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\EnterpriseAdmin\ListPublicKeysListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Admin🌀Keys());
    ...
    public function listPreReceiveEnvironmentsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\EnterpriseAdmin\ListPreReceiveEnvironmentsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Admin🌀PreReceiveEnvironments());
    ...
    public function listPersonalAccessTokensListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\EnterpriseAdmin\ListPersonalAccessTokensListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Admin🌀Tokens());
            $items    = [...$operator->call($arguments['per_page'], $arguments['page'])];
    ...
    public function getAuditLogListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\EnterpriseAdmin\GetAuditLogListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀AuditLog());
