...
final class Activity
{
    ...
    public function listReposStarredByAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListReposStarredByAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀Starred());
    ...
    public function listWatchedReposForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListWatchedReposForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀Subscriptions());
    ...
    public function listEventsForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListEventsForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀Events());
    ...
    public function listRepoEventsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListRepoEventsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Events());
    ...
    public function listRepoNotificationsForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListRepoNotificationsForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Notifications());
    ...
    public function listWatchersForRepoListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListWatchersForRepoListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Subscribers());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listOrgEventsForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListOrgEventsForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀Events🌀Orgs🌀Org());
