...
final class Six
{
    ...
    /** @return Schema\PreReceiveEnvironmentDownloadStatus|Schema\Operations\EnterpriseAdmin\ListSelectedOrganizationsEnabledGithubActionsEnterprise\Response\ApplicationJson\Ok|Schema\SelectedActions|Schema\RunnerGroupsEnterprise|iterable<Schema\RunnerApplication>|Schema\Runner|Schema\Operations\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\ApplicationJson\Ok|Schema\ActionsGetDefaultWorkflowPermissions|Schema\RunnerGroupsOrg|Schema\ActionsPublicKey|Schema\OrganizationActionsSecret|Schema\WebhookConfig|iterable<Schema\HookDeliveryItem>|array{code:int}|iterable<Schema\MinimalRepository>|iterable<Schema\TeamDiscussion>|iterable<Schema\SimpleUser>|iterable<Schema\TeamProject>|iterable<Schema\Team>|Schema\ProjectCollaboratorPermission|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoOrganizationSecrets\Response\ApplicationJson\Ok|Schema\ActionsRepositoryPermissions|Schema\Operations\Actions\ListSelfHostedRunnersForRepo\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok|Schema\Autolink|Schema\BranchWithProtection|Schema\BasicError|Schema\CheckRun|Schema\CheckSuite|iterable<Schema\CodeScanningAlertItems>|iterable<Schema\CodeScanningAnalysis>|Schema\CodeownersErrors|Schema\CommitComment|Schema\Commit|Schema\CommitComparison|Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|Schema\Deployment|Schema\Environment|Schema\Hook|iterable<Schema\IssueComment>|iterable<Schema\IssueEvent>|Schema\Issue|Schema\DeployKey|Schema\Label|Schema\Milestone|iterable<Schema\PageBuild>|iterable<Schema\PullRequestReviewComment>|Schema\PullRequest|Schema\Release|iterable<Schema\SecretScanningAlert>|iterable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Schema\ParticipationStats|array{code:int,location:string}|iterable<Schema\TeamDiscussionComment>|Schema\TeamRepository|iterable<Schema\Event> */
