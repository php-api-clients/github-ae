...
final class Three
{
    ...
    /** @return iterable<int,Schema\GlobalHook>|iterable<int,Schema\PublicKeyFull>|iterable<int,Schema\PreReceiveEnvironment>|iterable<int,Schema\Authorization>|iterable<int,Schema\IntegrationInstallationRequest>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|iterable<int,Schema\Installation>||iterable<int,Schema\BaseGist>|Observable<string>|WithoutBody|Schema\Operations\Apps\ListReposAccessibleToInstallation\Response\ApplicationJson\Ok|Schema\Operations\Search\Code\Response\ApplicationJson\Ok|Schema\Operations\Search\Commits\Response\ApplicationJson\Ok|Schema\Operations\Search\IssuesAndPullRequests\Response\ApplicationJson\Ok|Schema\Operations\Search\Labels\Response\ApplicationJson\Ok|Schema\Operations\Search\Repos\Response\ApplicationJson\Ok|Schema\Operations\Search\Topics\Response\ApplicationJson\Ok|Schema\Operations\Search\Users\Response\ApplicationJson\Ok|iterable<int,Schema\SimpleUser>|iterable<int,Schema\GpgKey>|Schema\Operations\Apps\ListInstallationsForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Issue>|iterable<int,Schema\Key>|iterable<int,Schema\Migration>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\Repository>|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\TeamFull> */
