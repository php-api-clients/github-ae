...
final class Seven
{
    ...
    /** @return Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersInGroupForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedReposForOrgSecret\Response\ApplicationJson\Ok|Schema\HookDelivery|Schema\TeamDiscussion|Schema\TeamMembership|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|Schema\TeamProject|Schema\Artifact|Schema\Job|Schema\SelectedActions|iterable<int,Schema\RunnerApplication>|Schema\Runner|Schema\WorkflowRun|Schema\ActionsPublicKey|Schema\ActionsSecret|Schema\Workflow|Schema\BranchProtection|iterable<int,Schema\CheckAnnotation>|Schema\Operations\Checks\ListForSuite\Response\ApplicationJson\Ok|Schema\CodeScanningAlert|Schema\CodeScanningAnalysis|Schema\CodeScanningSarifsStatus|Schema\RepositoryCollaboratorPermission|iterable<int,Schema\Reaction>|iterable<int,Schema\BranchShort>|iterable<int,Schema\CommitComment>|iterable<int,Schema\PullRequestSimple>|Schema\Operations\Checks\ListForRef\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Checks\ListSuitesForRef\Response\ApplicationJson\Ok|Schema\CombinedCommitStatus|iterable<int,Schema\Status>|Schema\BasicError|iterable<int,Schema\DeploymentStatus>|Schema\Operations\Repos\ListDeploymentBranchPolicies\Response\ApplicationJson\Ok|Schema\Blob|Schema\GitCommit|iterable<int,Schema\GitRef>|Schema\GitRef|Schema\GitTag|Schema\GitTree|Schema\WebhookConfig|iterable<int,Schema\HookDeliveryItem>|Schema\IssueComment|Schema\IssueEvent|iterable<int,Schema\IssueComment>|iterable<int,Schema\LabeledIssueEvent|Schema\UnlabeledIssueEvent|Schema\AssignedIssueEvent|Schema\UnassignedIssueEvent|Schema\MilestonedIssueEvent|Schema\DemilestonedIssueEvent|Schema\RenamedIssueEvent|Schema\ReviewRequestedIssueEvent|Schema\ReviewRequestRemovedIssueEvent|Schema\ReviewDismissedIssueEvent|Schema\LockedIssueEvent|Schema\AddedToProjectIssueEvent|Schema\MovedColumnInProjectIssueEvent|Schema\RemovedFromProjectIssueEvent|Schema\ConvertedNoteToIssueIssueEvent>|iterable<int,Schema\Label>|Schema\ConvertedNoteToIssueIssueEvent|Schema\TimelineCommentEvent|Schema\TimelineCrossReferencedEvent|Schema\TimelineCommittedEvent|Schema\TimelineReviewedEvent|Schema\TimelineLineCommentedEvent|Schema\TimelineCommitCommentedEvent|Schema\TimelineAssignedIssueEvent|Schema\TimelineUnassignedIssueEvent|Schema\StateChangeIssueEvent>|Schema\PageBuild|Schema\PullRequestReviewComment|iterable<int,Schema\PullRequestReviewComment>|iterable<int,Schema\Commit>|iterable<int,Schema\DiffEntry>|Schema\PullRequestReviewRequest|iterable<int,Schema\PullRequestReview>|Schema\ReleaseAsset|Schema\Release|iterable<int,Schema\ReleaseAsset>|Schema\SecretScanningAlert|Schema\TeamDiscussionComment */
