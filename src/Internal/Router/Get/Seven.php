...
final class Seven
{
    ...
    /** @return Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersInGroupForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedReposForOrgSecret\Response\ApplicationJson\Ok||Observable<Schema\RunnerApplication>|iterable<int,Schema\CheckAnnotation>|Schema\Operations\Checks\ListForSuite\Response\ApplicationJson\Ok|iterable<int,Schema\Reaction>|Observable<Schema\BranchShort>|iterable<int,Schema\CommitComment>|iterable<int,Schema\PullRequestSimple>|Schema\Operations\Checks\ListForRef\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Checks\ListSuitesForRef\Response\ApplicationJson\Ok|Schema\CombinedCommitStatus|iterable<int,Schema\Status>|Schema\BasicError|iterable<int,Schema\DeploymentStatus>|Schema\Operations\Repos\ListDeploymentBranchPolicies\Response\ApplicationJson\Ok|Observable<Schema\GitRef>|iterable<int,Schema\HookDeliveryItem>|iterable<int,Schema\IssueComment>|iterable<int,Schema\LabeledIssueEvent|Schema\UnlabeledIssueEvent|Schema\AssignedIssueEvent|Schema\UnassignedIssueEvent|Schema\MilestonedIssueEvent|Schema\DemilestonedIssueEvent|Schema\RenamedIssueEvent|Schema\ReviewRequestedIssueEvent|Schema\ReviewRequestRemovedIssueEvent|Schema\ReviewDismissedIssueEvent|Schema\LockedIssueEvent|Schema\AddedToProjectIssueEvent|Schema\MovedColumnInProjectIssueEvent|Schema\RemovedFromProjectIssueEvent|Schema\ConvertedNoteToIssueIssueEvent>|iterable<int,Schema\Label>|Schema\ConvertedNoteToIssueIssueEvent|Schema\TimelineCommentEvent|Schema\TimelineCrossReferencedEvent|Schema\TimelineCommittedEvent|Schema\TimelineReviewedEvent|Schema\TimelineLineCommentedEvent|Schema\TimelineCommitCommentedEvent|Schema\TimelineAssignedIssueEvent|Schema\TimelineUnassignedIssueEvent|Schema\StateChangeIssueEvent>|iterable<int,Schema\PullRequestReviewComment>|iterable<int,Schema\Commit>|iterable<int,Schema\DiffEntry>|iterable<int,Schema\PullRequestReview>|iterable<int,Schema\ReleaseAsset> */
