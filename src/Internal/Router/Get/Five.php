...
final class Five
{
    ...
    /** @return |Observable<Schema\OrganizationSecretScanningAlert>|Schema\GistComment|array{code:int}|Schema\ThreadSubscription|Observable<Schema\CodeScanningOrganizationAlertItems>|array{code:int,location:string}|Schema\ProjectCard|Observable<Schema\ProjectCard>|Observable<Schema\SimpleUser>|Observable<Schema\Autolink>|Observable<Schema\ShortBranch>|Observable<Schema\Collaborator>|Observable<Schema\CommitComment>|Observable<Schema\Commit>|iterable<Schema\Contributor>|Observable<Schema\Deployment>|Observable<Schema\Event>|Observable<Schema\MinimalRepository>|Observable<Schema\Hook>|Observable<Schema\RepositoryInvitation>|Observable<Schema\Issue>|Schema\BasicError|Observable<Schema\DeployKey>|Observable<Schema\Label>|Observable<Schema\Milestone>|Observable<Schema\Thread>|Observable<Schema\Project>|Observable<Schema\PullRequestSimple>|Observable<Schema\Release>|Schema\RepositorySubscription|Observable<Schema\Tag>|Observable<Schema\Team>|Schema\TeamProject|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok */
