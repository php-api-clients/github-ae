...
final class Five
{
    ...
    /** @return Schema\HookDelivery|Schema\ActionsEnterprisePermissions|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnerGroupsForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable<Schema\OrganizationSecretScanningAlert>|Schema\GistComment|array{code:int}|Schema\ThreadSubscription|Schema\ActionsOrganizationPermissions|Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|iterable<Schema\CodeScanningOrganizationAlertItems>|Schema\ExternalGroup|Schema\OrgHook|array{code:int,location:string}|Schema\OrgMembership|Schema\Migration|Schema\TeamFull|Schema\ProjectCard|iterable<Schema\ProjectCard>|iterable<Schema\SimpleUser>|iterable<Schema\Autolink>|iterable<Schema\ShortBranch>|iterable<Schema\Collaborator>|iterable<Schema\CommitComment>|iterable<Schema\Commit>|iterable<Schema\Contributor>|iterable<Schema\Deployment>|Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|iterable<Schema\Event>|iterable<Schema\MinimalRepository>|iterable<Schema\Hook>|Schema\Installation|Schema\BasicError|iterable<Schema\RepositoryInvitation>|iterable<Schema\Issue>|iterable<Schema\DeployKey>|iterable<Schema\Label>|Schema\Language|Schema\LicenseContent|iterable<Schema\Milestone>|iterable<Schema\Thread>|Schema\Page|iterable<Schema\Project>|iterable<Schema\PullRequestSimple>|Schema\ContentFile|iterable<Schema\Release>|Schema\SimpleUser|Schema\Stargazer|Schema\RepositorySubscription|iterable<Schema\Tag>|iterable<Schema\Team>|Schema\Topic|Schema\TeamDiscussion|Schema\TeamMembership|Schema\TeamProject|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok */
