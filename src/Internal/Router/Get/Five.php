...
final class Five
{
    ...
    /** @return Schema\HookDelivery|Schema\ActionsEnterprisePermissions|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnerGroupsForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable<int,Schema\OrganizationSecretScanningAlert>|Schema\GistComment|WithoutBody|Schema\ThreadSubscription|Schema\ActionsOrganizationPermissions|Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|iterable<int,Schema\CodeScanningOrganizationAlertItems>|Schema\ExternalGroup|Schema\OrgHook|Schema\OrgMembership|Schema\Migration|Schema\TeamFull|Schema\ProjectCard|iterable<int,Schema\ProjectCard>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\Autolink>|iterable<int,Schema\ShortBranch>|iterable<int,Schema\Collaborator>|iterable<int,Schema\CommitComment>|iterable<int,Schema\Commit>|iterable<int,Schema\Contributor>|iterable<int,Schema\Deployment>|Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|iterable<int,Schema\Event>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\Hook>|Schema\Installation|Schema\BasicError|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\Issue>|iterable<int,Schema\DeployKey>|iterable<int,Schema\Label>|Schema\Language|Schema\LicenseContent|iterable<int,Schema\Milestone>|iterable<int,Schema\Thread>|Schema\Page|iterable<int,Schema\Project>|iterable<int,Schema\PullRequestSimple>|Schema\ContentFile|iterable<int,Schema\Release>|Schema\SimpleUser|Schema\Stargazer|Schema\RepositorySubscription|iterable<int,Schema\Tag>|iterable<int,Schema\Team>|Schema\Topic|Schema\TeamDiscussion|Schema\TeamMembership|Schema\TeamProject|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok */
