...
final class Repos
{
    ...
    public function enableLfsForRepo(array $params): Json|WithoutBody
    {
        ...
        unset($params['repo']);
        $operator = new Internal\Operator\Repos\EnableLfsForRepo($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Lfs());
