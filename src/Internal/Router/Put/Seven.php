...
final class Seven
{
    ...
    /** @return array{code:int}|Schema\TeamMembership|Schema\EmptyObject|Schema\ProtectedBranch|iterable<Schema\Label>|Schema\BasicError|Schema\PullRequestMergeResult|Schema\Operations\Pulls\UpdateBranch\Response\ApplicationJson\Accepted\Application\Json */
