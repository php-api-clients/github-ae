...
final class RemoveLabel
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Labels\Name $hydrator, string $owner, string $repo, int $issueNumber, private string $name)
    {
        $this->owner       = $owner;
        $this->repo        = $repo;
