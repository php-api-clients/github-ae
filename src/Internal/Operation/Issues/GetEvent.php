...
final class GetEvent
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Events\EventId $hydrator, string $owner, string $repo, private int $eventId)
    {
        $this->owner = $owner;
        $this->repo  = $repo;
    }
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\IssueEvent::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
