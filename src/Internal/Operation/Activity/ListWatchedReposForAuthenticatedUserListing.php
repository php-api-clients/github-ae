...
final class ListWatchedReposForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\User\Subscriptions $hydrator, int $perPage = 30, int $page = 1)
    {
