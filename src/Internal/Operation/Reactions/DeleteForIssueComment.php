...
final class DeleteForIssueComment
{
    ...
    {
        return new Request('DELETE', str_replace(['{owner}', '{repo}', '{comment_id}', '{reaction_id}'], [$this->owner, $this->repo, $this->commentId, $this->reactionId], '/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}'));
    }
