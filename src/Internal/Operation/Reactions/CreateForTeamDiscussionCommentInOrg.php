...
final class CreateForTeamDiscussionCommentInOrg
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', str_replace(['{org}', '{team_slug}', '{discussion_number}', '{comment_number}'], [$this->org, $this->teamSlug, $this->discussionNumber, $this->commentNumber], '/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions'), ['Content-Type' => 'application/json'], json_encode($data));
    }
