...
final class CreateForPullRequestReviewComment
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', str_replace(['{owner}', '{repo}', '{comment_id}'], [$this->owner, $this->repo, $this->commentId], '/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions'), ['Content-Type' => 'application/json'], json_encode($data));
    }
