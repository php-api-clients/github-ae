...
final class ListFollowersForAuthenticatedUserListing
{
    public const OPERATION_ID    = 'users/list-followers-for-authenticated-user';
    public const OPERATION_MATCH = 'LIST /user/followers';
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\User\Followers $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', str_replace(['{per_page}', '{page}'], [$this->perPage, $this->page], '/user/followers' . '?per_page={per_page}&page={page}'));
    }
