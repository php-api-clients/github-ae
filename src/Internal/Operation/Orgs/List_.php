...
final class List_
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Organizations $hydrator, int $since, int $perPage = 30)
    {
        $this->since   = $since;
    ...
    {
        return new Request('GET', str_replace(['{since}', '{per_page}'], [$this->since, $this->perPage], '/organizations' . '?since={since}&per_page={per_page}'));
    }
