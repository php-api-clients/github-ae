...
final class ListForAuthenticatedUserListing
{
    ...
    public const OPERATION_MATCH = 'LIST /user/orgs';
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\User\Orgs $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', str_replace(['{per_page}', '{page}'], [$this->perPage, $this->page], '/user/orgs' . '?per_page={per_page}&page={page}'));
    }
