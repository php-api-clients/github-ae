...
final class GetWebhookDelivery
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\App\Hook\Deliveries\DeliveryId $hydrator, private int $deliveryId)
    {
    }

    public function createRequest(): RequestInterface
    {
        return new Request('GET', str_replace(['{delivery_id}'], [$this->deliveryId], '/app/hook/deliveries/{delivery_id}'));
    }
