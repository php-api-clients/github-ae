...
final class AddStatusCheckContexts
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', str_replace(['{owner}', '{repo}', '{branch}'], [$this->owner, $this->repo, $this->branch], '/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'), ['Content-Type' => 'application/json'], json_encode($data));
    }
