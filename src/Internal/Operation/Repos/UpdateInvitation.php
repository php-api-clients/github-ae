...
final class UpdateInvitation
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Invitations\InvitationId $hydrator, string $owner, string $repo, int $invitationId)
    {
        $this->owner        = $owner;
        $this->repo         = $repo;
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', str_replace(['{owner}', '{repo}', '{invitation_id}'], [$this->owner, $this->repo, $this->invitationId], '/repos/{owner}/{repo}/invitations/{invitation_id}'), ['Content-Type' => 'application/json'], json_encode($data));
    }
