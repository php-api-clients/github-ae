...
final class ListForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\Gists $hydrator, string $username, string $since, int $perPage = 30, int $page = 1)
    {
