...
final class ListPublicListing
{
    public const OPERATION_ID    = 'gists/list-public';
    public const OPERATION_MATCH = 'LIST /gists/public';
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Gists\Public_ $hydrator, string $since, int $perPage = 30, int $page = 1)
    {
        $this->since   = $since;
    ...
    {
        return new Request('GET', str_replace(['{since}', '{per_page}', '{page}'], [$this->since, $this->perPage, $this->page], '/gists/public' . '?since={since}&per_page={per_page}&page={page}'));
    }
