...
final class CreateReplyForReviewComment
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Comments\CommentId\Replies $hydrator, string $owner, string $repo, int $pullNumber, int $commentId)
    {
        $this->owner      = $owner;
        $this->repo       = $repo;
