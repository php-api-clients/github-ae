...
final class ListDiscussionsLegacy
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Teams\TeamId\Discussions $hydrator, int $teamId, string $direction = 'desc', int $perPage = 30, int $page = 1)
    {
        $this->teamId    = $teamId;
