...
final class List_
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Teams $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
    ...
    {
        return new Request('GET', str_replace(['{org}', '{per_page}', '{page}'], [$this->org, $this->perPage, $this->page], '/orgs/{org}/teams' . '?per_page={per_page}&page={page}'));
    }
