...
final class CreateImpersonationOAuthToken
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Admin\Users\Username\Authorizations $hydrator, string $username)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', str_replace(['{username}'], [$this->username], '/admin/users/{username}/authorizations'), ['Content-Type' => 'application/json'], json_encode($data));
    }
