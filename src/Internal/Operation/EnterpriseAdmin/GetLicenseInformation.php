...
final class GetLicenseInformation
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Enterprise\Settings\License $hydrator)
    {
    }
