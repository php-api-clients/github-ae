...
final class StartPreReceiveEnvironmentDownloadStreaming
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Admin\PreReceiveEnvironments\PreReceiveEnvironmentId\Downloads $hydrator, private readonly Browser $browser, int $preReceiveEnvironmentId)
    {
