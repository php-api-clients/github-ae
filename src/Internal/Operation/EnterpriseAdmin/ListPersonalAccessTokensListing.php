...
final class ListPersonalAccessTokensListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Admin\Tokens $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', str_replace(['{per_page}', '{page}'], [$this->perPage, $this->page], '/admin/tokens' . '?per_page={per_page}&page={page}'));
    }
