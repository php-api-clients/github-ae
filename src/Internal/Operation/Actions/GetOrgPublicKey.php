...
final class GetOrgPublicKey
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Actions\Secrets\PublicKey $hydrator, string $org)
    {
        $this->org = $org;
    }
