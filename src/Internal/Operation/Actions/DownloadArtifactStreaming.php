...
final class DownloadArtifactStreaming
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Artifacts\ArtifactId\ArchiveFormat $hydrator, private readonly Browser $browser, string $owner, string $repo, int $artifactId, private string $archiveFormat)
    {
        $this->owner      = $owner;
        $this->repo       = $repo;
