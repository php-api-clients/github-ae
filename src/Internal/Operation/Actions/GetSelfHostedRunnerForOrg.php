...
final class GetSelfHostedRunnerForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Actions\Runners\RunnerId $hydrator, string $org, int $runnerId)
    {
        $this->org      = $org;
