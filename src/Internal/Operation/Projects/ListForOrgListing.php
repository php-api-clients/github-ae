...
final class ListForOrgListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Projects $hydrator, string $org, string $state = 'open', int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
        $this->state   = $state;
