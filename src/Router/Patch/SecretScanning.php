...
final class SecretScanning
{
    ...
    public function updateAlert(array $params): SecretScanningAlert|array
    {
        ...
        $operator = new Operator\SecretScanning\UpdateAlert($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀SecretScanning🌀Alerts🌀AlertNumber());
