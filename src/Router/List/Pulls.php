...
final class Pulls
{
    ...
    public function listListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls());
    ...
    public function listReviewCommentsForRepoListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListReviewCommentsForRepoListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀Comments());
    ...
    public function listReviewCommentsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListReviewCommentsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Comments());
    ...
    public function listCommitsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListCommitsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Commits());
    ...
    public function listFilesListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListFilesListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Files());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['pull_number'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listReviewsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListReviewsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Reviews());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['pull_number'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listCommentsForReviewListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Pulls\ListCommentsForReviewListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pulls🌀PullNumber🌀Reviews🌀ReviewId🌀Comments());
