...
final class Repos
{
    ...
    public function listForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀Repos());
    ...
    public function listInvitationsForAuthenticatedUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListInvitationsForAuthenticatedUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀RepositoryInvitations());
    ...
    public function listForOrgListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListForOrgListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Repos());
    ...
    public function listForUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListForUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀Repos());
    ...
    public function listBranchesListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListBranchesListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches());
    ...
    public function listCollaboratorsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListCollaboratorsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Collaborators());
    ...
    public function listCommitCommentsForRepoListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListCommitCommentsForRepoListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Comments());
    ...
    public function listCommitsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListCommitsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Commits());
    ...
    public function listContributorsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListContributorsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Contributors());
    ...
    public function listDeploymentsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListDeploymentsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments());
    ...
    public function listForksListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListForksListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Forks());
    ...
    public function listWebhooksListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListWebhooksListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listInvitationsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListInvitationsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Invitations());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listDeployKeysListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListDeployKeysListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Keys());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listReleasesListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListReleasesListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Releases());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listTagsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListTagsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Tags());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listTeamsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListTeamsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Teams());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listPagesBuildsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListPagesBuildsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages🌀Builds());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listCommentsForCommitListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListCommentsForCommitListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Commits🌀CommitSha🌀Comments());
    ...
    public function listPullRequestsAssociatedWithCommitListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListPullRequestsAssociatedWithCommitListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Commits🌀CommitSha🌀Pulls());
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['commit_sha'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listCommitStatusesForRefListing(array $params): iterable|BasicError
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListCommitStatusesForRefListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Commits🌀Ref🌀Statuses());
    ...
    public function listDeploymentStatusesListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListDeploymentStatusesListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments🌀DeploymentId🌀Statuses());
    ...
    public function listReleaseAssetsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Operator\Repos\ListReleaseAssetsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Releases🌀ReleaseId🌀Assets());
