...
use ApiClients\Client\GitHubAE\Schema\Operation\Projects\MoveColumn\Response\Applicationjson\H201;
...
final class Projects
{
    ...
    public function moveCard(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): \ApiClients\Client\GitHubAE\Schema\Operation\Projects\MoveCard\Response\Applicationjson\H201 {
            return $operation->createResponse($response);
        });
    }
}
