...
final class Seven
{
    ...
    /** @return |(Schema\DeploymentBranchPolicy|array{code: int})|array{code: int}|(Observable<Schema\Label>|Schema\BasicError)|(Schema\PullRequestSimple|(Schema\ReleaseAsset */
