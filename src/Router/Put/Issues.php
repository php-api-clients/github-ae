...
final class Issues
{
    ...
    public function setLabels(array $params): iterable|BasicError
    {
        ...
        $operator = new Operator\Issues\SetLabels($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Issues🌀IssueNumber🌀Labels());
    ...
    public function lock(array $params): array
    {
        ...
        $arguments['issue_number'] = $params['issue_number'];
        unset($params['issue_number']);
        $operator = new Operator\Issues\Lock($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Issues🌀IssueNumber🌀Lock());
