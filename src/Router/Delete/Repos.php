...
final class Repos
{
    ...
    public function delete(array $params): BasicError|array
    {
        ...
        unset($params['repo']);
        $operator = new Operator\Repos\Delete($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo());
    ...
    public function declineInvitationForAuthenticatedUser(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeclineInvitationForAuthenticatedUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀RepositoryInvitations🌀InvitationId());
    ...
    public function deletePagesSite(array $params): array
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Operator\Repos\DeletePagesSite($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages());
    ...
    public function deleteBranchProtection(array $params): array
    {
        ...
        unset($params['branch']);
        $operator = new Operator\Repos\DeleteBranchProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection());
    ...
    public function deleteAutolink(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeleteAutolink($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Autolinks🌀AutolinkId());
    ...
    public function removeCollaborator(array $params): array
    {
        ...
        $operator = new Operator\Repos\RemoveCollaborator($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Collaborators🌀Username());
    ...
    public function deleteCommitComment(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeleteCommitComment($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Comments🌀CommentId());
    ...
    public function deleteFile(array $params): FileCommit|array
    {
        ...
        unset($params['path']);
        $operator = new Operator\Repos\DeleteFile($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Contents🌀Path());
    ...
    public function deleteDeployment(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeleteDeployment($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments🌀DeploymentId());
    ...
    public function deleteWebhook(array $params): array
    {
        ...
        $operator = new Operator\Repos\DeleteWebhook($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks🌀HookId());
    ...
    public function deleteAdminBranchProtection(array $params): array
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\DeleteAdminBranchProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀EnforceAdmins());
    ...
    public function deletePullRequestReviewProtection(array $params): array
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\DeletePullRequestReviewProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀RequiredPullRequestReviews());
    ...
    public function deleteCommitSignatureProtection(array $params): array
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\DeleteCommitSignatureProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀RequiredSignatures());
    ...
    public function removeStatusCheckContexts(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\RemoveStatusCheckContexts($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀RequiredStatusChecks🌀Contexts());
    ...
    public function removeAppAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\RemoveAppAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Apps());
    ...
    public function removeTeamAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\RemoveTeamAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Teams());
    ...
    public function removeUserAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new Operator\Repos\RemoveUserAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Users());
