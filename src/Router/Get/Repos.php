...
use ApiClients\Client\GitHubAE\Schema\Operation\Repos\GetCodeFrequencyStats\Response\Applicationjson\H202;
use ApiClients\Client\GitHubAE\Schema\Operation\Repos\GetContent\Response\Applicationjson\H200;
...
final class Repos
{
    ...
    public function codeownersErrors(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): CodeownersErrors {
            return $operation->createResponse($response);
        });
    }
    ...
    public function getCommitActivityStats(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): Observable|\ApiClients\Client\GitHubAE\Schema\Operation\Repos\GetCommitActivityStats\Response\Applicationjson\H202 {
            return $operation->createResponse($response);
        });
    }
    ...
    public function getContributorsStats(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): Observable|\ApiClients\Client\GitHubAE\Schema\Operation\Repos\GetContributorsStats\Response\Applicationjson\H202 {
            return $operation->createResponse($response);
        });
    }
    ...
    public function getAllEnvironments(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): \ApiClients\Client\GitHubAE\Schema\Operation\Repos\GetAllEnvironments\Response\Applicationjson\H200 {
            return $operation->createResponse($response);
        });
    }
    ...
    public function listDeploymentBranchPolicies(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): \ApiClients\Client\GitHubAE\Schema\Operation\Repos\ListDeploymentBranchPolicies\Response\Applicationjson\H200 {
            return $operation->createResponse($response);
        });
    }
