...
final class Operators
{
    ...
    private Operator\Apps\ResetAuthorization|null $apps👷ResetAuthorization                                                                                                 = null;
    ...
    public function apps👷ResetAuthorization(): Operator\Apps\ResetAuthorization
    {
        if ($this->apps👷ResetAuthorization instanceof Operator\Apps\ResetAuthorization === false) {
            $this->apps👷ResetAuthorization = new Operator\Apps\ResetAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀ClientId🌀Tokens🌀AccessToken());
        }
