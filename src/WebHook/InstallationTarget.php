 ...
 * @internal
 */
final class InstallationTarget implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    private readonly \League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator;
    private readonly Hydrator\WebHook\InstallationTarget $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, Hydrator\WebHook\InstallationTarget $hydrator)
    {
    ...
    public function resolve(array $headers, array $data) : Schema\WebhookInstallationTargetRenamed
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\WebhookInstallationTargetRenamed::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
