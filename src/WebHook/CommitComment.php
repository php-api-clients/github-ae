 ...
 * @internal
 */
final class CommitComment implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    private readonly \League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator;
    private readonly Hydrator\WebHook\CommitComment $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, Hydrator\WebHook\CommitComment $hydrator)
    {
    ...
    public function resolve(array $headers, array $data) : Schema\WebhookCommitCommentCreated
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\WebhookCommitCommentCreated::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
