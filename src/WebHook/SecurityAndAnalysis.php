...
final class SecurityAndAnalysis implements \ApiClients\Contracts\OpenAPI\WebHookInterface
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, Hydrator\WebHook\SecurityAndAnalysis $hydrator)
    {
    ...
    public function resolve(array $headers, array $data) : Schema\WebhookSecurityAndAnalysis
    {
        ...
        if ($headers['content-type'] == 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\WebhookSecurityAndAnalysis::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
