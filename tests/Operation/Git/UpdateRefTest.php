...
final class UpdateRefTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/git/refs/generated', Argument::type('array'), Schema\Git\UpdateRef\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Git\UpdateRef::OPERATION_MATCH, (static function (array $data): array {
