...
final class GetBlobTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/git/blobs/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Git\GetBlob::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'file_sha' => 'generated_null'));
    }
    /**
     * @test
     */
