...
use ApiClients\Client\GitHubAE\Operation\Git\CreateBlob;
...
final class CreateBlobTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/git/blobs', Argument::type('array'), Schema\Git\CreateBlob\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateBlob::OPERATION_MATCH, (static function (array $data): array {
