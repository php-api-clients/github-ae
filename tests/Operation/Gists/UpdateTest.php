...
use ApiClients\Client\GitHubAE\Operation\Gists\Update;
...
final class UpdateTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/gists/generated_null', Argument::type('array'), Schema\Gists\Update\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
