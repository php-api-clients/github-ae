...
final class GetRevisionTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/gists/generated_null/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Gists\GetRevision::OPERATION_MATCH, array('gist_id' => 'generated_null', 'sha' => 'generated_null'));
    }
    /**
     * @test
     */
