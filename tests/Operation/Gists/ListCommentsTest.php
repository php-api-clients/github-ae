...
use ApiClients\Client\GitHubAE\Operation\Gists\ListComments;
...
final class ListCommentsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/gists/generated_null/comments?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
