...
use ApiClients\Client\GitHubAE\Operation\Gists\ListPublic;
...
final class ListPublicTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/gists/public?since=1970-01-01T00:00:00+00:00&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
