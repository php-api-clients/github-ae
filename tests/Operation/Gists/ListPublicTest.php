...
/** @covers \ApiClients\Client\GitHubAE\Operation\Gists\ListPublic */
final class ListPublicTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/public?since=1970-01-01T00:00:00+00:00&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Gists\ListPublic::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/public?since=1970-01-01T00:00:00+00:00&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->gists()->listPublic('1970-01-01T00:00:00+00:00', 8, 4);
    }
