...
use ApiClients\Client\GitHubAE\Operation\Gists\CreateComment;
...
final class CreateCommentTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/gists/generated_null/comments', Argument::type('array'), Schema\Gists\CreateComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
