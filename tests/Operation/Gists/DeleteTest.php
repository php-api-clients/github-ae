...
use ApiClients\Client\GitHubAE\Operation\Gists\Delete;
...
final class DeleteTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/gists/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
