...
final class UnstarTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t404td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/gists/generated_null/star', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Gists\Unstar::OPERATION_MATCH, array('gist_id' => 'generated_null'));
    }
    /**
     * @test
     */
