...
/** @covers \ApiClients\Client\GitHubAE\Operation\Gists\ListStarredListing */
final class ListStarredListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Gists\ListStarredListing::OPERATION_MATCH, (static function (array $data): array {
