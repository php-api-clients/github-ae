...
final class ListStarredTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/starred?since=1970-01-01T00:00:00+00:00&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/starred?since=1970-01-01T00:00:00+00:00&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->gists()->listStarred('1970-01-01T00:00:00+00:00', 8, 4);
    }
