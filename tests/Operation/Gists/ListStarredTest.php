...
/** @covers \ApiClients\Client\GitHubAE\Operation\Gists\ListStarred */
final class ListStarredTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Gists\ListStarred::OPERATION_MATCH, (static function (array $data): array {
