...
use ApiClients\Client\GitHubAE\Operation\Gists\UpdateComment;
...
final class UpdateCommentTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/gists/generated_null/comments/13', Argument::type('array'), Schema\Gists\UpdateComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
