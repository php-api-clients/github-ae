...
use ApiClients\Client\GitHubAE\Operation\Gists\Star;
...
final class StarTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/gists/generated_null/star', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Star::OPERATION_MATCH, (static function (array $data): array {
