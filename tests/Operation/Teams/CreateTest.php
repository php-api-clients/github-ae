...
use ApiClients\Client\GitHubAE\Operation\Teams\Create;
...
final class CreateTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/teams', Argument::type('array'), Schema\Teams\Create\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
