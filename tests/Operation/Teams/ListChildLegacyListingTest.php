...
/** @covers \ApiClients\Client\GitHubAE\Operation\Teams\ListChildLegacyListing */
final class ListChildLegacyListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Teams\ListChildLegacyListing::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']  = 7;
            $data['per_page'] = 8;
            $data['page']     = 1;
