...
use ApiClients\Client\GitHubAE\Operation\Teams\UpdateDiscussionCommentLegacy;
...
final class UpdateDiscussionCommentLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/teams/13/discussions/13/comments/13', Argument::type('array'), Schema\Teams\UpdateDiscussionCommentLegacy\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateDiscussionCommentLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']           = 13;
