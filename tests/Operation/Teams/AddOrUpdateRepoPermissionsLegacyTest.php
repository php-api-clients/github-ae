...
final class AddOrUpdateRepoPermissionsLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/teams/7/repos/generated/generated', Argument::type('array'), Schema\Teams\AddOrUpdateRepoPermissionsLegacy\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
