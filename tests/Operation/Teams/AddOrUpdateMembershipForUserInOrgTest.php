...
final class AddOrUpdateMembershipForUserInOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/teams/generated/memberships/generated', Argument::type('array'), Schema\Teams\AddOrUpdateMembershipForUserInOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Teams\AddOrUpdateMembershipForUserInOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/teams/generated/memberships/generated', Argument::type('array'), Schema\Teams\AddOrUpdateMembershipForUserInOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->teams()->addOrUpdateMembershipForUserInOrg('generated', 'generated', 'generated', json_decode(Schema\Teams\AddOrUpdateMembershipForUserInOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
