...
use ApiClients\Client\GitHubAE\Operation\Teams\CreateDiscussionLegacy;
...
final class CreateDiscussionLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/teams/13/discussions', Argument::type('array'), Schema\Teams\CreateDiscussionLegacy\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateDiscussionLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id'] = 13;
