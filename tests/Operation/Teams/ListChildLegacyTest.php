...
use ApiClients\Client\GitHubAE\Operation\Teams\ListChildLegacy;
...
final class ListChildLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/teams/13/teams?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListChildLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']  = 13;
            $data['per_page'] = 13;
            $data['page']     = 13;
