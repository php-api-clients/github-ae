...
use ApiClients\Client\GitHubAE\Operation\Teams\GetMembershipForUserLegacy;
...
final class GetMembershipForUserLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/teams/13/memberships/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetMembershipForUserLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']  = 13;
