...
use ApiClients\Client\GitHubAE\Operation\EnterpriseAdmin\StartPreReceiveEnvironmentDownload;
...
final class StartPreReceiveEnvironmentDownloadTest extends AsyncTestCase
{
    ...
    public function httpCode_202_responseContentType_application_json(): void
    {
        ...
        $client->call(StartPreReceiveEnvironmentDownload::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function httpCode_422_responseContentType_application_json(): void
    {
        ...
        $response = new Response(422, ['Content-Type' => 'application/json'], Schema\Operation\EnterpriseAdmin\StartPreReceiveEnvironmentDownload\Response\Applicationjson\H422::SCHEMA_EXAMPLE_DATA);
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
