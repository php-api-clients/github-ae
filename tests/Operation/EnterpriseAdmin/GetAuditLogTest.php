...
use ApiClients\Client\GitHubAE\Operation\EnterpriseAdmin\GetAuditLog;
...
final class GetAuditLogTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/enterprises/generated_null/audit-log?phrase=generated_null&after=generated_null&before=generated_null&order=generated_null&page=13&per_page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
