...
use ApiClients\Client\GitHubAE\Operation\Users\Follow;
...
final class FollowTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/user/following/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Follow::OPERATION_MATCH, (static function (array $data): array {
