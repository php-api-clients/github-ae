...
use ApiClients\Client\GitHubAE\Operation\Users\CreatePublicSshKeyForAuthenticatedUser;
...
final class CreatePublicSshKeyForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $client->call(CreatePublicSshKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
