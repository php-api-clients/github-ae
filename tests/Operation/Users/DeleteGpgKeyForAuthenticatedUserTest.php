...
use ApiClients\Client\GitHubAE\Operation\Users\DeleteGpgKeyForAuthenticatedUser;
...
final class DeleteGpgKeyForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/gpg_keys/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteGpgKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['gpg_key_id'] = 13;
