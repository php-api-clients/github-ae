...
final class DeleteGpgKeyForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t404td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/user/gpg_keys/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Users\DeleteGpgKeyForAuthenticatedUser::OPERATION_MATCH, array('gpg_key_id' => 13));
    }
    /**
     * @test
     */
