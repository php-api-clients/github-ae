...
use ApiClients\Client\GitHubAE\Operation\Users\CreateGpgKeyForAuthenticatedUser;
...
final class CreateGpgKeyForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/user/gpg_keys', Argument::type('array'), Schema\Users\CreateGpgKeyForAuthenticatedUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateGpgKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
