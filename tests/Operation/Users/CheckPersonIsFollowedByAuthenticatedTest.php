...
use ApiClients\Client\GitHubAE\Operation\Users\CheckPersonIsFollowedByAuthenticated;
...
final class CheckPersonIsFollowedByAuthenticatedTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/user/following/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CheckPersonIsFollowedByAuthenticated::OPERATION_MATCH, (static function (array $data): array {
