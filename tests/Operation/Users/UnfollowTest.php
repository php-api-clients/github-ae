...
use ApiClients\Client\GitHubAE\Operation\Users\Unfollow;
...
final class UnfollowTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/following/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Unfollow::OPERATION_MATCH, (static function (array $data): array {
