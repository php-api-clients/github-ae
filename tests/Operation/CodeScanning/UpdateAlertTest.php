...
use ApiClients\Client\GitHubAE\Operation\CodeScanning\UpdateAlert;
...
final class UpdateAlertTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/code-scanning/alerts/13', Argument::type('array'), Schema\CodeScanning\UpdateAlert\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
