...
use ApiClients\Client\GitHubAE\Operation\CodeScanning\GetAlert;
...
final class GetAlertTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/code-scanning/alerts/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetAlert::OPERATION_MATCH, (static function (array $data): array {
