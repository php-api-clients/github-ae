...
final class GetAnalysisTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/code-scanning/analyses/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\CodeScanning\GetAnalysis::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'analysis_id' => 13));
    }
    /**
     * @test
     */
    public function t200t658c99071329307af8e6e600da1e7c4b()
    {
