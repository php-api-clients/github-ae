...
use ApiClients\Client\GitHubAE\Operation\CodeScanning\GetSarif;
...
final class GetSarifTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/code-scanning/sarifs/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetSarif::OPERATION_MATCH, (static function (array $data): array {
