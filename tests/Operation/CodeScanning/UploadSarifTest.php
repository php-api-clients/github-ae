...
use ApiClients\Client\GitHubAE\Operation\CodeScanning\UploadSarif;
...
final class UploadSarifTest extends AsyncTestCase
{
    ...
    public function httpCode_202_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/code-scanning/sarifs', Argument::type('array'), Schema\CodeScanning\UploadSarif\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UploadSarif::OPERATION_MATCH, (static function (array $data): array {
