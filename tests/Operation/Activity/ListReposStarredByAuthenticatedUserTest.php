...
/** @covers \ApiClients\Client\GitHubAE\Operation\Activity\ListReposStarredByAuthenticatedUser */
final class ListReposStarredByAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/starred?sort=generated&direction=generated&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Activity\ListReposStarredByAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['sort']      = 'generated';
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/starred?sort=generated&direction=generated&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->listReposStarredByAuthenticatedUser('generated', 'generated', 8, 4);
    }
