...
use ApiClients\Client\GitHubAE\Operation\Activity\GetRepoSubscription;
...
final class GetRepoSubscriptionTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetRepoSubscription::OPERATION_MATCH, (static function (array $data): array {
