...
/** @covers \ApiClients\Client\GitHubAE\Operation\Activity\MarkRepoNotificationsAsRead */
final class MarkRepoNotificationsAsReadTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Activity\MarkRepoNotificationsAsRead\Response\ApplicationJson\Accepted\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Operation\Activity\MarkRepoNotificationsAsRead::OPERATION_MATCH, (static function (array $data): array {
