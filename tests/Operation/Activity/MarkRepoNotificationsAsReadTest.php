...
final class MarkRepoNotificationsAsReadTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/notifications', Argument::type('array'), Schema\Activity\MarkRepoNotificationsAsRead\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
