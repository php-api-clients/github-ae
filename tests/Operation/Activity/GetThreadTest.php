...
use ApiClients\Client\GitHubAE\Operation\Activity\GetThread;
...
final class GetThreadTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/notifications/threads/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetThread::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 13;
