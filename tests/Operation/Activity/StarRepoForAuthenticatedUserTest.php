...
use ApiClients\Client\GitHubAE\Operation\Activity\StarRepoForAuthenticatedUser;
...
final class StarRepoForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/user/starred/generated_null/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(StarRepoForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
