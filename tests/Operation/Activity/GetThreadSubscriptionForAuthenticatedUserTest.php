...
final class GetThreadSubscriptionForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $browser->request('GET', '/notifications/threads/13/subscription', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
            $data['thread_id'] = 13;
            return $data;
        })(array()));
    }
