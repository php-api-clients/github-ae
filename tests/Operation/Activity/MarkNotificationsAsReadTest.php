...
final class MarkNotificationsAsReadTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    {
        $response = new \React\Http\Message\Response(202, array('Content-Type' => 'application/json'), Schema\Operation\Activity\MarkNotificationsAsRead\Response\Applicationjson\H202::SCHEMA_EXAMPLE_DATA);
        ...
        $client->call(\ApiClients\Client\GitHubAE\Operation\Activity\MarkNotificationsAsRead::OPERATION_MATCH, (static function (array $data) : array {
            return $data;
