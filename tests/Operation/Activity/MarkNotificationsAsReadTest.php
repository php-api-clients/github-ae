...
use ApiClients\Client\GitHubAE\Operation\Activity\MarkNotificationsAsRead;
...
final class MarkNotificationsAsReadTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], Schema\Operation\Activity\MarkNotificationsAsRead\Response\Applicationjson\H202::SCHEMA_EXAMPLE_DATA);
        ...
        $client->call(MarkNotificationsAsRead::OPERATION_MATCH, (static function (array $data): array {
            return $data;
