...
final class CheckRepoIsStarredByAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t404td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/user/starred/generated_null/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Activity\CheckRepoIsStarredByAuthenticatedUser::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null'));
    }
    /**
     * @test
     */
