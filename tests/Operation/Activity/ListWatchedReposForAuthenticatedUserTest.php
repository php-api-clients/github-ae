...
use ApiClients\Client\GitHubAE\Operation\Activity\ListWatchedReposForAuthenticatedUser;
...
final class ListWatchedReposForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/user/subscriptions?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListWatchedReposForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 13;
            $data['page']     = 13;
