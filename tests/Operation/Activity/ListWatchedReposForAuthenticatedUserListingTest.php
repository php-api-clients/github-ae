...
/** @covers \ApiClients\Client\GitHubAE\Operation\Activity\ListWatchedReposForAuthenticatedUserListing */
final class ListWatchedReposForAuthenticatedUserListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Activity\ListWatchedReposForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
