...
use ApiClients\Client\GitHubAE\Operation\Activity\SetThreadSubscription;
...
final class SetThreadSubscriptionTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/notifications/threads/13/subscription', Argument::type('array'), Schema\Activity\SetThreadSubscription\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetThreadSubscription::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 13;
