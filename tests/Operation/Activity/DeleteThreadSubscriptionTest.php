...
use ApiClients\Client\GitHubAE\Operation\Activity\DeleteThreadSubscription;
...
final class DeleteThreadSubscriptionTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/notifications/threads/13/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteThreadSubscription::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 13;
