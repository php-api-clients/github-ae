...
final class RerequestRunTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/check-runs/13/rerequest', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Checks\RerequestRun::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'check_run_id' => 13));
    }
    /**
     * @test
     */
