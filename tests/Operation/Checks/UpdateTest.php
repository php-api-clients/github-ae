...
use ApiClients\Client\GitHubAE\Operation\Checks\Update;
...
final class UpdateTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/check-runs/13', Argument::type('array'), Schema\Checks\Update\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
