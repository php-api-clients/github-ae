...
use ApiClients\Client\GitHubAE\Operation\Projects\GetColumn;
...
final class GetColumnTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/projects/columns/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetColumn::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id'] = 13;
