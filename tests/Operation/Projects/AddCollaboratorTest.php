...
use ApiClients\Client\GitHubAE\Operation\Projects\AddCollaborator;
...
final class AddCollaboratorTest extends AsyncTestCase
{
    ...
    public function httpCode_404_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/projects/13/collaborators/generated_null', Argument::type('array'), Schema\Projects\AddCollaborator\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
