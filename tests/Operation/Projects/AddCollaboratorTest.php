...
final class AddCollaboratorTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_404_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/projects/13/collaborators/generated_null', \Prophecy\Argument::type('array'), Schema\Projects\AddCollaborator\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Projects\AddCollaborator::OPERATION_MATCH, (static function (array $data) : array {
            $data['project_id'] = 13;
