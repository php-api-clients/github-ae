...
use ApiClients\Client\GitHubAE\Operation\Projects\CreateForRepo;
...
final class CreateForRepoTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/projects', Argument::type('array'), Schema\Projects\CreateForRepo\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateForRepo::OPERATION_MATCH, (static function (array $data): array {
