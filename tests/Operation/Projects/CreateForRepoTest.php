...
final class CreateForRepoTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/projects', \Prophecy\Argument::type('array'), Schema\Projects\CreateForRepo\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Projects\CreateForRepo::OPERATION_MATCH, (static function (array $data) : array {
