...
use ApiClients\Client\GitHubAE\Operation\Projects\GetCard;
...
final class GetCardTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/projects/columns/cards/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 13;
