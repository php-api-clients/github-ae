...
use ApiClients\Client\GitHubAE\Operation\Projects\ListForOrg;
...
final class ListForOrgTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/orgs/generated_null/projects?state=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
