...
final class CreateForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/projects', Argument::type('array'), Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/projects', Argument::type('array'), Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->projects()->createForAuthenticatedUser(json_decode(Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
