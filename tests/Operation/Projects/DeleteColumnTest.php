...
final class DeleteColumnTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t403td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/projects/columns/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Projects\DeleteColumn::OPERATION_MATCH, array('column_id' => 13));
    }
    /**
     * @test
     */
