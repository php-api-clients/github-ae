...
use ApiClients\Client\GitHubAE\Operation\Projects\ListCollaborators;
...
final class ListCollaboratorsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/projects/13/collaborators?affiliation=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
