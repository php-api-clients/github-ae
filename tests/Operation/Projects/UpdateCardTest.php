...
final class UpdateCardTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('PATCH', '/projects/columns/cards/13', \Prophecy\Argument::type('array'), Schema\Projects\UpdateCard\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Projects\UpdateCard::OPERATION_MATCH, (static function (array $data) : array {
            $data['card_id'] = 13;
            return $data;
