...
use ApiClients\Client\GitHubAE\Operation\Projects\UpdateCard;
...
final class UpdateCardTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/projects/columns/cards/13', Argument::type('array'), Schema\Projects\UpdateCard\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 13;
