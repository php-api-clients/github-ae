...
final class CreateForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/projects', Argument::type('array'), Schema\Projects\CreateForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Projects\CreateForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/projects', Argument::type('array'), Schema\Projects\CreateForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->projects()->createForOrg('generated', json_decode(Schema\Projects\CreateForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
