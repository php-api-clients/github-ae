...
use ApiClients\Client\GitHubAE\Operation\Projects\Delete;
...
final class DeleteTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $response = new Response(403, ['Content-Type' => 'application/json'], Schema\Operation\Projects\Delete\Response\Applicationjson\H403::SCHEMA_EXAMPLE_DATA);
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('DELETE', '/projects/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
