...
/** @covers \ApiClients\Client\GitHubAE\Operation\Projects\ListColumns */
final class ListColumnsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Projects\ListColumns::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 10;
            $data['per_page']   = 8;
            $data['page']       = 1;
