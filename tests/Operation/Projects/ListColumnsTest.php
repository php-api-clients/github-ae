...
use ApiClients\Client\GitHubAE\Operation\Projects\ListColumns;
...
final class ListColumnsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/projects/13/columns?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListColumns::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 13;
            $data['per_page']   = 13;
            $data['page']       = 13;
