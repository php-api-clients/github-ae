...
use ApiClients\Client\GitHubAE\Operation\Projects\RemoveCollaborator;
...
final class RemoveCollaboratorTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/projects/13/collaborators/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveCollaborator::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 13;
