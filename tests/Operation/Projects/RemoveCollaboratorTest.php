...
final class RemoveCollaboratorTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t404td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/projects/13/collaborators/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Projects\RemoveCollaborator::OPERATION_MATCH, array('project_id' => 13, 'username' => 'generated_null'));
    }
    /**
     * @test
     */
