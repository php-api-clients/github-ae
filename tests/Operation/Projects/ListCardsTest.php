...
use ApiClients\Client\GitHubAE\Operation\Projects\ListCards;
...
final class ListCardsTest extends AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/projects/columns/13/cards?archived_state=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListCards::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id']      = 13;
