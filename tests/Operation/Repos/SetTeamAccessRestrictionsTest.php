...
final class SetTeamAccessRestrictionsTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/teams', \Prophecy\Argument::type('array'), Schema\Repos\SetTeamAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\SetTeamAccessRestrictions::OPERATION_MATCH, (static function (array $data) : array {
