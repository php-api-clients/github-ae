...
final class CreateForkTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t202td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/forks', \Prophecy\Argument::type('array'), Schema\Repos\CreateFork\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\CreateFork::OPERATION_MATCH, (static function (array $data) : array {
