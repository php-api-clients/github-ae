...
use ApiClients\Client\GitHubAE\Operation\Repos\CreateFork;
...
final class CreateForkTest extends AsyncTestCase
{
    ...
    public function httpCode_202_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/forks', Argument::type('array'), Schema\Repos\CreateFork\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateFork::OPERATION_MATCH, (static function (array $data): array {
