...
/** @covers \ApiClients\Client\GitHubAE\Operation\Repos\ListForksListing */
final class ListForksListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Repos\ListForksListing::OPERATION_MATCH, (static function (array $data): array {
