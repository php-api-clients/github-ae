...
use ApiClients\Client\GitHubAE\Operation\Repos\AddUserAccessRestrictions;
...
final class AddUserAccessRestrictionsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/users', Argument::type('array'), Schema\Repos\AddUserAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(AddUserAccessRestrictions::OPERATION_MATCH, (static function (array $data): array {
