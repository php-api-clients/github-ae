...
final class RedeliverWebhookDeliveryTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_202_responseContentType_application_json()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/hooks/13/deliveries/13/attempts', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\RedeliverWebhookDelivery::OPERATION_MATCH, (static function (array $data) : array {
