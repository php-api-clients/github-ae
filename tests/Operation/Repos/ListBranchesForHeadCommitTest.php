...
final class ListBranchesForHeadCommitTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Repos\ListBranchesForHeadCommit::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/commits/generated/branches-where-head', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->repos()->listBranchesForHeadCommit('generated', 'generated', 'generated'));
    }
}
