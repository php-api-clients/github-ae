...
use ApiClients\Client\GitHubAE\Operation\Repos\Update;
...
final class UpdateTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null', Argument::type('array'), Schema\Repos\Update\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
     ...
     * @test
     */
    public function httpCode_307_requestContentType_application_json_responseContentType_application_json(): void
    {
