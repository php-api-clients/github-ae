...
use ApiClients\Client\GitHubAE\Operation\Repos\RemoveAppAccessRestrictions;
...
final class RemoveAppAccessRestrictionsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/apps', Argument::type('array'), Schema\Repos\RemoveAppAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveAppAccessRestrictions::OPERATION_MATCH, (static function (array $data): array {
