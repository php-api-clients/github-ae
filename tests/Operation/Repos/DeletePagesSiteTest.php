...
final class DeletePagesSiteTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t422td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/pages', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\DeletePagesSite::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null'));
    }
    /**
     * @test
     */
