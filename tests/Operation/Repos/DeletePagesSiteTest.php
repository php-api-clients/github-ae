...
final class DeletePagesSiteTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_422_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/pages', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\DeletePagesSite::OPERATION_MATCH, (static function (array $data) : array {
