...
use ApiClients\Client\GitHubAE\Operation\Repos\DeletePagesSite;
...
final class DeletePagesSiteTest extends AsyncTestCase
{
    ...
    public function httpCode_422_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/pages', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeletePagesSite::OPERATION_MATCH, (static function (array $data): array {
