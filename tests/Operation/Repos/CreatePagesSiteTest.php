...
use ApiClients\Client\GitHubAE\Operation\Repos\CreatePagesSite;
...
final class CreatePagesSiteTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/pages', Argument::type('array'), Schema\Repos\CreatePagesSite\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreatePagesSite::OPERATION_MATCH, (static function (array $data): array {
