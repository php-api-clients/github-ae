...
use ApiClients\Client\GitHubAE\Operation\Repos\CreateDeploymentStatus;
...
final class CreateDeploymentStatusTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/deployments/13/statuses', Argument::type('array'), Schema\Repos\CreateDeploymentStatus\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateDeploymentStatus::OPERATION_MATCH, (static function (array $data): array {
