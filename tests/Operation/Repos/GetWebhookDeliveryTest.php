...
final class GetWebhookDeliveryTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/hooks/13/deliveries/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\GetWebhookDelivery::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'hook_id' => 13, 'delivery_id' => 13));
    }
    /**
     * @test
     */
