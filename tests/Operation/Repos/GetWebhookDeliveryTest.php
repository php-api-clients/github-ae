...
use ApiClients\Client\GitHubAE\Operation\Repos\GetWebhookDelivery;
...
final class GetWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/hooks/13/deliveries/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetWebhookDelivery::OPERATION_MATCH, (static function (array $data): array {
