...
final class DeleteFileTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated/generated/contents/generated', Argument::type('array'), Schema\Repos\DeleteFile\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Repos\DeleteFile::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated/generated/contents/generated', Argument::type('array'), Schema\Repos\DeleteFile\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->repos()->deleteFile('generated', 'generated', 'generated', json_decode(Schema\Repos\DeleteFile\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
