...
use ApiClients\Client\GitHubAE\Operation\Repos\DeleteFile;
...
final class DeleteFileTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/contents/generated_null', Argument::type('array'), Schema\Repos\DeleteFile\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteFile::OPERATION_MATCH, (static function (array $data): array {
