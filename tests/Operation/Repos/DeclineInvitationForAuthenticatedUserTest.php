...
final class DeclineInvitationForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_409_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/user/repository_invitations/13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\DeclineInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
