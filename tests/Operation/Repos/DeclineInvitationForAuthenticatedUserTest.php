...
/** @covers \ApiClients\Client\GitHubAE\Operation\Repos\DeclineInvitationForAuthenticatedUser */
final class DeclineInvitationForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Repos\DeclineInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
