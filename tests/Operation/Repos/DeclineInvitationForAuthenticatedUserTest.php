...
final class DeclineInvitationForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t409td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/user/repository_invitations/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\DeclineInvitationForAuthenticatedUser::OPERATION_MATCH, array('invitation_id' => 13));
    }
    /**
     * @test
     */
