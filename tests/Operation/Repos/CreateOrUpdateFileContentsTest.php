...
final class CreateOrUpdateFileContentsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/contents/generated', Argument::type('array'), Schema\Repos\CreateOrUpdateFileContents\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
