...
final class AddCollaboratorTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/collaborators/generated', Argument::type('array'), Schema\Repos\AddCollaborator\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/collaborators/generated', Argument::type('array'), Schema\Repos\AddCollaborator\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->repos()->addCollaborator('generated', 'generated', 'generated', json_decode(Schema\Repos\AddCollaborator\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
