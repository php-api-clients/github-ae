...
use ApiClients\Client\GitHubAE\Operation\Repos\CreateAutolink;
...
final class CreateAutolinkTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/autolinks', Argument::type('array'), Schema\Repos\CreateAutolink\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateAutolink::OPERATION_MATCH, (static function (array $data): array {
