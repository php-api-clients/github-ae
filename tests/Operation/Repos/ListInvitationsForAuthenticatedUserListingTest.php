...
/** @covers \ApiClients\Client\GitHubAE\Operation\Repos\ListInvitationsForAuthenticatedUserListing */
final class ListInvitationsForAuthenticatedUserListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Repos\ListInvitationsForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
