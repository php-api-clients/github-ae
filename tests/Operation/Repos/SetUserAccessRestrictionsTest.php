...
use ApiClients\Client\GitHubAE\Operation\Repos\SetUserAccessRestrictions;
...
final class SetUserAccessRestrictionsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/users', Argument::type('array'), Schema\Repos\SetUserAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetUserAccessRestrictions::OPERATION_MATCH, (static function (array $data): array {
