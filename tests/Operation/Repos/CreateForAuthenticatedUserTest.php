...
use ApiClients\Client\GitHubAE\Operation\Repos\CreateForAuthenticatedUser;
...
final class CreateForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $client->call(CreateForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
