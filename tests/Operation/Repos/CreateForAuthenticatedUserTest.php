...
final class CreateForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/user/repos', \Prophecy\Argument::type('array'), Schema\Repos\CreateForAuthenticatedUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\CreateForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
            return $data;
