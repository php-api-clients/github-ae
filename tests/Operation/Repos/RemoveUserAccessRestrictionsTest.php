...
final class RemoveUserAccessRestrictionsTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/users', \Prophecy\Argument::type('array'), Schema\Repos\RemoveUserAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\RemoveUserAccessRestrictions::OPERATION_MATCH, (static function (array $data) : array {
