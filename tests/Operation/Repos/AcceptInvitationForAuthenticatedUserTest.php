...
use ApiClients\Client\GitHubAE\Operation\Repos\AcceptInvitationForAuthenticatedUser;
...
final class AcceptInvitationForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $client->call(AcceptInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
