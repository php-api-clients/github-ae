...
final class AcceptInvitationForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_403_responseContentType_application_json()
    {
        ...
        $browser->request('PATCH', '/user/repository_invitations/13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\AcceptInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
