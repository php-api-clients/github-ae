...
final class CreateDispatchEventTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/dispatches', Argument::type('array'), Schema\Repos\CreateDispatchEvent\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
