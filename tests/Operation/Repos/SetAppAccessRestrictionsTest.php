...
final class SetAppAccessRestrictionsTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/branches/generated_null/protection/restrictions/apps', \Prophecy\Argument::type('array'), Schema\Repos\SetAppAccessRestrictions\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Repos\SetAppAccessRestrictions::OPERATION_MATCH, (static function (array $data) : array {
