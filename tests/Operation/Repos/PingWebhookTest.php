...
use ApiClients\Client\GitHubAE\Operation\Repos\PingWebhook;
...
final class PingWebhookTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/hooks/13/pings', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
