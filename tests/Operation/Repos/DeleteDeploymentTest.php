...
use ApiClients\Client\GitHubAE\Operation\Repos\DeleteDeployment;
...
final class DeleteDeploymentTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/deployments/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteDeployment::OPERATION_MATCH, (static function (array $data): array {
