...
use ApiClients\Client\GitHubAE\Operation\Issues\Lock;
...
final class LockTest extends AsyncTestCase
{
    ...
    public function httpCode_403_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/issues/13/lock', Argument::type('array'), Schema\Issues\Lock\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Lock::OPERATION_MATCH, (static function (array $data): array {
