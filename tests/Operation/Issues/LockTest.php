...
final class LockTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/issues/12/lock', Argument::type('array'), Schema\Issues\Lock\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
