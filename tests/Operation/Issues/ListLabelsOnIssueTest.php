...
/** @covers \ApiClients\Client\GitHubAE\Operation\Issues\ListLabelsOnIssue */
final class ListLabelsOnIssueTest extends AsyncTestCase
{
    ...
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Issues\ListLabelsOnIssue::OPERATION_MATCH, (static function (array $data): array {
