...
use ApiClients\Client\GitHubAE\Operation\Issues\ListLabelsOnIssue;
...
final class ListLabelsOnIssueTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/issues/13/labels?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListLabelsOnIssue::OPERATION_MATCH, (static function (array $data): array {
