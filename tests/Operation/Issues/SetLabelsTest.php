...
use ApiClients\Client\GitHubAE\Operation\Issues\SetLabels;
...
final class SetLabelsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/issues/13/labels', Argument::type('array'), Schema\Issues\SetLabels\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetLabels::OPERATION_MATCH, (static function (array $data): array {
