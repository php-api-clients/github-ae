...
use ApiClients\Client\GitHubAE\Operation\Issues\Update;
...
final class UpdateTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/issues/13', Argument::type('array'), Schema\Issues\Update\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
