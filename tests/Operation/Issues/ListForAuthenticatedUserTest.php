...
use ApiClients\Client\GitHubAE\Operation\Issues\ListForAuthenticatedUser;
...
final class ListForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/user/issues?labels=generated_null&since=1970-01-01T00:00:00+00:00&filter=generated_null&state=generated_null&sort=generated_null&direction=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
