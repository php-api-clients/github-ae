...
use ApiClients\Client\GitHubAE\Operation\Issues\ListComments;
...
final class ListCommentsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/issues/13/comments?since=1970-01-01T00:00:00+00:00&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListComments::OPERATION_MATCH, (static function (array $data): array {
