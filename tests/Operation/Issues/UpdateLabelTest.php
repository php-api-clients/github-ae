...
use ApiClients\Client\GitHubAE\Operation\Issues\UpdateLabel;
...
final class UpdateLabelTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/labels/generated_null', Argument::type('array'), Schema\Issues\UpdateLabel\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateLabel::OPERATION_MATCH, (static function (array $data): array {
