...
/** @covers \ApiClients\Client\GitHubAE\Operation\Issues\ListLabelsOnIssueListing */
final class ListLabelsOnIssueListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Issues\ListLabelsOnIssueListing::OPERATION_MATCH, (static function (array $data): array {
