...
use ApiClients\Client\GitHubAE\Operation\Issues\UpdateComment;
...
final class UpdateCommentTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/issues/comments/13', Argument::type('array'), Schema\Issues\UpdateComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateComment::OPERATION_MATCH, (static function (array $data): array {
