...
use ApiClients\Client\GitHubAE\Operation\Issues\RemoveAllLabels;
...
final class RemoveAllLabelsTest extends AsyncTestCase
{
    ...
    public function httpCode_301_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/issues/13/labels', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveAllLabels::OPERATION_MATCH, (static function (array $data): array {
