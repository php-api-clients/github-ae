...
/** @covers \ApiClients\Client\GitHubAE\Operation\Issues\RemoveAllLabels */
final class RemoveAllLabelsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Issues\RemoveAllLabels::OPERATION_MATCH, (static function (array $data): array {
