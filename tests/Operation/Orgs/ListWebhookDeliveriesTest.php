...
final class ListWebhookDeliveriesTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/orgs/generated_null/hooks/13/deliveries?cursor=generated_null&redelivery=&per_page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Orgs\ListWebhookDeliveries::OPERATION_MATCH, array('org' => 'generated_null', 'hook_id' => 13, 'cursor' => 'generated_null', 'redelivery' => false, 'per_page' => 13));
    }
    /**
     * @test
     */
