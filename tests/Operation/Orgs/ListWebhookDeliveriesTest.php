...
use ApiClients\Client\GitHubAE\Operation\Orgs\ListWebhookDeliveries;
...
final class ListWebhookDeliveriesTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/orgs/generated_null/hooks/13/deliveries?cursor=generated_null&redelivery=&per_page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
