...
final class RedeliverWebhookDeliveryTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t202td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/orgs/generated_null/hooks/13/deliveries/13/attempts', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Orgs\RedeliverWebhookDelivery::OPERATION_MATCH, array('org' => 'generated_null', 'hook_id' => 13, 'delivery_id' => 13));
    }
    /**
     * @test
     */
