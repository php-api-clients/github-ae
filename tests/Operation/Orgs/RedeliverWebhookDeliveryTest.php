...
/** @covers \ApiClients\Client\GitHubAE\Operation\Orgs\RedeliverWebhookDelivery */
final class RedeliverWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Orgs\RedeliverWebhookDelivery::OPERATION_MATCH, (static function (array $data): array {
            $data['org']         = 'generated';
            $data['hook_id']     = 7;
            $data['delivery_id'] = 11;
