...
use ApiClients\Client\GitHubAE\Operation\Orgs\UpdateWebhook;
...
final class UpdateWebhookTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/orgs/generated_null/hooks/13', Argument::type('array'), Schema\Orgs\UpdateWebhook\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
