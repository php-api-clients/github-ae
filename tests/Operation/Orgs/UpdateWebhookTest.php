...
final class UpdateWebhookTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PATCH', '/orgs/generated_null/hooks/13', \Prophecy\Argument::type('array'), Schema\Orgs\UpdateWebhook\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Orgs\UpdateWebhook::OPERATION_MATCH, (static function (array $data) : array {
