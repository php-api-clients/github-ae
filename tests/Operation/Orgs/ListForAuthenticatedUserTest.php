...
use ApiClients\Client\GitHubAE\Operation\Orgs\ListForAuthenticatedUser;
...
final class ListForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/user/orgs?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
