...
use ApiClients\Client\GitHubAE\Operation\Orgs\SetMembershipForUser;
...
final class SetMembershipForUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/memberships/generated_null', Argument::type('array'), Schema\Orgs\SetMembershipForUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetMembershipForUser::OPERATION_MATCH, (static function (array $data): array {
