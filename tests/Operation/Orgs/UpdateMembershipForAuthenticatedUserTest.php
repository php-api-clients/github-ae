...
final class UpdateMembershipForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PATCH', '/user/memberships/orgs/generated_null', \Prophecy\Argument::type('array'), Schema\Orgs\UpdateMembershipForAuthenticatedUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Orgs\UpdateMembershipForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
