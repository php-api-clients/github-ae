...
use ApiClients\Client\GitHubAE\Operation\Reactions\CreateForRelease;
...
final class CreateForReleaseTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/releases/13/reactions', Argument::type('array'), Schema\Reactions\CreateForRelease\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateForRelease::OPERATION_MATCH, (static function (array $data): array {
