...
use ApiClients\Client\GitHubAE\Operation\Reactions\ListForIssue;
...
final class ListForIssueTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/issues/13/reactions?content=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListForIssue::OPERATION_MATCH, (static function (array $data): array {
