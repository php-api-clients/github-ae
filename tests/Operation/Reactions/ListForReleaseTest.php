...
final class ListForReleaseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/releases/13/reactions?content=generated_null&per_page=13&page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Reactions\ListForRelease::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'release_id' => 13, 'content' => 'generated_null', 'per_page' => 13, 'page' => 13));
    }
    /**
     * @test
     */
