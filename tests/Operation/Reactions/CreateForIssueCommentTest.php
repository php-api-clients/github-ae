...
use ApiClients\Client\GitHubAE\Operation\Reactions\CreateForIssueComment;
...
final class CreateForIssueCommentTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/issues/comments/13/reactions', Argument::type('array'), Schema\Reactions\CreateForIssueComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateForIssueComment::OPERATION_MATCH, (static function (array $data): array {
