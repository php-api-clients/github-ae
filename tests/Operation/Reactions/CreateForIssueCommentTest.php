...
final class CreateForIssueCommentTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/issues/comments/13/reactions', \Prophecy\Argument::type('array'), Schema\Reactions\CreateForIssueComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Reactions\CreateForIssueComment::OPERATION_MATCH, (static function (array $data) : array {
