...
use ApiClients\Client\GitHubAE\Operation\Actions\CreateOrUpdateOrgSecret;
...
final class CreateOrUpdateOrgSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/actions/secrets/generated_null', Argument::type('array'), Schema\Actions\CreateOrUpdateOrgSecret\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateOrUpdateOrgSecret::OPERATION_MATCH, (static function (array $data): array {
