...
use ApiClients\Client\GitHubAE\Operation\Actions\DownloadArtifactStreaming;
...
final class DownloadArtifactStreamingTest extends AsyncTestCase
{
    ...
    public function httpCode_410_responseContentType_application_json(): void
    {
        ...
        $client->call(DownloadArtifactStreaming::OPERATION_MATCH, (static function (array $data): array {
