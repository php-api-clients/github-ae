...
use ApiClients\Client\GitHubAE\Operation\Actions\CreateSelfHostedRunnerGroupForOrg;
...
final class CreateSelfHostedRunnerGroupForOrgTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/actions/runner-groups', Argument::type('array'), Schema\Actions\CreateSelfHostedRunnerGroupForOrg\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateSelfHostedRunnerGroupForOrg::OPERATION_MATCH, (static function (array $data): array {
