...
use ApiClients\Client\GitHubAE\Operation\Actions\CreateOrUpdateRepoSecret;
...
final class CreateOrUpdateRepoSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/actions/secrets/generated_null', Argument::type('array'), Schema\Actions\CreateOrUpdateRepoSecret\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
