...
final class CreateOrUpdateRepoSecretTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/actions/secrets/generated', Argument::type('array'), Schema\Actions\CreateOrUpdateRepoSecret\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Actions\CreateOrUpdateRepoSecret::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/actions/secrets/generated', Argument::type('array'), Schema\Actions\CreateOrUpdateRepoSecret\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->actions()->createOrUpdateRepoSecret('generated', 'generated', 'generated', json_decode(Schema\Actions\CreateOrUpdateRepoSecret\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
