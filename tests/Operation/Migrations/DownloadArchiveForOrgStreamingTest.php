...
use ApiClients\Client\GitHubAE\Operation\Migrations\DownloadArchiveForOrgStreaming;
...
final class DownloadArchiveForOrgStreamingTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $client->call(DownloadArchiveForOrgStreaming::OPERATION_MATCH, (static function (array $data): array {
