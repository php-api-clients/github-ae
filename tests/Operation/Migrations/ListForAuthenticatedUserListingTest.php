...
/** @covers \ApiClients\Client\GitHubAE\Operation\Migrations\ListForAuthenticatedUserListing */
final class ListForAuthenticatedUserListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Migrations\ListForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
