...
/** @covers \ApiClients\Client\GitHubAE\Operation\SecretScanning\ListAlertsForRepoListing */
final class ListAlertsForRepoListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\SecretScanning\ListAlertsForRepoListing::OPERATION_MATCH, (static function (array $data): array {
