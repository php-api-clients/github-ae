...
/** @covers \ApiClients\Client\GitHubAE\Operation\SecretScanning\ListLocationsForAlertListing */
final class ListLocationsForAlertListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\SecretScanning\ListLocationsForAlertListing::OPERATION_MATCH, (static function (array $data): array {
