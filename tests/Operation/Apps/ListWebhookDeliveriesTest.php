...
use ApiClients\Client\GitHubAE\Operation\Apps\ListWebhookDeliveries;
...
final class ListWebhookDeliveriesTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/app/hook/deliveries?cursor=generated_null&redelivery=&per_page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
