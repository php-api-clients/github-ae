...
/** @covers \ApiClients\Client\GitHubAE\Operation\Apps\ListWebhookDeliveries */
final class ListWebhookDeliveriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/app/hook/deliveries?cursor=generated&redelivery=&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Apps\ListWebhookDeliveries::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/app/hook/deliveries?cursor=generated&redelivery=&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->listWebhookDeliveries('generated', false, 8);
    }
