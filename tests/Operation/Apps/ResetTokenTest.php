...
use ApiClients\Client\GitHubAE\Operation\Apps\ResetToken;
...
final class ResetTokenTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/applications/generated_null/token', Argument::type('array'), Schema\Apps\ResetToken\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ResetToken::OPERATION_MATCH, (static function (array $data): array {
