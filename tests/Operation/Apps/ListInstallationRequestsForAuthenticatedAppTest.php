...
/** @covers \ApiClients\Client\GitHubAE\Operation\Apps\ListInstallationRequestsForAuthenticatedApp */
final class ListInstallationRequestsForAuthenticatedAppTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Apps\ListInstallationRequestsForAuthenticatedApp::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
