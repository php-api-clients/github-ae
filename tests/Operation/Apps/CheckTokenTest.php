...
use ApiClients\Client\GitHubAE\Operation\Apps\CheckToken;
...
final class CheckTokenTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/applications/generated_null/token', Argument::type('array'), Schema\Apps\CheckToken\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CheckToken::OPERATION_MATCH, (static function (array $data): array {
