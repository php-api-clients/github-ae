...
/** @covers \ApiClients\Client\GitHubAE\Operation\Apps\RedeliverWebhookDelivery */
final class RedeliverWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Apps\RedeliverWebhookDelivery::OPERATION_MATCH, (static function (array $data): array {
            $data['delivery_id'] = 11;
