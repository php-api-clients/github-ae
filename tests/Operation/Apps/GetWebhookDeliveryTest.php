...
use ApiClients\Client\GitHubAE\Operation\Apps\GetWebhookDelivery;
...
final class GetWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/app/hook/deliveries/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
