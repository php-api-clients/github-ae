...
/** @covers \ApiClients\Client\GitHubAE\Operation\Apps\GetWebhookDelivery */
final class GetWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Apps\GetWebhookDelivery::OPERATION_MATCH, (static function (array $data): array {
            $data['delivery_id'] = 11;
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/app/hook/deliveries/11', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->getWebhookDelivery(11);
    }
