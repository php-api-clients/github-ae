...
use ApiClients\Client\GitHubAE\Operation\Apps\DeleteToken;
...
final class DeleteTokenTest extends AsyncTestCase
{
    ...
    public function httpCode_422_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/applications/generated_null/token', Argument::type('array'), Schema\Apps\DeleteToken\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteToken::OPERATION_MATCH, (static function (array $data): array {
