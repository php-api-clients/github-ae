...
use ApiClients\Client\GitHubAE\Operation\Apps\GetBySlug;
...
final class GetBySlugTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/apps/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetBySlug::OPERATION_MATCH, (static function (array $data): array {
