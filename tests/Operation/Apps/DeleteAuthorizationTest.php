...
final class DeleteAuthorizationTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_422_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/applications/generated_null/grant', \Prophecy\Argument::type('array'), Schema\Apps\DeleteAuthorization\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Apps\DeleteAuthorization::OPERATION_MATCH, (static function (array $data) : array {
