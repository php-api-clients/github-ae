...
use ApiClients\Client\GitHubAE\Operation\Apps\GetRepoInstallation;
...
final class GetRepoInstallationTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/installation', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetRepoInstallation::OPERATION_MATCH, (static function (array $data): array {
