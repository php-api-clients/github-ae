...
use ApiClients\Client\GitHubAE\Operation\Apps\CreateInstallationAccessToken;
...
final class CreateInstallationAccessTokenTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/app/installations/13/access_tokens', Argument::type('array'), Schema\Apps\CreateInstallationAccessToken\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateInstallationAccessToken::OPERATION_MATCH, (static function (array $data): array {
