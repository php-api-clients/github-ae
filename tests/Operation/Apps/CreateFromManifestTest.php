...
final class CreateFromManifestTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/app-manifests/generated_null/conversions', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Apps\CreateFromManifest::OPERATION_MATCH, array('code' => 'generated_null'));
    }
    /**
     * @test
     */
