...
final class ReposTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], Schema\Operations\Search\Repos\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA);
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/search/repositories?q=generated&sort=generated&order=generated&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->search()->repos('generated', 'generated', 'generated', 8, 4));
    }
