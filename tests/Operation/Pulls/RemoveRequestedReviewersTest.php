...
use ApiClients\Client\GitHubAE\Operation\Pulls\RemoveRequestedReviewers;
...
final class RemoveRequestedReviewersTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/pulls/13/requested_reviewers', Argument::type('array'), Schema\Pulls\RemoveRequestedReviewers\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveRequestedReviewers::OPERATION_MATCH, (static function (array $data): array {
