...
final class UpdateReviewTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/pulls/13/reviews/13', \Prophecy\Argument::type('array'), Schema\Pulls\UpdateReview\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Pulls\UpdateReview::OPERATION_MATCH, (static function (array $data) : array {
