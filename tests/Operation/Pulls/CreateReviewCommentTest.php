...
final class CreateReviewCommentTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/pulls/13/comments', \Prophecy\Argument::type('array'), Schema\Pulls\CreateReviewComment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubAE\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubAE\Operation\Pulls\CreateReviewComment::OPERATION_MATCH, (static function (array $data) : array {
