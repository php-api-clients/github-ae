...
use ApiClients\Client\GitHubAE\Operation\Pulls\CreateReview;
...
final class CreateReviewTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/pulls/13/reviews', Argument::type('array'), Schema\Pulls\CreateReview\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateReview::OPERATION_MATCH, (static function (array $data): array {
