...
use ApiClients\Client\GitHubAE\Operation\Pulls\Create;
...
final class CreateTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/pulls', Argument::type('array'), Schema\Pulls\Create\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
