...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Licenses\GetAllCommonlyUsedListing */
final class GetAllCommonlyUsedListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_304_empty(): void
    {
        ...
        $result = $client->call(Internal\Operation\Licenses\GetAllCommonlyUsedListing::OPERATION_MATCH, (static function (array $data): array {
            $data['featured'] = false;
            $data['per_page'] = 8;
            $data['page']     = 1;
