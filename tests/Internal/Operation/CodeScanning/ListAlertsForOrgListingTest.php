...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\CodeScanning\ListAlertsForOrgListing */
final class ListAlertsForOrgListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\CodeScanning\ListAlertsForOrgListing::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/code-scanning/alerts?tool_name=generated&tool_guid=&before=generated&after=generated&state=generated&severity=generated&page=1&per_page=8&direction=generated&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->listAlertsForOrgListing('generated', 'generated', null, 'generated', 'generated', 'generated', 'generated', 1, 8, 'generated', 'generated');
        foreach ($result as $item) {
        }
    }
