...
namespace ApiClients\Tests\Client\GitHubAE\Internal\Operation\CodeScanning;
...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\CodeScanning\UploadSarif */
final class UploadSarifTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\CodeScanningSarifsReceipt::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('POST', '/repos/generated/generated/code-scanning/sarifs', Argument::type('array'), json_encode(json_decode(Schema\CodeScanning\UploadSarif\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\CodeScanning\UploadSarif::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_202_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/code-scanning/sarifs', Argument::type('array'), json_encode(json_decode(Schema\CodeScanning\UploadSarif\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->uploadSarif('generated', 'generated', json_decode(Schema\CodeScanning\UploadSarif\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
