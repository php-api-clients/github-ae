...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\CreateForCommitComment */
final class CreateForCommitCommentTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/comments/10/reactions', Argument::type('array'), json_encode(json_decode(Schema\Reactions\CreateForCommitComment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Reactions\CreateForCommitComment::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/comments/10/reactions', Argument::type('array'), json_encode(json_decode(Schema\Reactions\CreateForCommitComment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->reactions()->createForCommitComment('generated', 'generated', 10, json_decode(Schema\Reactions\CreateForCommitComment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
