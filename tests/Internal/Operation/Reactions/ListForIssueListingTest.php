...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Reactions\ListForIssueListing */
final class ListForIssueListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Reactions\ListForIssueListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/reactions?content=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->reactions()->listForIssueListing('generated', 'generated', 12, 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
