...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\CreateForAuthenticatedUser */
final class CreateForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/projects', Argument::type('array'), json_encode(json_decode(Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\CreateForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/projects', Argument::type('array'), json_encode(json_decode(Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->createForAuthenticatedUser(json_decode(Schema\Projects\CreateForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
