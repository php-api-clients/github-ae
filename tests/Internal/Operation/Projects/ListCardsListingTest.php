...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListCardsListing */
final class ListCardsListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Projects\ListCardsListing::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id']      = 9;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/columns/9/cards?archived_state=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->listCardsListing(9, 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
