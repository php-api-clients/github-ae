...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\DeleteColumn */
final class DeleteColumnTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/projects/columns/9', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\DeleteColumn::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id'] = 9;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/projects/columns/9', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->deleteColumn(9);
    }
