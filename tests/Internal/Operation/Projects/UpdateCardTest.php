...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\UpdateCard */
final class UpdateCardTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\ProjectCard::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('PATCH', '/projects/columns/cards/7', Argument::type('array'), json_encode(json_decode(Schema\Projects\UpdateCard\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\UpdateCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 7;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/projects/columns/cards/7', Argument::type('array'), json_encode(json_decode(Schema\Projects\UpdateCard\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->updateCard(7, json_decode(Schema\Projects\UpdateCard\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
