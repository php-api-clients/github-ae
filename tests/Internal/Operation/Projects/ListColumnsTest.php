...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListColumns */
final class ListColumnsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Projects\ListColumns::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 10;
            $data['per_page']   = 8;
            $data['page']       = 1;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/10/columns?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->listColumns(10, 8, 1);
    }
