...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\RemoveCollaborator */
final class RemoveCollaboratorTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/projects/10/collaborators/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\RemoveCollaborator::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 10;
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/projects/10/collaborators/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->removeCollaborator(10, 'generated');
    }
