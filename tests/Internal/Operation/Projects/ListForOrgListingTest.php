...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListForOrgListing */
final class ListForOrgListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Projects\ListForOrgListing::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
    ...
    public function operations_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/projects?state=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->listForOrgListing('generated', 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
}
