...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\ListCollaboratorsListing */
final class ListCollaboratorsListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/10/collaborators?affiliation=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\ListCollaboratorsListing::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id']  = 10;
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/10/collaborators?affiliation=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->listCollaboratorsListing(10, 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
