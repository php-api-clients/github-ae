...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Projects\CreateForRepo */
final class CreateForRepoTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/projects', Argument::type('array'), json_encode(json_decode(Schema\Projects\CreateForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Projects\CreateForRepo::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/projects', Argument::type('array'), json_encode(json_decode(Schema\Projects\CreateForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->createForRepo('generated', 'generated', json_decode(Schema\Projects\CreateForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
