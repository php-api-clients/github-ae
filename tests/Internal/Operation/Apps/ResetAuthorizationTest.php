...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Apps\ResetAuthorization */
final class ResetAuthorizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Apps\ResetAuthorization::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/applications/generated/tokens/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->resetAuthorization('generated', 'generated');
    }
}
