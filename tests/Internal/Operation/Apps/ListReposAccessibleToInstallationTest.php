...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Apps\ListReposAccessibleToInstallation */
final class ListReposAccessibleToInstallationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Apps\ListReposAccessibleToInstallation\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\Apps\ListReposAccessibleToInstallation::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
