...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Actions\ForceCancelWorkflowRun */
final class ForceCancelWorkflowRunTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runs/6/force-cancel', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Actions\ForceCancelWorkflowRun::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runs/6/force-cancel', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->actions()->forceCancelWorkflowRun('generated', 'generated', 6);
    }
