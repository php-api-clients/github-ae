...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\SecretScanning\ListAlertsForRepoListing */
final class ListAlertsForRepoListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\SecretScanning\ListAlertsForRepoListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/secret-scanning/alerts?state=generated&secret_type=generated&resolution=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->secretScanning()->listAlertsForRepoListing('generated', 'generated', 'generated', 'generated', 'generated', 1, 8);
        foreach ($result as $item) {
        }
    }
