...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\SecretScanning\ListLocationsForAlertListing */
final class ListLocationsForAlertListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\SecretScanning\ListLocationsForAlertListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_503_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/secret-scanning/alerts/12/locations?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->secretScanning()->listLocationsForAlertListing('generated', 'generated', 12, 1, 8);
        foreach ($result as $item) {
        }
    }
