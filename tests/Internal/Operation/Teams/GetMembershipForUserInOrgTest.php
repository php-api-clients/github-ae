...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Teams\GetMembershipForUserInOrg */
final class GetMembershipForUserInOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Teams\GetMembershipForUserInOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/teams/generated/memberships/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->teams()->getMembershipForUserInOrg('generated', 'generated', 'generated');
    }
