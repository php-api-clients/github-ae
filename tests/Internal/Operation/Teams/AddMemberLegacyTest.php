...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Teams\AddMemberLegacy */
final class AddMemberLegacyTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/teams/7/members/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Teams\AddMemberLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']  = 7;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/teams/7/members/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->teams()->addMemberLegacy(7, 'generated');
    }
