...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Teams\GetDiscussionCommentInOrg */
final class GetDiscussionCommentInOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Teams\GetDiscussionCommentInOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']               = 'generated';
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/teams/generated/discussions/17/comments/14', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->teams()->getDiscussionCommentInOrg('generated', 'generated', 17, 14);
    }
}
