...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\EnterpriseAdmin\UpdateGlobalWebhook */
final class UpdateGlobalWebhookTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\EnterpriseAdmin\UpdateGlobalWebhook::OPERATION_MATCH, (static function (array $data): array {
            $data['hook_id'] = 7;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/admin/hooks/7', Argument::type('array'), json_encode(json_decode(Schema\EnterpriseAdmin\UpdateGlobalWebhook\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->enterpriseAdmin()->updateGlobalWebhook(7, json_decode(Schema\EnterpriseAdmin\UpdateGlobalWebhook\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
}
