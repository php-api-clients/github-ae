...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Repos\CreateFork */
final class CreateForkTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_202_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/forks', Argument::type('array'), json_encode(json_decode(Schema\Repos\CreateFork\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Repos\CreateFork::OPERATION_MATCH, (static function (array $data): array {
            $data['owner'] = 'generated';
            $data['repo']  = 'generated';

            return $data;
        })(json_decode(Schema\Repos\CreateFork\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_202_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/forks', Argument::type('array'), json_encode(json_decode(Schema\Repos\CreateFork\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->createFork('generated', 'generated', json_decode(Schema\Repos\CreateFork\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
