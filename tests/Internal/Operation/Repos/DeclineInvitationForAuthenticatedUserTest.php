...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Repos\DeclineInvitationForAuthenticatedUser */
final class DeclineInvitationForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Repos\DeclineInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/repository_invitations/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->declineInvitationForAuthenticatedUser(13);
    }
