...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Repos\GetDeploymentBranchPolicy */
final class GetDeploymentBranchPolicyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Repos\GetDeploymentBranchPolicy::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/environments/generated/deployment-branch-policies/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->getDeploymentBranchPolicy('generated', 'generated', 'generated', 16);
    }
}
