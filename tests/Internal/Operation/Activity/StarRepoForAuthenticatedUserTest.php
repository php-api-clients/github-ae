...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Activity\StarRepoForAuthenticatedUser */
final class StarRepoForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Activity\StarRepoForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/starred/generated/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->starRepoForAuthenticatedUser('generated', 'generated');
    }
