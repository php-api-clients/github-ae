...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Activity\CheckRepoIsStarredByAuthenticatedUser */
final class CheckRepoIsStarredByAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/starred/generated/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Activity\CheckRepoIsStarredByAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/starred/generated/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->checkRepoIsStarredByAuthenticatedUser('generated', 'generated');
    }
