...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser */
final class GetThreadSubscriptionForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/notifications/threads/9/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/notifications/threads/9/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->getThreadSubscriptionForAuthenticatedUser(9);
    }
