...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Activity\DeleteThreadSubscription */
final class DeleteThreadSubscriptionTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/notifications/threads/9/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Activity\DeleteThreadSubscription::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/notifications/threads/9/subscription', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->deleteThreadSubscription(9);
    }
