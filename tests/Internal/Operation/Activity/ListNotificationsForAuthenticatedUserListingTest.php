...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Activity\ListNotificationsForAuthenticatedUserListing */
final class ListNotificationsForAuthenticatedUserListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Activity\ListNotificationsForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/notifications?since=1970-01-01T00:00:00+00:00&before=1970-01-01T00:00:00+00:00&all=&participating=&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->listNotificationsForAuthenticatedUserListing('1970-01-01T00:00:00+00:00', '1970-01-01T00:00:00+00:00', false, false, 1, 8);
        foreach ($result as $item) {
        }
    }
