...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Issues\Lock */
final class LockTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/issues/12/lock', Argument::type('array'), json_encode(json_decode(Schema\Issues\Lock\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Issues\Lock::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/issues/12/lock', Argument::type('array'), json_encode(json_decode(Schema\Issues\Lock\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->issues()->lock('generated', 'generated', 12, json_decode(Schema\Issues\Lock\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
