...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListLabelsOnIssueListing */
final class ListLabelsOnIssueListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/labels?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Issues\ListLabelsOnIssueListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/labels?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->issues()->listLabelsOnIssueListing('generated', 'generated', 12, 8, 1);
        foreach ($result as $item) {
        }
    }
