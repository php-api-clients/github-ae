...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Issues\ListLabelsOnIssue */
final class ListLabelsOnIssueTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Issues\ListLabelsOnIssue::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/labels?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->issues()->listLabelsOnIssue('generated', 'generated', 12, 8, 1);
    }
