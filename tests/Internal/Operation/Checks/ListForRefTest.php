...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Checks\ListForRef */
final class ListForRefTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Checks\ListForRef\Response\ApplicationJson\Ok\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\Checks\ListForRef::OPERATION_MATCH, (static function (array $data): array {
