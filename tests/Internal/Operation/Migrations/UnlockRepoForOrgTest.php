...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\UnlockRepoForOrg */
final class UnlockRepoForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Migrations\UnlockRepoForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']          = 'generated';
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/migrations/12/repos/generated/lock', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->migrations()->unlockRepoForOrg('generated', 12, 'generated');
    }
