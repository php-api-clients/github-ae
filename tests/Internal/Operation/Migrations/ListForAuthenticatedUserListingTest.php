...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Migrations\ListForAuthenticatedUserListing */
final class ListForAuthenticatedUserListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/migrations?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Migrations\ListForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/migrations?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->migrations()->listForAuthenticatedUserListing(8, 1);
        foreach ($result as $item) {
        }
    }
