...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Users\UpdateAuthenticated */
final class UpdateAuthenticatedTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\PrivateUser::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('PATCH', '/user', Argument::type('array'), json_encode(json_decode(Schema\Users\UpdateAuthenticated\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Users\UpdateAuthenticated::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/user', Argument::type('array'), json_encode(json_decode(Schema\Users\UpdateAuthenticated\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->updateAuthenticated(json_decode(Schema\Users\UpdateAuthenticated\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
