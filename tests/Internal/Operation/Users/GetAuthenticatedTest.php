...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Users\GetAuthenticated */
final class GetAuthenticatedTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Users\GetAuthenticated::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })([]));
    }
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->getAuthenticated();
    }
