...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Users\List_ */
final class List_Test extends AsyncTestCase
{
    ...
    public function call_httpCode_304_empty(): void
    {
        ...
        $result = $client->call(Internal\Operation\Users\List_::OPERATION_MATCH, (static function (array $data): array {
            $data['since']    = 5;
            $data['per_page'] = 8;
