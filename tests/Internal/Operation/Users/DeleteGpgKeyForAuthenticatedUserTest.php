...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Users\DeleteGpgKeyForAuthenticatedUser */
final class DeleteGpgKeyForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/gpg_keys/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Users\DeleteGpgKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['gpg_key_id'] = 10;
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/gpg_keys/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->deleteGpgKeyForAuthenticatedUser(10);
    }
