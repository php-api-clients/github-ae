...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Users\DeletePublicSshKeyForAuthenticatedUser */
final class DeletePublicSshKeyForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/keys/6', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Users\DeletePublicSshKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['key_id'] = 6;
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/keys/6', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->deletePublicSshKeyForAuthenticatedUser(6);
    }
