...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\UpdateWebhookConfigForOrg */
final class UpdateWebhookConfigForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\UpdateWebhookConfigForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']     = 'generated';
            $data['hook_id'] = 7;
