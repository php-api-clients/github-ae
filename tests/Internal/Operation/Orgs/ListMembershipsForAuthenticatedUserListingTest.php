...
/** @covers \ApiClients\Client\GitHubAE\Internal\Operation\Orgs\ListMembershipsForAuthenticatedUserListing */
final class ListMembershipsForAuthenticatedUserListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\ListMembershipsForAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/memberships/orgs?state=generated&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->listMembershipsForAuthenticatedUserListing('generated', 8, 1);
        foreach ($result as $item) {
        }
    }
