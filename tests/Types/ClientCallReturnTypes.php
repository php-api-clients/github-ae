...
assertType('Observable<Schema\\GlobalHook>', $client->call('GET /admin/hooks'));
assertType('Observable<Schema\\GlobalHook>', $client->call('LIST /admin/hooks'));
...
assertType('Observable<Schema\\PublicKeyFull>', $client->call('GET /admin/keys'));
assertType('Observable<Schema\\PublicKeyFull>', $client->call('LIST /admin/keys'));
...
assertType('Observable<Schema\\PreReceiveEnvironment>', $client->call('GET /admin/pre-receive-environments'));
assertType('Observable<Schema\\PreReceiveEnvironment>', $client->call('LIST /admin/pre-receive-environments'));
...
assertType('Observable<Schema\\Authorization>', $client->call('GET /admin/tokens'));
assertType('Observable<Schema\\Authorization>', $client->call('LIST /admin/tokens'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/permissions/organizations'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/runner-groups'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/runners'));
...
assertType('Observable<Schema\\AuditLogEvent>', $client->call('GET /enterprises/{enterprise}/audit-log'));
assertType('Observable<Schema\\AuditLogEvent>', $client->call('LIST /enterprises/{enterprise}/audit-log'));
...
assertType('Observable<Schema\\AuditLogEvent>', $client->call('LIST /orgs/{org}/audit-log'));
...
assertType('Schema\\FullRepository', $client->call('POST /orgs/{org}/repos'));
...
assertType('Observable<Schema\\PullRequestSimple>', $client->call('GET /repos/{owner}/{repo}/commits/{commit_sha}/pulls'));
assertType('Observable<Schema\\PullRequestSimple>', $client->call('LIST /repos/{owner}/{repo}/commits/{commit_sha}/pulls'));
...
assertType('Schema\\FullRepository', $client->call('POST /repos/{template_owner}/{template_repo}/generate'));
...
assertType('Schema\\FullRepository|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('POST /user/repos'));
